                  ...
                  double * const restrict INT__p_d_f_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_d_f_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_f_f_s = work + (SIMINT_NSHELL_SIMD * 150);
    double * const INT__s_f_g_s = work + (SIMINT_NSHELL_SIMD * 250);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_p_s = primwork + 175;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_d_s = primwork + 202;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_f_s = primwork + 256;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_g_s = primwork + 346;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_d_s = primwork + 481;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_f_s = primwork + 553;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_g_s = primwork + 673;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_f_s = primwork + 853;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_g_s = primwork + 953;
    double * const hrrwork = (double *)(primwork + 1103);
    double * const HRR_INT__p_d_f_s = hrrwork + 0;
    double * const HRR_INT__p_d_g_s = hrrwork + 180;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_d_f_p = INT__p_d_f_p + real_abcd * 540;
