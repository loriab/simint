                  ...
                  double * const restrict INT__f_d_g_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_d_g_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 1890;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 1962;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 2106;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 2346;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_h_s = primwork + 2706;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_i_s = primwork + 3210;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 3882;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 4062;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 4362;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_h_s = primwork + 4812;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_i_s = primwork + 5442;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 6282;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 6582;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 7032;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_i_s = primwork + 7662;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_g_s = primwork + 8502;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_h_s = primwork + 8817;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_i_s = primwork + 9258;
    ...
    double * const HRR_INT__f_d_g_p = hrrwork + 2820;
    double * const HRR_INT__f_d_h_s = hrrwork + 5520;
    double * const HRR_INT__f_d_h_p = hrrwork + 6780;
    double * const HRR_INT__f_d_i_s = hrrwork + 10560;
    double * const HRR_INT__g_p_g_s = hrrwork + 12240;
    double * const HRR_INT__g_p_h_s = hrrwork + 12915;
    double * const HRR_INT__g_p_i_s = hrrwork + 13860;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_d_g_d = INT__f_d_g_d + real_abcd * 5400;
                  ...
                  double * const restrict INT__d_f_g_d)
{
    ...
    int ret = ostei_f_d_g_d(P_tmp, Q, screen_tol, work, INT__d_f_g_d);
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 15; ++c)
        for(int d = 0; d < 6; ++d)
            buffer[idx++] = INT__d_f_g_d[q*5400+b*540+a*90+c*6+d];

        memcpy(INT__d_f_g_d+q*5400, buffer, 5400*sizeof(double));
    }
                  ...
                  double * const restrict INT__f_d_d_g)
{
    ...
    int ret = ostei_f_d_g_d(P, Q_tmp, screen_tol, work, INT__f_d_d_g);
    double buffer[5400] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 6; ++c)
        for(int d = 0; d < 15; ++d)
            buffer[idx++] = INT__f_d_d_g[q*5400+a*540+b*90+d*6+c];

        memcpy(INT__f_d_d_g+q*5400, buffer, 5400*sizeof(double));
    }
                  ...
                  double * const restrict INT__d_f_d_g)
{
    ...
    int ret = ostei_f_d_g_d(P_tmp, Q_tmp, screen_tol, work, INT__d_f_d_g);
    double buffer[5400] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 6; ++c)
        for(int d = 0; d < 15; ++d)
            buffer[idx++] = INT__d_f_d_g[q*5400+b*540+a*90+d*6+c];

        memcpy(INT__d_f_d_g+q*5400, buffer, 5400*sizeof(double));
    }
