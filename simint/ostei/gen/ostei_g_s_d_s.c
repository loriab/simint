                  ...
                  double * const restrict INT__g_s_d_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_s_d_s);
    memset(INT__g_s_d_s, 0, P.nshell12_clip * Q.nshell12_clip * 90 * sizeof(double));
                  ...
                  double * const restrict INT__s_g_d_s)
{
    ...
    int ret = ostei_g_s_d_s(P_tmp, Q, screen_tol, work, INT__s_g_d_s);
                  ...
                  double * const restrict INT__g_s_s_d)
{
    ...
    int ret = ostei_g_s_d_s(P, Q_tmp, screen_tol, work, INT__g_s_s_d);
                  ...
                  double * const restrict INT__s_g_s_d)
{
    ...
    int ret = ostei_g_s_d_s(P_tmp, Q_tmp, screen_tol, work, INT__s_g_s_d);
