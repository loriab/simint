                  ...
                  double * const restrict INT__p_s_d_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_s_d_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 55;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 73;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_s_d_p = INT__p_s_d_p + real_abcd * 54;
