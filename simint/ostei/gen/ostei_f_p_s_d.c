                  ...
                  double * const restrict INT__f_p_s_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_p_s_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_p = primwork + 55;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 91;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_p = primwork + 131;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_d = primwork + 191;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 251;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_p = primwork + 296;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_d = primwork + 386;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_p_s_d = INT__f_p_s_d + real_abcd * 180;
