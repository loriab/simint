                  ...
                  double * const restrict INT__f_f_p_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_f_p_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    // partition workspace
    double * const INT__f_s_p_s = work + (SIMINT_NSHELL_SIMD * 0);
    double * const INT__f_s_d_s = work + (SIMINT_NSHELL_SIMD * 30);
    double * const INT__g_s_p_s = work + (SIMINT_NSHELL_SIMD * 90);
    double * const INT__g_s_d_s = work + (SIMINT_NSHELL_SIMD * 135);
    double * const INT__h_s_p_s = work + (SIMINT_NSHELL_SIMD * 225);
    double * const INT__h_s_d_s = work + (SIMINT_NSHELL_SIMD * 288);
    double * const INT__i_s_p_s = work + (SIMINT_NSHELL_SIMD * 414);
    double * const INT__i_s_d_s = work + (SIMINT_NSHELL_SIMD * 498);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 75;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 111;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 171;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 231;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 291;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 366;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 456;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 546;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 630;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_d_s = primwork + 756;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 882;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_p_s = primwork + 966;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_d_s = primwork + 1134;
    double * const hrrwork = (double *)(primwork + 1302);
    double * const HRR_INT__f_p_p_s = hrrwork + 0;
    double * const HRR_INT__f_p_d_s = hrrwork + 90;
    double * const HRR_INT__f_d_p_s = hrrwork + 270;
    double * const HRR_INT__f_d_d_s = hrrwork + 450;
    double * const HRR_INT__f_f_p_s = hrrwork + 810;
    double * const HRR_INT__f_f_d_s = hrrwork + 1110;
    double * const HRR_INT__g_p_p_s = hrrwork + 1710;
    double * const HRR_INT__g_p_d_s = hrrwork + 1845;
    double * const HRR_INT__g_d_p_s = hrrwork + 2115;
    double * const HRR_INT__g_d_d_s = hrrwork + 2385;
    double * const HRR_INT__h_p_p_s = hrrwork + 2925;
    double * const HRR_INT__h_p_d_s = hrrwork + 3114;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_f_p_p = INT__f_f_p_p + real_abcd * 900;
                ...
                for(iket = 0; iket < 3; ++iket)
                {
                    ...
                    HRR_INT__f_p_p_s[1 * 3 + iket] = HRR_INT__g_s_p_s[1 * 3 + iket] + ( hAB[1] * HRR_INT__f_s_p_s[0 * 3 + iket] );

                    HRR_INT__f_p_p_s[2 * 3 + iket] = HRR_INT__g_s_p_s[2 * 3 + iket] + ( hAB[2] * HRR_INT__f_s_p_s[0 * 3 + iket] );
                    ...
                    HRR_INT__f_p_p_s[5 * 3 + iket] = HRR_INT__g_s_p_s[4 * 3 + iket] + ( hAB[2] * HRR_INT__f_s_p_s[1 * 3 + iket] );
                    ...
                    HRR_INT__f_p_p_s[11 * 3 + iket] = HRR_INT__g_s_p_s[7 * 3 + iket] + ( hAB[2] * HRR_INT__f_s_p_s[3 * 3 + iket] );
                    ...
                    HRR_INT__f_p_p_s[20 * 3 + iket] = HRR_INT__g_s_p_s[11 * 3 + iket] + ( hAB[2] * HRR_INT__f_s_p_s[6 * 3 + iket] );
                ...
                {
                    HRR_INT__f_f_p_p[ibra * 9 + 0] = HRR_INT__f_f_d_s[ibra * 6 + 0] + ( hCD[0] * HRR_INT__f_f_p_s[ibra * 3 + 0] );

                    HRR_INT__f_f_p_p[ibra * 9 + 1] = HRR_INT__f_f_d_s[ibra * 6 + 1] + ( hCD[1] * HRR_INT__f_f_p_s[ibra * 3 + 0] );

                    HRR_INT__f_f_p_p[ibra * 9 + 2] = HRR_INT__f_f_d_s[ibra * 6 + 2] + ( hCD[2] * HRR_INT__f_f_p_s[ibra * 3 + 0] );

                    HRR_INT__f_f_p_p[ibra * 9 + 3] = HRR_INT__f_f_d_s[ibra * 6 + 1] + ( hCD[0] * HRR_INT__f_f_p_s[ibra * 3 + 1] );

                    HRR_INT__f_f_p_p[ibra * 9 + 4] = HRR_INT__f_f_d_s[ibra * 6 + 3] + ( hCD[1] * HRR_INT__f_f_p_s[ibra * 3 + 1] );

                    HRR_INT__f_f_p_p[ibra * 9 + 5] = HRR_INT__f_f_d_s[ibra * 6 + 4] + ( hCD[2] * HRR_INT__f_f_p_s[ibra * 3 + 1] );

                    HRR_INT__f_f_p_p[ibra * 9 + 6] = HRR_INT__f_f_d_s[ibra * 6 + 2] + ( hCD[0] * HRR_INT__f_f_p_s[ibra * 3 + 2] );

                    HRR_INT__f_f_p_p[ibra * 9 + 7] = HRR_INT__f_f_d_s[ibra * 6 + 4] + ( hCD[1] * HRR_INT__f_f_p_s[ibra * 3 + 2] );

                    HRR_INT__f_f_p_p[ibra * 9 + 8] = HRR_INT__f_f_d_s[ibra * 6 + 5] + ( hCD[2] * HRR_INT__f_f_p_s[ibra * 3 + 2] );
