                  ...
                  double * const restrict INT__p_s_s_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_s_s_p);
    memset(INT__p_s_s_p, 0, P.nshell12_clip * Q.nshell12_clip * 9 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_p = primwork + 9;
    double * const hrrwork = (double *)(primwork + 18);
