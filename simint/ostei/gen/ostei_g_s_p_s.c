                  ...
                  double * const restrict INT__g_s_p_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_s_p_s);
    memset(INT__g_s_p_s, 0, P.nshell12_clip * Q.nshell12_clip * 45 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 105;
                  ...
                  double * const restrict INT__s_g_p_s)
{
    ...
    int ret = ostei_g_s_p_s(P_tmp, Q, screen_tol, work, INT__s_g_p_s);
                  ...
                  double * const restrict INT__g_s_s_p)
{
    ...
    int ret = ostei_g_s_p_s(P, Q_tmp, screen_tol, work, INT__g_s_s_p);
                  ...
                  double * const restrict INT__s_g_s_p)
{
    ...
    int ret = ostei_g_s_p_s(P_tmp, Q_tmp, screen_tol, work, INT__s_g_s_p);
