                  ...
                  double * const restrict INT__f_s_g_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_s_g_s);
    memset(INT__f_s_g_s, 0, P.nshell12_clip * Q.nshell12_clip * 150 * sizeof(double));
                  ...
                  double * const restrict INT__s_f_g_s)
{
    ...
    int ret = ostei_f_s_g_s(P_tmp, Q, screen_tol, work, INT__s_f_g_s);
                  ...
                  double * const restrict INT__f_s_s_g)
{
    ...
    int ret = ostei_f_s_g_s(P, Q_tmp, screen_tol, work, INT__f_s_s_g);
                  ...
                  double * const restrict INT__s_f_s_g)
{
    ...
    int ret = ostei_f_s_g_s(P_tmp, Q_tmp, screen_tol, work, INT__s_f_s_g);
