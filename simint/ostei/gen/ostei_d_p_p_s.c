                  ...
                  double * const restrict INT__d_p_p_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_p_p_s);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 35;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 53;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 73;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_p_p_s = INT__d_p_p_s + real_abcd * 54;
