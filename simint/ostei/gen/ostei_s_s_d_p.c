                  ...
                  double * const restrict INT__s_s_d_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_s_d_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_p_s = primwork + 4;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_d_s = primwork + 13;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_f_s = primwork + 25;
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    // Forming PRIM_INT__s_s_f_s[1 * 10];
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__s_s_d_p = INT__s_s_d_p + real_abcd * 18;
