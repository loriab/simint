                  ...
                  double * const restrict INT__p_p_p_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_p_p_s);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__d_s_p_s = work + (SIMINT_NSHELL_SIMD * 9);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 13;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 22;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 34;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_p_p_s = INT__p_p_p_s + real_abcd * 27;
