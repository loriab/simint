                  ...
                  double * const restrict INT__s_f_d_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_f_d_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const HRR_INT__s_f_p_f = hrrwork + 0;
    double * const HRR_INT__s_f_p_g = hrrwork + 300;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__s_f_d_f = INT__s_f_d_f + real_abcd * 600;

                // form INT__s_f_p_f
                for(ibra = 0; ibra < 10; ++ibra)
                {
                    HRR_INT__s_f_p_f[ibra * 30 + 0] = HRR_INT__s_f_s_g[ibra * 15 + 0] - ( hCD[0] * HRR_INT__s_f_s_f[ibra * 10 + 0] );

                    HRR_INT__s_f_p_f[ibra * 30 + 1] = HRR_INT__s_f_s_g[ibra * 15 + 1] - ( hCD[0] * HRR_INT__s_f_s_f[ibra * 10 + 1] );

                    HRR_INT__s_f_p_f[ibra * 30 + 2] = HRR_INT__s_f_s_g[ibra * 15 + 2] - ( hCD[0] * HRR_INT__s_f_s_f[ibra * 10 + 2] );

                    HRR_INT__s_f_p_f[ibra * 30 + 3] = HRR_INT__s_f_s_g[ibra * 15 + 3] - ( hCD[0] * HRR_INT__s_f_s_f[ibra * 10 + 3] );

                    HRR_INT__s_f_p_f[ibra * 30 + 4] = HRR_INT__s_f_s_g[ibra * 15 + 4] - ( hCD[0] * HRR_INT__s_f_s_f[ibra * 10 + 4] );

                    HRR_INT__s_f_p_f[ibra * 30 + 5] = HRR_INT__s_f_s_g[ibra * 15 + 5] - ( hCD[0] * HRR_INT__s_f_s_f[ibra * 10 + 5] );

                    HRR_INT__s_f_p_f[ibra * 30 + 6] = HRR_INT__s_f_s_g[ibra * 15 + 6] - ( hCD[0] * HRR_INT__s_f_s_f[ibra * 10 + 6] );

                    HRR_INT__s_f_p_f[ibra * 30 + 7] = HRR_INT__s_f_s_g[ibra * 15 + 7] - ( hCD[0] * HRR_INT__s_f_s_f[ibra * 10 + 7] );

                    HRR_INT__s_f_p_f[ibra * 30 + 8] = HRR_INT__s_f_s_g[ibra * 15 + 8] - ( hCD[0] * HRR_INT__s_f_s_f[ibra * 10 + 8] );

                    HRR_INT__s_f_p_f[ibra * 30 + 9] = HRR_INT__s_f_s_g[ibra * 15 + 9] - ( hCD[0] * HRR_INT__s_f_s_f[ibra * 10 + 9] );

                    HRR_INT__s_f_p_f[ibra * 30 + 10] = HRR_INT__s_f_s_g[ibra * 15 + 1] - ( hCD[1] * HRR_INT__s_f_s_f[ibra * 10 + 0] );

                    HRR_INT__s_f_p_f[ibra * 30 + 11] = HRR_INT__s_f_s_g[ibra * 15 + 3] - ( hCD[1] * HRR_INT__s_f_s_f[ibra * 10 + 1] );

                    HRR_INT__s_f_p_f[ibra * 30 + 12] = HRR_INT__s_f_s_g[ibra * 15 + 4] - ( hCD[1] * HRR_INT__s_f_s_f[ibra * 10 + 2] );

                    HRR_INT__s_f_p_f[ibra * 30 + 13] = HRR_INT__s_f_s_g[ibra * 15 + 6] - ( hCD[1] * HRR_INT__s_f_s_f[ibra * 10 + 3] );

                    HRR_INT__s_f_p_f[ibra * 30 + 14] = HRR_INT__s_f_s_g[ibra * 15 + 7] - ( hCD[1] * HRR_INT__s_f_s_f[ibra * 10 + 4] );

                    HRR_INT__s_f_p_f[ibra * 30 + 15] = HRR_INT__s_f_s_g[ibra * 15 + 8] - ( hCD[1] * HRR_INT__s_f_s_f[ibra * 10 + 5] );

                    HRR_INT__s_f_p_f[ibra * 30 + 16] = HRR_INT__s_f_s_g[ibra * 15 + 10] - ( hCD[1] * HRR_INT__s_f_s_f[ibra * 10 + 6] );

                    HRR_INT__s_f_p_f[ibra * 30 + 17] = HRR_INT__s_f_s_g[ibra * 15 + 11] - ( hCD[1] * HRR_INT__s_f_s_f[ibra * 10 + 7] );

                    HRR_INT__s_f_p_f[ibra * 30 + 18] = HRR_INT__s_f_s_g[ibra * 15 + 12] - ( hCD[1] * HRR_INT__s_f_s_f[ibra * 10 + 8] );

                    HRR_INT__s_f_p_f[ibra * 30 + 19] = HRR_INT__s_f_s_g[ibra * 15 + 13] - ( hCD[1] * HRR_INT__s_f_s_f[ibra * 10 + 9] );

                    HRR_INT__s_f_p_f[ibra * 30 + 20] = HRR_INT__s_f_s_g[ibra * 15 + 2] - ( hCD[2] * HRR_INT__s_f_s_f[ibra * 10 + 0] );

                    HRR_INT__s_f_p_f[ibra * 30 + 21] = HRR_INT__s_f_s_g[ibra * 15 + 4] - ( hCD[2] * HRR_INT__s_f_s_f[ibra * 10 + 1] );

                    HRR_INT__s_f_p_f[ibra * 30 + 22] = HRR_INT__s_f_s_g[ibra * 15 + 5] - ( hCD[2] * HRR_INT__s_f_s_f[ibra * 10 + 2] );

                    HRR_INT__s_f_p_f[ibra * 30 + 23] = HRR_INT__s_f_s_g[ibra * 15 + 7] - ( hCD[2] * HRR_INT__s_f_s_f[ibra * 10 + 3] );

                    HRR_INT__s_f_p_f[ibra * 30 + 24] = HRR_INT__s_f_s_g[ibra * 15 + 8] - ( hCD[2] * HRR_INT__s_f_s_f[ibra * 10 + 4] );

                    HRR_INT__s_f_p_f[ibra * 30 + 25] = HRR_INT__s_f_s_g[ibra * 15 + 9] - ( hCD[2] * HRR_INT__s_f_s_f[ibra * 10 + 5] );

                    HRR_INT__s_f_p_f[ibra * 30 + 26] = HRR_INT__s_f_s_g[ibra * 15 + 11] - ( hCD[2] * HRR_INT__s_f_s_f[ibra * 10 + 6] );

                    HRR_INT__s_f_p_f[ibra * 30 + 27] = HRR_INT__s_f_s_g[ibra * 15 + 12] - ( hCD[2] * HRR_INT__s_f_s_f[ibra * 10 + 7] );

                    HRR_INT__s_f_p_f[ibra * 30 + 28] = HRR_INT__s_f_s_g[ibra * 15 + 13] - ( hCD[2] * HRR_INT__s_f_s_f[ibra * 10 + 8] );

                    HRR_INT__s_f_p_f[ibra * 30 + 29] = HRR_INT__s_f_s_g[ibra * 15 + 14] - ( hCD[2] * HRR_INT__s_f_s_f[ibra * 10 + 9] );
