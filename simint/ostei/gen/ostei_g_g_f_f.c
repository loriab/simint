                  ...
                  double * const restrict INT__g_g_f_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_g_f_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__l_s_f_s = work + (SIMINT_NSHELL_SIMD * 7400);
    double * const INT__l_s_g_s = work + (SIMINT_NSHELL_SIMD * 7850);
    double * const INT__l_s_h_s = work + (SIMINT_NSHELL_SIMD * 8525);
    double * const INT__l_s_i_s = work + (SIMINT_NSHELL_SIMD * 9470);
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*10730);
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_s = primwork + 0;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_p_s = primwork + 15;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_d_s = primwork + 33;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 63;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 105;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 159;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 249;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 369;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 447;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 555;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 735;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 975;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 1245;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 1365;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 1545;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 1845;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 2245;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_h_s = primwork + 2695;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 3115;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 3280;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 3550;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 4000;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 4600;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 5275;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_i_s = primwork + 5905;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 6325;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 6535;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_d_s = primwork + 6913;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_f_s = primwork + 7543;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_g_s = primwork + 8383;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_h_s = primwork + 9328;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_i_s = primwork + 10210;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 10798;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_p_s = primwork + 11050;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_d_s = primwork + 11554;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_f_s = primwork + 12394;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_g_s = primwork + 13514;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_h_s = primwork + 14774;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_i_s = primwork + 15950;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_s_s = primwork + 16734;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_p_s = primwork + 17022;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_d_s = primwork + 17670;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_f_s = primwork + 18750;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_g_s = primwork + 20190;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_h_s = primwork + 21810;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_i_s = primwork + 23322;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_s_s = primwork + 24330;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_p_s = primwork + 24645;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_d_s = primwork + 25455;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_f_s = primwork + 26805;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_g_s = primwork + 28605;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_h_s = primwork + 30630;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_i_s = primwork + 32520;
    double * const hrrwork = (double *)(primwork + 33780);
    ...
    double * const HRR_INT__g_f_g_s = hrrwork + 11490;
    double * const HRR_INT__g_f_h_s = hrrwork + 13740;
    double * const HRR_INT__g_f_i_s = hrrwork + 16890;
    double * const HRR_INT__g_g_f_s = hrrwork + 21090;
    double * const HRR_INT__g_g_f_p = hrrwork + 23340;
    double * const HRR_INT__g_g_f_d = hrrwork + 30090;
    double * const HRR_INT__g_g_g_s = hrrwork + 43590;
    double * const HRR_INT__g_g_g_p = hrrwork + 46965;
    double * const HRR_INT__g_g_g_d = hrrwork + 57090;
    double * const HRR_INT__g_g_h_s = hrrwork + 77340;
    double * const HRR_INT__g_g_h_p = hrrwork + 82065;
    double * const HRR_INT__g_g_i_s = hrrwork + 96240;
    double * const HRR_INT__h_p_f_s = hrrwork + 102540;
    double * const HRR_INT__h_p_g_s = hrrwork + 103170;
    double * const HRR_INT__h_p_h_s = hrrwork + 104115;
    double * const HRR_INT__h_p_i_s = hrrwork + 105438;
    double * const HRR_INT__h_d_f_s = hrrwork + 107202;
    double * const HRR_INT__h_d_g_s = hrrwork + 108462;
    double * const HRR_INT__h_d_h_s = hrrwork + 110352;
    double * const HRR_INT__h_d_i_s = hrrwork + 112998;
    double * const HRR_INT__h_f_f_s = hrrwork + 116526;
    double * const HRR_INT__h_f_g_s = hrrwork + 118626;
    double * const HRR_INT__h_f_h_s = hrrwork + 121776;
    double * const HRR_INT__h_f_i_s = hrrwork + 126186;
    double * const HRR_INT__i_p_f_s = hrrwork + 132066;
    double * const HRR_INT__i_p_g_s = hrrwork + 132906;
    double * const HRR_INT__i_p_h_s = hrrwork + 134166;
    double * const HRR_INT__i_p_i_s = hrrwork + 135930;
    double * const HRR_INT__i_d_f_s = hrrwork + 138282;
    double * const HRR_INT__i_d_g_s = hrrwork + 139962;
    double * const HRR_INT__i_d_h_s = hrrwork + 142482;
    double * const HRR_INT__i_d_i_s = hrrwork + 146010;
    double * const HRR_INT__k_p_f_s = hrrwork + 150714;
    double * const HRR_INT__k_p_g_s = hrrwork + 151794;
    double * const HRR_INT__k_p_h_s = hrrwork + 153414;
    double * const HRR_INT__k_p_i_s = hrrwork + 155682;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 10730 * sizeof(double));
            abcd = 0;
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    boys_F_split(PRIM_INT__s_s_s_s, F_x, 14);
                    ...
                    // Forming PRIM_INT__p_s_s_s[14 * 3];
                    ...
                    // Forming PRIM_INT__d_s_s_s[13 * 6];
                    ...
                    // Forming PRIM_INT__f_s_s_s[12 * 10];
                    ...
                    // Forming PRIM_INT__g_s_s_s[11 * 15];
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__g_g_f_f = INT__g_g_f_f + real_abcd * 22500;
