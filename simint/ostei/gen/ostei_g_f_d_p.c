                  ...
                  double * const restrict INT__g_f_d_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_f_d_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*1600);
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_s = primwork + 0;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 11;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 41;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 95;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 149;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 229;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 319;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 439;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 544;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 679;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 859;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 1009;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 1135;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_d_s = primwork + 1324;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_f_s = primwork + 1576;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 1786;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_p_s = primwork + 1926;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_d_s = primwork + 2178;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_f_s = primwork + 2514;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_s_s = primwork + 2794;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_p_s = primwork + 2938;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_d_s = primwork + 3262;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_f_s = primwork + 3694;
    double * const hrrwork = (double *)(primwork + 4054);
    ...
    double * const HRR_INT__h_p_d_s = hrrwork + 4560;
    double * const HRR_INT__h_p_f_s = hrrwork + 4938;
    double * const HRR_INT__h_d_d_s = hrrwork + 5568;
    double * const HRR_INT__h_d_f_s = hrrwork + 6324;
    double * const HRR_INT__i_p_d_s = hrrwork + 7584;
    double * const HRR_INT__i_p_f_s = hrrwork + 8088;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 1600 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__g_f_d_p = INT__g_f_d_p + real_abcd * 2700;
                  ...
                  double * const restrict INT__f_g_d_p)
{
    ...
    int ret = ostei_g_f_d_p(P_tmp, Q, screen_tol, work, INT__f_g_d_p);
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 6; ++c)
        for(int d = 0; d < 3; ++d)
            buffer[idx++] = INT__f_g_d_p[q*2700+b*180+a*18+c*3+d];

        memcpy(INT__f_g_d_p+q*2700, buffer, 2700*sizeof(double));
    }
                  ...
                  double * const restrict INT__g_f_p_d)
{
    ...
    int ret = ostei_g_f_d_p(P, Q_tmp, screen_tol, work, INT__g_f_p_d);
    double buffer[2700] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 3; ++c)
        for(int d = 0; d < 6; ++d)
            buffer[idx++] = INT__g_f_p_d[q*2700+a*180+b*18+d*3+c];

        memcpy(INT__g_f_p_d+q*2700, buffer, 2700*sizeof(double));
    }
                  ...
                  double * const restrict INT__f_g_p_d)
{
    ...
    int ret = ostei_g_f_d_p(P_tmp, Q_tmp, screen_tol, work, INT__f_g_p_d);
    double buffer[2700] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 3; ++c)
        for(int d = 0; d < 6; ++d)
            buffer[idx++] = INT__f_g_p_d[q*2700+b*180+a*18+d*3+c];

        memcpy(INT__f_g_p_d+q*2700, buffer, 2700*sizeof(double));
    }
