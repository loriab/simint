                  ...
                  double * const restrict INT__d_s_f_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_s_f_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 238;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 274;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_g_s = primwork + 334;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_h_s = primwork + 424;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 550;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 610;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_h_s = primwork + 700;
    double * const hrrwork = (double *)(primwork + 826);
    double * const HRR_INT__d_s_f_p = hrrwork + 0;
    double * const HRR_INT__d_s_g_p = hrrwork + 180;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_s_f_d = INT__d_s_f_d + real_abcd * 360;
                ...
                for(ibra = 0; ibra < 6; ++ibra)
                {
                    ...
                    HRR_INT__d_s_f_p[ibra * 30 + 1] = HRR_INT__d_s_g_s[ibra * 15 + 1] + ( hCD[1] * HRR_INT__d_s_f_s[ibra * 10 + 0] );

                    HRR_INT__d_s_f_p[ibra * 30 + 2] = HRR_INT__d_s_g_s[ibra * 15 + 2] + ( hCD[2] * HRR_INT__d_s_f_s[ibra * 10 + 0] );
                    ...
                    HRR_INT__d_s_f_p[ibra * 30 + 5] = HRR_INT__d_s_g_s[ibra * 15 + 4] + ( hCD[2] * HRR_INT__d_s_f_s[ibra * 10 + 1] );
                    ...
                    HRR_INT__d_s_f_p[ibra * 30 + 11] = HRR_INT__d_s_g_s[ibra * 15 + 7] + ( hCD[2] * HRR_INT__d_s_f_s[ibra * 10 + 3] );
                    ...
                    HRR_INT__d_s_f_p[ibra * 30 + 20] = HRR_INT__d_s_g_s[ibra * 15 + 11] + ( hCD[2] * HRR_INT__d_s_f_s[ibra * 10 + 6] );
