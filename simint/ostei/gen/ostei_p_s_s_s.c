                  ...
                  double * const restrict INT__p_s_s_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_s_s_s);
    memset(INT__p_s_s_s, 0, P.nshell12_clip * Q.nshell12_clip * 3 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 2;
