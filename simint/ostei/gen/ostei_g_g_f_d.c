                  ...
                  double * const restrict INT__g_g_f_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_g_f_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__l_s_f_s = work + (SIMINT_NSHELL_SIMD * 4600);
    double * const INT__l_s_g_s = work + (SIMINT_NSHELL_SIMD * 5050);
    double * const INT__l_s_h_s = work + (SIMINT_NSHELL_SIMD * 5725);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 29;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 68;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 113;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 185;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 257;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 347;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 491;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 671;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 781;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 931;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 1171;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 1471;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 1771;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 1921;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 2146;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 2506;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 2956;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 3406;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 3721;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 3910;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_d_s = primwork + 4225;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_f_s = primwork + 4729;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_g_s = primwork + 5359;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_h_s = primwork + 5989;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 6430;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_p_s = primwork + 6654;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_d_s = primwork + 7074;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_f_s = primwork + 7746;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_g_s = primwork + 8586;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_h_s = primwork + 9426;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_s_s = primwork + 10014;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_p_s = primwork + 10266;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_d_s = primwork + 10806;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_f_s = primwork + 11670;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_g_s = primwork + 12750;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_h_s = primwork + 13830;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_s_s = primwork + 14586;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_p_s = primwork + 14856;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_d_s = primwork + 15531;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_f_s = primwork + 16611;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_g_s = primwork + 17961;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_h_s = primwork + 19311;
    ...
    double * const HRR_INT__g_f_g_s = hrrwork + 7710;
    double * const HRR_INT__g_f_h_s = hrrwork + 9960;
    double * const HRR_INT__g_g_f_s = hrrwork + 13110;
    double * const HRR_INT__g_g_f_p = hrrwork + 15360;
    double * const HRR_INT__g_g_g_s = hrrwork + 22110;
    double * const HRR_INT__g_g_g_p = hrrwork + 25485;
    double * const HRR_INT__g_g_h_s = hrrwork + 35610;
    double * const HRR_INT__h_p_f_s = hrrwork + 40335;
    double * const HRR_INT__h_p_g_s = hrrwork + 40965;
    double * const HRR_INT__h_p_h_s = hrrwork + 41910;
    double * const HRR_INT__h_d_f_s = hrrwork + 43233;
    double * const HRR_INT__h_d_g_s = hrrwork + 44493;
    double * const HRR_INT__h_d_h_s = hrrwork + 46383;
    double * const HRR_INT__h_f_f_s = hrrwork + 49029;
    double * const HRR_INT__h_f_g_s = hrrwork + 51129;
    double * const HRR_INT__h_f_h_s = hrrwork + 54279;
    double * const HRR_INT__i_p_f_s = hrrwork + 58689;
    double * const HRR_INT__i_p_g_s = hrrwork + 59529;
    double * const HRR_INT__i_p_h_s = hrrwork + 60789;
    double * const HRR_INT__i_d_f_s = hrrwork + 62553;
    double * const HRR_INT__i_d_g_s = hrrwork + 64233;
    double * const HRR_INT__i_d_h_s = hrrwork + 66753;
    double * const HRR_INT__k_p_f_s = hrrwork + 70281;
    double * const HRR_INT__k_p_g_s = hrrwork + 71361;
    double * const HRR_INT__k_p_h_s = hrrwork + 72981;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__g_g_f_d = INT__g_g_f_d + real_abcd * 13500;
                  ...
                  double * const restrict INT__g_g_d_f)
{
    ...
    int ret = ostei_g_g_f_d(P, Q_tmp, screen_tol, work, INT__g_g_d_f);
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 6; ++c)
        for(int d = 0; d < 10; ++d)
            buffer[idx++] = INT__g_g_d_f[q*13500+a*900+b*60+d*6+c];

        memcpy(INT__g_g_d_f+q*13500, buffer, 13500*sizeof(double));
    }
