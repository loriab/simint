                  ...
                  double * const restrict INT__g_p_f_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_p_f_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*2664);
    ...
    double * const HRR_INT__g_p_f_p = hrrwork + 450;
    double * const HRR_INT__g_p_f_d = hrrwork + 1800;
    double * const HRR_INT__g_p_g_s = hrrwork + 4500;
    double * const HRR_INT__g_p_g_p = hrrwork + 5175;
    double * const HRR_INT__g_p_g_d = hrrwork + 7200;
    double * const HRR_INT__g_p_h_s = hrrwork + 11250;
    double * const HRR_INT__g_p_h_p = hrrwork + 12195;
    double * const HRR_INT__g_p_i_s = hrrwork + 15030;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 2664 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__g_p_f_f = INT__g_p_f_f + real_abcd * 4500;
                ...
                for(ibra = 0; ibra < 45; ++ibra)
                {
                    ...
                    HRR_INT__g_p_f_p[ibra * 30 + 1] = HRR_INT__g_p_g_s[ibra * 15 + 1] + ( hCD[1] * HRR_INT__g_p_f_s[ibra * 10 + 0] );

                    HRR_INT__g_p_f_p[ibra * 30 + 2] = HRR_INT__g_p_g_s[ibra * 15 + 2] + ( hCD[2] * HRR_INT__g_p_f_s[ibra * 10 + 0] );
                    ...
                    HRR_INT__g_p_f_p[ibra * 30 + 5] = HRR_INT__g_p_g_s[ibra * 15 + 4] + ( hCD[2] * HRR_INT__g_p_f_s[ibra * 10 + 1] );
                    ...
                    HRR_INT__g_p_f_p[ibra * 30 + 11] = HRR_INT__g_p_g_s[ibra * 15 + 7] + ( hCD[2] * HRR_INT__g_p_f_s[ibra * 10 + 3] );
                    ...
                    HRR_INT__g_p_f_p[ibra * 30 + 20] = HRR_INT__g_p_g_s[ibra * 15 + 11] + ( hCD[2] * HRR_INT__g_p_f_s[ibra * 10 + 6] );
                  ...
                  double * const restrict INT__p_g_f_f)
{
    ...
    int ret = ostei_g_p_f_f(P_tmp, Q, screen_tol, work, INT__p_g_f_f);
    double buffer[4500] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 10; ++c)
        for(int d = 0; d < 10; ++d)
            buffer[idx++] = INT__p_g_f_f[q*4500+b*300+a*100+c*10+d];

        memcpy(INT__p_g_f_f+q*4500, buffer, 4500*sizeof(double));
    }
