                  ...
                  double * const restrict INT__s_p_f_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_p_f_s);
    memset(INT__s_p_f_s, 0, P.nshell12_clip * Q.nshell12_clip * 30 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_f_s = primwork + 55;
