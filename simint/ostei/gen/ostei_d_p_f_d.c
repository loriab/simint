                  ...
                  double * const restrict INT__d_p_f_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_p_f_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 294;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 321;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 375;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_g_s = primwork + 465;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_h_s = primwork + 600;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 789;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 861;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 981;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_h_s = primwork + 1161;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 1413;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 1513;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_h_s = primwork + 1663;
    ...
    double * const HRR_INT__d_p_g_s = hrrwork + 720;
    double * const HRR_INT__d_p_g_p = hrrwork + 990;
    double * const HRR_INT__d_p_h_s = hrrwork + 1800;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_p_f_d = INT__d_p_f_d + real_abcd * 1080;
