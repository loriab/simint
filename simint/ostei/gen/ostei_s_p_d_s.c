                  ...
                  double * const restrict INT__s_p_d_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_p_d_s);
    memset(INT__s_p_d_s, 0, P.nshell12_clip * Q.nshell12_clip * 18 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_d_s = primwork + 25;
