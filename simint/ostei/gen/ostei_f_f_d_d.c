                  ...
                  double * const restrict INT__f_f_d_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_f_d_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__h_s_d_s = work + (SIMINT_NSHELL_SIMD * 775);
    double * const INT__h_s_f_s = work + (SIMINT_NSHELL_SIMD * 901);
    double * const INT__h_s_g_s = work + (SIMINT_NSHELL_SIMD * 1111);
    double * const INT__i_s_d_s = work + (SIMINT_NSHELL_SIMD * 1426);
    double * const INT__i_s_f_s = work + (SIMINT_NSHELL_SIMD * 1594);
    double * const INT__i_s_g_s = work + (SIMINT_NSHELL_SIMD * 1874);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 53;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 89;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 143;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 197;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 269;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 377;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 497;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 577;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 697;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 877;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 1077;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 1227;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 1332;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 1512;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 1782;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 2082;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 2307;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 2433;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_d_s = primwork + 2685;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_f_s = primwork + 3063;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_g_s = primwork + 3483;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 3798;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_p_s = primwork + 3938;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_d_s = primwork + 4274;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_f_s = primwork + 4778;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_g_s = primwork + 5338;
    ...
    double * const HRR_INT__f_p_g_s = hrrwork + 480;
    double * const HRR_INT__f_d_d_s = hrrwork + 930;
    double * const HRR_INT__f_d_f_s = hrrwork + 1290;
    double * const HRR_INT__f_d_g_s = hrrwork + 1890;
    double * const HRR_INT__f_f_d_s = hrrwork + 2790;
    double * const HRR_INT__f_f_d_p = hrrwork + 3390;
    double * const HRR_INT__f_f_f_s = hrrwork + 5190;
    double * const HRR_INT__f_f_f_p = hrrwork + 6190;
    double * const HRR_INT__f_f_g_s = hrrwork + 9190;
    double * const HRR_INT__g_p_d_s = hrrwork + 10690;
    double * const HRR_INT__g_p_f_s = hrrwork + 10960;
    double * const HRR_INT__g_p_g_s = hrrwork + 11410;
    double * const HRR_INT__g_d_d_s = hrrwork + 12085;
    double * const HRR_INT__g_d_f_s = hrrwork + 12625;
    double * const HRR_INT__g_d_g_s = hrrwork + 13525;
    double * const HRR_INT__h_p_d_s = hrrwork + 14875;
    double * const HRR_INT__h_p_f_s = hrrwork + 15253;
    double * const HRR_INT__h_p_g_s = hrrwork + 15883;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_f_d_d = INT__f_f_d_d + real_abcd * 3600;
                ...
                {
                    HRR_INT__f_f_d_p[ibra * 18 + 0] = HRR_INT__f_f_f_s[ibra * 10 + 0] + ( hCD[0] * HRR_INT__f_f_d_s[ibra * 6 + 0] );

                    HRR_INT__f_f_d_p[ibra * 18 + 1] = HRR_INT__f_f_f_s[ibra * 10 + 1] + ( hCD[1] * HRR_INT__f_f_d_s[ibra * 6 + 0] );

                    HRR_INT__f_f_d_p[ibra * 18 + 2] = HRR_INT__f_f_f_s[ibra * 10 + 2] + ( hCD[2] * HRR_INT__f_f_d_s[ibra * 6 + 0] );

                    HRR_INT__f_f_d_p[ibra * 18 + 3] = HRR_INT__f_f_f_s[ibra * 10 + 1] + ( hCD[0] * HRR_INT__f_f_d_s[ibra * 6 + 1] );

                    HRR_INT__f_f_d_p[ibra * 18 + 4] = HRR_INT__f_f_f_s[ibra * 10 + 3] + ( hCD[1] * HRR_INT__f_f_d_s[ibra * 6 + 1] );

                    HRR_INT__f_f_d_p[ibra * 18 + 5] = HRR_INT__f_f_f_s[ibra * 10 + 4] + ( hCD[2] * HRR_INT__f_f_d_s[ibra * 6 + 1] );

                    HRR_INT__f_f_d_p[ibra * 18 + 6] = HRR_INT__f_f_f_s[ibra * 10 + 2] + ( hCD[0] * HRR_INT__f_f_d_s[ibra * 6 + 2] );

                    HRR_INT__f_f_d_p[ibra * 18 + 7] = HRR_INT__f_f_f_s[ibra * 10 + 4] + ( hCD[1] * HRR_INT__f_f_d_s[ibra * 6 + 2] );

                    HRR_INT__f_f_d_p[ibra * 18 + 8] = HRR_INT__f_f_f_s[ibra * 10 + 5] + ( hCD[2] * HRR_INT__f_f_d_s[ibra * 6 + 2] );

                    HRR_INT__f_f_d_p[ibra * 18 + 9] = HRR_INT__f_f_f_s[ibra * 10 + 3] + ( hCD[0] * HRR_INT__f_f_d_s[ibra * 6 + 3] );

                    HRR_INT__f_f_d_p[ibra * 18 + 10] = HRR_INT__f_f_f_s[ibra * 10 + 6] + ( hCD[1] * HRR_INT__f_f_d_s[ibra * 6 + 3] );

                    HRR_INT__f_f_d_p[ibra * 18 + 11] = HRR_INT__f_f_f_s[ibra * 10 + 7] + ( hCD[2] * HRR_INT__f_f_d_s[ibra * 6 + 3] );

                    HRR_INT__f_f_d_p[ibra * 18 + 12] = HRR_INT__f_f_f_s[ibra * 10 + 4] + ( hCD[0] * HRR_INT__f_f_d_s[ibra * 6 + 4] );

                    HRR_INT__f_f_d_p[ibra * 18 + 13] = HRR_INT__f_f_f_s[ibra * 10 + 7] + ( hCD[1] * HRR_INT__f_f_d_s[ibra * 6 + 4] );

                    HRR_INT__f_f_d_p[ibra * 18 + 14] = HRR_INT__f_f_f_s[ibra * 10 + 8] + ( hCD[2] * HRR_INT__f_f_d_s[ibra * 6 + 4] );

                    HRR_INT__f_f_d_p[ibra * 18 + 15] = HRR_INT__f_f_f_s[ibra * 10 + 5] + ( hCD[0] * HRR_INT__f_f_d_s[ibra * 6 + 5] );

                    HRR_INT__f_f_d_p[ibra * 18 + 16] = HRR_INT__f_f_f_s[ibra * 10 + 8] + ( hCD[1] * HRR_INT__f_f_d_s[ibra * 6 + 5] );

                    HRR_INT__f_f_d_p[ibra * 18 + 17] = HRR_INT__f_f_f_s[ibra * 10 + 9] + ( hCD[2] * HRR_INT__f_f_d_s[ibra * 6 + 5] );
                ...
                for(ibra = 0; ibra < 100; ++ibra)
                {
                    HRR_INT__f_f_d_d[ibra * 36 + 0] = HRR_INT__f_f_f_p[ibra * 30 + 0] + ( hCD[0] * HRR_INT__f_f_d_p[ibra * 18 + 0] );

                    HRR_INT__f_f_d_d[ibra * 36 + 1] = HRR_INT__f_f_f_p[ibra * 30 + 3] + ( hCD[1] * HRR_INT__f_f_d_p[ibra * 18 + 0] );

                    HRR_INT__f_f_d_d[ibra * 36 + 2] = HRR_INT__f_f_f_p[ibra * 30 + 6] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 0] );

                    HRR_INT__f_f_d_d[ibra * 36 + 3] = HRR_INT__f_f_f_p[ibra * 30 + 4] + ( hCD[1] * HRR_INT__f_f_d_p[ibra * 18 + 1] );

                    HRR_INT__f_f_d_d[ibra * 36 + 4] = HRR_INT__f_f_f_p[ibra * 30 + 7] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 1] );

                    HRR_INT__f_f_d_d[ibra * 36 + 5] = HRR_INT__f_f_f_p[ibra * 30 + 8] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 2] );

                    HRR_INT__f_f_d_d[ibra * 36 + 6] = HRR_INT__f_f_f_p[ibra * 30 + 3] + ( hCD[0] * HRR_INT__f_f_d_p[ibra * 18 + 3] );

                    HRR_INT__f_f_d_d[ibra * 36 + 7] = HRR_INT__f_f_f_p[ibra * 30 + 9] + ( hCD[1] * HRR_INT__f_f_d_p[ibra * 18 + 3] );

                    HRR_INT__f_f_d_d[ibra * 36 + 8] = HRR_INT__f_f_f_p[ibra * 30 + 12] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 3] );

                    HRR_INT__f_f_d_d[ibra * 36 + 9] = HRR_INT__f_f_f_p[ibra * 30 + 10] + ( hCD[1] * HRR_INT__f_f_d_p[ibra * 18 + 4] );

                    HRR_INT__f_f_d_d[ibra * 36 + 10] = HRR_INT__f_f_f_p[ibra * 30 + 13] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 4] );

                    HRR_INT__f_f_d_d[ibra * 36 + 11] = HRR_INT__f_f_f_p[ibra * 30 + 14] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 5] );

                    HRR_INT__f_f_d_d[ibra * 36 + 12] = HRR_INT__f_f_f_p[ibra * 30 + 6] + ( hCD[0] * HRR_INT__f_f_d_p[ibra * 18 + 6] );

                    HRR_INT__f_f_d_d[ibra * 36 + 13] = HRR_INT__f_f_f_p[ibra * 30 + 12] + ( hCD[1] * HRR_INT__f_f_d_p[ibra * 18 + 6] );

                    HRR_INT__f_f_d_d[ibra * 36 + 14] = HRR_INT__f_f_f_p[ibra * 30 + 15] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 6] );

                    HRR_INT__f_f_d_d[ibra * 36 + 15] = HRR_INT__f_f_f_p[ibra * 30 + 13] + ( hCD[1] * HRR_INT__f_f_d_p[ibra * 18 + 7] );

                    HRR_INT__f_f_d_d[ibra * 36 + 16] = HRR_INT__f_f_f_p[ibra * 30 + 16] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 7] );

                    HRR_INT__f_f_d_d[ibra * 36 + 17] = HRR_INT__f_f_f_p[ibra * 30 + 17] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 8] );

                    HRR_INT__f_f_d_d[ibra * 36 + 18] = HRR_INT__f_f_f_p[ibra * 30 + 9] + ( hCD[0] * HRR_INT__f_f_d_p[ibra * 18 + 9] );

                    HRR_INT__f_f_d_d[ibra * 36 + 19] = HRR_INT__f_f_f_p[ibra * 30 + 18] + ( hCD[1] * HRR_INT__f_f_d_p[ibra * 18 + 9] );

                    HRR_INT__f_f_d_d[ibra * 36 + 20] = HRR_INT__f_f_f_p[ibra * 30 + 21] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 9] );

                    HRR_INT__f_f_d_d[ibra * 36 + 21] = HRR_INT__f_f_f_p[ibra * 30 + 19] + ( hCD[1] * HRR_INT__f_f_d_p[ibra * 18 + 10] );

                    HRR_INT__f_f_d_d[ibra * 36 + 22] = HRR_INT__f_f_f_p[ibra * 30 + 22] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 10] );

                    HRR_INT__f_f_d_d[ibra * 36 + 23] = HRR_INT__f_f_f_p[ibra * 30 + 23] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 11] );

                    HRR_INT__f_f_d_d[ibra * 36 + 24] = HRR_INT__f_f_f_p[ibra * 30 + 12] + ( hCD[0] * HRR_INT__f_f_d_p[ibra * 18 + 12] );

                    HRR_INT__f_f_d_d[ibra * 36 + 25] = HRR_INT__f_f_f_p[ibra * 30 + 21] + ( hCD[1] * HRR_INT__f_f_d_p[ibra * 18 + 12] );

                    HRR_INT__f_f_d_d[ibra * 36 + 26] = HRR_INT__f_f_f_p[ibra * 30 + 24] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 12] );

                    HRR_INT__f_f_d_d[ibra * 36 + 27] = HRR_INT__f_f_f_p[ibra * 30 + 22] + ( hCD[1] * HRR_INT__f_f_d_p[ibra * 18 + 13] );

                    HRR_INT__f_f_d_d[ibra * 36 + 28] = HRR_INT__f_f_f_p[ibra * 30 + 25] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 13] );

                    HRR_INT__f_f_d_d[ibra * 36 + 29] = HRR_INT__f_f_f_p[ibra * 30 + 26] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 14] );

                    HRR_INT__f_f_d_d[ibra * 36 + 30] = HRR_INT__f_f_f_p[ibra * 30 + 15] + ( hCD[0] * HRR_INT__f_f_d_p[ibra * 18 + 15] );

                    HRR_INT__f_f_d_d[ibra * 36 + 31] = HRR_INT__f_f_f_p[ibra * 30 + 24] + ( hCD[1] * HRR_INT__f_f_d_p[ibra * 18 + 15] );

                    HRR_INT__f_f_d_d[ibra * 36 + 32] = HRR_INT__f_f_f_p[ibra * 30 + 27] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 15] );

                    HRR_INT__f_f_d_d[ibra * 36 + 33] = HRR_INT__f_f_f_p[ibra * 30 + 25] + ( hCD[1] * HRR_INT__f_f_d_p[ibra * 18 + 16] );

                    HRR_INT__f_f_d_d[ibra * 36 + 34] = HRR_INT__f_f_f_p[ibra * 30 + 28] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 16] );

                    HRR_INT__f_f_d_d[ibra * 36 + 35] = HRR_INT__f_f_f_p[ibra * 30 + 29] + ( hCD[2] * HRR_INT__f_f_d_p[ibra * 18 + 17] );
