                  ...
                  double * const restrict INT__g_f_g_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_f_g_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*10000);
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_s = primwork + 0;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_p_s = primwork + 15;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_d_s = primwork + 36;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_f_s = primwork + 72;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 122;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 164;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 227;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 335;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_g_s = primwork + 485;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 665;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 743;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 869;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 1085;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 1385;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_h_s = primwork + 1745;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 2123;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 2243;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 2453;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 2813;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 3313;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_h_s = primwork + 3913;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_i_s = primwork + 4543;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 5103;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 5268;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 5583;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 6123;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 6873;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 7773;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_i_s = primwork + 8718;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_k_s = primwork + 9558;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 10098;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 10308;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_d_s = primwork + 10749;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_f_s = primwork + 11505;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_g_s = primwork + 12555;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_h_s = primwork + 13815;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_i_s = primwork + 15138;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_k_s = primwork + 16314;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 17070;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_p_s = primwork + 17322;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_d_s = primwork + 17910;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_f_s = primwork + 18918;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_g_s = primwork + 20318;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_h_s = primwork + 21998;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_i_s = primwork + 23762;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_k_s = primwork + 25330;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_s_s = primwork + 26338;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_p_s = primwork + 26626;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_d_s = primwork + 27382;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_f_s = primwork + 28678;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_g_s = primwork + 30478;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_h_s = primwork + 32638;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_i_s = primwork + 34906;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_k_s = primwork + 36922;
    double * const hrrwork = (double *)(primwork + 38218);
    ...
    double * const HRR_INT__g_f_g_p = hrrwork + 15750;
    double * const HRR_INT__g_f_g_d = hrrwork + 22500;
    double * const HRR_INT__g_f_h_s = hrrwork + 36000;
    double * const HRR_INT__g_f_h_p = hrrwork + 39150;
    double * const HRR_INT__g_f_h_d = hrrwork + 48600;
    double * const HRR_INT__g_f_i_s = hrrwork + 67500;
    double * const HRR_INT__g_f_i_p = hrrwork + 71700;
    double * const HRR_INT__g_f_k_s = hrrwork + 84300;
    double * const HRR_INT__h_p_g_s = hrrwork + 89700;
    double * const HRR_INT__h_p_h_s = hrrwork + 90645;
    double * const HRR_INT__h_p_i_s = hrrwork + 91968;
    double * const HRR_INT__h_p_k_s = hrrwork + 93732;
    double * const HRR_INT__h_d_g_s = hrrwork + 96000;
    double * const HRR_INT__h_d_h_s = hrrwork + 97890;
    double * const HRR_INT__h_d_i_s = hrrwork + 100536;
    double * const HRR_INT__h_d_k_s = hrrwork + 104064;
    double * const HRR_INT__i_p_g_s = hrrwork + 108600;
    double * const HRR_INT__i_p_h_s = hrrwork + 109860;
    double * const HRR_INT__i_p_i_s = hrrwork + 111624;
    double * const HRR_INT__i_p_k_s = hrrwork + 113976;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 10000 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__g_f_g_f = INT__g_f_g_f + real_abcd * 22500;
                  ...
                  double * const restrict INT__f_g_g_f)
{
    ...
    int ret = ostei_g_f_g_f(P_tmp, Q, screen_tol, work, INT__f_g_g_f);
    double buffer[22500] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 15; ++c)
        for(int d = 0; d < 10; ++d)
            buffer[idx++] = INT__f_g_g_f[q*22500+b*1500+a*150+c*10+d];

        memcpy(INT__f_g_g_f+q*22500, buffer, 22500*sizeof(double));
    }
                  ...
                  double * const restrict INT__g_f_f_g)
{
    ...
    int ret = ostei_g_f_g_f(P, Q_tmp, screen_tol, work, INT__g_f_f_g);
    double buffer[22500] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 10; ++c)
        for(int d = 0; d < 15; ++d)
            buffer[idx++] = INT__g_f_f_g[q*22500+a*1500+b*150+d*10+c];

        memcpy(INT__g_f_f_g+q*22500, buffer, 22500*sizeof(double));
    }
                  ...
                  double * const restrict INT__f_g_f_g)
{
    ...
    int ret = ostei_g_f_g_f(P_tmp, Q_tmp, screen_tol, work, INT__f_g_f_g);
    double buffer[22500] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 10; ++c)
        for(int d = 0; d < 15; ++d)
            buffer[idx++] = INT__f_g_f_g[q*22500+b*1500+a*150+d*10+c];

        memcpy(INT__f_g_f_g+q*22500, buffer, 22500*sizeof(double));
    }
