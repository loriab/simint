                  ...
                  double * const restrict INT__f_f_f_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_f_f_s);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__g_s_f_s = work + (SIMINT_NSHELL_SIMD * 100);
    double * const INT__h_s_f_s = work + (SIMINT_NSHELL_SIMD * 250);
    double * const INT__i_s_f_s = work + (SIMINT_NSHELL_SIMD * 460);
    ...
    double * const HRR_INT__f_d_f_s = hrrwork + 300;
    double * const HRR_INT__g_p_f_s = hrrwork + 900;
    double * const HRR_INT__g_d_f_s = hrrwork + 1350;
    double * const HRR_INT__h_p_f_s = hrrwork + 2250;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_f_f_s = INT__f_f_f_s + real_abcd * 1000;
