                  ...
                  double * const restrict INT__f_f_g_g)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_f_g_g);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__g_s_g_s = work + (SIMINT_NSHELL_SIMD * 1450);
    double * const INT__g_s_h_s = work + (SIMINT_NSHELL_SIMD * 1675);
    double * const INT__g_s_i_s = work + (SIMINT_NSHELL_SIMD * 1990);
    double * const INT__g_s_k_s = work + (SIMINT_NSHELL_SIMD * 2410);
    double * const INT__g_s_l_s = work + (SIMINT_NSHELL_SIMD * 2950);
    double * const INT__h_s_g_s = work + (SIMINT_NSHELL_SIMD * 3625);
    double * const INT__h_s_h_s = work + (SIMINT_NSHELL_SIMD * 3940);
    double * const INT__h_s_i_s = work + (SIMINT_NSHELL_SIMD * 4381);
    double * const INT__h_s_k_s = work + (SIMINT_NSHELL_SIMD * 4969);
    double * const INT__h_s_l_s = work + (SIMINT_NSHELL_SIMD * 5725);
    double * const INT__i_s_g_s = work + (SIMINT_NSHELL_SIMD * 6670);
    double * const INT__i_s_h_s = work + (SIMINT_NSHELL_SIMD * 7090);
    double * const INT__i_s_i_s = work + (SIMINT_NSHELL_SIMD * 7678);
    double * const INT__i_s_k_s = work + (SIMINT_NSHELL_SIMD * 8462);
    double * const INT__i_s_l_s = work + (SIMINT_NSHELL_SIMD * 9470);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_d_s = primwork + 57;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_f_s = primwork + 135;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_g_s = primwork + 255;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_h_s = primwork + 420;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_i_s = primwork + 630;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_k_s = primwork + 882;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_l_s = primwork + 1170;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 1485;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 1503;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 1557;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 1665;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_g_s = primwork + 1845;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_h_s = primwork + 2115;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_i_s = primwork + 2493;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_k_s = primwork + 2997;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_l_s = primwork + 3645;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 4455;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 4485;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 4575;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 4755;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 5055;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_h_s = primwork + 5505;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_i_s = primwork + 6135;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_k_s = primwork + 6975;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_l_s = primwork + 8055;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 9405;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 9525;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 9765;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 10165;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_h_s = primwork + 10765;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_i_s = primwork + 11605;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_k_s = primwork + 12725;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_l_s = primwork + 14165;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 15965;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 16235;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 16685;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 17360;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_i_s = primwork + 18305;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_k_s = primwork + 19565;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_l_s = primwork + 21185;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_f_s = primwork + 23210;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_g_s = primwork + 23630;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_h_s = primwork + 24260;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_i_s = primwork + 25142;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_k_s = primwork + 26318;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_l_s = primwork + 27830;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_g_s = primwork + 29720;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_h_s = primwork + 30140;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_i_s = primwork + 30728;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_k_s = primwork + 31512;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_l_s = primwork + 32520;
    ...
    double * const HRR_INT__f_p_l_s = hrrwork + 3000;
    double * const HRR_INT__f_d_g_s = hrrwork + 4350;
    double * const HRR_INT__f_d_h_s = hrrwork + 5250;
    double * const HRR_INT__f_d_i_s = hrrwork + 6510;
    double * const HRR_INT__f_d_k_s = hrrwork + 8190;
    double * const HRR_INT__f_d_l_s = hrrwork + 10350;
    double * const HRR_INT__f_f_g_s = hrrwork + 13050;
    double * const HRR_INT__f_f_g_p = hrrwork + 14550;
    double * const HRR_INT__f_f_g_d = hrrwork + 19050;
    double * const HRR_INT__f_f_g_f = hrrwork + 28050;
    double * const HRR_INT__f_f_h_s = hrrwork + 43050;
    double * const HRR_INT__f_f_h_p = hrrwork + 45150;
    double * const HRR_INT__f_f_h_d = hrrwork + 51450;
    double * const HRR_INT__f_f_h_f = hrrwork + 64050;
    double * const HRR_INT__f_f_i_s = hrrwork + 85050;
    double * const HRR_INT__f_f_i_p = hrrwork + 87850;
    double * const HRR_INT__f_f_i_d = hrrwork + 96250;
    double * const HRR_INT__f_f_k_s = hrrwork + 113050;
    double * const HRR_INT__f_f_k_p = hrrwork + 116650;
    double * const HRR_INT__f_f_l_s = hrrwork + 127450;
    double * const HRR_INT__g_p_g_s = hrrwork + 131950;
    double * const HRR_INT__g_p_h_s = hrrwork + 132625;
    double * const HRR_INT__g_p_i_s = hrrwork + 133570;
    double * const HRR_INT__g_p_k_s = hrrwork + 134830;
    double * const HRR_INT__g_p_l_s = hrrwork + 136450;
    double * const HRR_INT__g_d_g_s = hrrwork + 138475;
    double * const HRR_INT__g_d_h_s = hrrwork + 139825;
    double * const HRR_INT__g_d_i_s = hrrwork + 141715;
    double * const HRR_INT__g_d_k_s = hrrwork + 144235;
    double * const HRR_INT__g_d_l_s = hrrwork + 147475;
    double * const HRR_INT__h_p_g_s = hrrwork + 151525;
    double * const HRR_INT__h_p_h_s = hrrwork + 152470;
    double * const HRR_INT__h_p_i_s = hrrwork + 153793;
    double * const HRR_INT__h_p_k_s = hrrwork + 155557;
    double * const HRR_INT__h_p_l_s = hrrwork + 157825;
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    // Forming PRIM_INT__s_s_p_s[14 * 3];
                    ...
                    // Forming PRIM_INT__s_s_d_s[13 * 6];
                    ...
                    // Forming PRIM_INT__s_s_f_s[12 * 10];
                    ...
                    // Forming PRIM_INT__s_s_g_s[11 * 15];
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_f_g_g = INT__f_f_g_g + real_abcd * 22500;
                ...
                for(iket = 0; iket < 45; ++iket)
                {
                    ...
                    HRR_INT__f_p_l_s[1 * 45 + iket] = HRR_INT__g_s_l_s[1 * 45 + iket] + ( hAB[1] * HRR_INT__f_s_l_s[0 * 45 + iket] );

                    HRR_INT__f_p_l_s[2 * 45 + iket] = HRR_INT__g_s_l_s[2 * 45 + iket] + ( hAB[2] * HRR_INT__f_s_l_s[0 * 45 + iket] );
                    ...
                    HRR_INT__f_p_l_s[5 * 45 + iket] = HRR_INT__g_s_l_s[4 * 45 + iket] + ( hAB[2] * HRR_INT__f_s_l_s[1 * 45 + iket] );
                    ...
                    HRR_INT__f_p_l_s[11 * 45 + iket] = HRR_INT__g_s_l_s[7 * 45 + iket] + ( hAB[2] * HRR_INT__f_s_l_s[3 * 45 + iket] );
                    ...
                    HRR_INT__f_p_l_s[20 * 45 + iket] = HRR_INT__g_s_l_s[11 * 45 + iket] + ( hAB[2] * HRR_INT__f_s_l_s[6 * 45 + iket] );
