                  ...
                  double * const restrict INT__d_s_d_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_s_d_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const HRR_INT__d_s_p_f = hrrwork + 0;
    double * const HRR_INT__d_s_p_g = hrrwork + 180;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_s_d_f = INT__d_s_d_f + real_abcd * 360;
