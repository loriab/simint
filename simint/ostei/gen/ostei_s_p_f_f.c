                  ...
                  double * const restrict INT__s_p_f_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_p_f_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    // partition workspace
    double * const INT__s_p_f_s = work + (SIMINT_NSHELL_SIMD * 0);
    double * const INT__s_p_g_s = work + (SIMINT_NSHELL_SIMD * 30);
    double * const INT__s_p_h_s = work + (SIMINT_NSHELL_SIMD * 75);
    double * const INT__s_p_i_s = work + (SIMINT_NSHELL_SIMD * 138);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_f_s = primwork + 294;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_g_s = primwork + 324;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_h_s = primwork + 369;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_i_s = primwork + 432;
    double * const hrrwork = (double *)(primwork + 516);
    double * const HRR_INT__s_p_f_p = hrrwork + 0;
    double * const HRR_INT__s_p_f_d = hrrwork + 90;
    double * const HRR_INT__s_p_g_p = hrrwork + 270;
    double * const HRR_INT__s_p_g_d = hrrwork + 405;
    double * const HRR_INT__s_p_h_p = hrrwork + 675;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                double * restrict PRIM_PTR_INT__s_p_h_s = INT__s_p_h_s + abcd * 63;
                double * restrict PRIM_PTR_INT__s_p_i_s = INT__s_p_i_s + abcd * 84;
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    if((iprimcd + SIMINT_SIMD_LEN) >= nprim_icd)
                    {
                        ...
                        if(iprimcd >= nprim_icd && ((icd+1) < nshellbatch))
                        {
                            ...
                            PRIM_PTR_INT__s_p_h_s += 63;
                            PRIM_PTR_INT__s_p_i_s += 84;
                        }
                        iprimcd++;
                    ...
                    if(check_screen)
                    {
                        ...
                        if(vmax < screen_tol)
                        {
                            ...
                            PRIM_PTR_INT__s_p_h_s += lastoffset*63;
                            PRIM_PTR_INT__s_p_i_s += lastoffset*84;
                            continue;
                        }
                    }
                    ...
                    if(lastoffset == 0)
                    {
                        ...
                        contract_all(63, PRIM_INT__s_p_h_s, PRIM_PTR_INT__s_p_h_s);
                        contract_all(84, PRIM_INT__s_p_i_s, PRIM_PTR_INT__s_p_i_s);
                    }
                    else
                    {
                        ...
                        contract(63, shelloffsets, PRIM_INT__s_p_h_s, PRIM_PTR_INT__s_p_h_s);
                        contract(84, shelloffsets, PRIM_INT__s_p_i_s, PRIM_PTR_INT__s_p_i_s);
                        PRIM_PTR_INT__s_p_f_s += lastoffset*30;
                        PRIM_PTR_INT__s_p_g_s += lastoffset*45;
                        PRIM_PTR_INT__s_p_h_s += lastoffset*63;
                        PRIM_PTR_INT__s_p_i_s += lastoffset*84;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double const * restrict HRR_INT__s_p_h_s = INT__s_p_h_s + abcd * 63;
                double const * restrict HRR_INT__s_p_i_s = INT__s_p_i_s + abcd * 84;
                double * restrict HRR_INT__s_p_f_f = INT__s_p_f_f + real_abcd * 300;
                ...
                for(ibra = 0; ibra < 3; ++ibra)
                {
                    ...
                    HRR_INT__s_p_f_p[ibra * 30 + 1] = HRR_INT__s_p_g_s[ibra * 15 + 1] + ( hCD[1] * HRR_INT__s_p_f_s[ibra * 10 + 0] );

                    HRR_INT__s_p_f_p[ibra * 30 + 2] = HRR_INT__s_p_g_s[ibra * 15 + 2] + ( hCD[2] * HRR_INT__s_p_f_s[ibra * 10 + 0] );
                    ...
                    HRR_INT__s_p_f_p[ibra * 30 + 5] = HRR_INT__s_p_g_s[ibra * 15 + 4] + ( hCD[2] * HRR_INT__s_p_f_s[ibra * 10 + 1] );
                    ...
                    HRR_INT__s_p_f_p[ibra * 30 + 11] = HRR_INT__s_p_g_s[ibra * 15 + 7] + ( hCD[2] * HRR_INT__s_p_f_s[ibra * 10 + 3] );
                    ...
                    HRR_INT__s_p_f_p[ibra * 30 + 20] = HRR_INT__s_p_g_s[ibra * 15 + 11] + ( hCD[2] * HRR_INT__s_p_f_s[ibra * 10 + 6] );
