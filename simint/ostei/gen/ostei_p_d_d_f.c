                  ...
                  double * const restrict INT__p_d_d_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_d_d_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_f_s_f = work + (SIMINT_NSHELL_SIMD * 276);
    double * const INT__s_f_s_g = work + (SIMINT_NSHELL_SIMD * 376);
    double * const INT__s_f_s_h = work + (SIMINT_NSHELL_SIMD * 526);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_d = primwork + 33;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_f = primwork + 75;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_g = primwork + 135;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_h = primwork + 210;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_p = primwork + 294;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_d = primwork + 321;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_f = primwork + 375;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_g = primwork + 465;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_h = primwork + 600;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_d = primwork + 789;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_f = primwork + 861;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_g = primwork + 981;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_h = primwork + 1161;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_f = primwork + 1413;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_g = primwork + 1513;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_h = primwork + 1663;
    double * const hrrwork = (double *)(primwork + 1873);
    double * const HRR_INT__p_d_s_f = hrrwork + 0;
    double * const HRR_INT__p_d_s_g = hrrwork + 180;
    double * const HRR_INT__p_d_s_h = hrrwork + 450;
    double * const HRR_INT__p_d_p_f = hrrwork + 828;
    double * const HRR_INT__p_d_p_g = hrrwork + 1368;
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    // Forming PRIM_INT__s_s_s_f[6 * 10];
                    ...
                    // Forming PRIM_INT__s_p_s_d[3 * 18];
                    for(n = 0; n < 3; ++n)  // loop over orders of auxiliary function
                    {
                    ...
                    // Forming PRIM_INT__s_s_s_g[5 * 15];
                    ...
                    for(n = 0; n < 3; ++n)  // loop over orders of auxiliary function
                    {
                        ...
                        PRIM_INT__s_p_s_p[n * 9 + 0] = SIMINT_MUL(P_PB[0], PRIM_INT__s_s_s_p[n * 3 + 0]);
                        PRIM_INT__s_p_s_p[n * 9 + 0] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_s_s_p[(n+1) * 3 + 0], PRIM_INT__s_p_s_p[n * 9 + 0]);
                        PRIM_INT__s_p_s_p[n * 9 + 0] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_s_s[(n+1) * 1 + 0], PRIM_INT__s_p_s_p[n * 9 + 0]);

                        PRIM_INT__s_p_s_p[n * 9 + 1] = SIMINT_MUL(P_PB[0], PRIM_INT__s_s_s_p[n * 3 + 1]);
                        PRIM_INT__s_p_s_p[n * 9 + 1] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_s_s_p[(n+1) * 3 + 1], PRIM_INT__s_p_s_p[n * 9 + 1]);

                        PRIM_INT__s_p_s_p[n * 9 + 2] = SIMINT_MUL(P_PB[0], PRIM_INT__s_s_s_p[n * 3 + 2]);
                        PRIM_INT__s_p_s_p[n * 9 + 2] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_s_s_p[(n+1) * 3 + 2], PRIM_INT__s_p_s_p[n * 9 + 2]);

                        PRIM_INT__s_p_s_p[n * 9 + 3] = SIMINT_MUL(P_PB[1], PRIM_INT__s_s_s_p[n * 3 + 0]);
                        PRIM_INT__s_p_s_p[n * 9 + 3] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_s_s_p[(n+1) * 3 + 0], PRIM_INT__s_p_s_p[n * 9 + 3]);

                        PRIM_INT__s_p_s_p[n * 9 + 4] = SIMINT_MUL(P_PB[1], PRIM_INT__s_s_s_p[n * 3 + 1]);
                        PRIM_INT__s_p_s_p[n * 9 + 4] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_s_s_p[(n+1) * 3 + 1], PRIM_INT__s_p_s_p[n * 9 + 4]);
                        PRIM_INT__s_p_s_p[n * 9 + 4] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_s_s[(n+1) * 1 + 0], PRIM_INT__s_p_s_p[n * 9 + 4]);

                        PRIM_INT__s_p_s_p[n * 9 + 5] = SIMINT_MUL(P_PB[1], PRIM_INT__s_s_s_p[n * 3 + 2]);
                        PRIM_INT__s_p_s_p[n * 9 + 5] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_s_s_p[(n+1) * 3 + 2], PRIM_INT__s_p_s_p[n * 9 + 5]);

                        PRIM_INT__s_p_s_p[n * 9 + 6] = SIMINT_MUL(P_PB[2], PRIM_INT__s_s_s_p[n * 3 + 0]);
                        PRIM_INT__s_p_s_p[n * 9 + 6] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_s_s_p[(n+1) * 3 + 0], PRIM_INT__s_p_s_p[n * 9 + 6]);

                        PRIM_INT__s_p_s_p[n * 9 + 7] = SIMINT_MUL(P_PB[2], PRIM_INT__s_s_s_p[n * 3 + 1]);
                        PRIM_INT__s_p_s_p[n * 9 + 7] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_s_s_p[(n+1) * 3 + 1], PRIM_INT__s_p_s_p[n * 9 + 7]);

                        PRIM_INT__s_p_s_p[n * 9 + 8] = SIMINT_MUL(P_PB[2], PRIM_INT__s_s_s_p[n * 3 + 2]);
                        PRIM_INT__s_p_s_p[n * 9 + 8] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_s_s_p[(n+1) * 3 + 2], PRIM_INT__s_p_s_p[n * 9 + 8]);
                    ...
                    for(n = 0; n < 2; ++n)  // loop over orders of auxiliary function
                    {
                        ...
                        PRIM_INT__s_d_s_d[n * 36 + 0] = SIMINT_MUL(P_PB[0], PRIM_INT__s_p_s_d[n * 18 + 0]);
                        PRIM_INT__s_d_s_d[n * 36 + 0] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_p_s_d[(n+1) * 18 + 0], PRIM_INT__s_d_s_d[n * 36 + 0]);
                        PRIM_INT__s_d_s_d[n * 36 + 0] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 0], PRIM_INT__s_s_s_d[n * 6 + 0]), PRIM_INT__s_d_s_d[n * 36 + 0]);
                        PRIM_INT__s_d_s_d[n * 36 + 0] = SIMINT_FMADD( vrr_const_2_over_2pq, PRIM_INT__s_p_s_p[(n+1) * 9 + 0], PRIM_INT__s_d_s_d[n * 36 + 0]);

                        PRIM_INT__s_d_s_d[n * 36 + 1] = SIMINT_MUL(P_PB[0], PRIM_INT__s_p_s_d[n * 18 + 1]);
                        PRIM_INT__s_d_s_d[n * 36 + 1] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_p_s_d[(n+1) * 18 + 1], PRIM_INT__s_d_s_d[n * 36 + 1]);
                        PRIM_INT__s_d_s_d[n * 36 + 1] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 1], PRIM_INT__s_s_s_d[n * 6 + 1]), PRIM_INT__s_d_s_d[n * 36 + 1]);
                        PRIM_INT__s_d_s_d[n * 36 + 1] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_p_s_p[(n+1) * 9 + 1], PRIM_INT__s_d_s_d[n * 36 + 1]);

                        PRIM_INT__s_d_s_d[n * 36 + 2] = SIMINT_MUL(P_PB[0], PRIM_INT__s_p_s_d[n * 18 + 2]);
                        PRIM_INT__s_d_s_d[n * 36 + 2] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_p_s_d[(n+1) * 18 + 2], PRIM_INT__s_d_s_d[n * 36 + 2]);
                        PRIM_INT__s_d_s_d[n * 36 + 2] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 2], PRIM_INT__s_s_s_d[n * 6 + 2]), PRIM_INT__s_d_s_d[n * 36 + 2]);
                        PRIM_INT__s_d_s_d[n * 36 + 2] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_p_s_p[(n+1) * 9 + 2], PRIM_INT__s_d_s_d[n * 36 + 2]);

                        PRIM_INT__s_d_s_d[n * 36 + 3] = SIMINT_MUL(P_PB[0], PRIM_INT__s_p_s_d[n * 18 + 3]);
                        PRIM_INT__s_d_s_d[n * 36 + 3] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_p_s_d[(n+1) * 18 + 3], PRIM_INT__s_d_s_d[n * 36 + 3]);
                        PRIM_INT__s_d_s_d[n * 36 + 3] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 3], PRIM_INT__s_s_s_d[n * 6 + 3]), PRIM_INT__s_d_s_d[n * 36 + 3]);

                        PRIM_INT__s_d_s_d[n * 36 + 4] = SIMINT_MUL(P_PB[0], PRIM_INT__s_p_s_d[n * 18 + 4]);
                        PRIM_INT__s_d_s_d[n * 36 + 4] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_p_s_d[(n+1) * 18 + 4], PRIM_INT__s_d_s_d[n * 36 + 4]);
                        PRIM_INT__s_d_s_d[n * 36 + 4] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 4], PRIM_INT__s_s_s_d[n * 6 + 4]), PRIM_INT__s_d_s_d[n * 36 + 4]);

                        PRIM_INT__s_d_s_d[n * 36 + 5] = SIMINT_MUL(P_PB[0], PRIM_INT__s_p_s_d[n * 18 + 5]);
                        PRIM_INT__s_d_s_d[n * 36 + 5] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_p_s_d[(n+1) * 18 + 5], PRIM_INT__s_d_s_d[n * 36 + 5]);
                        PRIM_INT__s_d_s_d[n * 36 + 5] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 5], PRIM_INT__s_s_s_d[n * 6 + 5]), PRIM_INT__s_d_s_d[n * 36 + 5]);

                        PRIM_INT__s_d_s_d[n * 36 + 6] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_d[n * 18 + 0]);
                        PRIM_INT__s_d_s_d[n * 36 + 6] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_d[(n+1) * 18 + 0], PRIM_INT__s_d_s_d[n * 36 + 6]);

                        PRIM_INT__s_d_s_d[n * 36 + 7] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_d[n * 18 + 1]);
                        PRIM_INT__s_d_s_d[n * 36 + 7] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_d[(n+1) * 18 + 1], PRIM_INT__s_d_s_d[n * 36 + 7]);
                        PRIM_INT__s_d_s_d[n * 36 + 7] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_p_s_p[(n+1) * 9 + 0], PRIM_INT__s_d_s_d[n * 36 + 7]);

                        PRIM_INT__s_d_s_d[n * 36 + 8] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_d[n * 18 + 2]);
                        PRIM_INT__s_d_s_d[n * 36 + 8] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_d[(n+1) * 18 + 2], PRIM_INT__s_d_s_d[n * 36 + 8]);

                        PRIM_INT__s_d_s_d[n * 36 + 9] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_d[n * 18 + 3]);
                        PRIM_INT__s_d_s_d[n * 36 + 9] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_d[(n+1) * 18 + 3], PRIM_INT__s_d_s_d[n * 36 + 9]);
                        PRIM_INT__s_d_s_d[n * 36 + 9] = SIMINT_FMADD( vrr_const_2_over_2pq, PRIM_INT__s_p_s_p[(n+1) * 9 + 1], PRIM_INT__s_d_s_d[n * 36 + 9]);

                        PRIM_INT__s_d_s_d[n * 36 + 10] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_d[n * 18 + 4]);
                        PRIM_INT__s_d_s_d[n * 36 + 10] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_d[(n+1) * 18 + 4], PRIM_INT__s_d_s_d[n * 36 + 10]);
                        PRIM_INT__s_d_s_d[n * 36 + 10] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_p_s_p[(n+1) * 9 + 2], PRIM_INT__s_d_s_d[n * 36 + 10]);

                        PRIM_INT__s_d_s_d[n * 36 + 11] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_d[n * 18 + 5]);
                        PRIM_INT__s_d_s_d[n * 36 + 11] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_d[(n+1) * 18 + 5], PRIM_INT__s_d_s_d[n * 36 + 11]);

                        PRIM_INT__s_d_s_d[n * 36 + 18] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_d[n * 18 + 6]);
                        PRIM_INT__s_d_s_d[n * 36 + 18] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_d[(n+1) * 18 + 6], PRIM_INT__s_d_s_d[n * 36 + 18]);
                        PRIM_INT__s_d_s_d[n * 36 + 18] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 0], PRIM_INT__s_s_s_d[n * 6 + 0]), PRIM_INT__s_d_s_d[n * 36 + 18]);

                        PRIM_INT__s_d_s_d[n * 36 + 19] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_d[n * 18 + 7]);
                        PRIM_INT__s_d_s_d[n * 36 + 19] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_d[(n+1) * 18 + 7], PRIM_INT__s_d_s_d[n * 36 + 19]);
                        PRIM_INT__s_d_s_d[n * 36 + 19] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 1], PRIM_INT__s_s_s_d[n * 6 + 1]), PRIM_INT__s_d_s_d[n * 36 + 19]);
                        PRIM_INT__s_d_s_d[n * 36 + 19] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_p_s_p[(n+1) * 9 + 3], PRIM_INT__s_d_s_d[n * 36 + 19]);

                        PRIM_INT__s_d_s_d[n * 36 + 20] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_d[n * 18 + 8]);
                        PRIM_INT__s_d_s_d[n * 36 + 20] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_d[(n+1) * 18 + 8], PRIM_INT__s_d_s_d[n * 36 + 20]);
                        PRIM_INT__s_d_s_d[n * 36 + 20] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 2], PRIM_INT__s_s_s_d[n * 6 + 2]), PRIM_INT__s_d_s_d[n * 36 + 20]);

                        PRIM_INT__s_d_s_d[n * 36 + 21] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_d[n * 18 + 9]);
                        PRIM_INT__s_d_s_d[n * 36 + 21] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_d[(n+1) * 18 + 9], PRIM_INT__s_d_s_d[n * 36 + 21]);
                        PRIM_INT__s_d_s_d[n * 36 + 21] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 3], PRIM_INT__s_s_s_d[n * 6 + 3]), PRIM_INT__s_d_s_d[n * 36 + 21]);
                        PRIM_INT__s_d_s_d[n * 36 + 21] = SIMINT_FMADD( vrr_const_2_over_2pq, PRIM_INT__s_p_s_p[(n+1) * 9 + 4], PRIM_INT__s_d_s_d[n * 36 + 21]);

                        PRIM_INT__s_d_s_d[n * 36 + 22] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_d[n * 18 + 10]);
                        PRIM_INT__s_d_s_d[n * 36 + 22] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_d[(n+1) * 18 + 10], PRIM_INT__s_d_s_d[n * 36 + 22]);
                        PRIM_INT__s_d_s_d[n * 36 + 22] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 4], PRIM_INT__s_s_s_d[n * 6 + 4]), PRIM_INT__s_d_s_d[n * 36 + 22]);
                        PRIM_INT__s_d_s_d[n * 36 + 22] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_p_s_p[(n+1) * 9 + 5], PRIM_INT__s_d_s_d[n * 36 + 22]);

                        PRIM_INT__s_d_s_d[n * 36 + 23] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_d[n * 18 + 11]);
                        PRIM_INT__s_d_s_d[n * 36 + 23] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_d[(n+1) * 18 + 11], PRIM_INT__s_d_s_d[n * 36 + 23]);
                        PRIM_INT__s_d_s_d[n * 36 + 23] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 5], PRIM_INT__s_s_s_d[n * 6 + 5]), PRIM_INT__s_d_s_d[n * 36 + 23]);

                        PRIM_INT__s_d_s_d[n * 36 + 30] = SIMINT_MUL(P_PB[2], PRIM_INT__s_p_s_d[n * 18 + 12]);
                        PRIM_INT__s_d_s_d[n * 36 + 30] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_p_s_d[(n+1) * 18 + 12], PRIM_INT__s_d_s_d[n * 36 + 30]);
                        PRIM_INT__s_d_s_d[n * 36 + 30] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 0], PRIM_INT__s_s_s_d[n * 6 + 0]), PRIM_INT__s_d_s_d[n * 36 + 30]);

                        PRIM_INT__s_d_s_d[n * 36 + 31] = SIMINT_MUL(P_PB[2], PRIM_INT__s_p_s_d[n * 18 + 13]);
                        PRIM_INT__s_d_s_d[n * 36 + 31] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_p_s_d[(n+1) * 18 + 13], PRIM_INT__s_d_s_d[n * 36 + 31]);
                        PRIM_INT__s_d_s_d[n * 36 + 31] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 1], PRIM_INT__s_s_s_d[n * 6 + 1]), PRIM_INT__s_d_s_d[n * 36 + 31]);

                        PRIM_INT__s_d_s_d[n * 36 + 32] = SIMINT_MUL(P_PB[2], PRIM_INT__s_p_s_d[n * 18 + 14]);
                        PRIM_INT__s_d_s_d[n * 36 + 32] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_p_s_d[(n+1) * 18 + 14], PRIM_INT__s_d_s_d[n * 36 + 32]);
                        PRIM_INT__s_d_s_d[n * 36 + 32] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 2], PRIM_INT__s_s_s_d[n * 6 + 2]), PRIM_INT__s_d_s_d[n * 36 + 32]);
                        PRIM_INT__s_d_s_d[n * 36 + 32] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_p_s_p[(n+1) * 9 + 6], PRIM_INT__s_d_s_d[n * 36 + 32]);

                        PRIM_INT__s_d_s_d[n * 36 + 33] = SIMINT_MUL(P_PB[2], PRIM_INT__s_p_s_d[n * 18 + 15]);
                        PRIM_INT__s_d_s_d[n * 36 + 33] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_p_s_d[(n+1) * 18 + 15], PRIM_INT__s_d_s_d[n * 36 + 33]);
                        PRIM_INT__s_d_s_d[n * 36 + 33] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 3], PRIM_INT__s_s_s_d[n * 6 + 3]), PRIM_INT__s_d_s_d[n * 36 + 33]);

                        PRIM_INT__s_d_s_d[n * 36 + 34] = SIMINT_MUL(P_PB[2], PRIM_INT__s_p_s_d[n * 18 + 16]);
                        PRIM_INT__s_d_s_d[n * 36 + 34] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_p_s_d[(n+1) * 18 + 16], PRIM_INT__s_d_s_d[n * 36 + 34]);
                        PRIM_INT__s_d_s_d[n * 36 + 34] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 4], PRIM_INT__s_s_s_d[n * 6 + 4]), PRIM_INT__s_d_s_d[n * 36 + 34]);
                        PRIM_INT__s_d_s_d[n * 36 + 34] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_p_s_p[(n+1) * 9 + 7], PRIM_INT__s_d_s_d[n * 36 + 34]);

                        PRIM_INT__s_d_s_d[n * 36 + 35] = SIMINT_MUL(P_PB[2], PRIM_INT__s_p_s_d[n * 18 + 17]);
                        PRIM_INT__s_d_s_d[n * 36 + 35] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_p_s_d[(n+1) * 18 + 17], PRIM_INT__s_d_s_d[n * 36 + 35]);
                        PRIM_INT__s_d_s_d[n * 36 + 35] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_d[(n+1) * 6 + 5], PRIM_INT__s_s_s_d[n * 6 + 5]), PRIM_INT__s_d_s_d[n * 36 + 35]);
                    ...
                    ostei_general_vrr_J(0, 3, 0, 5, 1,
                            one_over_2p, a_over_p, one_over_2pq, aop_PQ, P_PB,
                            PRIM_INT__s_d_s_h, NULL, PRIM_INT__s_p_s_h, NULL, PRIM_INT__s_d_s_g, PRIM_INT__s_f_s_h);
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_d_d_f = INT__p_d_d_f + real_abcd * 1080;

                // form INT__p_d_s_f
                for(iket = 0; iket < 10; ++iket)
                {
                    HRR_INT__p_d_s_f[0 * 10 + iket] = HRR_INT__s_f_s_f[0 * 10 + iket] - ( hAB[0] * HRR_INT__s_d_s_f[0 * 10 + iket] );

                    HRR_INT__p_d_s_f[1 * 10 + iket] = HRR_INT__s_f_s_f[1 * 10 + iket] - ( hAB[0] * HRR_INT__s_d_s_f[1 * 10 + iket] );

                    HRR_INT__p_d_s_f[2 * 10 + iket] = HRR_INT__s_f_s_f[2 * 10 + iket] - ( hAB[0] * HRR_INT__s_d_s_f[2 * 10 + iket] );

                    HRR_INT__p_d_s_f[3 * 10 + iket] = HRR_INT__s_f_s_f[3 * 10 + iket] - ( hAB[0] * HRR_INT__s_d_s_f[3 * 10 + iket] );

                    HRR_INT__p_d_s_f[4 * 10 + iket] = HRR_INT__s_f_s_f[4 * 10 + iket] - ( hAB[0] * HRR_INT__s_d_s_f[4 * 10 + iket] );

                    HRR_INT__p_d_s_f[5 * 10 + iket] = HRR_INT__s_f_s_f[5 * 10 + iket] - ( hAB[0] * HRR_INT__s_d_s_f[5 * 10 + iket] );

                    HRR_INT__p_d_s_f[6 * 10 + iket] = HRR_INT__s_f_s_f[1 * 10 + iket] - ( hAB[1] * HRR_INT__s_d_s_f[0 * 10 + iket] );

                    HRR_INT__p_d_s_f[7 * 10 + iket] = HRR_INT__s_f_s_f[3 * 10 + iket] - ( hAB[1] * HRR_INT__s_d_s_f[1 * 10 + iket] );

                    HRR_INT__p_d_s_f[8 * 10 + iket] = HRR_INT__s_f_s_f[4 * 10 + iket] - ( hAB[1] * HRR_INT__s_d_s_f[2 * 10 + iket] );

                    HRR_INT__p_d_s_f[9 * 10 + iket] = HRR_INT__s_f_s_f[6 * 10 + iket] - ( hAB[1] * HRR_INT__s_d_s_f[3 * 10 + iket] );

                    HRR_INT__p_d_s_f[10 * 10 + iket] = HRR_INT__s_f_s_f[7 * 10 + iket] - ( hAB[1] * HRR_INT__s_d_s_f[4 * 10 + iket] );

                    HRR_INT__p_d_s_f[11 * 10 + iket] = HRR_INT__s_f_s_f[8 * 10 + iket] - ( hAB[1] * HRR_INT__s_d_s_f[5 * 10 + iket] );

                    HRR_INT__p_d_s_f[12 * 10 + iket] = HRR_INT__s_f_s_f[2 * 10 + iket] - ( hAB[2] * HRR_INT__s_d_s_f[0 * 10 + iket] );

                    HRR_INT__p_d_s_f[13 * 10 + iket] = HRR_INT__s_f_s_f[4 * 10 + iket] - ( hAB[2] * HRR_INT__s_d_s_f[1 * 10 + iket] );

                    HRR_INT__p_d_s_f[14 * 10 + iket] = HRR_INT__s_f_s_f[5 * 10 + iket] - ( hAB[2] * HRR_INT__s_d_s_f[2 * 10 + iket] );

                    HRR_INT__p_d_s_f[15 * 10 + iket] = HRR_INT__s_f_s_f[7 * 10 + iket] - ( hAB[2] * HRR_INT__s_d_s_f[3 * 10 + iket] );

                    HRR_INT__p_d_s_f[16 * 10 + iket] = HRR_INT__s_f_s_f[8 * 10 + iket] - ( hAB[2] * HRR_INT__s_d_s_f[4 * 10 + iket] );

                    HRR_INT__p_d_s_f[17 * 10 + iket] = HRR_INT__s_f_s_f[9 * 10 + iket] - ( hAB[2] * HRR_INT__s_d_s_f[5 * 10 + iket] );
                ...
                {
                    HRR_INT__p_d_s_g[0 * 15 + iket] = HRR_INT__s_f_s_g[0 * 15 + iket] - ( hAB[0] * HRR_INT__s_d_s_g[0 * 15 + iket] );

                    HRR_INT__p_d_s_g[1 * 15 + iket] = HRR_INT__s_f_s_g[1 * 15 + iket] - ( hAB[0] * HRR_INT__s_d_s_g[1 * 15 + iket] );

                    HRR_INT__p_d_s_g[2 * 15 + iket] = HRR_INT__s_f_s_g[2 * 15 + iket] - ( hAB[0] * HRR_INT__s_d_s_g[2 * 15 + iket] );

                    HRR_INT__p_d_s_g[3 * 15 + iket] = HRR_INT__s_f_s_g[3 * 15 + iket] - ( hAB[0] * HRR_INT__s_d_s_g[3 * 15 + iket] );

                    HRR_INT__p_d_s_g[4 * 15 + iket] = HRR_INT__s_f_s_g[4 * 15 + iket] - ( hAB[0] * HRR_INT__s_d_s_g[4 * 15 + iket] );

                    HRR_INT__p_d_s_g[5 * 15 + iket] = HRR_INT__s_f_s_g[5 * 15 + iket] - ( hAB[0] * HRR_INT__s_d_s_g[5 * 15 + iket] );

                    HRR_INT__p_d_s_g[6 * 15 + iket] = HRR_INT__s_f_s_g[1 * 15 + iket] - ( hAB[1] * HRR_INT__s_d_s_g[0 * 15 + iket] );

                    HRR_INT__p_d_s_g[7 * 15 + iket] = HRR_INT__s_f_s_g[3 * 15 + iket] - ( hAB[1] * HRR_INT__s_d_s_g[1 * 15 + iket] );

                    HRR_INT__p_d_s_g[8 * 15 + iket] = HRR_INT__s_f_s_g[4 * 15 + iket] - ( hAB[1] * HRR_INT__s_d_s_g[2 * 15 + iket] );

                    HRR_INT__p_d_s_g[9 * 15 + iket] = HRR_INT__s_f_s_g[6 * 15 + iket] - ( hAB[1] * HRR_INT__s_d_s_g[3 * 15 + iket] );

                    HRR_INT__p_d_s_g[10 * 15 + iket] = HRR_INT__s_f_s_g[7 * 15 + iket] - ( hAB[1] * HRR_INT__s_d_s_g[4 * 15 + iket] );

                    HRR_INT__p_d_s_g[11 * 15 + iket] = HRR_INT__s_f_s_g[8 * 15 + iket] - ( hAB[1] * HRR_INT__s_d_s_g[5 * 15 + iket] );

                    HRR_INT__p_d_s_g[12 * 15 + iket] = HRR_INT__s_f_s_g[2 * 15 + iket] - ( hAB[2] * HRR_INT__s_d_s_g[0 * 15 + iket] );

                    HRR_INT__p_d_s_g[13 * 15 + iket] = HRR_INT__s_f_s_g[4 * 15 + iket] - ( hAB[2] * HRR_INT__s_d_s_g[1 * 15 + iket] );

                    HRR_INT__p_d_s_g[14 * 15 + iket] = HRR_INT__s_f_s_g[5 * 15 + iket] - ( hAB[2] * HRR_INT__s_d_s_g[2 * 15 + iket] );

                    HRR_INT__p_d_s_g[15 * 15 + iket] = HRR_INT__s_f_s_g[7 * 15 + iket] - ( hAB[2] * HRR_INT__s_d_s_g[3 * 15 + iket] );

                    HRR_INT__p_d_s_g[16 * 15 + iket] = HRR_INT__s_f_s_g[8 * 15 + iket] - ( hAB[2] * HRR_INT__s_d_s_g[4 * 15 + iket] );

                    HRR_INT__p_d_s_g[17 * 15 + iket] = HRR_INT__s_f_s_g[9 * 15 + iket] - ( hAB[2] * HRR_INT__s_d_s_g[5 * 15 + iket] );
                ...
                {
                    HRR_INT__p_d_s_h[0 * 21 + iket] = HRR_INT__s_f_s_h[0 * 21 + iket] - ( hAB[0] * HRR_INT__s_d_s_h[0 * 21 + iket] );

                    HRR_INT__p_d_s_h[1 * 21 + iket] = HRR_INT__s_f_s_h[1 * 21 + iket] - ( hAB[0] * HRR_INT__s_d_s_h[1 * 21 + iket] );

                    HRR_INT__p_d_s_h[2 * 21 + iket] = HRR_INT__s_f_s_h[2 * 21 + iket] - ( hAB[0] * HRR_INT__s_d_s_h[2 * 21 + iket] );

                    HRR_INT__p_d_s_h[3 * 21 + iket] = HRR_INT__s_f_s_h[3 * 21 + iket] - ( hAB[0] * HRR_INT__s_d_s_h[3 * 21 + iket] );

                    HRR_INT__p_d_s_h[4 * 21 + iket] = HRR_INT__s_f_s_h[4 * 21 + iket] - ( hAB[0] * HRR_INT__s_d_s_h[4 * 21 + iket] );

                    HRR_INT__p_d_s_h[5 * 21 + iket] = HRR_INT__s_f_s_h[5 * 21 + iket] - ( hAB[0] * HRR_INT__s_d_s_h[5 * 21 + iket] );

                    HRR_INT__p_d_s_h[6 * 21 + iket] = HRR_INT__s_f_s_h[1 * 21 + iket] - ( hAB[1] * HRR_INT__s_d_s_h[0 * 21 + iket] );

                    HRR_INT__p_d_s_h[7 * 21 + iket] = HRR_INT__s_f_s_h[3 * 21 + iket] - ( hAB[1] * HRR_INT__s_d_s_h[1 * 21 + iket] );

                    HRR_INT__p_d_s_h[8 * 21 + iket] = HRR_INT__s_f_s_h[4 * 21 + iket] - ( hAB[1] * HRR_INT__s_d_s_h[2 * 21 + iket] );

                    HRR_INT__p_d_s_h[9 * 21 + iket] = HRR_INT__s_f_s_h[6 * 21 + iket] - ( hAB[1] * HRR_INT__s_d_s_h[3 * 21 + iket] );

                    HRR_INT__p_d_s_h[10 * 21 + iket] = HRR_INT__s_f_s_h[7 * 21 + iket] - ( hAB[1] * HRR_INT__s_d_s_h[4 * 21 + iket] );

                    HRR_INT__p_d_s_h[11 * 21 + iket] = HRR_INT__s_f_s_h[8 * 21 + iket] - ( hAB[1] * HRR_INT__s_d_s_h[5 * 21 + iket] );

                    HRR_INT__p_d_s_h[12 * 21 + iket] = HRR_INT__s_f_s_h[2 * 21 + iket] - ( hAB[2] * HRR_INT__s_d_s_h[0 * 21 + iket] );

                    HRR_INT__p_d_s_h[13 * 21 + iket] = HRR_INT__s_f_s_h[4 * 21 + iket] - ( hAB[2] * HRR_INT__s_d_s_h[1 * 21 + iket] );

                    HRR_INT__p_d_s_h[14 * 21 + iket] = HRR_INT__s_f_s_h[5 * 21 + iket] - ( hAB[2] * HRR_INT__s_d_s_h[2 * 21 + iket] );

                    HRR_INT__p_d_s_h[15 * 21 + iket] = HRR_INT__s_f_s_h[7 * 21 + iket] - ( hAB[2] * HRR_INT__s_d_s_h[3 * 21 + iket] );

                    HRR_INT__p_d_s_h[16 * 21 + iket] = HRR_INT__s_f_s_h[8 * 21 + iket] - ( hAB[2] * HRR_INT__s_d_s_h[4 * 21 + iket] );

                    HRR_INT__p_d_s_h[17 * 21 + iket] = HRR_INT__s_f_s_h[9 * 21 + iket] - ( hAB[2] * HRR_INT__s_d_s_h[5 * 21 + iket] );
                ...
                {
                    HRR_INT__p_d_p_f[ibra * 30 + 0] = HRR_INT__p_d_s_g[ibra * 15 + 0] - ( hCD[0] * HRR_INT__p_d_s_f[ibra * 10 + 0] );

                    HRR_INT__p_d_p_f[ibra * 30 + 1] = HRR_INT__p_d_s_g[ibra * 15 + 1] - ( hCD[0] * HRR_INT__p_d_s_f[ibra * 10 + 1] );

                    HRR_INT__p_d_p_f[ibra * 30 + 2] = HRR_INT__p_d_s_g[ibra * 15 + 2] - ( hCD[0] * HRR_INT__p_d_s_f[ibra * 10 + 2] );

                    HRR_INT__p_d_p_f[ibra * 30 + 3] = HRR_INT__p_d_s_g[ibra * 15 + 3] - ( hCD[0] * HRR_INT__p_d_s_f[ibra * 10 + 3] );

                    HRR_INT__p_d_p_f[ibra * 30 + 4] = HRR_INT__p_d_s_g[ibra * 15 + 4] - ( hCD[0] * HRR_INT__p_d_s_f[ibra * 10 + 4] );

                    HRR_INT__p_d_p_f[ibra * 30 + 5] = HRR_INT__p_d_s_g[ibra * 15 + 5] - ( hCD[0] * HRR_INT__p_d_s_f[ibra * 10 + 5] );

                    HRR_INT__p_d_p_f[ibra * 30 + 6] = HRR_INT__p_d_s_g[ibra * 15 + 6] - ( hCD[0] * HRR_INT__p_d_s_f[ibra * 10 + 6] );

                    HRR_INT__p_d_p_f[ibra * 30 + 7] = HRR_INT__p_d_s_g[ibra * 15 + 7] - ( hCD[0] * HRR_INT__p_d_s_f[ibra * 10 + 7] );

                    HRR_INT__p_d_p_f[ibra * 30 + 8] = HRR_INT__p_d_s_g[ibra * 15 + 8] - ( hCD[0] * HRR_INT__p_d_s_f[ibra * 10 + 8] );

                    HRR_INT__p_d_p_f[ibra * 30 + 9] = HRR_INT__p_d_s_g[ibra * 15 + 9] - ( hCD[0] * HRR_INT__p_d_s_f[ibra * 10 + 9] );

                    HRR_INT__p_d_p_f[ibra * 30 + 10] = HRR_INT__p_d_s_g[ibra * 15 + 1] - ( hCD[1] * HRR_INT__p_d_s_f[ibra * 10 + 0] );

                    HRR_INT__p_d_p_f[ibra * 30 + 11] = HRR_INT__p_d_s_g[ibra * 15 + 3] - ( hCD[1] * HRR_INT__p_d_s_f[ibra * 10 + 1] );

                    HRR_INT__p_d_p_f[ibra * 30 + 12] = HRR_INT__p_d_s_g[ibra * 15 + 4] - ( hCD[1] * HRR_INT__p_d_s_f[ibra * 10 + 2] );

                    HRR_INT__p_d_p_f[ibra * 30 + 13] = HRR_INT__p_d_s_g[ibra * 15 + 6] - ( hCD[1] * HRR_INT__p_d_s_f[ibra * 10 + 3] );

                    HRR_INT__p_d_p_f[ibra * 30 + 14] = HRR_INT__p_d_s_g[ibra * 15 + 7] - ( hCD[1] * HRR_INT__p_d_s_f[ibra * 10 + 4] );

                    HRR_INT__p_d_p_f[ibra * 30 + 15] = HRR_INT__p_d_s_g[ibra * 15 + 8] - ( hCD[1] * HRR_INT__p_d_s_f[ibra * 10 + 5] );

                    HRR_INT__p_d_p_f[ibra * 30 + 16] = HRR_INT__p_d_s_g[ibra * 15 + 10] - ( hCD[1] * HRR_INT__p_d_s_f[ibra * 10 + 6] );

                    HRR_INT__p_d_p_f[ibra * 30 + 17] = HRR_INT__p_d_s_g[ibra * 15 + 11] - ( hCD[1] * HRR_INT__p_d_s_f[ibra * 10 + 7] );

                    HRR_INT__p_d_p_f[ibra * 30 + 18] = HRR_INT__p_d_s_g[ibra * 15 + 12] - ( hCD[1] * HRR_INT__p_d_s_f[ibra * 10 + 8] );

                    HRR_INT__p_d_p_f[ibra * 30 + 19] = HRR_INT__p_d_s_g[ibra * 15 + 13] - ( hCD[1] * HRR_INT__p_d_s_f[ibra * 10 + 9] );

                    HRR_INT__p_d_p_f[ibra * 30 + 20] = HRR_INT__p_d_s_g[ibra * 15 + 2] - ( hCD[2] * HRR_INT__p_d_s_f[ibra * 10 + 0] );

                    HRR_INT__p_d_p_f[ibra * 30 + 21] = HRR_INT__p_d_s_g[ibra * 15 + 4] - ( hCD[2] * HRR_INT__p_d_s_f[ibra * 10 + 1] );

                    HRR_INT__p_d_p_f[ibra * 30 + 22] = HRR_INT__p_d_s_g[ibra * 15 + 5] - ( hCD[2] * HRR_INT__p_d_s_f[ibra * 10 + 2] );

                    HRR_INT__p_d_p_f[ibra * 30 + 23] = HRR_INT__p_d_s_g[ibra * 15 + 7] - ( hCD[2] * HRR_INT__p_d_s_f[ibra * 10 + 3] );

                    HRR_INT__p_d_p_f[ibra * 30 + 24] = HRR_INT__p_d_s_g[ibra * 15 + 8] - ( hCD[2] * HRR_INT__p_d_s_f[ibra * 10 + 4] );

                    HRR_INT__p_d_p_f[ibra * 30 + 25] = HRR_INT__p_d_s_g[ibra * 15 + 9] - ( hCD[2] * HRR_INT__p_d_s_f[ibra * 10 + 5] );

                    HRR_INT__p_d_p_f[ibra * 30 + 26] = HRR_INT__p_d_s_g[ibra * 15 + 11] - ( hCD[2] * HRR_INT__p_d_s_f[ibra * 10 + 6] );

                    HRR_INT__p_d_p_f[ibra * 30 + 27] = HRR_INT__p_d_s_g[ibra * 15 + 12] - ( hCD[2] * HRR_INT__p_d_s_f[ibra * 10 + 7] );

                    HRR_INT__p_d_p_f[ibra * 30 + 28] = HRR_INT__p_d_s_g[ibra * 15 + 13] - ( hCD[2] * HRR_INT__p_d_s_f[ibra * 10 + 8] );

                    HRR_INT__p_d_p_f[ibra * 30 + 29] = HRR_INT__p_d_s_g[ibra * 15 + 14] - ( hCD[2] * HRR_INT__p_d_s_f[ibra * 10 + 9] );
