                  ...
                  double * const restrict INT__p_d_d_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_d_d_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_f_d_s = work + (SIMINT_NSHELL_SIMD * 96);
    double * const INT__s_f_f_s = work + (SIMINT_NSHELL_SIMD * 156);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_p_s = primwork + 34;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_d_s = primwork + 61;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_s = primwork + 97;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_p_s = primwork + 127;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_d_s = primwork + 181;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_f_s = primwork + 253;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_s = primwork + 313;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_p_s = primwork + 353;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_d_s = primwork + 443;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_f_s = primwork + 563;
    double * const hrrwork = (double *)(primwork + 663);
    double * const HRR_INT__p_d_d_s = hrrwork + 0;
    double * const HRR_INT__p_d_f_s = hrrwork + 108;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    for(n = 0; n < 2; ++n)  // loop over orders of auxiliary function
                    {
                        ...
                        PRIM_INT__s_p_d_s[n * 18 + 1] = SIMINT_MUL(Q_PA[1], PRIM_INT__s_p_p_s[n * 9 + 0]);
                        PRIM_INT__s_p_d_s[n * 18 + 1] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__s_p_p_s[(n+1) * 9 + 0], PRIM_INT__s_p_d_s[n * 18 + 1]);
                        ...
                        PRIM_INT__s_p_d_s[n * 18 + 7] = SIMINT_MUL(Q_PA[1], PRIM_INT__s_p_p_s[n * 9 + 3]);
                        PRIM_INT__s_p_d_s[n * 18 + 7] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__s_p_p_s[(n+1) * 9 + 3], PRIM_INT__s_p_d_s[n * 18 + 7]);
                        ...
                        PRIM_INT__s_p_d_s[n * 18 + 13] = SIMINT_MUL(Q_PA[1], PRIM_INT__s_p_p_s[n * 9 + 6]);
                        PRIM_INT__s_p_d_s[n * 18 + 13] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__s_p_p_s[(n+1) * 9 + 6], PRIM_INT__s_p_d_s[n * 18 + 13]);
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_d_d_p = INT__p_d_d_p + real_abcd * 324;
