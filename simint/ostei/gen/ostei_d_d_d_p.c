                  ...
                  double * const restrict INT__d_d_d_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_d_d_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__f_s_d_s = work + (SIMINT_NSHELL_SIMD * 96);
    double * const INT__f_s_f_s = work + (SIMINT_NSHELL_SIMD * 156);
    double * const INT__g_s_d_s = work + (SIMINT_NSHELL_SIMD * 256);
    double * const INT__g_s_f_s = work + (SIMINT_NSHELL_SIMD * 346);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 38;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 65;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 101;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 137;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 191;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 263;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 323;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 373;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 463;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 583;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 683;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 743;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 878;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 1058;
    ...
    double * const HRR_INT__d_d_d_s = hrrwork + 288;
    double * const HRR_INT__d_d_f_s = hrrwork + 504;
    double * const HRR_INT__f_p_d_s = hrrwork + 864;
    double * const HRR_INT__f_p_f_s = hrrwork + 1044;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_d_d_p = INT__d_d_d_p + real_abcd * 648;
