                  ...
                  double * const restrict INT__d_f_p_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_f_p_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_h_s_d = work + (SIMINT_NSHELL_SIMD * 400);
    double * const INT__s_h_s_f = work + (SIMINT_NSHELL_SIMD * 526);
    ...
    double * const HRR_INT__p_g_s_d = hrrwork + 480;
    double * const HRR_INT__p_g_s_f = hrrwork + 750;
    double * const HRR_INT__d_f_s_d = hrrwork + 1200;
    double * const HRR_INT__d_f_s_f = hrrwork + 1560;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                double * restrict PRIM_PTR_INT__s_h_s_d = INT__s_h_s_d + abcd * 126;
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    if(check_screen)
                    {
                        ...
                        if(vmax < screen_tol)
                        {
                            ...
                            PRIM_PTR_INT__s_h_s_d += lastoffset*126;
                    ...
                    if(lastoffset == 0)
                    {
                        ...
                        contract_all(126, PRIM_INT__s_h_s_d, PRIM_PTR_INT__s_h_s_d);
                    ...
                    else
                    {
                        ...
                        contract(126, shelloffsets, PRIM_INT__s_h_s_d, PRIM_PTR_INT__s_h_s_d);
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double const * restrict HRR_INT__s_h_s_d = INT__s_h_s_d + abcd * 126;
                double const * restrict HRR_INT__s_h_s_f = INT__s_h_s_f + abcd * 210;
                double * restrict HRR_INT__d_f_p_d = INT__d_f_p_d + real_abcd * 1080;
                ...
                {
                    HRR_INT__d_f_p_d[ibra * 18 + 0] = HRR_INT__d_f_s_f[ibra * 10 + 0] - ( hCD[0] * HRR_INT__d_f_s_d[ibra * 6 + 0] );

                    HRR_INT__d_f_p_d[ibra * 18 + 1] = HRR_INT__d_f_s_f[ibra * 10 + 1] - ( hCD[0] * HRR_INT__d_f_s_d[ibra * 6 + 1] );

                    HRR_INT__d_f_p_d[ibra * 18 + 2] = HRR_INT__d_f_s_f[ibra * 10 + 2] - ( hCD[0] * HRR_INT__d_f_s_d[ibra * 6 + 2] );

                    HRR_INT__d_f_p_d[ibra * 18 + 3] = HRR_INT__d_f_s_f[ibra * 10 + 3] - ( hCD[0] * HRR_INT__d_f_s_d[ibra * 6 + 3] );

                    HRR_INT__d_f_p_d[ibra * 18 + 4] = HRR_INT__d_f_s_f[ibra * 10 + 4] - ( hCD[0] * HRR_INT__d_f_s_d[ibra * 6 + 4] );

                    HRR_INT__d_f_p_d[ibra * 18 + 5] = HRR_INT__d_f_s_f[ibra * 10 + 5] - ( hCD[0] * HRR_INT__d_f_s_d[ibra * 6 + 5] );

                    HRR_INT__d_f_p_d[ibra * 18 + 6] = HRR_INT__d_f_s_f[ibra * 10 + 1] - ( hCD[1] * HRR_INT__d_f_s_d[ibra * 6 + 0] );

                    HRR_INT__d_f_p_d[ibra * 18 + 7] = HRR_INT__d_f_s_f[ibra * 10 + 3] - ( hCD[1] * HRR_INT__d_f_s_d[ibra * 6 + 1] );

                    HRR_INT__d_f_p_d[ibra * 18 + 8] = HRR_INT__d_f_s_f[ibra * 10 + 4] - ( hCD[1] * HRR_INT__d_f_s_d[ibra * 6 + 2] );

                    HRR_INT__d_f_p_d[ibra * 18 + 9] = HRR_INT__d_f_s_f[ibra * 10 + 6] - ( hCD[1] * HRR_INT__d_f_s_d[ibra * 6 + 3] );

                    HRR_INT__d_f_p_d[ibra * 18 + 10] = HRR_INT__d_f_s_f[ibra * 10 + 7] - ( hCD[1] * HRR_INT__d_f_s_d[ibra * 6 + 4] );

                    HRR_INT__d_f_p_d[ibra * 18 + 11] = HRR_INT__d_f_s_f[ibra * 10 + 8] - ( hCD[1] * HRR_INT__d_f_s_d[ibra * 6 + 5] );

                    HRR_INT__d_f_p_d[ibra * 18 + 12] = HRR_INT__d_f_s_f[ibra * 10 + 2] - ( hCD[2] * HRR_INT__d_f_s_d[ibra * 6 + 0] );

                    HRR_INT__d_f_p_d[ibra * 18 + 13] = HRR_INT__d_f_s_f[ibra * 10 + 4] - ( hCD[2] * HRR_INT__d_f_s_d[ibra * 6 + 1] );

                    HRR_INT__d_f_p_d[ibra * 18 + 14] = HRR_INT__d_f_s_f[ibra * 10 + 5] - ( hCD[2] * HRR_INT__d_f_s_d[ibra * 6 + 2] );

                    HRR_INT__d_f_p_d[ibra * 18 + 15] = HRR_INT__d_f_s_f[ibra * 10 + 7] - ( hCD[2] * HRR_INT__d_f_s_d[ibra * 6 + 3] );

                    HRR_INT__d_f_p_d[ibra * 18 + 16] = HRR_INT__d_f_s_f[ibra * 10 + 8] - ( hCD[2] * HRR_INT__d_f_s_d[ibra * 6 + 4] );

                    HRR_INT__d_f_p_d[ibra * 18 + 17] = HRR_INT__d_f_s_f[ibra * 10 + 9] - ( hCD[2] * HRR_INT__d_f_s_d[ibra * 6 + 5] );
