                  ...
                  double * const restrict INT__f_f_p_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_f_p_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__f_s_s_f = work + (SIMINT_NSHELL_SIMD * 60);
    double * const INT__g_s_s_d = work + (SIMINT_NSHELL_SIMD * 160);
    double * const INT__g_s_s_f = work + (SIMINT_NSHELL_SIMD * 250);
    double * const INT__h_s_s_d = work + (SIMINT_NSHELL_SIMD * 400);
    double * const INT__h_s_s_f = work + (SIMINT_NSHELL_SIMD * 526);
    double * const INT__i_s_s_d = work + (SIMINT_NSHELL_SIMD * 736);
    double * const INT__i_s_s_f = work + (SIMINT_NSHELL_SIMD * 904);
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*1184);
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_s = primwork + 0;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 10;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_p = primwork + 37;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 64;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_p = primwork + 112;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_d = primwork + 166;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 238;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_p = primwork + 308;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_d = primwork + 398;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_f = primwork + 518;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 618;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_p = primwork + 708;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_d = primwork + 843;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_f = primwork + 1023;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 1173;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_p = primwork + 1278;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_d = primwork + 1467;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_f = primwork + 1719;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 1929;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_p = primwork + 2041;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_d = primwork + 2293;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_f = primwork + 2629;
    double * const hrrwork = (double *)(primwork + 2909);
    double * const HRR_INT__f_p_s_d = hrrwork + 0;
    double * const HRR_INT__f_p_s_f = hrrwork + 180;
    double * const HRR_INT__f_d_s_d = hrrwork + 480;
    double * const HRR_INT__f_d_s_f = hrrwork + 840;
    double * const HRR_INT__f_f_s_d = hrrwork + 1440;
    double * const HRR_INT__f_f_s_f = hrrwork + 2040;
    double * const HRR_INT__g_p_s_d = hrrwork + 3040;
    double * const HRR_INT__g_p_s_f = hrrwork + 3310;
    double * const HRR_INT__g_d_s_d = hrrwork + 3760;
    double * const HRR_INT__g_d_s_f = hrrwork + 4300;
    double * const HRR_INT__h_p_s_d = hrrwork + 5200;
    double * const HRR_INT__h_p_s_f = hrrwork + 5578;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 1184 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_f_p_d = INT__f_f_p_d + real_abcd * 1800;
                ...
                {
                    HRR_INT__f_f_p_d[ibra * 18 + 0] = HRR_INT__f_f_s_f[ibra * 10 + 0] - ( hCD[0] * HRR_INT__f_f_s_d[ibra * 6 + 0] );

                    HRR_INT__f_f_p_d[ibra * 18 + 1] = HRR_INT__f_f_s_f[ibra * 10 + 1] - ( hCD[0] * HRR_INT__f_f_s_d[ibra * 6 + 1] );

                    HRR_INT__f_f_p_d[ibra * 18 + 2] = HRR_INT__f_f_s_f[ibra * 10 + 2] - ( hCD[0] * HRR_INT__f_f_s_d[ibra * 6 + 2] );

                    HRR_INT__f_f_p_d[ibra * 18 + 3] = HRR_INT__f_f_s_f[ibra * 10 + 3] - ( hCD[0] * HRR_INT__f_f_s_d[ibra * 6 + 3] );

                    HRR_INT__f_f_p_d[ibra * 18 + 4] = HRR_INT__f_f_s_f[ibra * 10 + 4] - ( hCD[0] * HRR_INT__f_f_s_d[ibra * 6 + 4] );

                    HRR_INT__f_f_p_d[ibra * 18 + 5] = HRR_INT__f_f_s_f[ibra * 10 + 5] - ( hCD[0] * HRR_INT__f_f_s_d[ibra * 6 + 5] );

                    HRR_INT__f_f_p_d[ibra * 18 + 6] = HRR_INT__f_f_s_f[ibra * 10 + 1] - ( hCD[1] * HRR_INT__f_f_s_d[ibra * 6 + 0] );

                    HRR_INT__f_f_p_d[ibra * 18 + 7] = HRR_INT__f_f_s_f[ibra * 10 + 3] - ( hCD[1] * HRR_INT__f_f_s_d[ibra * 6 + 1] );

                    HRR_INT__f_f_p_d[ibra * 18 + 8] = HRR_INT__f_f_s_f[ibra * 10 + 4] - ( hCD[1] * HRR_INT__f_f_s_d[ibra * 6 + 2] );

                    HRR_INT__f_f_p_d[ibra * 18 + 9] = HRR_INT__f_f_s_f[ibra * 10 + 6] - ( hCD[1] * HRR_INT__f_f_s_d[ibra * 6 + 3] );

                    HRR_INT__f_f_p_d[ibra * 18 + 10] = HRR_INT__f_f_s_f[ibra * 10 + 7] - ( hCD[1] * HRR_INT__f_f_s_d[ibra * 6 + 4] );

                    HRR_INT__f_f_p_d[ibra * 18 + 11] = HRR_INT__f_f_s_f[ibra * 10 + 8] - ( hCD[1] * HRR_INT__f_f_s_d[ibra * 6 + 5] );

                    HRR_INT__f_f_p_d[ibra * 18 + 12] = HRR_INT__f_f_s_f[ibra * 10 + 2] - ( hCD[2] * HRR_INT__f_f_s_d[ibra * 6 + 0] );

                    HRR_INT__f_f_p_d[ibra * 18 + 13] = HRR_INT__f_f_s_f[ibra * 10 + 4] - ( hCD[2] * HRR_INT__f_f_s_d[ibra * 6 + 1] );

                    HRR_INT__f_f_p_d[ibra * 18 + 14] = HRR_INT__f_f_s_f[ibra * 10 + 5] - ( hCD[2] * HRR_INT__f_f_s_d[ibra * 6 + 2] );

                    HRR_INT__f_f_p_d[ibra * 18 + 15] = HRR_INT__f_f_s_f[ibra * 10 + 7] - ( hCD[2] * HRR_INT__f_f_s_d[ibra * 6 + 3] );

                    HRR_INT__f_f_p_d[ibra * 18 + 16] = HRR_INT__f_f_s_f[ibra * 10 + 8] - ( hCD[2] * HRR_INT__f_f_s_d[ibra * 6 + 4] );

                    HRR_INT__f_f_p_d[ibra * 18 + 17] = HRR_INT__f_f_s_f[ibra * 10 + 9] - ( hCD[2] * HRR_INT__f_f_s_d[ibra * 6 + 5] );
