                  ...
                  double * const restrict INT__g_f_p_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_f_p_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 155;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 215;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 305;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 395;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 485;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 590;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_d_s = primwork + 716;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 842;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_p_s = primwork + 954;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_d_s = primwork + 1122;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_s_s = primwork + 1290;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_p_s = primwork + 1398;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_d_s = primwork + 1614;
    ...
    double * const HRR_INT__h_p_p_s = hrrwork + 2565;
    double * const HRR_INT__h_p_d_s = hrrwork + 2754;
    double * const HRR_INT__h_d_p_s = hrrwork + 3132;
    double * const HRR_INT__h_d_d_s = hrrwork + 3510;
    double * const HRR_INT__i_p_p_s = hrrwork + 4266;
    double * const HRR_INT__i_p_d_s = hrrwork + 4518;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__g_f_p_p = INT__g_f_p_p + real_abcd * 1350;
                ...
                {
                    HRR_INT__g_f_p_p[ibra * 9 + 0] = HRR_INT__g_f_d_s[ibra * 6 + 0] + ( hCD[0] * HRR_INT__g_f_p_s[ibra * 3 + 0] );

                    HRR_INT__g_f_p_p[ibra * 9 + 1] = HRR_INT__g_f_d_s[ibra * 6 + 1] + ( hCD[1] * HRR_INT__g_f_p_s[ibra * 3 + 0] );

                    HRR_INT__g_f_p_p[ibra * 9 + 2] = HRR_INT__g_f_d_s[ibra * 6 + 2] + ( hCD[2] * HRR_INT__g_f_p_s[ibra * 3 + 0] );

                    HRR_INT__g_f_p_p[ibra * 9 + 3] = HRR_INT__g_f_d_s[ibra * 6 + 1] + ( hCD[0] * HRR_INT__g_f_p_s[ibra * 3 + 1] );

                    HRR_INT__g_f_p_p[ibra * 9 + 4] = HRR_INT__g_f_d_s[ibra * 6 + 3] + ( hCD[1] * HRR_INT__g_f_p_s[ibra * 3 + 1] );

                    HRR_INT__g_f_p_p[ibra * 9 + 5] = HRR_INT__g_f_d_s[ibra * 6 + 4] + ( hCD[2] * HRR_INT__g_f_p_s[ibra * 3 + 1] );

                    HRR_INT__g_f_p_p[ibra * 9 + 6] = HRR_INT__g_f_d_s[ibra * 6 + 2] + ( hCD[0] * HRR_INT__g_f_p_s[ibra * 3 + 2] );

                    HRR_INT__g_f_p_p[ibra * 9 + 7] = HRR_INT__g_f_d_s[ibra * 6 + 4] + ( hCD[1] * HRR_INT__g_f_p_s[ibra * 3 + 2] );

                    HRR_INT__g_f_p_p[ibra * 9 + 8] = HRR_INT__g_f_d_s[ibra * 6 + 5] + ( hCD[2] * HRR_INT__g_f_p_s[ibra * 3 + 2] );
                  ...
                  double * const restrict INT__f_g_p_p)
{
    ...
    int ret = ostei_g_f_p_p(P_tmp, Q, screen_tol, work, INT__f_g_p_p);
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 3; ++c)
        for(int d = 0; d < 3; ++d)
            buffer[idx++] = INT__f_g_p_p[q*1350+b*90+a*9+c*3+d];

        memcpy(INT__f_g_p_p+q*1350, buffer, 1350*sizeof(double));
    }
