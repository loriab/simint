                  ...
                  double * const restrict INT__f_p_d_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_p_d_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const HRR_INT__f_p_p_f = hrrwork + 1380;
    double * const HRR_INT__f_p_p_g = hrrwork + 2280;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_p_d_f = INT__f_p_d_f + real_abcd * 1800;
