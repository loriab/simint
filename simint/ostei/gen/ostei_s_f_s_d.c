                  ...
                  double * const restrict INT__s_f_s_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_f_s_d);
    memset(INT__s_f_s_d, 0, P.nshell12_clip * Q.nshell12_clip * 60 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_p = primwork + 45;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_s = primwork + 81;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_p = primwork + 111;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_d = primwork + 171;
