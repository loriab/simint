                  ...
                  double * const restrict INT__f_f_d_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_f_d_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    // partition workspace
    double * const INT__f_s_s_f = work + (SIMINT_NSHELL_SIMD * 0);
    double * const INT__f_s_s_g = work + (SIMINT_NSHELL_SIMD * 100);
    double * const INT__f_s_s_h = work + (SIMINT_NSHELL_SIMD * 250);
    double * const INT__g_s_s_f = work + (SIMINT_NSHELL_SIMD * 460);
    double * const INT__g_s_s_g = work + (SIMINT_NSHELL_SIMD * 610);
    double * const INT__g_s_s_h = work + (SIMINT_NSHELL_SIMD * 835);
    double * const INT__h_s_s_f = work + (SIMINT_NSHELL_SIMD * 1150);
    double * const INT__h_s_s_g = work + (SIMINT_NSHELL_SIMD * 1360);
    double * const INT__h_s_s_h = work + (SIMINT_NSHELL_SIMD * 1675);
    double * const INT__i_s_s_f = work + (SIMINT_NSHELL_SIMD * 2116);
    double * const INT__i_s_s_g = work + (SIMINT_NSHELL_SIMD * 2396);
    double * const INT__i_s_s_h = work + (SIMINT_NSHELL_SIMD * 2816);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_p = primwork + 12;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_d = primwork + 27;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 51;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_p = primwork + 84;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_d = primwork + 129;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_f = primwork + 201;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 291;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_p = primwork + 351;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_d = primwork + 441;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_f = primwork + 585;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_g = primwork + 765;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 945;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_p = primwork + 1035;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_d = primwork + 1185;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_f = primwork + 1425;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_g = primwork + 1725;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_h = primwork + 2025;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 2235;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_p = primwork + 2355;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_d = primwork + 2580;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_f = primwork + 2940;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_g = primwork + 3390;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_h = primwork + 3840;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 4155;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_p = primwork + 4302;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_d = primwork + 4617;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_f = primwork + 5121;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_g = primwork + 5751;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_h = primwork + 6381;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 6822;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_p = primwork + 6990;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_d = primwork + 7410;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_f = primwork + 8082;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_g = primwork + 8922;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_h = primwork + 9762;
    double * const hrrwork = (double *)(primwork + 10350);
    double * const HRR_INT__f_p_s_f = hrrwork + 0;
    double * const HRR_INT__f_p_s_g = hrrwork + 300;
    double * const HRR_INT__f_p_s_h = hrrwork + 750;
    double * const HRR_INT__f_d_s_f = hrrwork + 1380;
    double * const HRR_INT__f_d_s_g = hrrwork + 1980;
    double * const HRR_INT__f_d_s_h = hrrwork + 2880;
    double * const HRR_INT__f_f_s_f = hrrwork + 4140;
    double * const HRR_INT__f_f_s_g = hrrwork + 5140;
    double * const HRR_INT__f_f_s_h = hrrwork + 6640;
    double * const HRR_INT__f_f_p_f = hrrwork + 8740;
    double * const HRR_INT__f_f_p_g = hrrwork + 11740;
    double * const HRR_INT__g_p_s_f = hrrwork + 16240;
    double * const HRR_INT__g_p_s_g = hrrwork + 16690;
    double * const HRR_INT__g_p_s_h = hrrwork + 17365;
    double * const HRR_INT__g_d_s_f = hrrwork + 18310;
    double * const HRR_INT__g_d_s_g = hrrwork + 19210;
    double * const HRR_INT__g_d_s_h = hrrwork + 20560;
    double * const HRR_INT__h_p_s_f = hrrwork + 22450;
    double * const HRR_INT__h_p_s_g = hrrwork + 23080;
    double * const HRR_INT__h_p_s_h = hrrwork + 24025;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                double * restrict PRIM_PTR_INT__h_s_s_f = INT__h_s_s_f + abcd * 210;
                double * restrict PRIM_PTR_INT__h_s_s_g = INT__h_s_s_g + abcd * 315;
                double * restrict PRIM_PTR_INT__h_s_s_h = INT__h_s_s_h + abcd * 441;
                double * restrict PRIM_PTR_INT__i_s_s_f = INT__i_s_s_f + abcd * 280;
                double * restrict PRIM_PTR_INT__i_s_s_g = INT__i_s_s_g + abcd * 420;
                double * restrict PRIM_PTR_INT__i_s_s_h = INT__i_s_s_h + abcd * 588;
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    if((iprimcd + SIMINT_SIMD_LEN) >= nprim_icd)
                    {
                        ...
                        if(iprimcd >= nprim_icd && ((icd+1) < nshellbatch))
                        {
                            ...
                            PRIM_PTR_INT__h_s_s_f += 210;
                            PRIM_PTR_INT__h_s_s_g += 315;
                            PRIM_PTR_INT__h_s_s_h += 441;
                            PRIM_PTR_INT__i_s_s_f += 280;
                            PRIM_PTR_INT__i_s_s_g += 420;
                            PRIM_PTR_INT__i_s_s_h += 588;
                        }
                        iprimcd++;
                    ...
                    if(check_screen)
                    {
                        ...
                        if(vmax < screen_tol)
                        {
                            ...
                            PRIM_PTR_INT__h_s_s_f += lastoffset*210;
                            PRIM_PTR_INT__h_s_s_g += lastoffset*315;
                            PRIM_PTR_INT__h_s_s_h += lastoffset*441;
                            PRIM_PTR_INT__i_s_s_f += lastoffset*280;
                            PRIM_PTR_INT__i_s_s_g += lastoffset*420;
                            PRIM_PTR_INT__i_s_s_h += lastoffset*588;
                            continue;
                        }
                    }
                    ...
                    // Forming PRIM_INT__f_s_s_p[5 * 30];
                    ...
                    // Forming PRIM_INT__d_s_s_p[5 * 18];
                    for(n = 0; n < 5; ++n)  // loop over orders of auxiliary function
                    {
                    ...
                    // Forming PRIM_INT__p_s_s_p[5 * 9];
                    for(n = 0; n < 5; ++n)  // loop over orders of auxiliary function
                    {

                        PRIM_INT__p_s_s_p[n * 9 + 0] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_s[n * 3 + 0]);
                        PRIM_INT__p_s_s_p[n * 9 + 0] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_s[(n+1) * 3 + 0], PRIM_INT__p_s_s_p[n * 9 + 0]);
                        PRIM_INT__p_s_s_p[n * 9 + 0] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_s_s[(n+1) * 1 + 0], PRIM_INT__p_s_s_p[n * 9 + 0]);

                        PRIM_INT__p_s_s_p[n * 9 + 1] = SIMINT_MUL(Q_PB[1], PRIM_INT__p_s_s_s[n * 3 + 0]);
                        PRIM_INT__p_s_s_p[n * 9 + 1] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_s_s[(n+1) * 3 + 0], PRIM_INT__p_s_s_p[n * 9 + 1]);

                        PRIM_INT__p_s_s_p[n * 9 + 2] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_s[n * 3 + 0]);
                        PRIM_INT__p_s_s_p[n * 9 + 2] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_s[(n+1) * 3 + 0], PRIM_INT__p_s_s_p[n * 9 + 2]);

                        PRIM_INT__p_s_s_p[n * 9 + 3] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_s[n * 3 + 1]);
                        PRIM_INT__p_s_s_p[n * 9 + 3] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_s[(n+1) * 3 + 1], PRIM_INT__p_s_s_p[n * 9 + 3]);

                        PRIM_INT__p_s_s_p[n * 9 + 4] = SIMINT_MUL(Q_PB[1], PRIM_INT__p_s_s_s[n * 3 + 1]);
                        PRIM_INT__p_s_s_p[n * 9 + 4] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_s_s[(n+1) * 3 + 1], PRIM_INT__p_s_s_p[n * 9 + 4]);
                        PRIM_INT__p_s_s_p[n * 9 + 4] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_s_s[(n+1) * 1 + 0], PRIM_INT__p_s_s_p[n * 9 + 4]);

                        PRIM_INT__p_s_s_p[n * 9 + 5] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_s[n * 3 + 1]);
                        PRIM_INT__p_s_s_p[n * 9 + 5] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_s[(n+1) * 3 + 1], PRIM_INT__p_s_s_p[n * 9 + 5]);

                        PRIM_INT__p_s_s_p[n * 9 + 6] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_s[n * 3 + 2]);
                        PRIM_INT__p_s_s_p[n * 9 + 6] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_s[(n+1) * 3 + 2], PRIM_INT__p_s_s_p[n * 9 + 6]);

                        PRIM_INT__p_s_s_p[n * 9 + 7] = SIMINT_MUL(Q_PB[1], PRIM_INT__p_s_s_s[n * 3 + 2]);
                        PRIM_INT__p_s_s_p[n * 9 + 7] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_s_s[(n+1) * 3 + 2], PRIM_INT__p_s_s_p[n * 9 + 7]);

                        PRIM_INT__p_s_s_p[n * 9 + 8] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_s[n * 3 + 2]);
                        PRIM_INT__p_s_s_p[n * 9 + 8] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_s[(n+1) * 3 + 2], PRIM_INT__p_s_s_p[n * 9 + 8]);
                    ...
                    // Forming PRIM_INT__d_s_s_d[4 * 36];
                    for(n = 0; n < 4; ++n)  // loop over orders of auxiliary function
                    {

                        PRIM_INT__d_s_s_d[n * 36 + 0] = SIMINT_MUL(Q_PB[0], PRIM_INT__d_s_s_p[n * 18 + 0]);
                        PRIM_INT__d_s_s_d[n * 36 + 0] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__d_s_s_p[(n+1) * 18 + 0], PRIM_INT__d_s_s_d[n * 36 + 0]);
                        PRIM_INT__d_s_s_d[n * 36 + 0] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 0], PRIM_INT__d_s_s_s[n * 6 + 0]), PRIM_INT__d_s_s_d[n * 36 + 0]);
                        PRIM_INT__d_s_s_d[n * 36 + 0] = SIMINT_FMADD( vrr_const_2_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 0], PRIM_INT__d_s_s_d[n * 36 + 0]);

                        PRIM_INT__d_s_s_d[n * 36 + 1] = SIMINT_MUL(Q_PB[1], PRIM_INT__d_s_s_p[n * 18 + 0]);
                        PRIM_INT__d_s_s_d[n * 36 + 1] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__d_s_s_p[(n+1) * 18 + 0], PRIM_INT__d_s_s_d[n * 36 + 1]);

                        PRIM_INT__d_s_s_d[n * 36 + 3] = SIMINT_MUL(Q_PB[1], PRIM_INT__d_s_s_p[n * 18 + 1]);
                        PRIM_INT__d_s_s_d[n * 36 + 3] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__d_s_s_p[(n+1) * 18 + 1], PRIM_INT__d_s_s_d[n * 36 + 3]);
                        PRIM_INT__d_s_s_d[n * 36 + 3] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 0], PRIM_INT__d_s_s_s[n * 6 + 0]), PRIM_INT__d_s_s_d[n * 36 + 3]);

                        PRIM_INT__d_s_s_d[n * 36 + 5] = SIMINT_MUL(Q_PB[2], PRIM_INT__d_s_s_p[n * 18 + 2]);
                        PRIM_INT__d_s_s_d[n * 36 + 5] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_s_p[(n+1) * 18 + 2], PRIM_INT__d_s_s_d[n * 36 + 5]);
                        PRIM_INT__d_s_s_d[n * 36 + 5] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 0], PRIM_INT__d_s_s_s[n * 6 + 0]), PRIM_INT__d_s_s_d[n * 36 + 5]);

                        PRIM_INT__d_s_s_d[n * 36 + 6] = SIMINT_MUL(Q_PB[0], PRIM_INT__d_s_s_p[n * 18 + 3]);
                        PRIM_INT__d_s_s_d[n * 36 + 6] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__d_s_s_p[(n+1) * 18 + 3], PRIM_INT__d_s_s_d[n * 36 + 6]);
                        PRIM_INT__d_s_s_d[n * 36 + 6] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 1], PRIM_INT__d_s_s_s[n * 6 + 1]), PRIM_INT__d_s_s_d[n * 36 + 6]);
                        PRIM_INT__d_s_s_d[n * 36 + 6] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 3], PRIM_INT__d_s_s_d[n * 36 + 6]);

                        PRIM_INT__d_s_s_d[n * 36 + 7] = SIMINT_MUL(Q_PB[1], PRIM_INT__d_s_s_p[n * 18 + 3]);
                        PRIM_INT__d_s_s_d[n * 36 + 7] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__d_s_s_p[(n+1) * 18 + 3], PRIM_INT__d_s_s_d[n * 36 + 7]);
                        PRIM_INT__d_s_s_d[n * 36 + 7] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 0], PRIM_INT__d_s_s_d[n * 36 + 7]);

                        PRIM_INT__d_s_s_d[n * 36 + 9] = SIMINT_MUL(Q_PB[1], PRIM_INT__d_s_s_p[n * 18 + 4]);
                        PRIM_INT__d_s_s_d[n * 36 + 9] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__d_s_s_p[(n+1) * 18 + 4], PRIM_INT__d_s_s_d[n * 36 + 9]);
                        PRIM_INT__d_s_s_d[n * 36 + 9] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 1], PRIM_INT__d_s_s_s[n * 6 + 1]), PRIM_INT__d_s_s_d[n * 36 + 9]);
                        PRIM_INT__d_s_s_d[n * 36 + 9] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 1], PRIM_INT__d_s_s_d[n * 36 + 9]);

                        PRIM_INT__d_s_s_d[n * 36 + 11] = SIMINT_MUL(Q_PB[2], PRIM_INT__d_s_s_p[n * 18 + 5]);
                        PRIM_INT__d_s_s_d[n * 36 + 11] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_s_p[(n+1) * 18 + 5], PRIM_INT__d_s_s_d[n * 36 + 11]);
                        PRIM_INT__d_s_s_d[n * 36 + 11] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 1], PRIM_INT__d_s_s_s[n * 6 + 1]), PRIM_INT__d_s_s_d[n * 36 + 11]);

                        PRIM_INT__d_s_s_d[n * 36 + 12] = SIMINT_MUL(Q_PB[0], PRIM_INT__d_s_s_p[n * 18 + 6]);
                        PRIM_INT__d_s_s_d[n * 36 + 12] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__d_s_s_p[(n+1) * 18 + 6], PRIM_INT__d_s_s_d[n * 36 + 12]);
                        PRIM_INT__d_s_s_d[n * 36 + 12] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 2], PRIM_INT__d_s_s_s[n * 6 + 2]), PRIM_INT__d_s_s_d[n * 36 + 12]);
                        PRIM_INT__d_s_s_d[n * 36 + 12] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 6], PRIM_INT__d_s_s_d[n * 36 + 12]);

                        PRIM_INT__d_s_s_d[n * 36 + 13] = SIMINT_MUL(Q_PB[1], PRIM_INT__d_s_s_p[n * 18 + 6]);
                        PRIM_INT__d_s_s_d[n * 36 + 13] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__d_s_s_p[(n+1) * 18 + 6], PRIM_INT__d_s_s_d[n * 36 + 13]);

                        PRIM_INT__d_s_s_d[n * 36 + 15] = SIMINT_MUL(Q_PB[1], PRIM_INT__d_s_s_p[n * 18 + 7]);
                        PRIM_INT__d_s_s_d[n * 36 + 15] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__d_s_s_p[(n+1) * 18 + 7], PRIM_INT__d_s_s_d[n * 36 + 15]);
                        PRIM_INT__d_s_s_d[n * 36 + 15] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 2], PRIM_INT__d_s_s_s[n * 6 + 2]), PRIM_INT__d_s_s_d[n * 36 + 15]);

                        PRIM_INT__d_s_s_d[n * 36 + 17] = SIMINT_MUL(Q_PB[2], PRIM_INT__d_s_s_p[n * 18 + 8]);
                        PRIM_INT__d_s_s_d[n * 36 + 17] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_s_p[(n+1) * 18 + 8], PRIM_INT__d_s_s_d[n * 36 + 17]);
                        PRIM_INT__d_s_s_d[n * 36 + 17] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 2], PRIM_INT__d_s_s_s[n * 6 + 2]), PRIM_INT__d_s_s_d[n * 36 + 17]);
                        PRIM_INT__d_s_s_d[n * 36 + 17] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 2], PRIM_INT__d_s_s_d[n * 36 + 17]);

                        PRIM_INT__d_s_s_d[n * 36 + 18] = SIMINT_MUL(Q_PB[0], PRIM_INT__d_s_s_p[n * 18 + 9]);
                        PRIM_INT__d_s_s_d[n * 36 + 18] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__d_s_s_p[(n+1) * 18 + 9], PRIM_INT__d_s_s_d[n * 36 + 18]);
                        PRIM_INT__d_s_s_d[n * 36 + 18] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 3], PRIM_INT__d_s_s_s[n * 6 + 3]), PRIM_INT__d_s_s_d[n * 36 + 18]);

                        PRIM_INT__d_s_s_d[n * 36 + 19] = SIMINT_MUL(Q_PB[1], PRIM_INT__d_s_s_p[n * 18 + 9]);
                        PRIM_INT__d_s_s_d[n * 36 + 19] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__d_s_s_p[(n+1) * 18 + 9], PRIM_INT__d_s_s_d[n * 36 + 19]);
                        PRIM_INT__d_s_s_d[n * 36 + 19] = SIMINT_FMADD( vrr_const_2_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 3], PRIM_INT__d_s_s_d[n * 36 + 19]);

                        PRIM_INT__d_s_s_d[n * 36 + 21] = SIMINT_MUL(Q_PB[1], PRIM_INT__d_s_s_p[n * 18 + 10]);
                        PRIM_INT__d_s_s_d[n * 36 + 21] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__d_s_s_p[(n+1) * 18 + 10], PRIM_INT__d_s_s_d[n * 36 + 21]);
                        PRIM_INT__d_s_s_d[n * 36 + 21] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 3], PRIM_INT__d_s_s_s[n * 6 + 3]), PRIM_INT__d_s_s_d[n * 36 + 21]);
                        PRIM_INT__d_s_s_d[n * 36 + 21] = SIMINT_FMADD( vrr_const_2_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 4], PRIM_INT__d_s_s_d[n * 36 + 21]);

                        PRIM_INT__d_s_s_d[n * 36 + 23] = SIMINT_MUL(Q_PB[2], PRIM_INT__d_s_s_p[n * 18 + 11]);
                        PRIM_INT__d_s_s_d[n * 36 + 23] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_s_p[(n+1) * 18 + 11], PRIM_INT__d_s_s_d[n * 36 + 23]);
                        PRIM_INT__d_s_s_d[n * 36 + 23] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 3], PRIM_INT__d_s_s_s[n * 6 + 3]), PRIM_INT__d_s_s_d[n * 36 + 23]);

                        PRIM_INT__d_s_s_d[n * 36 + 24] = SIMINT_MUL(Q_PB[0], PRIM_INT__d_s_s_p[n * 18 + 12]);
                        PRIM_INT__d_s_s_d[n * 36 + 24] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__d_s_s_p[(n+1) * 18 + 12], PRIM_INT__d_s_s_d[n * 36 + 24]);
                        PRIM_INT__d_s_s_d[n * 36 + 24] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 4], PRIM_INT__d_s_s_s[n * 6 + 4]), PRIM_INT__d_s_s_d[n * 36 + 24]);

                        PRIM_INT__d_s_s_d[n * 36 + 25] = SIMINT_MUL(Q_PB[1], PRIM_INT__d_s_s_p[n * 18 + 12]);
                        PRIM_INT__d_s_s_d[n * 36 + 25] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__d_s_s_p[(n+1) * 18 + 12], PRIM_INT__d_s_s_d[n * 36 + 25]);
                        PRIM_INT__d_s_s_d[n * 36 + 25] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 6], PRIM_INT__d_s_s_d[n * 36 + 25]);

                        PRIM_INT__d_s_s_d[n * 36 + 27] = SIMINT_MUL(Q_PB[1], PRIM_INT__d_s_s_p[n * 18 + 13]);
                        PRIM_INT__d_s_s_d[n * 36 + 27] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__d_s_s_p[(n+1) * 18 + 13], PRIM_INT__d_s_s_d[n * 36 + 27]);
                        PRIM_INT__d_s_s_d[n * 36 + 27] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 4], PRIM_INT__d_s_s_s[n * 6 + 4]), PRIM_INT__d_s_s_d[n * 36 + 27]);
                        PRIM_INT__d_s_s_d[n * 36 + 27] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 7], PRIM_INT__d_s_s_d[n * 36 + 27]);

                        PRIM_INT__d_s_s_d[n * 36 + 29] = SIMINT_MUL(Q_PB[2], PRIM_INT__d_s_s_p[n * 18 + 14]);
                        PRIM_INT__d_s_s_d[n * 36 + 29] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_s_p[(n+1) * 18 + 14], PRIM_INT__d_s_s_d[n * 36 + 29]);
                        PRIM_INT__d_s_s_d[n * 36 + 29] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 4], PRIM_INT__d_s_s_s[n * 6 + 4]), PRIM_INT__d_s_s_d[n * 36 + 29]);
                        PRIM_INT__d_s_s_d[n * 36 + 29] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 5], PRIM_INT__d_s_s_d[n * 36 + 29]);

                        PRIM_INT__d_s_s_d[n * 36 + 30] = SIMINT_MUL(Q_PB[0], PRIM_INT__d_s_s_p[n * 18 + 15]);
                        PRIM_INT__d_s_s_d[n * 36 + 30] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__d_s_s_p[(n+1) * 18 + 15], PRIM_INT__d_s_s_d[n * 36 + 30]);
                        PRIM_INT__d_s_s_d[n * 36 + 30] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 5], PRIM_INT__d_s_s_s[n * 6 + 5]), PRIM_INT__d_s_s_d[n * 36 + 30]);

                        PRIM_INT__d_s_s_d[n * 36 + 31] = SIMINT_MUL(Q_PB[1], PRIM_INT__d_s_s_p[n * 18 + 15]);
                        PRIM_INT__d_s_s_d[n * 36 + 31] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__d_s_s_p[(n+1) * 18 + 15], PRIM_INT__d_s_s_d[n * 36 + 31]);

                        PRIM_INT__d_s_s_d[n * 36 + 33] = SIMINT_MUL(Q_PB[1], PRIM_INT__d_s_s_p[n * 18 + 16]);
                        PRIM_INT__d_s_s_d[n * 36 + 33] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__d_s_s_p[(n+1) * 18 + 16], PRIM_INT__d_s_s_d[n * 36 + 33]);
                        PRIM_INT__d_s_s_d[n * 36 + 33] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 5], PRIM_INT__d_s_s_s[n * 6 + 5]), PRIM_INT__d_s_s_d[n * 36 + 33]);

                        PRIM_INT__d_s_s_d[n * 36 + 35] = SIMINT_MUL(Q_PB[2], PRIM_INT__d_s_s_p[n * 18 + 17]);
                        PRIM_INT__d_s_s_d[n * 36 + 35] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_s_p[(n+1) * 18 + 17], PRIM_INT__d_s_s_d[n * 36 + 35]);
                        PRIM_INT__d_s_s_d[n * 36 + 35] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__d_s_s_s[(n+1) * 6 + 5], PRIM_INT__d_s_s_s[n * 6 + 5]), PRIM_INT__d_s_s_d[n * 36 + 35]);
                    ...
                    for(n = 0; n < 4; ++n)  // loop over orders of auxiliary function
                    {
                        ...
                        PRIM_INT__p_s_s_d[n * 18 + 0] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_p[n * 9 + 0]);
                        PRIM_INT__p_s_s_d[n * 18 + 0] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_p[(n+1) * 9 + 0], PRIM_INT__p_s_s_d[n * 18 + 0]);
                        PRIM_INT__p_s_s_d[n * 18 + 0] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_s[(n+1) * 3 + 0], PRIM_INT__p_s_s_s[n * 3 + 0]), PRIM_INT__p_s_s_d[n * 18 + 0]);
                        PRIM_INT__p_s_s_d[n * 18 + 0] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_s_p[(n+1) * 3 + 0], PRIM_INT__p_s_s_d[n * 18 + 0]);

                        PRIM_INT__p_s_s_d[n * 18 + 3] = SIMINT_MUL(Q_PB[1], PRIM_INT__p_s_s_p[n * 9 + 1]);
                        PRIM_INT__p_s_s_d[n * 18 + 3] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_s_p[(n+1) * 9 + 1], PRIM_INT__p_s_s_d[n * 18 + 3]);
                        PRIM_INT__p_s_s_d[n * 18 + 3] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_s[(n+1) * 3 + 0], PRIM_INT__p_s_s_s[n * 3 + 0]), PRIM_INT__p_s_s_d[n * 18 + 3]);

                        PRIM_INT__p_s_s_d[n * 18 + 5] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_p[n * 9 + 2]);
                        PRIM_INT__p_s_s_d[n * 18 + 5] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_p[(n+1) * 9 + 2], PRIM_INT__p_s_s_d[n * 18 + 5]);
                        PRIM_INT__p_s_s_d[n * 18 + 5] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_s[(n+1) * 3 + 0], PRIM_INT__p_s_s_s[n * 3 + 0]), PRIM_INT__p_s_s_d[n * 18 + 5]);

                        PRIM_INT__p_s_s_d[n * 18 + 6] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_p[n * 9 + 3]);
                        PRIM_INT__p_s_s_d[n * 18 + 6] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_p[(n+1) * 9 + 3], PRIM_INT__p_s_s_d[n * 18 + 6]);
                        PRIM_INT__p_s_s_d[n * 18 + 6] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_s[(n+1) * 3 + 1], PRIM_INT__p_s_s_s[n * 3 + 1]), PRIM_INT__p_s_s_d[n * 18 + 6]);

                        PRIM_INT__p_s_s_d[n * 18 + 9] = SIMINT_MUL(Q_PB[1], PRIM_INT__p_s_s_p[n * 9 + 4]);
                        PRIM_INT__p_s_s_d[n * 18 + 9] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_s_p[(n+1) * 9 + 4], PRIM_INT__p_s_s_d[n * 18 + 9]);
                        PRIM_INT__p_s_s_d[n * 18 + 9] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_s[(n+1) * 3 + 1], PRIM_INT__p_s_s_s[n * 3 + 1]), PRIM_INT__p_s_s_d[n * 18 + 9]);
                        PRIM_INT__p_s_s_d[n * 18 + 9] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_s_p[(n+1) * 3 + 1], PRIM_INT__p_s_s_d[n * 18 + 9]);

                        PRIM_INT__p_s_s_d[n * 18 + 11] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_p[n * 9 + 5]);
                        PRIM_INT__p_s_s_d[n * 18 + 11] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_p[(n+1) * 9 + 5], PRIM_INT__p_s_s_d[n * 18 + 11]);
                        PRIM_INT__p_s_s_d[n * 18 + 11] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_s[(n+1) * 3 + 1], PRIM_INT__p_s_s_s[n * 3 + 1]), PRIM_INT__p_s_s_d[n * 18 + 11]);

                        PRIM_INT__p_s_s_d[n * 18 + 12] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_p[n * 9 + 6]);
                        PRIM_INT__p_s_s_d[n * 18 + 12] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_p[(n+1) * 9 + 6], PRIM_INT__p_s_s_d[n * 18 + 12]);
                        PRIM_INT__p_s_s_d[n * 18 + 12] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_s[(n+1) * 3 + 2], PRIM_INT__p_s_s_s[n * 3 + 2]), PRIM_INT__p_s_s_d[n * 18 + 12]);

                        PRIM_INT__p_s_s_d[n * 18 + 15] = SIMINT_MUL(Q_PB[1], PRIM_INT__p_s_s_p[n * 9 + 7]);
                        PRIM_INT__p_s_s_d[n * 18 + 15] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_s_p[(n+1) * 9 + 7], PRIM_INT__p_s_s_d[n * 18 + 15]);
                        PRIM_INT__p_s_s_d[n * 18 + 15] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_s[(n+1) * 3 + 2], PRIM_INT__p_s_s_s[n * 3 + 2]), PRIM_INT__p_s_s_d[n * 18 + 15]);

                        PRIM_INT__p_s_s_d[n * 18 + 17] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_p[n * 9 + 8]);
                        PRIM_INT__p_s_s_d[n * 18 + 17] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_p[(n+1) * 9 + 8], PRIM_INT__p_s_s_d[n * 18 + 17]);
                        PRIM_INT__p_s_s_d[n * 18 + 17] = SIMINT_FMADD( vrr_const_1_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_s[(n+1) * 3 + 2], PRIM_INT__p_s_s_s[n * 3 + 2]), PRIM_INT__p_s_s_d[n * 18 + 17]);
                        PRIM_INT__p_s_s_d[n * 18 + 17] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_s_p[(n+1) * 3 + 2], PRIM_INT__p_s_s_d[n * 18 + 17]);
                    ...
                    // Forming PRIM_INT__p_s_s_f[3 * 30];
                    for(n = 0; n < 3; ++n)  // loop over orders of auxiliary function
                    {

                        PRIM_INT__p_s_s_f[n * 30 + 0] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_d[n * 18 + 0]);
                        PRIM_INT__p_s_s_f[n * 30 + 0] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_d[(n+1) * 18 + 0], PRIM_INT__p_s_s_f[n * 30 + 0]);
                        PRIM_INT__p_s_s_f[n * 30 + 0] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_p[(n+1) * 9 + 0], PRIM_INT__p_s_s_p[n * 9 + 0]), PRIM_INT__p_s_s_f[n * 30 + 0]);
                        PRIM_INT__p_s_s_f[n * 30 + 0] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_s_d[(n+1) * 6 + 0], PRIM_INT__p_s_s_f[n * 30 + 0]);

                        PRIM_INT__p_s_s_f[n * 30 + 1] = SIMINT_MUL(Q_PB[1], PRIM_INT__p_s_s_d[n * 18 + 0]);
                        PRIM_INT__p_s_s_f[n * 30 + 1] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_s_d[(n+1) * 18 + 0], PRIM_INT__p_s_s_f[n * 30 + 1]);

                        PRIM_INT__p_s_s_f[n * 30 + 2] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_d[n * 18 + 0]);
                        PRIM_INT__p_s_s_f[n * 30 + 2] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 0], PRIM_INT__p_s_s_f[n * 30 + 2]);

                        PRIM_INT__p_s_s_f[n * 30 + 6] = SIMINT_MUL(Q_PB[1], PRIM_INT__p_s_s_d[n * 18 + 3]);
                        PRIM_INT__p_s_s_f[n * 30 + 6] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_s_d[(n+1) * 18 + 3], PRIM_INT__p_s_s_f[n * 30 + 6]);
                        PRIM_INT__p_s_s_f[n * 30 + 6] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_p[(n+1) * 9 + 1], PRIM_INT__p_s_s_p[n * 9 + 1]), PRIM_INT__p_s_s_f[n * 30 + 6]);

                        PRIM_INT__p_s_s_f[n * 30 + 7] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_d[n * 18 + 3]);
                        PRIM_INT__p_s_s_f[n * 30 + 7] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 3], PRIM_INT__p_s_s_f[n * 30 + 7]);

                        PRIM_INT__p_s_s_f[n * 30 + 9] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_d[n * 18 + 5]);
                        PRIM_INT__p_s_s_f[n * 30 + 9] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 5], PRIM_INT__p_s_s_f[n * 30 + 9]);
                        PRIM_INT__p_s_s_f[n * 30 + 9] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_p[(n+1) * 9 + 2], PRIM_INT__p_s_s_p[n * 9 + 2]), PRIM_INT__p_s_s_f[n * 30 + 9]);

                        PRIM_INT__p_s_s_f[n * 30 + 10] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_d[n * 18 + 6]);
                        PRIM_INT__p_s_s_f[n * 30 + 10] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_d[(n+1) * 18 + 6], PRIM_INT__p_s_s_f[n * 30 + 10]);
                        PRIM_INT__p_s_s_f[n * 30 + 10] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_p[(n+1) * 9 + 3], PRIM_INT__p_s_s_p[n * 9 + 3]), PRIM_INT__p_s_s_f[n * 30 + 10]);

                        PRIM_INT__p_s_s_f[n * 30 + 11] = SIMINT_MUL(Q_PB[1], PRIM_INT__p_s_s_d[n * 18 + 6]);
                        PRIM_INT__p_s_s_f[n * 30 + 11] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_s_d[(n+1) * 18 + 6], PRIM_INT__p_s_s_f[n * 30 + 11]);
                        PRIM_INT__p_s_s_f[n * 30 + 11] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_s_d[(n+1) * 6 + 0], PRIM_INT__p_s_s_f[n * 30 + 11]);

                        PRIM_INT__p_s_s_f[n * 30 + 12] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_d[n * 18 + 6]);
                        PRIM_INT__p_s_s_f[n * 30 + 12] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 6], PRIM_INT__p_s_s_f[n * 30 + 12]);

                        PRIM_INT__p_s_s_f[n * 30 + 16] = SIMINT_MUL(Q_PB[1], PRIM_INT__p_s_s_d[n * 18 + 9]);
                        PRIM_INT__p_s_s_f[n * 30 + 16] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_s_d[(n+1) * 18 + 9], PRIM_INT__p_s_s_f[n * 30 + 16]);
                        PRIM_INT__p_s_s_f[n * 30 + 16] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_p[(n+1) * 9 + 4], PRIM_INT__p_s_s_p[n * 9 + 4]), PRIM_INT__p_s_s_f[n * 30 + 16]);
                        PRIM_INT__p_s_s_f[n * 30 + 16] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_s_d[(n+1) * 6 + 3], PRIM_INT__p_s_s_f[n * 30 + 16]);

                        PRIM_INT__p_s_s_f[n * 30 + 17] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_d[n * 18 + 9]);
                        PRIM_INT__p_s_s_f[n * 30 + 17] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 9], PRIM_INT__p_s_s_f[n * 30 + 17]);

                        PRIM_INT__p_s_s_f[n * 30 + 19] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_d[n * 18 + 11]);
                        PRIM_INT__p_s_s_f[n * 30 + 19] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 11], PRIM_INT__p_s_s_f[n * 30 + 19]);
                        PRIM_INT__p_s_s_f[n * 30 + 19] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_p[(n+1) * 9 + 5], PRIM_INT__p_s_s_p[n * 9 + 5]), PRIM_INT__p_s_s_f[n * 30 + 19]);

                        PRIM_INT__p_s_s_f[n * 30 + 20] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_d[n * 18 + 12]);
                        PRIM_INT__p_s_s_f[n * 30 + 20] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_d[(n+1) * 18 + 12], PRIM_INT__p_s_s_f[n * 30 + 20]);
                        PRIM_INT__p_s_s_f[n * 30 + 20] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_p[(n+1) * 9 + 6], PRIM_INT__p_s_s_p[n * 9 + 6]), PRIM_INT__p_s_s_f[n * 30 + 20]);

                        PRIM_INT__p_s_s_f[n * 30 + 21] = SIMINT_MUL(Q_PB[1], PRIM_INT__p_s_s_d[n * 18 + 12]);
                        PRIM_INT__p_s_s_f[n * 30 + 21] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_s_d[(n+1) * 18 + 12], PRIM_INT__p_s_s_f[n * 30 + 21]);

                        PRIM_INT__p_s_s_f[n * 30 + 22] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_d[n * 18 + 12]);
                        PRIM_INT__p_s_s_f[n * 30 + 22] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 12], PRIM_INT__p_s_s_f[n * 30 + 22]);
                        PRIM_INT__p_s_s_f[n * 30 + 22] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_s_d[(n+1) * 6 + 0], PRIM_INT__p_s_s_f[n * 30 + 22]);

                        PRIM_INT__p_s_s_f[n * 30 + 26] = SIMINT_MUL(Q_PB[1], PRIM_INT__p_s_s_d[n * 18 + 15]);
                        PRIM_INT__p_s_s_f[n * 30 + 26] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_s_d[(n+1) * 18 + 15], PRIM_INT__p_s_s_f[n * 30 + 26]);
                        PRIM_INT__p_s_s_f[n * 30 + 26] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_p[(n+1) * 9 + 7], PRIM_INT__p_s_s_p[n * 9 + 7]), PRIM_INT__p_s_s_f[n * 30 + 26]);

                        PRIM_INT__p_s_s_f[n * 30 + 27] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_d[n * 18 + 15]);
                        PRIM_INT__p_s_s_f[n * 30 + 27] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 15], PRIM_INT__p_s_s_f[n * 30 + 27]);
                        PRIM_INT__p_s_s_f[n * 30 + 27] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_s_d[(n+1) * 6 + 3], PRIM_INT__p_s_s_f[n * 30 + 27]);

                        PRIM_INT__p_s_s_f[n * 30 + 29] = SIMINT_MUL(Q_PB[2], PRIM_INT__p_s_s_d[n * 18 + 17]);
                        PRIM_INT__p_s_s_f[n * 30 + 29] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 17], PRIM_INT__p_s_s_f[n * 30 + 29]);
                        PRIM_INT__p_s_s_f[n * 30 + 29] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__p_s_s_p[(n+1) * 9 + 8], PRIM_INT__p_s_s_p[n * 9 + 8]), PRIM_INT__p_s_s_f[n * 30 + 29]);
                        PRIM_INT__p_s_s_f[n * 30 + 29] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_s_d[(n+1) * 6 + 5], PRIM_INT__p_s_s_f[n * 30 + 29]);
                    ...
                    ostei_general_vrr_L(3, 0, 0, 5, 1,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PB,
                            PRIM_INT__f_s_s_g, NULL, PRIM_INT__f_s_s_f, PRIM_INT__d_s_s_g, NULL, PRIM_INT__f_s_s_h);


                    ostei_general_vrr_L(4, 0, 0, 4, 2,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PB,
                            PRIM_INT__g_s_s_f, NULL, PRIM_INT__g_s_s_d, PRIM_INT__f_s_s_f, NULL, PRIM_INT__g_s_s_g);
                    ...
                    ostei_general_vrr_L(5, 0, 0, 3, 3,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PB,
                            PRIM_INT__h_s_s_d, NULL, PRIM_INT__h_s_s_p, PRIM_INT__g_s_s_d, NULL, PRIM_INT__h_s_s_f);


                    ostei_general_vrr_L(4, 0, 0, 5, 1,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PB,
                            PRIM_INT__g_s_s_g, NULL, PRIM_INT__g_s_s_f, PRIM_INT__f_s_s_g, NULL, PRIM_INT__g_s_s_h);


                    ostei_general_vrr_L(5, 0, 0, 4, 2,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PB,
                            PRIM_INT__h_s_s_f, NULL, PRIM_INT__h_s_s_d, PRIM_INT__g_s_s_f, NULL, PRIM_INT__h_s_s_g);
                    ...
                    ostei_general_vrr_L(6, 0, 0, 2, 4,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PB,
                            PRIM_INT__i_s_s_p, NULL, PRIM_INT__i_s_s_s, PRIM_INT__h_s_s_p, NULL, PRIM_INT__i_s_s_d);


                    ostei_general_vrr_L(6, 0, 0, 3, 3,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PB,
                            PRIM_INT__i_s_s_d, NULL, PRIM_INT__i_s_s_p, PRIM_INT__h_s_s_d, NULL, PRIM_INT__i_s_s_f);


                    ostei_general_vrr_L(5, 0, 0, 5, 1,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PB,
                            PRIM_INT__h_s_s_g, NULL, PRIM_INT__h_s_s_f, PRIM_INT__g_s_s_g, NULL, PRIM_INT__h_s_s_h);


                    ostei_general_vrr_L(6, 0, 0, 4, 2,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PB,
                            PRIM_INT__i_s_s_f, NULL, PRIM_INT__i_s_s_d, PRIM_INT__h_s_s_f, NULL, PRIM_INT__i_s_s_g);


                    ostei_general_vrr_L(6, 0, 0, 5, 1,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PB,
                            PRIM_INT__i_s_s_g, NULL, PRIM_INT__i_s_s_f, PRIM_INT__h_s_s_g, NULL, PRIM_INT__i_s_s_h);
                    ...
                    if(lastoffset == 0)
                    {
                        ...
                        contract_all(210, PRIM_INT__h_s_s_f, PRIM_PTR_INT__h_s_s_f);
                        contract_all(315, PRIM_INT__h_s_s_g, PRIM_PTR_INT__h_s_s_g);
                        contract_all(441, PRIM_INT__h_s_s_h, PRIM_PTR_INT__h_s_s_h);
                        contract_all(280, PRIM_INT__i_s_s_f, PRIM_PTR_INT__i_s_s_f);
                        contract_all(420, PRIM_INT__i_s_s_g, PRIM_PTR_INT__i_s_s_g);
                        contract_all(588, PRIM_INT__i_s_s_h, PRIM_PTR_INT__i_s_s_h);
                    }
                    else
                    {
                        ...
                        contract(210, shelloffsets, PRIM_INT__h_s_s_f, PRIM_PTR_INT__h_s_s_f);
                        contract(315, shelloffsets, PRIM_INT__h_s_s_g, PRIM_PTR_INT__h_s_s_g);
                        contract(441, shelloffsets, PRIM_INT__h_s_s_h, PRIM_PTR_INT__h_s_s_h);
                        contract(280, shelloffsets, PRIM_INT__i_s_s_f, PRIM_PTR_INT__i_s_s_f);
                        contract(420, shelloffsets, PRIM_INT__i_s_s_g, PRIM_PTR_INT__i_s_s_g);
                        contract(588, shelloffsets, PRIM_INT__i_s_s_h, PRIM_PTR_INT__i_s_s_h);
                        PRIM_PTR_INT__f_s_s_f += lastoffset*100;
                        PRIM_PTR_INT__f_s_s_g += lastoffset*150;
                        PRIM_PTR_INT__f_s_s_h += lastoffset*210;
                        PRIM_PTR_INT__g_s_s_f += lastoffset*150;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double const * restrict HRR_INT__h_s_s_f = INT__h_s_s_f + abcd * 210;
                double const * restrict HRR_INT__h_s_s_g = INT__h_s_s_g + abcd * 315;
                double const * restrict HRR_INT__h_s_s_h = INT__h_s_s_h + abcd * 441;
                double const * restrict HRR_INT__i_s_s_f = INT__i_s_s_f + abcd * 280;
                double const * restrict HRR_INT__i_s_s_g = INT__i_s_s_g + abcd * 420;
                double const * restrict HRR_INT__i_s_s_h = INT__i_s_s_h + abcd * 588;
                double * restrict HRR_INT__f_f_d_f = INT__f_f_d_f + real_abcd * 6000;
                ...
                for(iket = 0; iket < 10; ++iket)
                {
                    ...
                    HRR_INT__f_p_s_f[1 * 10 + iket] = HRR_INT__g_s_s_f[1 * 10 + iket] + ( hAB[1] * HRR_INT__f_s_s_f[0 * 10 + iket] );

                    HRR_INT__f_p_s_f[2 * 10 + iket] = HRR_INT__g_s_s_f[2 * 10 + iket] + ( hAB[2] * HRR_INT__f_s_s_f[0 * 10 + iket] );
                    ...
                    HRR_INT__f_p_s_f[5 * 10 + iket] = HRR_INT__g_s_s_f[4 * 10 + iket] + ( hAB[2] * HRR_INT__f_s_s_f[1 * 10 + iket] );
                    ...
                    HRR_INT__f_p_s_f[11 * 10 + iket] = HRR_INT__g_s_s_f[7 * 10 + iket] + ( hAB[2] * HRR_INT__f_s_s_f[3 * 10 + iket] );
                    ...
                    HRR_INT__f_p_s_f[20 * 10 + iket] = HRR_INT__g_s_s_f[11 * 10 + iket] + ( hAB[2] * HRR_INT__f_s_s_f[6 * 10 + iket] );
                ...
                for(iket = 0; iket < 15; ++iket)
                {
                    ...
                    HRR_INT__f_p_s_g[1 * 15 + iket] = HRR_INT__g_s_s_g[1 * 15 + iket] + ( hAB[1] * HRR_INT__f_s_s_g[0 * 15 + iket] );

                    HRR_INT__f_p_s_g[2 * 15 + iket] = HRR_INT__g_s_s_g[2 * 15 + iket] + ( hAB[2] * HRR_INT__f_s_s_g[0 * 15 + iket] );
                    ...
                    HRR_INT__f_p_s_g[5 * 15 + iket] = HRR_INT__g_s_s_g[4 * 15 + iket] + ( hAB[2] * HRR_INT__f_s_s_g[1 * 15 + iket] );
                    ...
                    HRR_INT__f_p_s_g[11 * 15 + iket] = HRR_INT__g_s_s_g[7 * 15 + iket] + ( hAB[2] * HRR_INT__f_s_s_g[3 * 15 + iket] );
                    ...
                    HRR_INT__f_p_s_g[20 * 15 + iket] = HRR_INT__g_s_s_g[11 * 15 + iket] + ( hAB[2] * HRR_INT__f_s_s_g[6 * 15 + iket] );
                ...
                for(iket = 0; iket < 21; ++iket)
                {
                    ...
                    HRR_INT__f_p_s_h[1 * 21 + iket] = HRR_INT__g_s_s_h[1 * 21 + iket] + ( hAB[1] * HRR_INT__f_s_s_h[0 * 21 + iket] );

                    HRR_INT__f_p_s_h[2 * 21 + iket] = HRR_INT__g_s_s_h[2 * 21 + iket] + ( hAB[2] * HRR_INT__f_s_s_h[0 * 21 + iket] );
                    ...
                    HRR_INT__f_p_s_h[5 * 21 + iket] = HRR_INT__g_s_s_h[4 * 21 + iket] + ( hAB[2] * HRR_INT__f_s_s_h[1 * 21 + iket] );
                    ...
                    HRR_INT__f_p_s_h[11 * 21 + iket] = HRR_INT__g_s_s_h[7 * 21 + iket] + ( hAB[2] * HRR_INT__f_s_s_h[3 * 21 + iket] );
                    ...
                    HRR_INT__f_p_s_h[20 * 21 + iket] = HRR_INT__g_s_s_h[11 * 21 + iket] + ( hAB[2] * HRR_INT__f_s_s_h[6 * 21 + iket] );
                ...
                {
                    HRR_INT__f_f_p_f[ibra * 30 + 0] = HRR_INT__f_f_s_g[ibra * 15 + 0] - ( hCD[0] * HRR_INT__f_f_s_f[ibra * 10 + 0] );

                    HRR_INT__f_f_p_f[ibra * 30 + 1] = HRR_INT__f_f_s_g[ibra * 15 + 1] - ( hCD[0] * HRR_INT__f_f_s_f[ibra * 10 + 1] );

                    HRR_INT__f_f_p_f[ibra * 30 + 2] = HRR_INT__f_f_s_g[ibra * 15 + 2] - ( hCD[0] * HRR_INT__f_f_s_f[ibra * 10 + 2] );

                    HRR_INT__f_f_p_f[ibra * 30 + 3] = HRR_INT__f_f_s_g[ibra * 15 + 3] - ( hCD[0] * HRR_INT__f_f_s_f[ibra * 10 + 3] );

                    HRR_INT__f_f_p_f[ibra * 30 + 4] = HRR_INT__f_f_s_g[ibra * 15 + 4] - ( hCD[0] * HRR_INT__f_f_s_f[ibra * 10 + 4] );

                    HRR_INT__f_f_p_f[ibra * 30 + 5] = HRR_INT__f_f_s_g[ibra * 15 + 5] - ( hCD[0] * HRR_INT__f_f_s_f[ibra * 10 + 5] );

                    HRR_INT__f_f_p_f[ibra * 30 + 6] = HRR_INT__f_f_s_g[ibra * 15 + 6] - ( hCD[0] * HRR_INT__f_f_s_f[ibra * 10 + 6] );

                    HRR_INT__f_f_p_f[ibra * 30 + 7] = HRR_INT__f_f_s_g[ibra * 15 + 7] - ( hCD[0] * HRR_INT__f_f_s_f[ibra * 10 + 7] );

                    HRR_INT__f_f_p_f[ibra * 30 + 8] = HRR_INT__f_f_s_g[ibra * 15 + 8] - ( hCD[0] * HRR_INT__f_f_s_f[ibra * 10 + 8] );

                    HRR_INT__f_f_p_f[ibra * 30 + 9] = HRR_INT__f_f_s_g[ibra * 15 + 9] - ( hCD[0] * HRR_INT__f_f_s_f[ibra * 10 + 9] );

                    HRR_INT__f_f_p_f[ibra * 30 + 10] = HRR_INT__f_f_s_g[ibra * 15 + 1] - ( hCD[1] * HRR_INT__f_f_s_f[ibra * 10 + 0] );

                    HRR_INT__f_f_p_f[ibra * 30 + 11] = HRR_INT__f_f_s_g[ibra * 15 + 3] - ( hCD[1] * HRR_INT__f_f_s_f[ibra * 10 + 1] );

                    HRR_INT__f_f_p_f[ibra * 30 + 12] = HRR_INT__f_f_s_g[ibra * 15 + 4] - ( hCD[1] * HRR_INT__f_f_s_f[ibra * 10 + 2] );

                    HRR_INT__f_f_p_f[ibra * 30 + 13] = HRR_INT__f_f_s_g[ibra * 15 + 6] - ( hCD[1] * HRR_INT__f_f_s_f[ibra * 10 + 3] );

                    HRR_INT__f_f_p_f[ibra * 30 + 14] = HRR_INT__f_f_s_g[ibra * 15 + 7] - ( hCD[1] * HRR_INT__f_f_s_f[ibra * 10 + 4] );

                    HRR_INT__f_f_p_f[ibra * 30 + 15] = HRR_INT__f_f_s_g[ibra * 15 + 8] - ( hCD[1] * HRR_INT__f_f_s_f[ibra * 10 + 5] );

                    HRR_INT__f_f_p_f[ibra * 30 + 16] = HRR_INT__f_f_s_g[ibra * 15 + 10] - ( hCD[1] * HRR_INT__f_f_s_f[ibra * 10 + 6] );

                    HRR_INT__f_f_p_f[ibra * 30 + 17] = HRR_INT__f_f_s_g[ibra * 15 + 11] - ( hCD[1] * HRR_INT__f_f_s_f[ibra * 10 + 7] );

                    HRR_INT__f_f_p_f[ibra * 30 + 18] = HRR_INT__f_f_s_g[ibra * 15 + 12] - ( hCD[1] * HRR_INT__f_f_s_f[ibra * 10 + 8] );

                    HRR_INT__f_f_p_f[ibra * 30 + 19] = HRR_INT__f_f_s_g[ibra * 15 + 13] - ( hCD[1] * HRR_INT__f_f_s_f[ibra * 10 + 9] );

                    HRR_INT__f_f_p_f[ibra * 30 + 20] = HRR_INT__f_f_s_g[ibra * 15 + 2] - ( hCD[2] * HRR_INT__f_f_s_f[ibra * 10 + 0] );

                    HRR_INT__f_f_p_f[ibra * 30 + 21] = HRR_INT__f_f_s_g[ibra * 15 + 4] - ( hCD[2] * HRR_INT__f_f_s_f[ibra * 10 + 1] );

                    HRR_INT__f_f_p_f[ibra * 30 + 22] = HRR_INT__f_f_s_g[ibra * 15 + 5] - ( hCD[2] * HRR_INT__f_f_s_f[ibra * 10 + 2] );

                    HRR_INT__f_f_p_f[ibra * 30 + 23] = HRR_INT__f_f_s_g[ibra * 15 + 7] - ( hCD[2] * HRR_INT__f_f_s_f[ibra * 10 + 3] );

                    HRR_INT__f_f_p_f[ibra * 30 + 24] = HRR_INT__f_f_s_g[ibra * 15 + 8] - ( hCD[2] * HRR_INT__f_f_s_f[ibra * 10 + 4] );

                    HRR_INT__f_f_p_f[ibra * 30 + 25] = HRR_INT__f_f_s_g[ibra * 15 + 9] - ( hCD[2] * HRR_INT__f_f_s_f[ibra * 10 + 5] );

                    HRR_INT__f_f_p_f[ibra * 30 + 26] = HRR_INT__f_f_s_g[ibra * 15 + 11] - ( hCD[2] * HRR_INT__f_f_s_f[ibra * 10 + 6] );

                    HRR_INT__f_f_p_f[ibra * 30 + 27] = HRR_INT__f_f_s_g[ibra * 15 + 12] - ( hCD[2] * HRR_INT__f_f_s_f[ibra * 10 + 7] );

                    HRR_INT__f_f_p_f[ibra * 30 + 28] = HRR_INT__f_f_s_g[ibra * 15 + 13] - ( hCD[2] * HRR_INT__f_f_s_f[ibra * 10 + 8] );

                    HRR_INT__f_f_p_f[ibra * 30 + 29] = HRR_INT__f_f_s_g[ibra * 15 + 14] - ( hCD[2] * HRR_INT__f_f_s_f[ibra * 10 + 9] );
