                  ...
                  double * const restrict INT__s_s_g_g)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_s_g_g);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_s_l_s = work + (SIMINT_NSHELL_SIMD * 100);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_l_s = primwork + 450;
    double * const hrrwork = (double *)(primwork + 495);
    double * const HRR_INT__s_s_g_p = hrrwork + 0;
    double * const HRR_INT__s_s_g_d = hrrwork + 45;
    double * const HRR_INT__s_s_g_f = hrrwork + 135;
    double * const HRR_INT__s_s_h_p = hrrwork + 285;
    double * const HRR_INT__s_s_h_d = hrrwork + 348;
    double * const HRR_INT__s_s_h_f = hrrwork + 474;
    double * const HRR_INT__s_s_i_p = hrrwork + 684;
    double * const HRR_INT__s_s_i_d = hrrwork + 768;
    double * const HRR_INT__s_s_k_p = hrrwork + 936;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                double * restrict PRIM_PTR_INT__s_s_l_s = INT__s_s_l_s + abcd * 45;
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    if(check_screen)
                    {
                        ...
                        if(vmax < screen_tol)
                        {
                            ...
                            PRIM_PTR_INT__s_s_l_s += lastoffset*45;
                            continue;
                        }
                    }
                    ...
                    if(lastoffset == 0)
                    {
                        ...
                        contract_all(45, PRIM_INT__s_s_l_s, PRIM_PTR_INT__s_s_l_s);
                    }
                    else
                    {
                        ...
                        contract(45, shelloffsets, PRIM_INT__s_s_l_s, PRIM_PTR_INT__s_s_l_s);
                        PRIM_PTR_INT__s_s_g_s += lastoffset*15;
                        PRIM_PTR_INT__s_s_h_s += lastoffset*21;
                        PRIM_PTR_INT__s_s_i_s += lastoffset*28;
                        PRIM_PTR_INT__s_s_k_s += lastoffset*36;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double const * restrict HRR_INT__s_s_l_s = INT__s_s_l_s + abcd * 45;
                double * restrict HRR_INT__s_s_g_g = INT__s_s_g_g + real_abcd * 225;
