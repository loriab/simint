                  ...
                  double * const restrict INT__d_f_f_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_f_f_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_g_f_s = work + (SIMINT_NSHELL_SIMD * 460);
    double * const INT__s_g_g_s = work + (SIMINT_NSHELL_SIMD * 610);
    double * const INT__s_g_h_s = work + (SIMINT_NSHELL_SIMD * 835);
    double * const INT__s_h_f_s = work + (SIMINT_NSHELL_SIMD * 1150);
    double * const INT__s_h_g_s = work + (SIMINT_NSHELL_SIMD * 1360);
    double * const INT__s_h_h_s = work + (SIMINT_NSHELL_SIMD * 1675);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_d_s = primwork + 26;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_s = primwork + 50;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_p_s = primwork + 80;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_d_s = primwork + 125;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_f_s = primwork + 197;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_s = primwork + 287;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_p_s = primwork + 341;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_d_s = primwork + 431;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_f_s = primwork + 575;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_g_s = primwork + 755;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_s = primwork + 935;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_p_s = primwork + 1015;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_d_s = primwork + 1165;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_f_s = primwork + 1405;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_g_s = primwork + 1705;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_h_s = primwork + 2005;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_s = primwork + 2215;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_p_s = primwork + 2320;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_d_s = primwork + 2545;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_f_s = primwork + 2905;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_g_s = primwork + 3355;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_h_s = primwork + 3805;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_s_s = primwork + 4120;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_p_s = primwork + 4246;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_d_s = primwork + 4561;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_f_s = primwork + 5065;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_g_s = primwork + 5695;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_h_s = primwork + 6325;
    ...
    double * const HRR_INT__p_g_f_s = hrrwork + 1380;
    double * const HRR_INT__p_g_g_s = hrrwork + 1830;
    double * const HRR_INT__p_g_h_s = hrrwork + 2505;
    double * const HRR_INT__d_f_f_s = hrrwork + 3450;
    double * const HRR_INT__d_f_f_p = hrrwork + 4050;
    double * const HRR_INT__d_f_g_s = hrrwork + 5850;
    double * const HRR_INT__d_f_g_p = hrrwork + 6750;
    double * const HRR_INT__d_f_h_s = hrrwork + 9450;
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    // Forming PRIM_INT__s_f_p_s[5 * 30];
                    ...
                    // Forming PRIM_INT__s_d_p_s[5 * 18];
                    for(n = 0; n < 5; ++n)  // loop over orders of auxiliary function
                    {
                    ...
                    for(n = 0; n < 3; ++n)  // loop over orders of auxiliary function
                    {
                        ...
                        PRIM_INT__s_p_f_s[n * 30 + 0] = SIMINT_MUL(Q_PA[0], PRIM_INT__s_p_d_s[n * 18 + 0]);
                        PRIM_INT__s_p_f_s[n * 30 + 0] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__s_p_d_s[(n+1) * 18 + 0], PRIM_INT__s_p_f_s[n * 30 + 0]);
                        PRIM_INT__s_p_f_s[n * 30 + 0] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__s_p_p_s[(n+1) * 9 + 0], PRIM_INT__s_p_p_s[n * 9 + 0]), PRIM_INT__s_p_f_s[n * 30 + 0]);
                        PRIM_INT__s_p_f_s[n * 30 + 0] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_d_s[(n+1) * 6 + 0], PRIM_INT__s_p_f_s[n * 30 + 0]);

                        PRIM_INT__s_p_f_s[n * 30 + 1] = SIMINT_MUL(Q_PA[1], PRIM_INT__s_p_d_s[n * 18 + 0]);
                        PRIM_INT__s_p_f_s[n * 30 + 1] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__s_p_d_s[(n+1) * 18 + 0], PRIM_INT__s_p_f_s[n * 30 + 1]);

                        PRIM_INT__s_p_f_s[n * 30 + 2] = SIMINT_MUL(Q_PA[2], PRIM_INT__s_p_d_s[n * 18 + 0]);
                        PRIM_INT__s_p_f_s[n * 30 + 2] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_p_d_s[(n+1) * 18 + 0], PRIM_INT__s_p_f_s[n * 30 + 2]);

                        PRIM_INT__s_p_f_s[n * 30 + 6] = SIMINT_MUL(Q_PA[1], PRIM_INT__s_p_d_s[n * 18 + 3]);
                        PRIM_INT__s_p_f_s[n * 30 + 6] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__s_p_d_s[(n+1) * 18 + 3], PRIM_INT__s_p_f_s[n * 30 + 6]);
                        PRIM_INT__s_p_f_s[n * 30 + 6] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__s_p_p_s[(n+1) * 9 + 1], PRIM_INT__s_p_p_s[n * 9 + 1]), PRIM_INT__s_p_f_s[n * 30 + 6]);

                        PRIM_INT__s_p_f_s[n * 30 + 7] = SIMINT_MUL(Q_PA[2], PRIM_INT__s_p_d_s[n * 18 + 3]);
                        PRIM_INT__s_p_f_s[n * 30 + 7] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_p_d_s[(n+1) * 18 + 3], PRIM_INT__s_p_f_s[n * 30 + 7]);

                        PRIM_INT__s_p_f_s[n * 30 + 9] = SIMINT_MUL(Q_PA[2], PRIM_INT__s_p_d_s[n * 18 + 5]);
                        PRIM_INT__s_p_f_s[n * 30 + 9] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_p_d_s[(n+1) * 18 + 5], PRIM_INT__s_p_f_s[n * 30 + 9]);
                        PRIM_INT__s_p_f_s[n * 30 + 9] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__s_p_p_s[(n+1) * 9 + 2], PRIM_INT__s_p_p_s[n * 9 + 2]), PRIM_INT__s_p_f_s[n * 30 + 9]);

                        PRIM_INT__s_p_f_s[n * 30 + 10] = SIMINT_MUL(Q_PA[0], PRIM_INT__s_p_d_s[n * 18 + 6]);
                        PRIM_INT__s_p_f_s[n * 30 + 10] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__s_p_d_s[(n+1) * 18 + 6], PRIM_INT__s_p_f_s[n * 30 + 10]);
                        PRIM_INT__s_p_f_s[n * 30 + 10] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__s_p_p_s[(n+1) * 9 + 3], PRIM_INT__s_p_p_s[n * 9 + 3]), PRIM_INT__s_p_f_s[n * 30 + 10]);

                        PRIM_INT__s_p_f_s[n * 30 + 11] = SIMINT_MUL(Q_PA[1], PRIM_INT__s_p_d_s[n * 18 + 6]);
                        PRIM_INT__s_p_f_s[n * 30 + 11] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__s_p_d_s[(n+1) * 18 + 6], PRIM_INT__s_p_f_s[n * 30 + 11]);
                        PRIM_INT__s_p_f_s[n * 30 + 11] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_d_s[(n+1) * 6 + 0], PRIM_INT__s_p_f_s[n * 30 + 11]);

                        PRIM_INT__s_p_f_s[n * 30 + 12] = SIMINT_MUL(Q_PA[2], PRIM_INT__s_p_d_s[n * 18 + 6]);
                        PRIM_INT__s_p_f_s[n * 30 + 12] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_p_d_s[(n+1) * 18 + 6], PRIM_INT__s_p_f_s[n * 30 + 12]);

                        PRIM_INT__s_p_f_s[n * 30 + 16] = SIMINT_MUL(Q_PA[1], PRIM_INT__s_p_d_s[n * 18 + 9]);
                        PRIM_INT__s_p_f_s[n * 30 + 16] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__s_p_d_s[(n+1) * 18 + 9], PRIM_INT__s_p_f_s[n * 30 + 16]);
                        PRIM_INT__s_p_f_s[n * 30 + 16] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__s_p_p_s[(n+1) * 9 + 4], PRIM_INT__s_p_p_s[n * 9 + 4]), PRIM_INT__s_p_f_s[n * 30 + 16]);
                        PRIM_INT__s_p_f_s[n * 30 + 16] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_d_s[(n+1) * 6 + 3], PRIM_INT__s_p_f_s[n * 30 + 16]);

                        PRIM_INT__s_p_f_s[n * 30 + 17] = SIMINT_MUL(Q_PA[2], PRIM_INT__s_p_d_s[n * 18 + 9]);
                        PRIM_INT__s_p_f_s[n * 30 + 17] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_p_d_s[(n+1) * 18 + 9], PRIM_INT__s_p_f_s[n * 30 + 17]);

                        PRIM_INT__s_p_f_s[n * 30 + 19] = SIMINT_MUL(Q_PA[2], PRIM_INT__s_p_d_s[n * 18 + 11]);
                        PRIM_INT__s_p_f_s[n * 30 + 19] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_p_d_s[(n+1) * 18 + 11], PRIM_INT__s_p_f_s[n * 30 + 19]);
                        PRIM_INT__s_p_f_s[n * 30 + 19] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__s_p_p_s[(n+1) * 9 + 5], PRIM_INT__s_p_p_s[n * 9 + 5]), PRIM_INT__s_p_f_s[n * 30 + 19]);

                        PRIM_INT__s_p_f_s[n * 30 + 20] = SIMINT_MUL(Q_PA[0], PRIM_INT__s_p_d_s[n * 18 + 12]);
                        PRIM_INT__s_p_f_s[n * 30 + 20] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__s_p_d_s[(n+1) * 18 + 12], PRIM_INT__s_p_f_s[n * 30 + 20]);
                        PRIM_INT__s_p_f_s[n * 30 + 20] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__s_p_p_s[(n+1) * 9 + 6], PRIM_INT__s_p_p_s[n * 9 + 6]), PRIM_INT__s_p_f_s[n * 30 + 20]);

                        PRIM_INT__s_p_f_s[n * 30 + 21] = SIMINT_MUL(Q_PA[1], PRIM_INT__s_p_d_s[n * 18 + 12]);
                        PRIM_INT__s_p_f_s[n * 30 + 21] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__s_p_d_s[(n+1) * 18 + 12], PRIM_INT__s_p_f_s[n * 30 + 21]);

                        PRIM_INT__s_p_f_s[n * 30 + 22] = SIMINT_MUL(Q_PA[2], PRIM_INT__s_p_d_s[n * 18 + 12]);
                        PRIM_INT__s_p_f_s[n * 30 + 22] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_p_d_s[(n+1) * 18 + 12], PRIM_INT__s_p_f_s[n * 30 + 22]);
                        PRIM_INT__s_p_f_s[n * 30 + 22] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_d_s[(n+1) * 6 + 0], PRIM_INT__s_p_f_s[n * 30 + 22]);

                        PRIM_INT__s_p_f_s[n * 30 + 26] = SIMINT_MUL(Q_PA[1], PRIM_INT__s_p_d_s[n * 18 + 15]);
                        PRIM_INT__s_p_f_s[n * 30 + 26] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__s_p_d_s[(n+1) * 18 + 15], PRIM_INT__s_p_f_s[n * 30 + 26]);
                        PRIM_INT__s_p_f_s[n * 30 + 26] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__s_p_p_s[(n+1) * 9 + 7], PRIM_INT__s_p_p_s[n * 9 + 7]), PRIM_INT__s_p_f_s[n * 30 + 26]);

                        PRIM_INT__s_p_f_s[n * 30 + 27] = SIMINT_MUL(Q_PA[2], PRIM_INT__s_p_d_s[n * 18 + 15]);
                        PRIM_INT__s_p_f_s[n * 30 + 27] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_p_d_s[(n+1) * 18 + 15], PRIM_INT__s_p_f_s[n * 30 + 27]);
                        PRIM_INT__s_p_f_s[n * 30 + 27] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_d_s[(n+1) * 6 + 3], PRIM_INT__s_p_f_s[n * 30 + 27]);

                        PRIM_INT__s_p_f_s[n * 30 + 29] = SIMINT_MUL(Q_PA[2], PRIM_INT__s_p_d_s[n * 18 + 17]);
                        PRIM_INT__s_p_f_s[n * 30 + 29] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_p_d_s[(n+1) * 18 + 17], PRIM_INT__s_p_f_s[n * 30 + 29]);
                        PRIM_INT__s_p_f_s[n * 30 + 29] = SIMINT_FMADD( vrr_const_2_over_2q, SIMINT_FMADD(a_over_q, PRIM_INT__s_p_p_s[(n+1) * 9 + 8], PRIM_INT__s_p_p_s[n * 9 + 8]), PRIM_INT__s_p_f_s[n * 30 + 29]);
                        PRIM_INT__s_p_f_s[n * 30 + 29] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_d_s[(n+1) * 6 + 5], PRIM_INT__s_p_f_s[n * 30 + 29]);
                    ...
                    ostei_general_vrr_K(0, 3, 5, 0, 1,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PA,
                            PRIM_INT__s_f_g_s, PRIM_INT__s_f_f_s, NULL, NULL, PRIM_INT__s_d_g_s, PRIM_INT__s_f_h_s);


                    ostei_general_vrr_K(0, 4, 4, 0, 2,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PA,
                    ...
                    ostei_general_vrr_K(0, 5, 3, 0, 3,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PA,
                            PRIM_INT__s_h_d_s, PRIM_INT__s_h_p_s, NULL, NULL, PRIM_INT__s_g_d_s, PRIM_INT__s_h_f_s);


                    ostei_general_vrr_K(0, 4, 5, 0, 1,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PA,
                            PRIM_INT__s_g_g_s, PRIM_INT__s_g_f_s, NULL, NULL, PRIM_INT__s_f_g_s, PRIM_INT__s_g_h_s);


                    ostei_general_vrr_K(0, 5, 4, 0, 2,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PA,
                            PRIM_INT__s_h_f_s, PRIM_INT__s_h_d_s, NULL, NULL, PRIM_INT__s_g_f_s, PRIM_INT__s_h_g_s);


                    ostei_general_vrr_K(0, 5, 5, 0, 1,
                            one_over_2q, a_over_q, one_over_2pq, aoq_PQ, Q_PA,
                            PRIM_INT__s_h_g_s, PRIM_INT__s_h_f_s, NULL, NULL, PRIM_INT__s_g_g_s, PRIM_INT__s_h_h_s);
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_f_f_d = INT__d_f_f_d + real_abcd * 3600;
