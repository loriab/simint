                  ...
                  double * const restrict INT__f_d_d_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_d_d_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 50;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_p = primwork + 80;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_d = primwork + 125;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_f = primwork + 197;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 287;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_p = primwork + 341;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_d = primwork + 431;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_f = primwork + 575;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_g = primwork + 755;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 935;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_p = primwork + 1015;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_d = primwork + 1165;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_f = primwork + 1405;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_g = primwork + 1705;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_h = primwork + 2005;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 2215;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_p = primwork + 2320;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_d = primwork + 2545;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_f = primwork + 2905;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_g = primwork + 3355;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_h = primwork + 3805;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 4120;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_p = primwork + 4246;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_d = primwork + 4561;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_f = primwork + 5065;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_g = primwork + 5695;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_h = primwork + 6325;
    ...
    double * const HRR_INT__f_d_p_f = hrrwork + 4140;
    double * const HRR_INT__f_d_p_g = hrrwork + 5940;
    double * const HRR_INT__g_p_s_f = hrrwork + 8640;
    double * const HRR_INT__g_p_s_g = hrrwork + 9090;
    double * const HRR_INT__g_p_s_h = hrrwork + 9765;
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    // Forming PRIM_INT__p_s_s_s[10 * 3];
                    ...
                    // Forming PRIM_INT__f_s_s_s[8 * 10];
                    ...
                    // Forming PRIM_INT__g_s_s_s[7 * 15];
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_d_d_f = INT__f_d_d_f + real_abcd * 3600;
                ...
                {
                    HRR_INT__f_d_p_f[ibra * 30 + 0] = HRR_INT__f_d_s_g[ibra * 15 + 0] - ( hCD[0] * HRR_INT__f_d_s_f[ibra * 10 + 0] );

                    HRR_INT__f_d_p_f[ibra * 30 + 1] = HRR_INT__f_d_s_g[ibra * 15 + 1] - ( hCD[0] * HRR_INT__f_d_s_f[ibra * 10 + 1] );

                    HRR_INT__f_d_p_f[ibra * 30 + 2] = HRR_INT__f_d_s_g[ibra * 15 + 2] - ( hCD[0] * HRR_INT__f_d_s_f[ibra * 10 + 2] );

                    HRR_INT__f_d_p_f[ibra * 30 + 3] = HRR_INT__f_d_s_g[ibra * 15 + 3] - ( hCD[0] * HRR_INT__f_d_s_f[ibra * 10 + 3] );

                    HRR_INT__f_d_p_f[ibra * 30 + 4] = HRR_INT__f_d_s_g[ibra * 15 + 4] - ( hCD[0] * HRR_INT__f_d_s_f[ibra * 10 + 4] );

                    HRR_INT__f_d_p_f[ibra * 30 + 5] = HRR_INT__f_d_s_g[ibra * 15 + 5] - ( hCD[0] * HRR_INT__f_d_s_f[ibra * 10 + 5] );

                    HRR_INT__f_d_p_f[ibra * 30 + 6] = HRR_INT__f_d_s_g[ibra * 15 + 6] - ( hCD[0] * HRR_INT__f_d_s_f[ibra * 10 + 6] );

                    HRR_INT__f_d_p_f[ibra * 30 + 7] = HRR_INT__f_d_s_g[ibra * 15 + 7] - ( hCD[0] * HRR_INT__f_d_s_f[ibra * 10 + 7] );

                    HRR_INT__f_d_p_f[ibra * 30 + 8] = HRR_INT__f_d_s_g[ibra * 15 + 8] - ( hCD[0] * HRR_INT__f_d_s_f[ibra * 10 + 8] );

                    HRR_INT__f_d_p_f[ibra * 30 + 9] = HRR_INT__f_d_s_g[ibra * 15 + 9] - ( hCD[0] * HRR_INT__f_d_s_f[ibra * 10 + 9] );

                    HRR_INT__f_d_p_f[ibra * 30 + 10] = HRR_INT__f_d_s_g[ibra * 15 + 1] - ( hCD[1] * HRR_INT__f_d_s_f[ibra * 10 + 0] );

                    HRR_INT__f_d_p_f[ibra * 30 + 11] = HRR_INT__f_d_s_g[ibra * 15 + 3] - ( hCD[1] * HRR_INT__f_d_s_f[ibra * 10 + 1] );

                    HRR_INT__f_d_p_f[ibra * 30 + 12] = HRR_INT__f_d_s_g[ibra * 15 + 4] - ( hCD[1] * HRR_INT__f_d_s_f[ibra * 10 + 2] );

                    HRR_INT__f_d_p_f[ibra * 30 + 13] = HRR_INT__f_d_s_g[ibra * 15 + 6] - ( hCD[1] * HRR_INT__f_d_s_f[ibra * 10 + 3] );

                    HRR_INT__f_d_p_f[ibra * 30 + 14] = HRR_INT__f_d_s_g[ibra * 15 + 7] - ( hCD[1] * HRR_INT__f_d_s_f[ibra * 10 + 4] );

                    HRR_INT__f_d_p_f[ibra * 30 + 15] = HRR_INT__f_d_s_g[ibra * 15 + 8] - ( hCD[1] * HRR_INT__f_d_s_f[ibra * 10 + 5] );

                    HRR_INT__f_d_p_f[ibra * 30 + 16] = HRR_INT__f_d_s_g[ibra * 15 + 10] - ( hCD[1] * HRR_INT__f_d_s_f[ibra * 10 + 6] );

                    HRR_INT__f_d_p_f[ibra * 30 + 17] = HRR_INT__f_d_s_g[ibra * 15 + 11] - ( hCD[1] * HRR_INT__f_d_s_f[ibra * 10 + 7] );

                    HRR_INT__f_d_p_f[ibra * 30 + 18] = HRR_INT__f_d_s_g[ibra * 15 + 12] - ( hCD[1] * HRR_INT__f_d_s_f[ibra * 10 + 8] );

                    HRR_INT__f_d_p_f[ibra * 30 + 19] = HRR_INT__f_d_s_g[ibra * 15 + 13] - ( hCD[1] * HRR_INT__f_d_s_f[ibra * 10 + 9] );

                    HRR_INT__f_d_p_f[ibra * 30 + 20] = HRR_INT__f_d_s_g[ibra * 15 + 2] - ( hCD[2] * HRR_INT__f_d_s_f[ibra * 10 + 0] );

                    HRR_INT__f_d_p_f[ibra * 30 + 21] = HRR_INT__f_d_s_g[ibra * 15 + 4] - ( hCD[2] * HRR_INT__f_d_s_f[ibra * 10 + 1] );

                    HRR_INT__f_d_p_f[ibra * 30 + 22] = HRR_INT__f_d_s_g[ibra * 15 + 5] - ( hCD[2] * HRR_INT__f_d_s_f[ibra * 10 + 2] );

                    HRR_INT__f_d_p_f[ibra * 30 + 23] = HRR_INT__f_d_s_g[ibra * 15 + 7] - ( hCD[2] * HRR_INT__f_d_s_f[ibra * 10 + 3] );

                    HRR_INT__f_d_p_f[ibra * 30 + 24] = HRR_INT__f_d_s_g[ibra * 15 + 8] - ( hCD[2] * HRR_INT__f_d_s_f[ibra * 10 + 4] );

                    HRR_INT__f_d_p_f[ibra * 30 + 25] = HRR_INT__f_d_s_g[ibra * 15 + 9] - ( hCD[2] * HRR_INT__f_d_s_f[ibra * 10 + 5] );

                    HRR_INT__f_d_p_f[ibra * 30 + 26] = HRR_INT__f_d_s_g[ibra * 15 + 11] - ( hCD[2] * HRR_INT__f_d_s_f[ibra * 10 + 6] );

                    HRR_INT__f_d_p_f[ibra * 30 + 27] = HRR_INT__f_d_s_g[ibra * 15 + 12] - ( hCD[2] * HRR_INT__f_d_s_f[ibra * 10 + 7] );

                    HRR_INT__f_d_p_f[ibra * 30 + 28] = HRR_INT__f_d_s_g[ibra * 15 + 13] - ( hCD[2] * HRR_INT__f_d_s_f[ibra * 10 + 8] );

                    HRR_INT__f_d_p_f[ibra * 30 + 29] = HRR_INT__f_d_s_g[ibra * 15 + 14] - ( hCD[2] * HRR_INT__f_d_s_f[ibra * 10 + 9] );
