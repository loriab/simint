                  ...
                  double * const restrict INT__d_p_d_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_p_d_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 34;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 61;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 97;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 127;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 181;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 253;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 313;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 353;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 443;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 563;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_p_d_p = INT__d_p_d_p + real_abcd * 324;
