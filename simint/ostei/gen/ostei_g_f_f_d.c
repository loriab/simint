                  ...
                  double * const restrict INT__g_f_f_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_f_f_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__k_s_f_s = work + (SIMINT_NSHELL_SIMD * 2944);
    double * const INT__k_s_g_s = work + (SIMINT_NSHELL_SIMD * 3304);
    double * const INT__k_s_h_s = work + (SIMINT_NSHELL_SIMD * 3844);
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*4600);
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_s = primwork + 0;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_p_s = primwork + 13;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 28;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 64;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 109;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 181;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 247;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 337;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 481;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 661;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 761;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 911;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 1151;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 1451;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 1751;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 1886;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 2111;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 2471;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 2921;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 3371;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 3686;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 3854;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_d_s = primwork + 4169;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_f_s = primwork + 4673;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_g_s = primwork + 5303;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_h_s = primwork + 5933;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 6374;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_p_s = primwork + 6570;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_d_s = primwork + 6990;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_f_s = primwork + 7662;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_g_s = primwork + 8502;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_h_s = primwork + 9342;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_s_s = primwork + 9930;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_p_s = primwork + 10146;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_d_s = primwork + 10686;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_f_s = primwork + 11550;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_g_s = primwork + 12630;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_h_s = primwork + 13710;
    double * const hrrwork = (double *)(primwork + 14466);
    ...
    double * const HRR_INT__g_d_g_s = hrrwork + 2970;
    double * const HRR_INT__g_d_h_s = hrrwork + 4320;
    double * const HRR_INT__g_f_f_s = hrrwork + 6210;
    double * const HRR_INT__g_f_f_p = hrrwork + 7710;
    double * const HRR_INT__g_f_g_s = hrrwork + 12210;
    double * const HRR_INT__g_f_g_p = hrrwork + 14460;
    double * const HRR_INT__g_f_h_s = hrrwork + 21210;
    double * const HRR_INT__h_p_f_s = hrrwork + 24360;
    double * const HRR_INT__h_p_g_s = hrrwork + 24990;
    double * const HRR_INT__h_p_h_s = hrrwork + 25935;
    double * const HRR_INT__h_d_f_s = hrrwork + 27258;
    double * const HRR_INT__h_d_g_s = hrrwork + 28518;
    double * const HRR_INT__h_d_h_s = hrrwork + 30408;
    double * const HRR_INT__i_p_f_s = hrrwork + 33054;
    double * const HRR_INT__i_p_g_s = hrrwork + 33894;
    double * const HRR_INT__i_p_h_s = hrrwork + 35154;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 4600 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__g_f_f_d = INT__g_f_f_d + real_abcd * 9000;
                  ...
                  double * const restrict INT__f_g_f_d)
{
    ...
    int ret = ostei_g_f_f_d(P_tmp, Q, screen_tol, work, INT__f_g_f_d);
    double buffer[9000] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 10; ++c)
        for(int d = 0; d < 6; ++d)
            buffer[idx++] = INT__f_g_f_d[q*9000+b*600+a*60+c*6+d];

        memcpy(INT__f_g_f_d+q*9000, buffer, 9000*sizeof(double));
    }
                  ...
                  double * const restrict INT__g_f_d_f)
{
    ...
    int ret = ostei_g_f_f_d(P, Q_tmp, screen_tol, work, INT__g_f_d_f);
    double buffer[9000] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 6; ++c)
        for(int d = 0; d < 10; ++d)
            buffer[idx++] = INT__g_f_d_f[q*9000+a*600+b*60+d*6+c];

        memcpy(INT__g_f_d_f+q*9000, buffer, 9000*sizeof(double));
    }
                  ...
                  double * const restrict INT__f_g_d_f)
{
    ...
    int ret = ostei_g_f_f_d(P_tmp, Q_tmp, screen_tol, work, INT__f_g_d_f);
    double buffer[9000] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 6; ++c)
        for(int d = 0; d < 10; ++d)
            buffer[idx++] = INT__f_g_d_f[q*9000+b*600+a*60+d*6+c];

        memcpy(INT__f_g_d_f+q*9000, buffer, 9000*sizeof(double));
    }
