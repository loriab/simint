                  ...
                  double * const restrict INT__g_p_f_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_p_f_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*1656);
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_s = primwork + 0;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_p_s = primwork + 11;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 26;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 56;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 101;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 173;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 227;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 317;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 461;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 641;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 721;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 871;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 1111;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 1411;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 1711;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 1816;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 2041;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 2401;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 2851;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 3301;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 3616;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 3742;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_d_s = primwork + 4057;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_f_s = primwork + 4561;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_g_s = primwork + 5191;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_h_s = primwork + 5821;
    double * const hrrwork = (double *)(primwork + 6262);
    double * const HRR_INT__g_p_f_s = hrrwork + 0;
    double * const HRR_INT__g_p_f_p = hrrwork + 450;
    double * const HRR_INT__g_p_g_s = hrrwork + 1800;
    double * const HRR_INT__g_p_g_p = hrrwork + 2475;
    double * const HRR_INT__g_p_h_s = hrrwork + 4500;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 1656 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__g_p_f_d = INT__g_p_f_d + real_abcd * 2700;
                  ...
                  double * const restrict INT__p_g_f_d)
{
    ...
    int ret = ostei_g_p_f_d(P_tmp, Q, screen_tol, work, INT__p_g_f_d);
    double buffer[2700] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 10; ++c)
        for(int d = 0; d < 6; ++d)
            buffer[idx++] = INT__p_g_f_d[q*2700+b*180+a*60+c*6+d];

        memcpy(INT__p_g_f_d+q*2700, buffer, 2700*sizeof(double));
    }
                  ...
                  double * const restrict INT__g_p_d_f)
{
    ...
    int ret = ostei_g_p_f_d(P, Q_tmp, screen_tol, work, INT__g_p_d_f);
    double buffer[2700] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 6; ++c)
        for(int d = 0; d < 10; ++d)
            buffer[idx++] = INT__g_p_d_f[q*2700+a*180+b*60+d*6+c];

        memcpy(INT__g_p_d_f+q*2700, buffer, 2700*sizeof(double));
    }
                  ...
                  double * const restrict INT__p_g_d_f)
{
    ...
    int ret = ostei_g_p_f_d(P_tmp, Q_tmp, screen_tol, work, INT__p_g_d_f);
    double buffer[2700] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 6; ++c)
        for(int d = 0; d < 10; ++d)
            buffer[idx++] = INT__p_g_d_f[q*2700+b*180+a*60+d*6+c];

        memcpy(INT__p_g_d_f+q*2700, buffer, 2700*sizeof(double));
    }
