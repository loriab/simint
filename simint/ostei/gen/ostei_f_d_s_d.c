                  ...
                  double * const restrict INT__f_d_s_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_d_s_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_p = primwork + 65;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 101;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_p = primwork + 151;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_d = primwork + 211;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 271;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_p = primwork + 331;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_d = primwork + 421;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 511;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_p = primwork + 574;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_d = primwork + 700;
    double * const hrrwork = (double *)(primwork + 826);
    double * const HRR_INT__f_p_s_d = hrrwork + 0;
    double * const HRR_INT__g_p_s_d = hrrwork + 180;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_d_s_d = INT__f_d_s_d + real_abcd * 360;
