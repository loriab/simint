                  ...
                  double * const restrict INT__d_d_s_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_d_s_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__f_s_s_d = work + (SIMINT_NSHELL_SIMD * 36);
    double * const INT__g_s_s_d = work + (SIMINT_NSHELL_SIMD * 96);
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*186);
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_s = primwork + 0;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 7;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_p = primwork + 25;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 43;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_p = primwork + 73;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_d = primwork + 109;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 145;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_p = primwork + 185;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_d = primwork + 245;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 305;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_p = primwork + 350;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_d = primwork + 440;
    double * const hrrwork = (double *)(primwork + 530);
    double * const HRR_INT__d_p_s_d = hrrwork + 0;
    double * const HRR_INT__f_p_s_d = hrrwork + 108;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 186 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_d_s_d = INT__d_d_s_d + real_abcd * 216;
