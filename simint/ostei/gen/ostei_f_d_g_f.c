                  ...
                  double * const restrict INT__f_d_g_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_d_g_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 930;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 945;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 990;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 1080;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_g_s = primwork + 1230;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_h_s = primwork + 1455;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_i_s = primwork + 1770;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_k_s = primwork + 2190;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 2730;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 2802;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 2946;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 3186;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_h_s = primwork + 3546;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_i_s = primwork + 4050;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_k_s = primwork + 4722;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 5586;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 5766;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 6066;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_h_s = primwork + 6516;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_i_s = primwork + 7146;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_k_s = primwork + 7986;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 9066;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 9366;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 9816;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_i_s = primwork + 10446;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_k_s = primwork + 11286;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_g_s = primwork + 12366;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_h_s = primwork + 12681;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_i_s = primwork + 13122;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_k_s = primwork + 13710;
    ...
    double * const HRR_INT__f_d_g_p = hrrwork + 3900;
    double * const HRR_INT__f_d_g_d = hrrwork + 6600;
    double * const HRR_INT__f_d_h_s = hrrwork + 12000;
    double * const HRR_INT__f_d_h_p = hrrwork + 13260;
    double * const HRR_INT__f_d_h_d = hrrwork + 17040;
    double * const HRR_INT__f_d_i_s = hrrwork + 24600;
    double * const HRR_INT__f_d_i_p = hrrwork + 26280;
    double * const HRR_INT__f_d_k_s = hrrwork + 31320;
    double * const HRR_INT__g_p_g_s = hrrwork + 33480;
    double * const HRR_INT__g_p_h_s = hrrwork + 34155;
    double * const HRR_INT__g_p_i_s = hrrwork + 35100;
    double * const HRR_INT__g_p_k_s = hrrwork + 36360;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_d_g_f = INT__f_d_g_f + real_abcd * 9000;
                  ...
                  double * const restrict INT__d_f_g_f)
{
    ...
    int ret = ostei_f_d_g_f(P_tmp, Q, screen_tol, work, INT__d_f_g_f);
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 15; ++c)
        for(int d = 0; d < 10; ++d)
            buffer[idx++] = INT__d_f_g_f[q*9000+b*900+a*150+c*10+d];

        memcpy(INT__d_f_g_f+q*9000, buffer, 9000*sizeof(double));
    }
                  ...
                  double * const restrict INT__f_d_f_g)
{
    ...
    int ret = ostei_f_d_g_f(P, Q_tmp, screen_tol, work, INT__f_d_f_g);
    double buffer[9000] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 10; ++c)
        for(int d = 0; d < 15; ++d)
            buffer[idx++] = INT__f_d_f_g[q*9000+a*900+b*150+d*10+c];

        memcpy(INT__f_d_f_g+q*9000, buffer, 9000*sizeof(double));
    }
                  ...
                  double * const restrict INT__d_f_f_g)
{
    ...
    int ret = ostei_f_d_g_f(P_tmp, Q_tmp, screen_tol, work, INT__d_f_f_g);
    double buffer[9000] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 10; ++c)
        for(int d = 0; d < 15; ++d)
            buffer[idx++] = INT__d_f_f_g[q*9000+b*900+a*150+d*10+c];

        memcpy(INT__d_f_f_g+q*9000, buffer, 9000*sizeof(double));
    }
