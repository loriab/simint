                  ...
                  double * const restrict INT__p_s_f_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_s_f_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 294;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_g_s = primwork + 324;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_h_s = primwork + 369;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_i_s = primwork + 432;
    double * const hrrwork = (double *)(primwork + 516);
    double * const HRR_INT__p_s_f_p = hrrwork + 0;
    double * const HRR_INT__p_s_f_d = hrrwork + 90;
    double * const HRR_INT__p_s_g_p = hrrwork + 270;
    double * const HRR_INT__p_s_g_d = hrrwork + 405;
    double * const HRR_INT__p_s_h_p = hrrwork + 675;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_s_f_f = INT__p_s_f_f + real_abcd * 300;
                ...
                for(ibra = 0; ibra < 3; ++ibra)
                {
                    ...
                    HRR_INT__p_s_f_p[ibra * 30 + 1] = HRR_INT__p_s_g_s[ibra * 15 + 1] + ( hCD[1] * HRR_INT__p_s_f_s[ibra * 10 + 0] );

                    HRR_INT__p_s_f_p[ibra * 30 + 2] = HRR_INT__p_s_g_s[ibra * 15 + 2] + ( hCD[2] * HRR_INT__p_s_f_s[ibra * 10 + 0] );
                    ...
                    HRR_INT__p_s_f_p[ibra * 30 + 5] = HRR_INT__p_s_g_s[ibra * 15 + 4] + ( hCD[2] * HRR_INT__p_s_f_s[ibra * 10 + 1] );
                    ...
                    HRR_INT__p_s_f_p[ibra * 30 + 11] = HRR_INT__p_s_g_s[ibra * 15 + 7] + ( hCD[2] * HRR_INT__p_s_f_s[ibra * 10 + 3] );
                    ...
                    HRR_INT__p_s_f_p[ibra * 30 + 20] = HRR_INT__p_s_g_s[ibra * 15 + 11] + ( hCD[2] * HRR_INT__p_s_f_s[ibra * 10 + 6] );
