                  ...
                  double * const restrict INT__s_s_d_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_s_d_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_s_s_h = work + (SIMINT_NSHELL_SIMD * 25);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_h = primwork + 105;
    double * const hrrwork = (double *)(primwork + 126);
    double * const HRR_INT__s_s_p_f = hrrwork + 0;
    double * const HRR_INT__s_s_p_g = hrrwork + 30;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                double * restrict PRIM_PTR_INT__s_s_s_h = INT__s_s_s_h + abcd * 21;
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    if(check_screen)
                    {
                        ...
                        if(vmax < screen_tol)
                        {
                            ...
                            PRIM_PTR_INT__s_s_s_h += lastoffset*21;
                            continue;
                        }
                    }
                    ...
                    if(lastoffset == 0)
                    {
                        ...
                        contract_all(21, PRIM_INT__s_s_s_h, PRIM_PTR_INT__s_s_s_h);
                    }
                    else
                    {
                        ...
                        contract(21, shelloffsets, PRIM_INT__s_s_s_h, PRIM_PTR_INT__s_s_s_h);
                        PRIM_PTR_INT__s_s_s_f += lastoffset*10;
                        PRIM_PTR_INT__s_s_s_g += lastoffset*15;
                        PRIM_PTR_INT__s_s_s_h += lastoffset*21;
                    }
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double const * restrict HRR_INT__s_s_s_h = INT__s_s_s_h + abcd * 21;
                double * restrict HRR_INT__s_s_d_f = INT__s_s_d_f + real_abcd * 60;
