                  ...
                  double * const restrict INT__s_d_s_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_d_s_s);
    memset(INT__s_d_s_s, 0, P.nshell12_clip * Q.nshell12_clip * 6 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_s = primwork + 9;
