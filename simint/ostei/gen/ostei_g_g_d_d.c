                  ...
                  double * const restrict INT__g_g_d_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_g_d_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__l_s_d_s = work + (SIMINT_NSHELL_SIMD * 3100);
    double * const INT__l_s_f_s = work + (SIMINT_NSHELL_SIMD * 3370);
    double * const INT__l_s_g_s = work + (SIMINT_NSHELL_SIMD * 3820);
    ...
    double * const HRR_INT__g_f_f_s = hrrwork + 5085;
    double * const HRR_INT__g_f_g_s = hrrwork + 6585;
    double * const HRR_INT__g_g_d_s = hrrwork + 8835;
    double * const HRR_INT__g_g_d_p = hrrwork + 10185;
    double * const HRR_INT__g_g_f_s = hrrwork + 14235;
    double * const HRR_INT__g_g_f_p = hrrwork + 16485;
    double * const HRR_INT__g_g_g_s = hrrwork + 23235;
    double * const HRR_INT__h_p_d_s = hrrwork + 26610;
    double * const HRR_INT__h_p_f_s = hrrwork + 26988;
    double * const HRR_INT__h_p_g_s = hrrwork + 27618;
    double * const HRR_INT__h_d_d_s = hrrwork + 28563;
    double * const HRR_INT__h_d_f_s = hrrwork + 29319;
    double * const HRR_INT__h_d_g_s = hrrwork + 30579;
    double * const HRR_INT__h_f_d_s = hrrwork + 32469;
    double * const HRR_INT__h_f_f_s = hrrwork + 33729;
    double * const HRR_INT__h_f_g_s = hrrwork + 35829;
    double * const HRR_INT__i_p_d_s = hrrwork + 38979;
    double * const HRR_INT__i_p_f_s = hrrwork + 39483;
    double * const HRR_INT__i_p_g_s = hrrwork + 40323;
    double * const HRR_INT__i_d_d_s = hrrwork + 41583;
    double * const HRR_INT__i_d_f_s = hrrwork + 42591;
    double * const HRR_INT__i_d_g_s = hrrwork + 44271;
    double * const HRR_INT__k_p_d_s = hrrwork + 46791;
    double * const HRR_INT__k_p_f_s = hrrwork + 47439;
    double * const HRR_INT__k_p_g_s = hrrwork + 48519;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__g_g_d_d = INT__g_g_d_d + real_abcd * 8100;
                ...
                for(ibra = 0; ibra < 225; ++ibra)
                {
                    HRR_INT__g_g_d_d[ibra * 36 + 0] = HRR_INT__g_g_f_p[ibra * 30 + 0] + ( hCD[0] * HRR_INT__g_g_d_p[ibra * 18 + 0] );

                    HRR_INT__g_g_d_d[ibra * 36 + 1] = HRR_INT__g_g_f_p[ibra * 30 + 3] + ( hCD[1] * HRR_INT__g_g_d_p[ibra * 18 + 0] );

                    HRR_INT__g_g_d_d[ibra * 36 + 2] = HRR_INT__g_g_f_p[ibra * 30 + 6] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 0] );

                    HRR_INT__g_g_d_d[ibra * 36 + 3] = HRR_INT__g_g_f_p[ibra * 30 + 4] + ( hCD[1] * HRR_INT__g_g_d_p[ibra * 18 + 1] );

                    HRR_INT__g_g_d_d[ibra * 36 + 4] = HRR_INT__g_g_f_p[ibra * 30 + 7] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 1] );

                    HRR_INT__g_g_d_d[ibra * 36 + 5] = HRR_INT__g_g_f_p[ibra * 30 + 8] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 2] );

                    HRR_INT__g_g_d_d[ibra * 36 + 6] = HRR_INT__g_g_f_p[ibra * 30 + 3] + ( hCD[0] * HRR_INT__g_g_d_p[ibra * 18 + 3] );

                    HRR_INT__g_g_d_d[ibra * 36 + 7] = HRR_INT__g_g_f_p[ibra * 30 + 9] + ( hCD[1] * HRR_INT__g_g_d_p[ibra * 18 + 3] );

                    HRR_INT__g_g_d_d[ibra * 36 + 8] = HRR_INT__g_g_f_p[ibra * 30 + 12] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 3] );

                    HRR_INT__g_g_d_d[ibra * 36 + 9] = HRR_INT__g_g_f_p[ibra * 30 + 10] + ( hCD[1] * HRR_INT__g_g_d_p[ibra * 18 + 4] );

                    HRR_INT__g_g_d_d[ibra * 36 + 10] = HRR_INT__g_g_f_p[ibra * 30 + 13] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 4] );

                    HRR_INT__g_g_d_d[ibra * 36 + 11] = HRR_INT__g_g_f_p[ibra * 30 + 14] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 5] );

                    HRR_INT__g_g_d_d[ibra * 36 + 12] = HRR_INT__g_g_f_p[ibra * 30 + 6] + ( hCD[0] * HRR_INT__g_g_d_p[ibra * 18 + 6] );

                    HRR_INT__g_g_d_d[ibra * 36 + 13] = HRR_INT__g_g_f_p[ibra * 30 + 12] + ( hCD[1] * HRR_INT__g_g_d_p[ibra * 18 + 6] );

                    HRR_INT__g_g_d_d[ibra * 36 + 14] = HRR_INT__g_g_f_p[ibra * 30 + 15] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 6] );

                    HRR_INT__g_g_d_d[ibra * 36 + 15] = HRR_INT__g_g_f_p[ibra * 30 + 13] + ( hCD[1] * HRR_INT__g_g_d_p[ibra * 18 + 7] );

                    HRR_INT__g_g_d_d[ibra * 36 + 16] = HRR_INT__g_g_f_p[ibra * 30 + 16] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 7] );

                    HRR_INT__g_g_d_d[ibra * 36 + 17] = HRR_INT__g_g_f_p[ibra * 30 + 17] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 8] );

                    HRR_INT__g_g_d_d[ibra * 36 + 18] = HRR_INT__g_g_f_p[ibra * 30 + 9] + ( hCD[0] * HRR_INT__g_g_d_p[ibra * 18 + 9] );

                    HRR_INT__g_g_d_d[ibra * 36 + 19] = HRR_INT__g_g_f_p[ibra * 30 + 18] + ( hCD[1] * HRR_INT__g_g_d_p[ibra * 18 + 9] );

                    HRR_INT__g_g_d_d[ibra * 36 + 20] = HRR_INT__g_g_f_p[ibra * 30 + 21] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 9] );

                    HRR_INT__g_g_d_d[ibra * 36 + 21] = HRR_INT__g_g_f_p[ibra * 30 + 19] + ( hCD[1] * HRR_INT__g_g_d_p[ibra * 18 + 10] );

                    HRR_INT__g_g_d_d[ibra * 36 + 22] = HRR_INT__g_g_f_p[ibra * 30 + 22] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 10] );

                    HRR_INT__g_g_d_d[ibra * 36 + 23] = HRR_INT__g_g_f_p[ibra * 30 + 23] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 11] );

                    HRR_INT__g_g_d_d[ibra * 36 + 24] = HRR_INT__g_g_f_p[ibra * 30 + 12] + ( hCD[0] * HRR_INT__g_g_d_p[ibra * 18 + 12] );

                    HRR_INT__g_g_d_d[ibra * 36 + 25] = HRR_INT__g_g_f_p[ibra * 30 + 21] + ( hCD[1] * HRR_INT__g_g_d_p[ibra * 18 + 12] );

                    HRR_INT__g_g_d_d[ibra * 36 + 26] = HRR_INT__g_g_f_p[ibra * 30 + 24] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 12] );

                    HRR_INT__g_g_d_d[ibra * 36 + 27] = HRR_INT__g_g_f_p[ibra * 30 + 22] + ( hCD[1] * HRR_INT__g_g_d_p[ibra * 18 + 13] );

                    HRR_INT__g_g_d_d[ibra * 36 + 28] = HRR_INT__g_g_f_p[ibra * 30 + 25] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 13] );

                    HRR_INT__g_g_d_d[ibra * 36 + 29] = HRR_INT__g_g_f_p[ibra * 30 + 26] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 14] );

                    HRR_INT__g_g_d_d[ibra * 36 + 30] = HRR_INT__g_g_f_p[ibra * 30 + 15] + ( hCD[0] * HRR_INT__g_g_d_p[ibra * 18 + 15] );

                    HRR_INT__g_g_d_d[ibra * 36 + 31] = HRR_INT__g_g_f_p[ibra * 30 + 24] + ( hCD[1] * HRR_INT__g_g_d_p[ibra * 18 + 15] );

                    HRR_INT__g_g_d_d[ibra * 36 + 32] = HRR_INT__g_g_f_p[ibra * 30 + 27] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 15] );

                    HRR_INT__g_g_d_d[ibra * 36 + 33] = HRR_INT__g_g_f_p[ibra * 30 + 25] + ( hCD[1] * HRR_INT__g_g_d_p[ibra * 18 + 16] );

                    HRR_INT__g_g_d_d[ibra * 36 + 34] = HRR_INT__g_g_f_p[ibra * 30 + 28] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 16] );

                    HRR_INT__g_g_d_d[ibra * 36 + 35] = HRR_INT__g_g_f_p[ibra * 30 + 29] + ( hCD[2] * HRR_INT__g_g_d_p[ibra * 18 + 17] );
