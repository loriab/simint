                  ...
                  double * const restrict INT__f_f_s_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_f_s_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    // partition workspace
    double * const INT__f_s_s_p = work + (SIMINT_NSHELL_SIMD * 0);
    double * const INT__g_s_s_p = work + (SIMINT_NSHELL_SIMD * 30);
    double * const INT__h_s_s_p = work + (SIMINT_NSHELL_SIMD * 75);
    double * const INT__i_s_s_p = work + (SIMINT_NSHELL_SIMD * 138);
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*222);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 65;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_p = primwork + 115;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 145;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_p = primwork + 205;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 250;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_p = primwork + 313;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 376;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_p = primwork + 432;
    double * const hrrwork = (double *)(primwork + 516);
    double * const HRR_INT__f_p_s_p = hrrwork + 0;
    double * const HRR_INT__f_d_s_p = hrrwork + 90;
    double * const HRR_INT__g_p_s_p = hrrwork + 270;
    double * const HRR_INT__g_d_s_p = hrrwork + 405;
    double * const HRR_INT__h_p_s_p = hrrwork + 675;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 222 * sizeof(double));
            abcd = 0;
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                double * restrict PRIM_PTR_INT__h_s_s_p = INT__h_s_s_p + abcd * 63;
                double * restrict PRIM_PTR_INT__i_s_s_p = INT__i_s_s_p + abcd * 84;
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    if((iprimcd + SIMINT_SIMD_LEN) >= nprim_icd)
                    {
                        ...
                        if(iprimcd >= nprim_icd && ((icd+1) < nshellbatch))
                        {
                            ...
                            PRIM_PTR_INT__h_s_s_p += 63;
                            PRIM_PTR_INT__i_s_s_p += 84;
                        }
                        iprimcd++;
                    ...
                    if(check_screen)
                    {
                        ...
                        if(vmax < screen_tol)
                        {
                            ...
                            PRIM_PTR_INT__h_s_s_p += lastoffset*63;
                            PRIM_PTR_INT__i_s_s_p += lastoffset*84;
                            continue;
                        }
                    }
                    ...
                    if(lastoffset == 0)
                    {
                        ...
                        contract_all(63, PRIM_INT__h_s_s_p, PRIM_PTR_INT__h_s_s_p);
                        contract_all(84, PRIM_INT__i_s_s_p, PRIM_PTR_INT__i_s_s_p);
                    }
                    else
                    {
                        ...
                        contract(63, shelloffsets, PRIM_INT__h_s_s_p, PRIM_PTR_INT__h_s_s_p);
                        contract(84, shelloffsets, PRIM_INT__i_s_s_p, PRIM_PTR_INT__i_s_s_p);
                        PRIM_PTR_INT__f_s_s_p += lastoffset*30;
                        PRIM_PTR_INT__g_s_s_p += lastoffset*45;
                        PRIM_PTR_INT__h_s_s_p += lastoffset*63;
                        PRIM_PTR_INT__i_s_s_p += lastoffset*84;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double const * restrict HRR_INT__h_s_s_p = INT__h_s_s_p + abcd * 63;
                double const * restrict HRR_INT__i_s_s_p = INT__i_s_s_p + abcd * 84;
                double * restrict HRR_INT__f_f_s_p = INT__f_f_s_p + real_abcd * 300;
                ...
                for(iket = 0; iket < 3; ++iket)
                {
                    ...
                    HRR_INT__f_p_s_p[1 * 3 + iket] = HRR_INT__g_s_s_p[1 * 3 + iket] + ( hAB[1] * HRR_INT__f_s_s_p[0 * 3 + iket] );

                    HRR_INT__f_p_s_p[2 * 3 + iket] = HRR_INT__g_s_s_p[2 * 3 + iket] + ( hAB[2] * HRR_INT__f_s_s_p[0 * 3 + iket] );
                    ...
                    HRR_INT__f_p_s_p[5 * 3 + iket] = HRR_INT__g_s_s_p[4 * 3 + iket] + ( hAB[2] * HRR_INT__f_s_s_p[1 * 3 + iket] );
                    ...
                    HRR_INT__f_p_s_p[11 * 3 + iket] = HRR_INT__g_s_s_p[7 * 3 + iket] + ( hAB[2] * HRR_INT__f_s_s_p[3 * 3 + iket] );
                    ...
                    HRR_INT__f_p_s_p[20 * 3 + iket] = HRR_INT__g_s_s_p[11 * 3 + iket] + ( hAB[2] * HRR_INT__f_s_s_p[6 * 3 + iket] );
