                  ...
                  double * const restrict INT__d_f_p_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_f_p_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_h_s_f = work + (SIMINT_NSHELL_SIMD * 625);
    double * const INT__s_h_s_g = work + (SIMINT_NSHELL_SIMD * 835);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_p = primwork + 49;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_d = primwork + 85;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_s = primwork + 139;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_p = primwork + 187;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_d = primwork + 259;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_f = primwork + 367;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_s = primwork + 487;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_p = primwork + 557;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_d = primwork + 677;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_f = primwork + 857;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_g = primwork + 1057;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_s = primwork + 1207;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_p = primwork + 1297;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_d = primwork + 1477;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_f = primwork + 1747;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_g = primwork + 2047;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_s_s = primwork + 2272;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_s_p = primwork + 2377;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_s_d = primwork + 2629;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_s_f = primwork + 3007;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_s_g = primwork + 3427;
    ...
    double * const HRR_INT__p_g_s_g = hrrwork + 1200;
    double * const HRR_INT__d_f_s_f = hrrwork + 1875;
    double * const HRR_INT__d_f_s_g = hrrwork + 2475;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_f_p_f = INT__d_f_p_f + real_abcd * 1800;
