                  ...
                  double * const restrict INT__f_d_f_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_d_f_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 80;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 125;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 197;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 287;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 341;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 431;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 575;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 755;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 935;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 1015;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 1165;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 1405;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 1705;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_h_s = primwork + 2005;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 2215;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 2320;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 2545;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 2905;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 3355;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 3805;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 4120;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 4246;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_d_s = primwork + 4561;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_f_s = primwork + 5065;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_g_s = primwork + 5695;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_h_s = primwork + 6325;
    ...
    double * const HRR_INT__f_d_f_p = hrrwork + 1980;
    double * const HRR_INT__f_d_g_s = hrrwork + 3780;
    double * const HRR_INT__f_d_g_p = hrrwork + 4680;
    double * const HRR_INT__f_d_h_s = hrrwork + 7380;
    double * const HRR_INT__g_p_f_s = hrrwork + 8640;
    double * const HRR_INT__g_p_g_s = hrrwork + 9090;
    double * const HRR_INT__g_p_h_s = hrrwork + 9765;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_d_f_d = INT__f_d_f_d + real_abcd * 3600;
