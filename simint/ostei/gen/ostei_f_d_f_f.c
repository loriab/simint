                  ...
                  double * const restrict INT__f_d_f_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_d_f_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__f_s_i_s = work + (SIMINT_NSHELL_SIMD * 460);
    double * const INT__g_s_f_s = work + (SIMINT_NSHELL_SIMD * 740);
    double * const INT__g_s_g_s = work + (SIMINT_NSHELL_SIMD * 890);
    double * const INT__g_s_h_s = work + (SIMINT_NSHELL_SIMD * 1115);
    double * const INT__g_s_i_s = work + (SIMINT_NSHELL_SIMD * 1430);
    double * const INT__h_s_f_s = work + (SIMINT_NSHELL_SIMD * 1850);
    double * const INT__h_s_g_s = work + (SIMINT_NSHELL_SIMD * 2060);
    double * const INT__h_s_h_s = work + (SIMINT_NSHELL_SIMD * 2375);
    double * const INT__h_s_i_s = work + (SIMINT_NSHELL_SIMD * 2816);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 630;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 645;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 690;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 780;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_g_s = primwork + 930;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_h_s = primwork + 1155;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_i_s = primwork + 1470;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 1890;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 1914;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 1986;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 2130;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 2370;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_h_s = primwork + 2730;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_i_s = primwork + 3234;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 3906;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 3996;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 4176;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 4476;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_h_s = primwork + 4926;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_i_s = primwork + 5556;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 6396;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 6576;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 6876;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 7326;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_i_s = primwork + 7956;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_f_s = primwork + 8796;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_g_s = primwork + 9006;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_h_s = primwork + 9321;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_i_s = primwork + 9762;
    ...
    double * const HRR_INT__f_p_i_s = hrrwork + 1380;
    double * const HRR_INT__f_d_f_s = hrrwork + 2220;
    double * const HRR_INT__f_d_f_p = hrrwork + 2820;
    double * const HRR_INT__f_d_f_d = hrrwork + 4620;
    double * const HRR_INT__f_d_g_s = hrrwork + 8220;
    double * const HRR_INT__f_d_g_p = hrrwork + 9120;
    double * const HRR_INT__f_d_g_d = hrrwork + 11820;
    double * const HRR_INT__f_d_h_s = hrrwork + 17220;
    double * const HRR_INT__f_d_h_p = hrrwork + 18480;
    double * const HRR_INT__f_d_i_s = hrrwork + 22260;
    double * const HRR_INT__g_p_f_s = hrrwork + 23940;
    double * const HRR_INT__g_p_g_s = hrrwork + 24390;
    double * const HRR_INT__g_p_h_s = hrrwork + 25065;
    double * const HRR_INT__g_p_i_s = hrrwork + 26010;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    for(n = 0; n < 3; ++n)  // loop over orders of auxiliary function
                    {
                        ...
                        PRIM_INT__f_s_p_s[n * 30 + 6] = SIMINT_MUL(P_PA[2], PRIM_INT__d_s_p_s[n * 18 + 0]);
                        PRIM_INT__f_s_p_s[n * 30 + 6] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 0], PRIM_INT__f_s_p_s[n * 30 + 6]);

                        PRIM_INT__f_s_p_s[n * 30 + 7] = SIMINT_MUL(P_PA[2], PRIM_INT__d_s_p_s[n * 18 + 1]);
                        PRIM_INT__f_s_p_s[n * 30 + 7] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 1], PRIM_INT__f_s_p_s[n * 30 + 7]);

                        PRIM_INT__f_s_p_s[n * 30 + 8] = SIMINT_MUL(P_PA[2], PRIM_INT__d_s_p_s[n * 18 + 2]);
                        PRIM_INT__f_s_p_s[n * 30 + 8] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 2], PRIM_INT__f_s_p_s[n * 30 + 8]);
                        ...
                        PRIM_INT__f_s_p_s[n * 30 + 21] = SIMINT_MUL(P_PA[2], PRIM_INT__d_s_p_s[n * 18 + 9]);
                        PRIM_INT__f_s_p_s[n * 30 + 21] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 9], PRIM_INT__f_s_p_s[n * 30 + 21]);

                        PRIM_INT__f_s_p_s[n * 30 + 22] = SIMINT_MUL(P_PA[2], PRIM_INT__d_s_p_s[n * 18 + 10]);
                        PRIM_INT__f_s_p_s[n * 30 + 22] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 10], PRIM_INT__f_s_p_s[n * 30 + 22]);

                        PRIM_INT__f_s_p_s[n * 30 + 23] = SIMINT_MUL(P_PA[2], PRIM_INT__d_s_p_s[n * 18 + 11]);
                        PRIM_INT__f_s_p_s[n * 30 + 23] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 11], PRIM_INT__f_s_p_s[n * 30 + 23]);
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_d_f_f = INT__f_d_f_f + real_abcd * 6000;
                ...
                for(ibra = 0; ibra < 60; ++ibra)
                {
                    ...
                    HRR_INT__f_d_f_p[ibra * 30 + 1] = HRR_INT__f_d_g_s[ibra * 15 + 1] + ( hCD[1] * HRR_INT__f_d_f_s[ibra * 10 + 0] );

                    HRR_INT__f_d_f_p[ibra * 30 + 2] = HRR_INT__f_d_g_s[ibra * 15 + 2] + ( hCD[2] * HRR_INT__f_d_f_s[ibra * 10 + 0] );
                    ...
                    HRR_INT__f_d_f_p[ibra * 30 + 5] = HRR_INT__f_d_g_s[ibra * 15 + 4] + ( hCD[2] * HRR_INT__f_d_f_s[ibra * 10 + 1] );
                    ...
                    HRR_INT__f_d_f_p[ibra * 30 + 11] = HRR_INT__f_d_g_s[ibra * 15 + 7] + ( hCD[2] * HRR_INT__f_d_f_s[ibra * 10 + 3] );
                    ...
                    HRR_INT__f_d_f_p[ibra * 30 + 20] = HRR_INT__f_d_g_s[ibra * 15 + 11] + ( hCD[2] * HRR_INT__f_d_f_s[ibra * 10 + 6] );
