                  ...
                  double * const restrict INT__g_g_g_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_g_g_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__k_s_g_s = work + (SIMINT_NSHELL_SIMD * 4096);
    double * const INT__k_s_h_s = work + (SIMINT_NSHELL_SIMD * 4636);
    double * const INT__k_s_i_s = work + (SIMINT_NSHELL_SIMD * 5392);
    double * const INT__l_s_g_s = work + (SIMINT_NSHELL_SIMD * 6400);
    double * const INT__l_s_h_s = work + (SIMINT_NSHELL_SIMD * 7075);
    double * const INT__l_s_i_s = work + (SIMINT_NSHELL_SIMD * 8020);
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*9280);
    ...
    double * const HRR_INT__g_d_h_s = hrrwork + 4230;
    double * const HRR_INT__g_d_i_s = hrrwork + 6120;
    double * const HRR_INT__g_f_g_s = hrrwork + 8640;
    double * const HRR_INT__g_f_h_s = hrrwork + 10890;
    double * const HRR_INT__g_f_i_s = hrrwork + 14040;
    double * const HRR_INT__g_g_g_s = hrrwork + 18240;
    double * const HRR_INT__g_g_g_p = hrrwork + 21615;
    double * const HRR_INT__g_g_h_s = hrrwork + 31740;
    double * const HRR_INT__g_g_h_p = hrrwork + 36465;
    double * const HRR_INT__g_g_i_s = hrrwork + 50640;
    double * const HRR_INT__h_p_g_s = hrrwork + 56940;
    double * const HRR_INT__h_p_h_s = hrrwork + 57885;
    double * const HRR_INT__h_p_i_s = hrrwork + 59208;
    double * const HRR_INT__h_d_g_s = hrrwork + 60972;
    double * const HRR_INT__h_d_h_s = hrrwork + 62862;
    double * const HRR_INT__h_d_i_s = hrrwork + 65508;
    double * const HRR_INT__h_f_g_s = hrrwork + 69036;
    double * const HRR_INT__h_f_h_s = hrrwork + 72186;
    double * const HRR_INT__h_f_i_s = hrrwork + 76596;
    double * const HRR_INT__i_p_g_s = hrrwork + 82476;
    double * const HRR_INT__i_p_h_s = hrrwork + 83736;
    double * const HRR_INT__i_p_i_s = hrrwork + 85500;
    double * const HRR_INT__i_d_g_s = hrrwork + 87852;
    double * const HRR_INT__i_d_h_s = hrrwork + 90372;
    double * const HRR_INT__i_d_i_s = hrrwork + 93900;
    double * const HRR_INT__k_p_g_s = hrrwork + 98604;
    double * const HRR_INT__k_p_h_s = hrrwork + 100224;
    double * const HRR_INT__k_p_i_s = hrrwork + 102492;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 9280 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__g_g_g_d = INT__g_g_g_d + real_abcd * 20250;
                  ...
                  double * const restrict INT__g_g_d_g)
{
    ...
    int ret = ostei_g_g_g_d(P, Q_tmp, screen_tol, work, INT__g_g_d_g);
    double buffer[20250] SIMINT_ALIGN_ARRAY_DBL;
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 6; ++c)
        for(int d = 0; d < 15; ++d)
            buffer[idx++] = INT__g_g_d_g[q*20250+a*1350+b*90+d*6+c];

        memcpy(INT__g_g_d_g+q*20250, buffer, 20250*sizeof(double));
    }
