                  ...
                  double * const restrict INT__g_s_s_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_s_s_s);
    memset(INT__g_s_s_s, 0, P.nshell12_clip * Q.nshell12_clip * 15 * sizeof(double));
                  ...
                  double * const restrict INT__s_g_s_s)
{
    ...
    int ret = ostei_g_s_s_s(P_tmp, Q, screen_tol, work, INT__s_g_s_s);
