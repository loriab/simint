                  ...
                  double * const restrict INT__s_s_g_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_s_g_s);
    memset(INT__s_s_g_s, 0, P.nshell12_clip * Q.nshell12_clip * 15 * sizeof(double));
                  ...
                  double * const restrict INT__s_s_s_g)
{
    ...
    int ret = ostei_s_s_g_s(P, Q_tmp, screen_tol, work, INT__s_s_s_g);
