                  ...
                  double * const restrict INT__s_d_s_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_d_s_d);
    memset(INT__s_d_s_d, 0, P.nshell12_clip * Q.nshell12_clip * 36 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_p = primwork + 17;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_s = primwork + 35;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_p = primwork + 53;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_d = primwork + 89;
