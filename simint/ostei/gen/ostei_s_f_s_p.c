                  ...
                  double * const restrict INT__s_f_s_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_f_s_p);
    memset(INT__s_f_s_p, 0, P.nshell12_clip * Q.nshell12_clip * 30 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_p = primwork + 55;
