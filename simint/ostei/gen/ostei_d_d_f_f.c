                  ...
                  double * const restrict INT__d_d_f_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_d_f_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__d_s_h_s = work + (SIMINT_NSHELL_SIMD * 150);
    double * const INT__d_s_i_s = work + (SIMINT_NSHELL_SIMD * 276);
    double * const INT__f_s_f_s = work + (SIMINT_NSHELL_SIMD * 444);
    double * const INT__f_s_g_s = work + (SIMINT_NSHELL_SIMD * 544);
    double * const INT__f_s_h_s = work + (SIMINT_NSHELL_SIMD * 694);
    double * const INT__f_s_i_s = work + (SIMINT_NSHELL_SIMD * 904);
    double * const INT__g_s_f_s = work + (SIMINT_NSHELL_SIMD * 1184);
    double * const INT__g_s_g_s = work + (SIMINT_NSHELL_SIMD * 1334);
    double * const INT__g_s_h_s = work + (SIMINT_NSHELL_SIMD * 1559);
    double * const INT__g_s_i_s = work + (SIMINT_NSHELL_SIMD * 1874);
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*2294);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 546;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 558;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 594;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 666;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_g_s = primwork + 786;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_h_s = primwork + 966;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_i_s = primwork + 1218;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 1554;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 1608;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 1716;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 1896;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_h_s = primwork + 2166;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_i_s = primwork + 2544;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 3048;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 3168;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 3368;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_h_s = primwork + 3668;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_i_s = primwork + 4088;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 4648;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 4798;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 5023;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_i_s = primwork + 5338;
    ...
    double * const HRR_INT__d_p_h_s = hrrwork + 450;
    double * const HRR_INT__d_p_i_s = hrrwork + 828;
    double * const HRR_INT__d_d_f_s = hrrwork + 1332;
    double * const HRR_INT__d_d_f_p = hrrwork + 1692;
    double * const HRR_INT__d_d_f_d = hrrwork + 2772;
    double * const HRR_INT__d_d_g_s = hrrwork + 4932;
    double * const HRR_INT__d_d_g_p = hrrwork + 5472;
    double * const HRR_INT__d_d_g_d = hrrwork + 7092;
    double * const HRR_INT__d_d_h_s = hrrwork + 10332;
    double * const HRR_INT__d_d_h_p = hrrwork + 11088;
    double * const HRR_INT__d_d_i_s = hrrwork + 13356;
    double * const HRR_INT__f_p_f_s = hrrwork + 14364;
    double * const HRR_INT__f_p_g_s = hrrwork + 14664;
    double * const HRR_INT__f_p_h_s = hrrwork + 15114;
    double * const HRR_INT__f_p_i_s = hrrwork + 15744;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 2294 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_d_f_f = INT__d_d_f_f + real_abcd * 3600;
