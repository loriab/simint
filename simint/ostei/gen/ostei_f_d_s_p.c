                  ...
                  double * const restrict INT__f_d_s_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_d_s_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_p = primwork + 95;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 125;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_p = primwork + 170;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 215;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_p = primwork + 257;
    double * const hrrwork = (double *)(primwork + 320);
    double * const HRR_INT__f_p_s_p = hrrwork + 0;
    double * const HRR_INT__g_p_s_p = hrrwork + 90;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_d_s_p = INT__f_d_s_p + real_abcd * 180;
