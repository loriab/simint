                  ...
                  double * const restrict INT__d_s_g_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_s_g_s);
    memset(INT__d_s_g_s, 0, P.nshell12_clip * Q.nshell12_clip * 90 * sizeof(double));
                  ...
                  double * const restrict INT__s_d_g_s)
{
    ...
    int ret = ostei_d_s_g_s(P_tmp, Q, screen_tol, work, INT__s_d_g_s);
                  ...
                  double * const restrict INT__d_s_s_g)
{
    ...
    int ret = ostei_d_s_g_s(P, Q_tmp, screen_tol, work, INT__d_s_s_g);
                  ...
                  double * const restrict INT__s_d_s_g)
{
    ...
    int ret = ostei_d_s_g_s(P_tmp, Q_tmp, screen_tol, work, INT__s_d_s_g);
