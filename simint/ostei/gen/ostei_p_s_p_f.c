                  ...
                  double * const restrict INT__p_s_p_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_s_p_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_f = primwork + 105;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_g = primwork + 135;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_s_p_f = INT__p_s_p_f + real_abcd * 90;
