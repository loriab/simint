                  ...
                  double * const restrict INT__p_d_p_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_d_p_s);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_f_p_s = work + (SIMINT_NSHELL_SIMD * 18);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_p_s = primwork + 35;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_s = primwork + 53;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_p_s = primwork + 73;
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    // Forming PRIM_INT__s_d_p_s[1 * 18];
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_d_p_s = INT__p_d_p_s + real_abcd * 54;
