                  ...
                  double * const restrict INT__p_s_f_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_s_f_s);
    memset(INT__p_s_f_s, 0, P.nshell12_clip * Q.nshell12_clip * 30 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 55;
