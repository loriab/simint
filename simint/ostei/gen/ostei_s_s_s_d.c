                  ...
                  double * const restrict INT__s_s_s_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_s_s_d);
    memset(INT__s_s_s_d, 0, P.nshell12_clip * Q.nshell12_clip * 6 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_p = primwork + 3;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_d = primwork + 9;
