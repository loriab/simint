                  ...
                  double * const restrict INT__f_f_s_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_f_s_s);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__i_s_s_s = work + (SIMINT_NSHELL_SIMD * 46);
    ...
    double * const HRR_INT__f_d_s_s = hrrwork + 30;
    double * const HRR_INT__g_p_s_s = hrrwork + 90;
    double * const HRR_INT__g_d_s_s = hrrwork + 135;
    double * const HRR_INT__h_p_s_s = hrrwork + 225;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_f_s_s = INT__f_f_s_s + real_abcd * 100;
