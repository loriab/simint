                  ...
                  double * const restrict INT__s_d_f_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_d_f_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_d_s = primwork + 378;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_f_s = primwork + 414;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_g_s = primwork + 474;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_h_s = primwork + 564;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_i_s = primwork + 690;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_f_s = primwork + 858;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_g_s = primwork + 918;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_h_s = primwork + 1008;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_i_s = primwork + 1134;
    double * const hrrwork = (double *)(primwork + 1302);
    double * const HRR_INT__s_d_f_p = hrrwork + 0;
    double * const HRR_INT__s_d_f_d = hrrwork + 180;
    double * const HRR_INT__s_d_g_p = hrrwork + 540;
    double * const HRR_INT__s_d_g_d = hrrwork + 810;
    double * const HRR_INT__s_d_h_p = hrrwork + 1350;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__s_d_f_f = INT__s_d_f_f + real_abcd * 600;
                ...
                for(ibra = 0; ibra < 6; ++ibra)
                {
                    ...
                    HRR_INT__s_d_f_p[ibra * 30 + 1] = HRR_INT__s_d_g_s[ibra * 15 + 1] + ( hCD[1] * HRR_INT__s_d_f_s[ibra * 10 + 0] );

                    HRR_INT__s_d_f_p[ibra * 30 + 2] = HRR_INT__s_d_g_s[ibra * 15 + 2] + ( hCD[2] * HRR_INT__s_d_f_s[ibra * 10 + 0] );
                    ...
                    HRR_INT__s_d_f_p[ibra * 30 + 5] = HRR_INT__s_d_g_s[ibra * 15 + 4] + ( hCD[2] * HRR_INT__s_d_f_s[ibra * 10 + 1] );
                    ...
                    HRR_INT__s_d_f_p[ibra * 30 + 11] = HRR_INT__s_d_g_s[ibra * 15 + 7] + ( hCD[2] * HRR_INT__s_d_f_s[ibra * 10 + 3] );
                    ...
                    HRR_INT__s_d_f_p[ibra * 30 + 20] = HRR_INT__s_d_g_s[ibra * 15 + 11] + ( hCD[2] * HRR_INT__s_d_f_s[ibra * 10 + 6] );
