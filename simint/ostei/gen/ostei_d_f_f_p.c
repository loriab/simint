                  ...
                  double * const restrict INT__d_f_f_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_f_f_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_h_f_s = work + (SIMINT_NSHELL_SIMD * 625);
    double * const INT__s_h_g_s = work + (SIMINT_NSHELL_SIMD * 835);
    ...
    double * const HRR_INT__p_g_g_s = hrrwork + 1200;
    double * const HRR_INT__d_f_f_s = hrrwork + 1875;
    double * const HRR_INT__d_f_g_s = hrrwork + 2475;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_f_f_p = INT__d_f_f_p + real_abcd * 1800;
