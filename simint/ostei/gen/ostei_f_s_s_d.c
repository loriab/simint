                  ...
                  double * const restrict INT__f_s_s_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_s_s_d);
    memset(INT__f_s_s_d, 0, P.nshell12_clip * Q.nshell12_clip * 60 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_p = primwork + 111;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_d = primwork + 171;
