                  ...
                  double * const restrict INT__p_f_s_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_f_s_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_p = primwork + 75;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_s = primwork + 105;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_p = primwork + 135;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_f_s_p = INT__p_f_s_p + real_abcd * 90;
