                  ...
                  double * const restrict INT__d_f_p_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_f_p_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_f_d_s = work + (SIMINT_NSHELL_SIMD * 30);
    double * const INT__s_g_p_s = work + (SIMINT_NSHELL_SIMD * 90);
    double * const INT__s_g_d_s = work + (SIMINT_NSHELL_SIMD * 135);
    double * const INT__s_h_p_s = work + (SIMINT_NSHELL_SIMD * 225);
    double * const INT__s_h_d_s = work + (SIMINT_NSHELL_SIMD * 288);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_s = primwork + 29;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_p_s = primwork + 65;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_s = primwork + 101;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_p_s = primwork + 151;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_d_s = primwork + 211;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_s = primwork + 271;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_p_s = primwork + 331;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_d_s = primwork + 421;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_s_s = primwork + 511;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_p_s = primwork + 574;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_d_s = primwork + 700;
    double * const hrrwork = (double *)(primwork + 826);
    double * const HRR_INT__p_f_p_s = hrrwork + 0;
    double * const HRR_INT__p_f_d_s = hrrwork + 90;
    double * const HRR_INT__p_g_p_s = hrrwork + 270;
    double * const HRR_INT__p_g_d_s = hrrwork + 405;
    double * const HRR_INT__d_f_p_s = hrrwork + 675;
    double * const HRR_INT__d_f_d_s = hrrwork + 855;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_f_p_p = INT__d_f_p_p + real_abcd * 540;
                ...
                {
                    HRR_INT__d_f_p_p[ibra * 9 + 0] = HRR_INT__d_f_d_s[ibra * 6 + 0] + ( hCD[0] * HRR_INT__d_f_p_s[ibra * 3 + 0] );

                    HRR_INT__d_f_p_p[ibra * 9 + 1] = HRR_INT__d_f_d_s[ibra * 6 + 1] + ( hCD[1] * HRR_INT__d_f_p_s[ibra * 3 + 0] );

                    HRR_INT__d_f_p_p[ibra * 9 + 2] = HRR_INT__d_f_d_s[ibra * 6 + 2] + ( hCD[2] * HRR_INT__d_f_p_s[ibra * 3 + 0] );

                    HRR_INT__d_f_p_p[ibra * 9 + 3] = HRR_INT__d_f_d_s[ibra * 6 + 1] + ( hCD[0] * HRR_INT__d_f_p_s[ibra * 3 + 1] );

                    HRR_INT__d_f_p_p[ibra * 9 + 4] = HRR_INT__d_f_d_s[ibra * 6 + 3] + ( hCD[1] * HRR_INT__d_f_p_s[ibra * 3 + 1] );

                    HRR_INT__d_f_p_p[ibra * 9 + 5] = HRR_INT__d_f_d_s[ibra * 6 + 4] + ( hCD[2] * HRR_INT__d_f_p_s[ibra * 3 + 1] );

                    HRR_INT__d_f_p_p[ibra * 9 + 6] = HRR_INT__d_f_d_s[ibra * 6 + 2] + ( hCD[0] * HRR_INT__d_f_p_s[ibra * 3 + 2] );

                    HRR_INT__d_f_p_p[ibra * 9 + 7] = HRR_INT__d_f_d_s[ibra * 6 + 4] + ( hCD[1] * HRR_INT__d_f_p_s[ibra * 3 + 2] );

                    HRR_INT__d_f_p_p[ibra * 9 + 8] = HRR_INT__d_f_d_s[ibra * 6 + 5] + ( hCD[2] * HRR_INT__d_f_p_s[ibra * 3 + 2] );
