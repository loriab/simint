                  ...
                  double * const restrict INT__f_f_f_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_f_f_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__i_s_f_s = work + (SIMINT_NSHELL_SIMD * 1150);
    double * const INT__i_s_g_s = work + (SIMINT_NSHELL_SIMD * 1430);
    ...
    double * const HRR_INT__f_f_f_s = hrrwork + 2250;
    double * const HRR_INT__f_f_g_s = hrrwork + 3250;
    double * const HRR_INT__g_p_f_s = hrrwork + 4750;
    double * const HRR_INT__g_p_g_s = hrrwork + 5200;
    double * const HRR_INT__g_d_f_s = hrrwork + 5875;
    double * const HRR_INT__g_d_g_s = hrrwork + 6775;
    double * const HRR_INT__h_p_f_s = hrrwork + 8125;
    double * const HRR_INT__h_p_g_s = hrrwork + 8755;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_f_f_p = INT__f_f_f_p + real_abcd * 3000;
