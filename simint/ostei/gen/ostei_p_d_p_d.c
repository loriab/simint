                  ...
                  double * const restrict INT__p_d_p_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_d_p_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_f_s_d = work + (SIMINT_NSHELL_SIMD * 96);
    double * const INT__s_f_s_f = work + (SIMINT_NSHELL_SIMD * 156);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_s = primwork + 16;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_p = primwork + 34;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_d = primwork + 61;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_s = primwork + 97;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_p = primwork + 127;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_d = primwork + 181;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_f = primwork + 253;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_s = primwork + 313;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_p = primwork + 353;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_d = primwork + 443;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_f = primwork + 563;
    double * const hrrwork = (double *)(primwork + 663);
    double * const HRR_INT__p_d_s_d = hrrwork + 0;
    double * const HRR_INT__p_d_s_f = hrrwork + 108;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    for(n = 0; n < 2; ++n)  // loop over orders of auxiliary function
                    {
                        ...
                        PRIM_INT__s_d_s_d[n * 36 + 2] = SIMINT_MUL(Q_PB[2], PRIM_INT__s_d_s_p[n * 18 + 0]);
                        PRIM_INT__s_d_s_d[n * 36 + 2] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_d_s_p[(n+1) * 18 + 0], PRIM_INT__s_d_s_d[n * 36 + 2]);
                        ...
                        PRIM_INT__s_d_s_d[n * 36 + 4] = SIMINT_MUL(Q_PB[2], PRIM_INT__s_d_s_p[n * 18 + 1]);
                        PRIM_INT__s_d_s_d[n * 36 + 4] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_d_s_p[(n+1) * 18 + 1], PRIM_INT__s_d_s_d[n * 36 + 4]);
                        ...
                        PRIM_INT__s_d_s_d[n * 36 + 8] = SIMINT_MUL(Q_PB[2], PRIM_INT__s_d_s_p[n * 18 + 3]);
                        PRIM_INT__s_d_s_d[n * 36 + 8] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_d_s_p[(n+1) * 18 + 3], PRIM_INT__s_d_s_d[n * 36 + 8]);
                        ...
                        PRIM_INT__s_d_s_d[n * 36 + 10] = SIMINT_MUL(Q_PB[2], PRIM_INT__s_d_s_p[n * 18 + 4]);
                        PRIM_INT__s_d_s_d[n * 36 + 10] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_d_s_p[(n+1) * 18 + 4], PRIM_INT__s_d_s_d[n * 36 + 10]);
                        ...
                        PRIM_INT__s_d_s_d[n * 36 + 14] = SIMINT_MUL(Q_PB[2], PRIM_INT__s_d_s_p[n * 18 + 6]);
                        PRIM_INT__s_d_s_d[n * 36 + 14] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_d_s_p[(n+1) * 18 + 6], PRIM_INT__s_d_s_d[n * 36 + 14]);
                        ...
                        PRIM_INT__s_d_s_d[n * 36 + 16] = SIMINT_MUL(Q_PB[2], PRIM_INT__s_d_s_p[n * 18 + 7]);
                        PRIM_INT__s_d_s_d[n * 36 + 16] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_d_s_p[(n+1) * 18 + 7], PRIM_INT__s_d_s_d[n * 36 + 16]);
                        ...
                        PRIM_INT__s_d_s_d[n * 36 + 20] = SIMINT_MUL(Q_PB[2], PRIM_INT__s_d_s_p[n * 18 + 9]);
                        PRIM_INT__s_d_s_d[n * 36 + 20] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_d_s_p[(n+1) * 18 + 9], PRIM_INT__s_d_s_d[n * 36 + 20]);
                        ...
                        PRIM_INT__s_d_s_d[n * 36 + 22] = SIMINT_MUL(Q_PB[2], PRIM_INT__s_d_s_p[n * 18 + 10]);
                        PRIM_INT__s_d_s_d[n * 36 + 22] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_d_s_p[(n+1) * 18 + 10], PRIM_INT__s_d_s_d[n * 36 + 22]);
                        ...
                        PRIM_INT__s_d_s_d[n * 36 + 26] = SIMINT_MUL(Q_PB[2], PRIM_INT__s_d_s_p[n * 18 + 12]);
                        PRIM_INT__s_d_s_d[n * 36 + 26] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_d_s_p[(n+1) * 18 + 12], PRIM_INT__s_d_s_d[n * 36 + 26]);
                        ...
                        PRIM_INT__s_d_s_d[n * 36 + 28] = SIMINT_MUL(Q_PB[2], PRIM_INT__s_d_s_p[n * 18 + 13]);
                        PRIM_INT__s_d_s_d[n * 36 + 28] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_d_s_p[(n+1) * 18 + 13], PRIM_INT__s_d_s_d[n * 36 + 28]);
                        ...
                        PRIM_INT__s_d_s_d[n * 36 + 32] = SIMINT_MUL(Q_PB[2], PRIM_INT__s_d_s_p[n * 18 + 15]);
                        PRIM_INT__s_d_s_d[n * 36 + 32] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_d_s_p[(n+1) * 18 + 15], PRIM_INT__s_d_s_d[n * 36 + 32]);
                        PRIM_INT__s_d_s_d[n * 36 + 32] = SIMINT_FMADD( vrr_const_2_over_2pq, PRIM_INT__s_p_s_p[(n+1) * 9 + 6], PRIM_INT__s_d_s_d[n * 36 + 32]);
                        ...
                        PRIM_INT__s_d_s_d[n * 36 + 34] = SIMINT_MUL(Q_PB[2], PRIM_INT__s_d_s_p[n * 18 + 16]);
                        PRIM_INT__s_d_s_d[n * 36 + 34] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__s_d_s_p[(n+1) * 18 + 16], PRIM_INT__s_d_s_d[n * 36 + 34]);
                        PRIM_INT__s_d_s_d[n * 36 + 34] = SIMINT_FMADD( vrr_const_2_over_2pq, PRIM_INT__s_p_s_p[(n+1) * 9 + 7], PRIM_INT__s_d_s_d[n * 36 + 34]);
                    ...
                    for(n = 0; n < 2; ++n)  // loop over orders of auxiliary function
                    {
                        ...
                        PRIM_INT__s_p_s_d[n * 18 + 1] = SIMINT_MUL(Q_PB[1], PRIM_INT__s_p_s_p[n * 9 + 0]);
                        PRIM_INT__s_p_s_d[n * 18 + 1] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__s_p_s_p[(n+1) * 9 + 0], PRIM_INT__s_p_s_d[n * 18 + 1]);
                        ...
                        PRIM_INT__s_p_s_d[n * 18 + 7] = SIMINT_MUL(Q_PB[1], PRIM_INT__s_p_s_p[n * 9 + 3]);
                        PRIM_INT__s_p_s_d[n * 18 + 7] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__s_p_s_p[(n+1) * 9 + 3], PRIM_INT__s_p_s_d[n * 18 + 7]);
                        ...
                        PRIM_INT__s_p_s_d[n * 18 + 13] = SIMINT_MUL(Q_PB[1], PRIM_INT__s_p_s_p[n * 9 + 6]);
                        PRIM_INT__s_p_s_d[n * 18 + 13] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__s_p_s_p[(n+1) * 9 + 6], PRIM_INT__s_p_s_d[n * 18 + 13]);
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_d_p_d = INT__p_d_p_d + real_abcd * 324;

                // form INT__p_d_s_d
                for(iket = 0; iket < 6; ++iket)
                {
                    HRR_INT__p_d_s_d[0 * 6 + iket] = HRR_INT__s_f_s_d[0 * 6 + iket] - ( hAB[0] * HRR_INT__s_d_s_d[0 * 6 + iket] );

                    HRR_INT__p_d_s_d[1 * 6 + iket] = HRR_INT__s_f_s_d[1 * 6 + iket] - ( hAB[0] * HRR_INT__s_d_s_d[1 * 6 + iket] );

                    HRR_INT__p_d_s_d[2 * 6 + iket] = HRR_INT__s_f_s_d[2 * 6 + iket] - ( hAB[0] * HRR_INT__s_d_s_d[2 * 6 + iket] );

                    HRR_INT__p_d_s_d[3 * 6 + iket] = HRR_INT__s_f_s_d[3 * 6 + iket] - ( hAB[0] * HRR_INT__s_d_s_d[3 * 6 + iket] );

                    HRR_INT__p_d_s_d[4 * 6 + iket] = HRR_INT__s_f_s_d[4 * 6 + iket] - ( hAB[0] * HRR_INT__s_d_s_d[4 * 6 + iket] );

                    HRR_INT__p_d_s_d[5 * 6 + iket] = HRR_INT__s_f_s_d[5 * 6 + iket] - ( hAB[0] * HRR_INT__s_d_s_d[5 * 6 + iket] );

                    HRR_INT__p_d_s_d[6 * 6 + iket] = HRR_INT__s_f_s_d[1 * 6 + iket] - ( hAB[1] * HRR_INT__s_d_s_d[0 * 6 + iket] );

                    HRR_INT__p_d_s_d[7 * 6 + iket] = HRR_INT__s_f_s_d[3 * 6 + iket] - ( hAB[1] * HRR_INT__s_d_s_d[1 * 6 + iket] );

                    HRR_INT__p_d_s_d[8 * 6 + iket] = HRR_INT__s_f_s_d[4 * 6 + iket] - ( hAB[1] * HRR_INT__s_d_s_d[2 * 6 + iket] );

                    HRR_INT__p_d_s_d[9 * 6 + iket] = HRR_INT__s_f_s_d[6 * 6 + iket] - ( hAB[1] * HRR_INT__s_d_s_d[3 * 6 + iket] );

                    HRR_INT__p_d_s_d[10 * 6 + iket] = HRR_INT__s_f_s_d[7 * 6 + iket] - ( hAB[1] * HRR_INT__s_d_s_d[4 * 6 + iket] );

                    HRR_INT__p_d_s_d[11 * 6 + iket] = HRR_INT__s_f_s_d[8 * 6 + iket] - ( hAB[1] * HRR_INT__s_d_s_d[5 * 6 + iket] );

                    HRR_INT__p_d_s_d[12 * 6 + iket] = HRR_INT__s_f_s_d[2 * 6 + iket] - ( hAB[2] * HRR_INT__s_d_s_d[0 * 6 + iket] );

                    HRR_INT__p_d_s_d[13 * 6 + iket] = HRR_INT__s_f_s_d[4 * 6 + iket] - ( hAB[2] * HRR_INT__s_d_s_d[1 * 6 + iket] );

                    HRR_INT__p_d_s_d[14 * 6 + iket] = HRR_INT__s_f_s_d[5 * 6 + iket] - ( hAB[2] * HRR_INT__s_d_s_d[2 * 6 + iket] );

                    HRR_INT__p_d_s_d[15 * 6 + iket] = HRR_INT__s_f_s_d[7 * 6 + iket] - ( hAB[2] * HRR_INT__s_d_s_d[3 * 6 + iket] );

                    HRR_INT__p_d_s_d[16 * 6 + iket] = HRR_INT__s_f_s_d[8 * 6 + iket] - ( hAB[2] * HRR_INT__s_d_s_d[4 * 6 + iket] );

                    HRR_INT__p_d_s_d[17 * 6 + iket] = HRR_INT__s_f_s_d[9 * 6 + iket] - ( hAB[2] * HRR_INT__s_d_s_d[5 * 6 + iket] );
                ...
                {
                    HRR_INT__p_d_p_d[ibra * 18 + 0] = HRR_INT__p_d_s_f[ibra * 10 + 0] - ( hCD[0] * HRR_INT__p_d_s_d[ibra * 6 + 0] );

                    HRR_INT__p_d_p_d[ibra * 18 + 1] = HRR_INT__p_d_s_f[ibra * 10 + 1] - ( hCD[0] * HRR_INT__p_d_s_d[ibra * 6 + 1] );

                    HRR_INT__p_d_p_d[ibra * 18 + 2] = HRR_INT__p_d_s_f[ibra * 10 + 2] - ( hCD[0] * HRR_INT__p_d_s_d[ibra * 6 + 2] );

                    HRR_INT__p_d_p_d[ibra * 18 + 3] = HRR_INT__p_d_s_f[ibra * 10 + 3] - ( hCD[0] * HRR_INT__p_d_s_d[ibra * 6 + 3] );

                    HRR_INT__p_d_p_d[ibra * 18 + 4] = HRR_INT__p_d_s_f[ibra * 10 + 4] - ( hCD[0] * HRR_INT__p_d_s_d[ibra * 6 + 4] );

                    HRR_INT__p_d_p_d[ibra * 18 + 5] = HRR_INT__p_d_s_f[ibra * 10 + 5] - ( hCD[0] * HRR_INT__p_d_s_d[ibra * 6 + 5] );

                    HRR_INT__p_d_p_d[ibra * 18 + 6] = HRR_INT__p_d_s_f[ibra * 10 + 1] - ( hCD[1] * HRR_INT__p_d_s_d[ibra * 6 + 0] );

                    HRR_INT__p_d_p_d[ibra * 18 + 7] = HRR_INT__p_d_s_f[ibra * 10 + 3] - ( hCD[1] * HRR_INT__p_d_s_d[ibra * 6 + 1] );

                    HRR_INT__p_d_p_d[ibra * 18 + 8] = HRR_INT__p_d_s_f[ibra * 10 + 4] - ( hCD[1] * HRR_INT__p_d_s_d[ibra * 6 + 2] );

                    HRR_INT__p_d_p_d[ibra * 18 + 9] = HRR_INT__p_d_s_f[ibra * 10 + 6] - ( hCD[1] * HRR_INT__p_d_s_d[ibra * 6 + 3] );

                    HRR_INT__p_d_p_d[ibra * 18 + 10] = HRR_INT__p_d_s_f[ibra * 10 + 7] - ( hCD[1] * HRR_INT__p_d_s_d[ibra * 6 + 4] );

                    HRR_INT__p_d_p_d[ibra * 18 + 11] = HRR_INT__p_d_s_f[ibra * 10 + 8] - ( hCD[1] * HRR_INT__p_d_s_d[ibra * 6 + 5] );

                    HRR_INT__p_d_p_d[ibra * 18 + 12] = HRR_INT__p_d_s_f[ibra * 10 + 2] - ( hCD[2] * HRR_INT__p_d_s_d[ibra * 6 + 0] );

                    HRR_INT__p_d_p_d[ibra * 18 + 13] = HRR_INT__p_d_s_f[ibra * 10 + 4] - ( hCD[2] * HRR_INT__p_d_s_d[ibra * 6 + 1] );

                    HRR_INT__p_d_p_d[ibra * 18 + 14] = HRR_INT__p_d_s_f[ibra * 10 + 5] - ( hCD[2] * HRR_INT__p_d_s_d[ibra * 6 + 2] );

                    HRR_INT__p_d_p_d[ibra * 18 + 15] = HRR_INT__p_d_s_f[ibra * 10 + 7] - ( hCD[2] * HRR_INT__p_d_s_d[ibra * 6 + 3] );

                    HRR_INT__p_d_p_d[ibra * 18 + 16] = HRR_INT__p_d_s_f[ibra * 10 + 8] - ( hCD[2] * HRR_INT__p_d_s_d[ibra * 6 + 4] );

                    HRR_INT__p_d_p_d[ibra * 18 + 17] = HRR_INT__p_d_s_f[ibra * 10 + 9] - ( hCD[2] * HRR_INT__p_d_s_d[ibra * 6 + 5] );
