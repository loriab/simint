                  ...
                  double * const restrict INT__s_d_p_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_d_p_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_d = primwork + 140;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_f = primwork + 176;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_g = primwork + 236;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_f = primwork + 326;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_g = primwork + 386;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__s_d_p_f = INT__s_d_p_f + real_abcd * 180;
