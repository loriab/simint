                  ...
                  double * const restrict INT__d_s_f_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_s_f_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 140;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 176;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_g_s = primwork + 236;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 326;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 386;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_s_f_p = INT__d_s_f_p + real_abcd * 180;
