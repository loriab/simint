                  ...
                  double * const restrict INT__s_d_s_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_d_s_f);
    memset(INT__s_d_s_f, 0, P.nshell12_clip * Q.nshell12_clip * 60 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_d = primwork + 75;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_f = primwork + 111;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_f = primwork + 171;
