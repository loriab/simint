                  ...
                  double * const restrict INT__d_f_f_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_f_f_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_h_f_s = work + (SIMINT_NSHELL_SIMD * 1850);
    double * const INT__s_h_g_s = work + (SIMINT_NSHELL_SIMD * 2060);
    double * const INT__s_h_h_s = work + (SIMINT_NSHELL_SIMD * 2375);
    double * const INT__s_h_i_s = work + (SIMINT_NSHELL_SIMD * 2816);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_s = primwork + 630;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_p_s = primwork + 645;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_d_s = primwork + 690;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_f_s = primwork + 780;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_g_s = primwork + 930;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_h_s = primwork + 1155;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_i_s = primwork + 1470;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_s = primwork + 1890;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_p_s = primwork + 1914;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_d_s = primwork + 1986;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_f_s = primwork + 2130;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_g_s = primwork + 2370;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_h_s = primwork + 2730;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_i_s = primwork + 3234;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_p_s = primwork + 3906;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_d_s = primwork + 3996;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_f_s = primwork + 4176;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_g_s = primwork + 4476;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_h_s = primwork + 4926;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_i_s = primwork + 5556;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_d_s = primwork + 6396;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_f_s = primwork + 6576;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_g_s = primwork + 6876;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_h_s = primwork + 7326;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_i_s = primwork + 7956;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_f_s = primwork + 8796;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_g_s = primwork + 9006;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_h_s = primwork + 9321;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_i_s = primwork + 9762;
    double * const hrrwork = (double *)(primwork + 10350);
    double * const HRR_INT__p_f_f_s = hrrwork + 0;
    double * const HRR_INT__p_f_g_s = hrrwork + 300;
    double * const HRR_INT__p_f_h_s = hrrwork + 750;
    double * const HRR_INT__p_f_i_s = hrrwork + 1380;
    double * const HRR_INT__p_g_f_s = hrrwork + 2220;
    double * const HRR_INT__p_g_g_s = hrrwork + 2670;
    double * const HRR_INT__p_g_h_s = hrrwork + 3345;
    double * const HRR_INT__p_g_i_s = hrrwork + 4290;
    double * const HRR_INT__d_f_f_s = hrrwork + 5550;
    double * const HRR_INT__d_f_f_p = hrrwork + 6150;
    double * const HRR_INT__d_f_f_d = hrrwork + 7950;
    double * const HRR_INT__d_f_g_s = hrrwork + 11550;
    double * const HRR_INT__d_f_g_p = hrrwork + 12450;
    double * const HRR_INT__d_f_g_d = hrrwork + 15150;
    double * const HRR_INT__d_f_h_s = hrrwork + 20550;
    double * const HRR_INT__d_f_h_p = hrrwork + 21810;
    double * const HRR_INT__d_f_i_s = hrrwork + 25590;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                double * restrict PRIM_PTR_INT__s_h_h_s = INT__s_h_h_s + abcd * 441;
                double * restrict PRIM_PTR_INT__s_h_i_s = INT__s_h_i_s + abcd * 588;
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    if((iprimcd + SIMINT_SIMD_LEN) >= nprim_icd)
                    {
                        ...
                        if(iprimcd >= nprim_icd && ((icd+1) < nshellbatch))
                        {
                            ...
                            PRIM_PTR_INT__s_h_h_s += 441;
                            PRIM_PTR_INT__s_h_i_s += 588;
                        }
                        iprimcd++;
                    ...
                    if(check_screen)
                    {
                        ...
                        if(vmax < screen_tol)
                        {
                            ...
                            PRIM_PTR_INT__s_h_h_s += lastoffset*441;
                            PRIM_PTR_INT__s_h_i_s += lastoffset*588;
                            continue;
                        }
                    }
                    ...
                    // Forming PRIM_INT__s_p_f_s[5 * 30];
                    ...
                    // Forming PRIM_INT__s_p_d_s[5 * 18];
                    for(n = 0; n < 5; ++n)  // loop over orders of auxiliary function
                    {
                    ...
                    // Forming PRIM_INT__s_d_d_s[4 * 36];
                    ...
                    // Forming PRIM_INT__s_f_p_s[3 * 30];
                    for(n = 0; n < 3; ++n)  // loop over orders of auxiliary function
                    {

                        PRIM_INT__s_f_p_s[n * 30 + 0] = SIMINT_MUL(P_PB[0], PRIM_INT__s_d_p_s[n * 18 + 0]);
                        PRIM_INT__s_f_p_s[n * 30 + 0] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_d_p_s[(n+1) * 18 + 0], PRIM_INT__s_f_p_s[n * 30 + 0]);
                        PRIM_INT__s_f_p_s[n * 30 + 0] = SIMINT_FMADD( vrr_const_2_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_p_p_s[(n+1) * 9 + 0], PRIM_INT__s_p_p_s[n * 9 + 0]), PRIM_INT__s_f_p_s[n * 30 + 0]);
                        PRIM_INT__s_f_p_s[n * 30 + 0] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_d_s_s[(n+1) * 6 + 0], PRIM_INT__s_f_p_s[n * 30 + 0]);

                        PRIM_INT__s_f_p_s[n * 30 + 1] = SIMINT_MUL(P_PB[0], PRIM_INT__s_d_p_s[n * 18 + 1]);
                        PRIM_INT__s_f_p_s[n * 30 + 1] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_d_p_s[(n+1) * 18 + 1], PRIM_INT__s_f_p_s[n * 30 + 1]);
                        PRIM_INT__s_f_p_s[n * 30 + 1] = SIMINT_FMADD( vrr_const_2_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_p_p_s[(n+1) * 9 + 1], PRIM_INT__s_p_p_s[n * 9 + 1]), PRIM_INT__s_f_p_s[n * 30 + 1]);

                        PRIM_INT__s_f_p_s[n * 30 + 2] = SIMINT_MUL(P_PB[0], PRIM_INT__s_d_p_s[n * 18 + 2]);
                        PRIM_INT__s_f_p_s[n * 30 + 2] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_d_p_s[(n+1) * 18 + 2], PRIM_INT__s_f_p_s[n * 30 + 2]);
                        PRIM_INT__s_f_p_s[n * 30 + 2] = SIMINT_FMADD( vrr_const_2_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_p_p_s[(n+1) * 9 + 2], PRIM_INT__s_p_p_s[n * 9 + 2]), PRIM_INT__s_f_p_s[n * 30 + 2]);

                        PRIM_INT__s_f_p_s[n * 30 + 3] = SIMINT_MUL(P_PB[1], PRIM_INT__s_d_p_s[n * 18 + 0]);
                        PRIM_INT__s_f_p_s[n * 30 + 3] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_d_p_s[(n+1) * 18 + 0], PRIM_INT__s_f_p_s[n * 30 + 3]);

                        PRIM_INT__s_f_p_s[n * 30 + 4] = SIMINT_MUL(P_PB[1], PRIM_INT__s_d_p_s[n * 18 + 1]);
                        PRIM_INT__s_f_p_s[n * 30 + 4] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_d_p_s[(n+1) * 18 + 1], PRIM_INT__s_f_p_s[n * 30 + 4]);
                        PRIM_INT__s_f_p_s[n * 30 + 4] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_d_s_s[(n+1) * 6 + 0], PRIM_INT__s_f_p_s[n * 30 + 4]);

                        PRIM_INT__s_f_p_s[n * 30 + 5] = SIMINT_MUL(P_PB[1], PRIM_INT__s_d_p_s[n * 18 + 2]);
                        PRIM_INT__s_f_p_s[n * 30 + 5] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_d_p_s[(n+1) * 18 + 2], PRIM_INT__s_f_p_s[n * 30 + 5]);

                        PRIM_INT__s_f_p_s[n * 30 + 6] = SIMINT_MUL(P_PB[2], PRIM_INT__s_d_p_s[n * 18 + 0]);
                        PRIM_INT__s_f_p_s[n * 30 + 6] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_d_p_s[(n+1) * 18 + 0], PRIM_INT__s_f_p_s[n * 30 + 6]);

                        PRIM_INT__s_f_p_s[n * 30 + 7] = SIMINT_MUL(P_PB[2], PRIM_INT__s_d_p_s[n * 18 + 1]);
                        PRIM_INT__s_f_p_s[n * 30 + 7] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_d_p_s[(n+1) * 18 + 1], PRIM_INT__s_f_p_s[n * 30 + 7]);

                        PRIM_INT__s_f_p_s[n * 30 + 8] = SIMINT_MUL(P_PB[2], PRIM_INT__s_d_p_s[n * 18 + 2]);
                        PRIM_INT__s_f_p_s[n * 30 + 8] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_d_p_s[(n+1) * 18 + 2], PRIM_INT__s_f_p_s[n * 30 + 8]);
                        PRIM_INT__s_f_p_s[n * 30 + 8] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_d_s_s[(n+1) * 6 + 0], PRIM_INT__s_f_p_s[n * 30 + 8]);

                        PRIM_INT__s_f_p_s[n * 30 + 18] = SIMINT_MUL(P_PB[1], PRIM_INT__s_d_p_s[n * 18 + 9]);
                        PRIM_INT__s_f_p_s[n * 30 + 18] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_d_p_s[(n+1) * 18 + 9], PRIM_INT__s_f_p_s[n * 30 + 18]);
                        PRIM_INT__s_f_p_s[n * 30 + 18] = SIMINT_FMADD( vrr_const_2_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_p_p_s[(n+1) * 9 + 3], PRIM_INT__s_p_p_s[n * 9 + 3]), PRIM_INT__s_f_p_s[n * 30 + 18]);

                        PRIM_INT__s_f_p_s[n * 30 + 19] = SIMINT_MUL(P_PB[1], PRIM_INT__s_d_p_s[n * 18 + 10]);
                        PRIM_INT__s_f_p_s[n * 30 + 19] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_d_p_s[(n+1) * 18 + 10], PRIM_INT__s_f_p_s[n * 30 + 19]);
                        PRIM_INT__s_f_p_s[n * 30 + 19] = SIMINT_FMADD( vrr_const_2_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_p_p_s[(n+1) * 9 + 4], PRIM_INT__s_p_p_s[n * 9 + 4]), PRIM_INT__s_f_p_s[n * 30 + 19]);
                        PRIM_INT__s_f_p_s[n * 30 + 19] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_d_s_s[(n+1) * 6 + 3], PRIM_INT__s_f_p_s[n * 30 + 19]);

                        PRIM_INT__s_f_p_s[n * 30 + 20] = SIMINT_MUL(P_PB[1], PRIM_INT__s_d_p_s[n * 18 + 11]);
                        PRIM_INT__s_f_p_s[n * 30 + 20] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_d_p_s[(n+1) * 18 + 11], PRIM_INT__s_f_p_s[n * 30 + 20]);
                        PRIM_INT__s_f_p_s[n * 30 + 20] = SIMINT_FMADD( vrr_const_2_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_p_p_s[(n+1) * 9 + 5], PRIM_INT__s_p_p_s[n * 9 + 5]), PRIM_INT__s_f_p_s[n * 30 + 20]);

                        PRIM_INT__s_f_p_s[n * 30 + 21] = SIMINT_MUL(P_PB[2], PRIM_INT__s_d_p_s[n * 18 + 9]);
                        PRIM_INT__s_f_p_s[n * 30 + 21] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_d_p_s[(n+1) * 18 + 9], PRIM_INT__s_f_p_s[n * 30 + 21]);

                        PRIM_INT__s_f_p_s[n * 30 + 22] = SIMINT_MUL(P_PB[2], PRIM_INT__s_d_p_s[n * 18 + 10]);
                        PRIM_INT__s_f_p_s[n * 30 + 22] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_d_p_s[(n+1) * 18 + 10], PRIM_INT__s_f_p_s[n * 30 + 22]);

                        PRIM_INT__s_f_p_s[n * 30 + 23] = SIMINT_MUL(P_PB[2], PRIM_INT__s_d_p_s[n * 18 + 11]);
                        PRIM_INT__s_f_p_s[n * 30 + 23] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_d_p_s[(n+1) * 18 + 11], PRIM_INT__s_f_p_s[n * 30 + 23]);
                        PRIM_INT__s_f_p_s[n * 30 + 23] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_d_s_s[(n+1) * 6 + 3], PRIM_INT__s_f_p_s[n * 30 + 23]);

                        PRIM_INT__s_f_p_s[n * 30 + 27] = SIMINT_MUL(P_PB[2], PRIM_INT__s_d_p_s[n * 18 + 15]);
                        PRIM_INT__s_f_p_s[n * 30 + 27] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_d_p_s[(n+1) * 18 + 15], PRIM_INT__s_f_p_s[n * 30 + 27]);
                        PRIM_INT__s_f_p_s[n * 30 + 27] = SIMINT_FMADD( vrr_const_2_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_p_p_s[(n+1) * 9 + 6], PRIM_INT__s_p_p_s[n * 9 + 6]), PRIM_INT__s_f_p_s[n * 30 + 27]);

                        PRIM_INT__s_f_p_s[n * 30 + 28] = SIMINT_MUL(P_PB[2], PRIM_INT__s_d_p_s[n * 18 + 16]);
                        PRIM_INT__s_f_p_s[n * 30 + 28] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_d_p_s[(n+1) * 18 + 16], PRIM_INT__s_f_p_s[n * 30 + 28]);
                        PRIM_INT__s_f_p_s[n * 30 + 28] = SIMINT_FMADD( vrr_const_2_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_p_p_s[(n+1) * 9 + 7], PRIM_INT__s_p_p_s[n * 9 + 7]), PRIM_INT__s_f_p_s[n * 30 + 28]);

                        PRIM_INT__s_f_p_s[n * 30 + 29] = SIMINT_MUL(P_PB[2], PRIM_INT__s_d_p_s[n * 18 + 17]);
                        PRIM_INT__s_f_p_s[n * 30 + 29] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_d_p_s[(n+1) * 18 + 17], PRIM_INT__s_f_p_s[n * 30 + 29]);
                        PRIM_INT__s_f_p_s[n * 30 + 29] = SIMINT_FMADD( vrr_const_2_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_p_p_s[(n+1) * 9 + 8], PRIM_INT__s_p_p_s[n * 9 + 8]), PRIM_INT__s_f_p_s[n * 30 + 29]);
                        PRIM_INT__s_f_p_s[n * 30 + 29] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_d_s_s[(n+1) * 6 + 5], PRIM_INT__s_f_p_s[n * 30 + 29]);
                    ...
                    ostei_general_vrr_J(0, 5, 3, 0, 1,
                            one_over_2p, a_over_p, one_over_2pq, aop_PQ, P_PB,
                            PRIM_INT__s_g_f_s, NULL, PRIM_INT__s_f_f_s, PRIM_INT__s_g_d_s, NULL, PRIM_INT__s_h_f_s);
                    ...
                    ostei_general_vrr_J(0, 2, 6, 0, 4,
                            one_over_2p, a_over_p, one_over_2pq, aop_PQ, P_PB,
                            PRIM_INT__s_p_i_s, NULL, PRIM_INT__s_s_i_s, PRIM_INT__s_p_h_s, NULL, PRIM_INT__s_d_i_s);


                    ostei_general_vrr_J(0, 3, 6, 0, 3,
                            one_over_2p, a_over_p, one_over_2pq, aop_PQ, P_PB,
                            PRIM_INT__s_d_i_s, NULL, PRIM_INT__s_p_i_s, PRIM_INT__s_d_h_s, NULL, PRIM_INT__s_f_i_s);


                    ostei_general_vrr_J(0, 4, 5, 0, 2,
                            one_over_2p, a_over_p, one_over_2pq, aop_PQ, P_PB,
                            PRIM_INT__s_f_h_s, NULL, PRIM_INT__s_d_h_s, PRIM_INT__s_f_g_s, NULL, PRIM_INT__s_g_h_s);


                    ostei_general_vrr_J(0, 5, 4, 0, 1,
                            one_over_2p, a_over_p, one_over_2pq, aop_PQ, P_PB,
                            PRIM_INT__s_g_g_s, NULL, PRIM_INT__s_f_g_s, PRIM_INT__s_g_f_s, NULL, PRIM_INT__s_h_g_s);


                    ostei_general_vrr_J(0, 4, 6, 0, 2,
                            one_over_2p, a_over_p, one_over_2pq, aop_PQ, P_PB,
                            PRIM_INT__s_f_i_s, NULL, PRIM_INT__s_d_i_s, PRIM_INT__s_f_h_s, NULL, PRIM_INT__s_g_i_s);


                    ostei_general_vrr_J(0, 5, 5, 0, 1,
                            one_over_2p, a_over_p, one_over_2pq, aop_PQ, P_PB,
                            PRIM_INT__s_g_h_s, NULL, PRIM_INT__s_f_h_s, PRIM_INT__s_g_g_s, NULL, PRIM_INT__s_h_h_s);


                    ostei_general_vrr_J(0, 5, 6, 0, 1,
                            one_over_2p, a_over_p, one_over_2pq, aop_PQ, P_PB,
                            PRIM_INT__s_g_i_s, NULL, PRIM_INT__s_f_i_s, PRIM_INT__s_g_h_s, NULL, PRIM_INT__s_h_i_s);
                    ...
                    if(lastoffset == 0)
                    {
                        ...
                        contract_all(441, PRIM_INT__s_h_h_s, PRIM_PTR_INT__s_h_h_s);
                        contract_all(588, PRIM_INT__s_h_i_s, PRIM_PTR_INT__s_h_i_s);
                    }
                    else
                    {
                        ...
                        contract(441, shelloffsets, PRIM_INT__s_h_h_s, PRIM_PTR_INT__s_h_h_s);
                        contract(588, shelloffsets, PRIM_INT__s_h_i_s, PRIM_PTR_INT__s_h_i_s);
                        PRIM_PTR_INT__s_f_f_s += lastoffset*100;
                        PRIM_PTR_INT__s_f_g_s += lastoffset*150;
                        PRIM_PTR_INT__s_f_h_s += lastoffset*210;
                        PRIM_PTR_INT__s_f_i_s += lastoffset*280;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double const * restrict HRR_INT__s_h_h_s = INT__s_h_h_s + abcd * 441;
                double const * restrict HRR_INT__s_h_i_s = INT__s_h_i_s + abcd * 588;
                double * restrict HRR_INT__d_f_f_f = INT__d_f_f_f + real_abcd * 6000;
                ...
                for(ibra = 0; ibra < 60; ++ibra)
                {
                    ...
                    HRR_INT__d_f_f_p[ibra * 30 + 1] = HRR_INT__d_f_g_s[ibra * 15 + 1] + ( hCD[1] * HRR_INT__d_f_f_s[ibra * 10 + 0] );

                    HRR_INT__d_f_f_p[ibra * 30 + 2] = HRR_INT__d_f_g_s[ibra * 15 + 2] + ( hCD[2] * HRR_INT__d_f_f_s[ibra * 10 + 0] );
                    ...
                    HRR_INT__d_f_f_p[ibra * 30 + 5] = HRR_INT__d_f_g_s[ibra * 15 + 4] + ( hCD[2] * HRR_INT__d_f_f_s[ibra * 10 + 1] );
                    ...
                    HRR_INT__d_f_f_p[ibra * 30 + 11] = HRR_INT__d_f_g_s[ibra * 15 + 7] + ( hCD[2] * HRR_INT__d_f_f_s[ibra * 10 + 3] );
                    ...
                    HRR_INT__d_f_f_p[ibra * 30 + 20] = HRR_INT__d_f_g_s[ibra * 15 + 11] + ( hCD[2] * HRR_INT__d_f_f_s[ibra * 10 + 6] );
