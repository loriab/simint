                  ...
                  double * const restrict INT__p_d_p_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_d_p_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_f_s_f = work + (SIMINT_NSHELL_SIMD * 150);
    double * const INT__s_f_s_g = work + (SIMINT_NSHELL_SIMD * 250);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_p = primwork + 175;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_d = primwork + 202;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_f = primwork + 256;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_g = primwork + 346;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_d = primwork + 481;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_f = primwork + 553;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_g = primwork + 673;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_f = primwork + 853;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_g = primwork + 953;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_d_p_f = INT__p_d_p_f + real_abcd * 540;
