                  ...
                  double * const restrict INT__p_f_s_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_f_s_s);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*25);
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_s = primwork + 0;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_s = primwork + 5;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_s = primwork + 17;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_s = primwork + 35;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_s = primwork + 55;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 25 * sizeof(double));
            abcd = 0;
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    // Forming PRIM_INT__s_f_s_s[2 * 10];
                    ...
                    // Forming PRIM_INT__s_g_s_s[1 * 15];
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_f_s_s = INT__p_f_s_s + real_abcd * 30;
