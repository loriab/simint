                  ...
                  double * const restrict INT__g_d_g_g)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_d_g_g);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const HRR_INT__g_d_g_p = hrrwork + 7875;
    double * const HRR_INT__g_d_g_d = hrrwork + 11925;
    double * const HRR_INT__g_d_g_f = hrrwork + 20025;
    double * const HRR_INT__g_d_h_s = hrrwork + 33525;
    double * const HRR_INT__g_d_h_p = hrrwork + 35415;
    double * const HRR_INT__g_d_h_d = hrrwork + 41085;
    double * const HRR_INT__g_d_h_f = hrrwork + 52425;
    double * const HRR_INT__g_d_i_s = hrrwork + 71325;
    double * const HRR_INT__g_d_i_p = hrrwork + 73845;
    double * const HRR_INT__g_d_i_d = hrrwork + 81405;
    double * const HRR_INT__g_d_k_s = hrrwork + 96525;
    double * const HRR_INT__g_d_k_p = hrrwork + 99765;
    double * const HRR_INT__g_d_l_s = hrrwork + 109485;
    double * const HRR_INT__h_p_g_s = hrrwork + 113535;
    double * const HRR_INT__h_p_h_s = hrrwork + 114480;
    double * const HRR_INT__h_p_i_s = hrrwork + 115803;
    double * const HRR_INT__h_p_k_s = hrrwork + 117567;
    double * const HRR_INT__h_p_l_s = hrrwork + 119835;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__g_d_g_g = INT__g_d_g_g + real_abcd * 20250;
                  ...
                  double * const restrict INT__d_g_g_g)
{
    ...
    int ret = ostei_g_d_g_g(P_tmp, Q, screen_tol, work, INT__d_g_g_g);
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 15; ++c)
        for(int d = 0; d < 15; ++d)
            buffer[idx++] = INT__d_g_g_g[q*20250+b*1350+a*225+c*15+d];

        memcpy(INT__d_g_g_g+q*20250, buffer, 20250*sizeof(double));
    }
