                  ...
                  double * const restrict INT__s_s_f_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_s_f_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    // partition workspace
    double * const INT__s_s_f_s = work + (SIMINT_NSHELL_SIMD * 0);
    double * const INT__s_s_g_s = work + (SIMINT_NSHELL_SIMD * 10);
    double * const INT__s_s_h_s = work + (SIMINT_NSHELL_SIMD * 25);
    double * const INT__s_s_i_s = work + (SIMINT_NSHELL_SIMD * 46);
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*74);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_i_s = primwork + 182;
    double * const hrrwork = (double *)(primwork + 210);
    double * const HRR_INT__s_s_f_p = hrrwork + 0;
    double * const HRR_INT__s_s_f_d = hrrwork + 30;
    double * const HRR_INT__s_s_g_p = hrrwork + 90;
    double * const HRR_INT__s_s_g_d = hrrwork + 135;
    double * const HRR_INT__s_s_h_p = hrrwork + 225;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 74 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__s_s_f_f = INT__s_s_f_f + real_abcd * 100;
                ...
                for(ibra = 0; ibra < 1; ++ibra)
                {
                    ...
                    HRR_INT__s_s_f_p[ibra * 30 + 1] = HRR_INT__s_s_g_s[ibra * 15 + 1] + ( hCD[1] * HRR_INT__s_s_f_s[ibra * 10 + 0] );

                    HRR_INT__s_s_f_p[ibra * 30 + 2] = HRR_INT__s_s_g_s[ibra * 15 + 2] + ( hCD[2] * HRR_INT__s_s_f_s[ibra * 10 + 0] );
                    ...
                    HRR_INT__s_s_f_p[ibra * 30 + 5] = HRR_INT__s_s_g_s[ibra * 15 + 4] + ( hCD[2] * HRR_INT__s_s_f_s[ibra * 10 + 1] );
                    ...
                    HRR_INT__s_s_f_p[ibra * 30 + 11] = HRR_INT__s_s_g_s[ibra * 15 + 7] + ( hCD[2] * HRR_INT__s_s_f_s[ibra * 10 + 3] );
                    ...
                    HRR_INT__s_s_f_p[ibra * 30 + 20] = HRR_INT__s_s_g_s[ibra * 15 + 11] + ( hCD[2] * HRR_INT__s_s_f_s[ibra * 10 + 6] );
