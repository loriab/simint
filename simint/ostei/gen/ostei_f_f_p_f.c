                  ...
                  double * const restrict INT__f_f_p_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_f_p_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__g_s_s_f = work + (SIMINT_NSHELL_SIMD * 250);
    double * const INT__g_s_s_g = work + (SIMINT_NSHELL_SIMD * 400);
    double * const INT__h_s_s_f = work + (SIMINT_NSHELL_SIMD * 625);
    double * const INT__h_s_s_g = work + (SIMINT_NSHELL_SIMD * 835);
    double * const INT__i_s_s_f = work + (SIMINT_NSHELL_SIMD * 1150);
    double * const INT__i_s_s_g = work + (SIMINT_NSHELL_SIMD * 1430);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 23;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_p = primwork + 53;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_d = primwork + 89;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 143;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_p = primwork + 197;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_d = primwork + 269;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_f = primwork + 377;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 497;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_p = primwork + 577;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_d = primwork + 697;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_f = primwork + 877;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_g = primwork + 1077;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 1227;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_p = primwork + 1332;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_d = primwork + 1512;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_f = primwork + 1782;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_g = primwork + 2082;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 2307;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_p = primwork + 2433;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_d = primwork + 2685;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_f = primwork + 3063;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_g = primwork + 3483;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 3798;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_p = primwork + 3938;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_d = primwork + 4274;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_f = primwork + 4778;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_g = primwork + 5338;
    ...
    double * const HRR_INT__f_d_s_f = hrrwork + 750;
    double * const HRR_INT__f_d_s_g = hrrwork + 1350;
    double * const HRR_INT__f_f_s_f = hrrwork + 2250;
    double * const HRR_INT__f_f_s_g = hrrwork + 3250;
    double * const HRR_INT__g_p_s_f = hrrwork + 4750;
    double * const HRR_INT__g_p_s_g = hrrwork + 5200;
    double * const HRR_INT__g_d_s_f = hrrwork + 5875;
    double * const HRR_INT__g_d_s_g = hrrwork + 6775;
    double * const HRR_INT__h_p_s_f = hrrwork + 8125;
    double * const HRR_INT__h_p_s_g = hrrwork + 8755;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_f_p_f = INT__f_f_p_f + real_abcd * 3000;
