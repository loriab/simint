                  ...
                  double * const restrict INT__f_p_g_g)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_p_g_g);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const HRR_INT__f_p_g_f = hrrwork + 4500;
    double * const HRR_INT__f_p_h_s = hrrwork + 9000;
    double * const HRR_INT__f_p_h_p = hrrwork + 9630;
    double * const HRR_INT__f_p_h_d = hrrwork + 11520;
    double * const HRR_INT__f_p_h_f = hrrwork + 15300;
    double * const HRR_INT__f_p_i_s = hrrwork + 21600;
    double * const HRR_INT__f_p_i_p = hrrwork + 22440;
    double * const HRR_INT__f_p_i_d = hrrwork + 24960;
    double * const HRR_INT__f_p_k_s = hrrwork + 30000;
    double * const HRR_INT__f_p_k_p = hrrwork + 31080;
    double * const HRR_INT__f_p_l_s = hrrwork + 34320;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_p_g_g = INT__f_p_g_g + real_abcd * 6750;
                  ...
                  double * const restrict INT__p_f_g_g)
{
    ...
    int ret = ostei_f_p_g_g(P_tmp, Q, screen_tol, work, INT__p_f_g_g);
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 15; ++c)
        for(int d = 0; d < 15; ++d)
            buffer[idx++] = INT__p_f_g_g[q*6750+b*675+a*225+c*15+d];

        memcpy(INT__p_f_g_g+q*6750, buffer, 6750*sizeof(double));
    }
