                  ...
                  double * const restrict INT__f_d_g_g)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_d_g_g);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*6670);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_l_s = primwork + 1050;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 1320;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 1335;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 1380;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 1470;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_g_s = primwork + 1620;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_h_s = primwork + 1845;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_i_s = primwork + 2160;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_k_s = primwork + 2580;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_l_s = primwork + 3120;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 3795;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 3867;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 4011;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 4251;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_h_s = primwork + 4611;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_i_s = primwork + 5115;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_k_s = primwork + 5787;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_l_s = primwork + 6651;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 7731;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 7911;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 8211;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_h_s = primwork + 8661;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_i_s = primwork + 9291;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_k_s = primwork + 10131;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_l_s = primwork + 11211;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 12561;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 12861;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 13311;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_i_s = primwork + 13941;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_k_s = primwork + 14781;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_l_s = primwork + 15861;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_g_s = primwork + 17211;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_h_s = primwork + 17526;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_i_s = primwork + 17967;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_k_s = primwork + 18555;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_l_s = primwork + 19311;
    double * const hrrwork = (double *)(primwork + 20256);
    ...
    double * const HRR_INT__f_d_g_p = hrrwork + 5250;
    double * const HRR_INT__f_d_g_d = hrrwork + 7950;
    double * const HRR_INT__f_d_g_f = hrrwork + 13350;
    double * const HRR_INT__f_d_h_s = hrrwork + 22350;
    double * const HRR_INT__f_d_h_p = hrrwork + 23610;
    double * const HRR_INT__f_d_h_d = hrrwork + 27390;
    double * const HRR_INT__f_d_h_f = hrrwork + 34950;
    double * const HRR_INT__f_d_i_s = hrrwork + 47550;
    double * const HRR_INT__f_d_i_p = hrrwork + 49230;
    double * const HRR_INT__f_d_i_d = hrrwork + 54270;
    double * const HRR_INT__f_d_k_s = hrrwork + 64350;
    double * const HRR_INT__f_d_k_p = hrrwork + 66510;
    double * const HRR_INT__f_d_l_s = hrrwork + 72990;
    double * const HRR_INT__g_p_g_s = hrrwork + 75690;
    double * const HRR_INT__g_p_h_s = hrrwork + 76365;
    double * const HRR_INT__g_p_i_s = hrrwork + 77310;
    double * const HRR_INT__g_p_k_s = hrrwork + 78570;
    double * const HRR_INT__g_p_l_s = hrrwork + 80190;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 6670 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_d_g_g = INT__f_d_g_g + real_abcd * 13500;
                  ...
                  double * const restrict INT__d_f_g_g)
{
    ...
    int ret = ostei_f_d_g_g(P_tmp, Q, screen_tol, work, INT__d_f_g_g);
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 15; ++c)
        for(int d = 0; d < 15; ++d)
            buffer[idx++] = INT__d_f_g_g[q*13500+b*1350+a*225+c*15+d];

        memcpy(INT__d_f_g_g+q*13500, buffer, 13500*sizeof(double));
    }
