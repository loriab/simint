                  ...
                  double * const restrict INT__s_s_p_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_s_p_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    // partition workspace
    double * const INT__s_s_s_f = work + (SIMINT_NSHELL_SIMD * 0);
    double * const INT__s_s_s_g = work + (SIMINT_NSHELL_SIMD * 10);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_d = primwork + 17;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_f = primwork + 35;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_g = primwork + 55;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                double * restrict PRIM_PTR_INT__s_s_s_g = INT__s_s_s_g + abcd * 15;
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    if(check_screen)
                    {
                        ...
                        if(vmax < screen_tol)
                        {
                            ...
                            PRIM_PTR_INT__s_s_s_g += lastoffset*15;
                            continue;
                        }
                    }
                    ...
                    // Forming PRIM_INT__s_s_s_f[2 * 10];
                    ...
                    // Forming PRIM_INT__s_s_s_g[1 * 15];
                    ...
                    if(lastoffset == 0)
                    {
                        ...
                        contract_all(15, PRIM_INT__s_s_s_g, PRIM_PTR_INT__s_s_s_g);
                    }
                    else
                    {
                        contract(10, shelloffsets, PRIM_INT__s_s_s_f, PRIM_PTR_INT__s_s_s_f);
                        contract(15, shelloffsets, PRIM_INT__s_s_s_g, PRIM_PTR_INT__s_s_s_g);
                        PRIM_PTR_INT__s_s_s_f += lastoffset*10;
                        PRIM_PTR_INT__s_s_s_g += lastoffset*15;
                    }
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double const * restrict HRR_INT__s_s_s_g = INT__s_s_s_g + abcd * 15;
                double * restrict HRR_INT__s_s_p_f = INT__s_s_p_f + real_abcd * 30;

                // form INT__s_s_p_f
                for(ibra = 0; ibra < 1; ++ibra)
                {
                    HRR_INT__s_s_p_f[ibra * 30 + 0] = HRR_INT__s_s_s_g[ibra * 15 + 0] - ( hCD[0] * HRR_INT__s_s_s_f[ibra * 10 + 0] );

                    HRR_INT__s_s_p_f[ibra * 30 + 1] = HRR_INT__s_s_s_g[ibra * 15 + 1] - ( hCD[0] * HRR_INT__s_s_s_f[ibra * 10 + 1] );

                    HRR_INT__s_s_p_f[ibra * 30 + 2] = HRR_INT__s_s_s_g[ibra * 15 + 2] - ( hCD[0] * HRR_INT__s_s_s_f[ibra * 10 + 2] );

                    HRR_INT__s_s_p_f[ibra * 30 + 3] = HRR_INT__s_s_s_g[ibra * 15 + 3] - ( hCD[0] * HRR_INT__s_s_s_f[ibra * 10 + 3] );

                    HRR_INT__s_s_p_f[ibra * 30 + 4] = HRR_INT__s_s_s_g[ibra * 15 + 4] - ( hCD[0] * HRR_INT__s_s_s_f[ibra * 10 + 4] );

                    HRR_INT__s_s_p_f[ibra * 30 + 5] = HRR_INT__s_s_s_g[ibra * 15 + 5] - ( hCD[0] * HRR_INT__s_s_s_f[ibra * 10 + 5] );

                    HRR_INT__s_s_p_f[ibra * 30 + 6] = HRR_INT__s_s_s_g[ibra * 15 + 6] - ( hCD[0] * HRR_INT__s_s_s_f[ibra * 10 + 6] );

                    HRR_INT__s_s_p_f[ibra * 30 + 7] = HRR_INT__s_s_s_g[ibra * 15 + 7] - ( hCD[0] * HRR_INT__s_s_s_f[ibra * 10 + 7] );

                    HRR_INT__s_s_p_f[ibra * 30 + 8] = HRR_INT__s_s_s_g[ibra * 15 + 8] - ( hCD[0] * HRR_INT__s_s_s_f[ibra * 10 + 8] );

                    HRR_INT__s_s_p_f[ibra * 30 + 9] = HRR_INT__s_s_s_g[ibra * 15 + 9] - ( hCD[0] * HRR_INT__s_s_s_f[ibra * 10 + 9] );

                    HRR_INT__s_s_p_f[ibra * 30 + 10] = HRR_INT__s_s_s_g[ibra * 15 + 1] - ( hCD[1] * HRR_INT__s_s_s_f[ibra * 10 + 0] );

                    HRR_INT__s_s_p_f[ibra * 30 + 11] = HRR_INT__s_s_s_g[ibra * 15 + 3] - ( hCD[1] * HRR_INT__s_s_s_f[ibra * 10 + 1] );

                    HRR_INT__s_s_p_f[ibra * 30 + 12] = HRR_INT__s_s_s_g[ibra * 15 + 4] - ( hCD[1] * HRR_INT__s_s_s_f[ibra * 10 + 2] );

                    HRR_INT__s_s_p_f[ibra * 30 + 13] = HRR_INT__s_s_s_g[ibra * 15 + 6] - ( hCD[1] * HRR_INT__s_s_s_f[ibra * 10 + 3] );

                    HRR_INT__s_s_p_f[ibra * 30 + 14] = HRR_INT__s_s_s_g[ibra * 15 + 7] - ( hCD[1] * HRR_INT__s_s_s_f[ibra * 10 + 4] );

                    HRR_INT__s_s_p_f[ibra * 30 + 15] = HRR_INT__s_s_s_g[ibra * 15 + 8] - ( hCD[1] * HRR_INT__s_s_s_f[ibra * 10 + 5] );

                    HRR_INT__s_s_p_f[ibra * 30 + 16] = HRR_INT__s_s_s_g[ibra * 15 + 10] - ( hCD[1] * HRR_INT__s_s_s_f[ibra * 10 + 6] );

                    HRR_INT__s_s_p_f[ibra * 30 + 17] = HRR_INT__s_s_s_g[ibra * 15 + 11] - ( hCD[1] * HRR_INT__s_s_s_f[ibra * 10 + 7] );

                    HRR_INT__s_s_p_f[ibra * 30 + 18] = HRR_INT__s_s_s_g[ibra * 15 + 12] - ( hCD[1] * HRR_INT__s_s_s_f[ibra * 10 + 8] );

                    HRR_INT__s_s_p_f[ibra * 30 + 19] = HRR_INT__s_s_s_g[ibra * 15 + 13] - ( hCD[1] * HRR_INT__s_s_s_f[ibra * 10 + 9] );

                    HRR_INT__s_s_p_f[ibra * 30 + 20] = HRR_INT__s_s_s_g[ibra * 15 + 2] - ( hCD[2] * HRR_INT__s_s_s_f[ibra * 10 + 0] );

                    HRR_INT__s_s_p_f[ibra * 30 + 21] = HRR_INT__s_s_s_g[ibra * 15 + 4] - ( hCD[2] * HRR_INT__s_s_s_f[ibra * 10 + 1] );

                    HRR_INT__s_s_p_f[ibra * 30 + 22] = HRR_INT__s_s_s_g[ibra * 15 + 5] - ( hCD[2] * HRR_INT__s_s_s_f[ibra * 10 + 2] );

                    HRR_INT__s_s_p_f[ibra * 30 + 23] = HRR_INT__s_s_s_g[ibra * 15 + 7] - ( hCD[2] * HRR_INT__s_s_s_f[ibra * 10 + 3] );

                    HRR_INT__s_s_p_f[ibra * 30 + 24] = HRR_INT__s_s_s_g[ibra * 15 + 8] - ( hCD[2] * HRR_INT__s_s_s_f[ibra * 10 + 4] );

                    HRR_INT__s_s_p_f[ibra * 30 + 25] = HRR_INT__s_s_s_g[ibra * 15 + 9] - ( hCD[2] * HRR_INT__s_s_s_f[ibra * 10 + 5] );

                    HRR_INT__s_s_p_f[ibra * 30 + 26] = HRR_INT__s_s_s_g[ibra * 15 + 11] - ( hCD[2] * HRR_INT__s_s_s_f[ibra * 10 + 6] );

                    HRR_INT__s_s_p_f[ibra * 30 + 27] = HRR_INT__s_s_s_g[ibra * 15 + 12] - ( hCD[2] * HRR_INT__s_s_s_f[ibra * 10 + 7] );

                    HRR_INT__s_s_p_f[ibra * 30 + 28] = HRR_INT__s_s_s_g[ibra * 15 + 13] - ( hCD[2] * HRR_INT__s_s_s_f[ibra * 10 + 8] );

                    HRR_INT__s_s_p_f[ibra * 30 + 29] = HRR_INT__s_s_s_g[ibra * 15 + 14] - ( hCD[2] * HRR_INT__s_s_s_f[ibra * 10 + 9] );
