                  ...
                  double * const restrict INT__d_s_s_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_s_s_p);
    memset(INT__d_s_s_p, 0, P.nshell12_clip * Q.nshell12_clip * 18 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_p = primwork + 25;
