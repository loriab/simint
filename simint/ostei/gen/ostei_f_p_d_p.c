                  ...
                  double * const restrict INT__f_p_d_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_p_d_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 29;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 56;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 92;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 146;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 218;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 268;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 358;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 478;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 578;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 638;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 773;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 953;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_p_d_p = INT__f_p_d_p + real_abcd * 540;
