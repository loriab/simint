                  ...
                  double * const restrict INT__f_f_d_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_f_d_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__i_s_d_s = work + (SIMINT_NSHELL_SIMD * 736);
    double * const INT__i_s_f_s = work + (SIMINT_NSHELL_SIMD * 904);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 112;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 166;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 238;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 308;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 398;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 518;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 618;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 708;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 843;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 1023;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 1173;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 1278;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_d_s = primwork + 1467;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_f_s = primwork + 1719;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 1929;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_p_s = primwork + 2041;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_d_s = primwork + 2293;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_f_s = primwork + 2629;
    ...
    double * const HRR_INT__f_f_d_s = hrrwork + 1440;
    double * const HRR_INT__f_f_f_s = hrrwork + 2040;
    double * const HRR_INT__g_p_d_s = hrrwork + 3040;
    double * const HRR_INT__g_p_f_s = hrrwork + 3310;
    double * const HRR_INT__g_d_d_s = hrrwork + 3760;
    double * const HRR_INT__g_d_f_s = hrrwork + 4300;
    double * const HRR_INT__h_p_d_s = hrrwork + 5200;
    double * const HRR_INT__h_p_f_s = hrrwork + 5578;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_f_d_p = INT__f_f_d_p + real_abcd * 1800;
