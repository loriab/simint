                  ...
                  double * const restrict INT__d_d_f_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_d_f_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    // partition workspace
    double * const INT__d_s_f_s = work + (SIMINT_NSHELL_SIMD * 0);
    double * const INT__d_s_g_s = work + (SIMINT_NSHELL_SIMD * 60);
    double * const INT__f_s_f_s = work + (SIMINT_NSHELL_SIMD * 150);
    double * const INT__f_s_g_s = work + (SIMINT_NSHELL_SIMD * 250);
    double * const INT__g_s_f_s = work + (SIMINT_NSHELL_SIMD * 400);
    double * const INT__g_s_g_s = work + (SIMINT_NSHELL_SIMD * 550);
    ...
    double * const HRR_INT__d_p_f_s = hrrwork + 0;
    double * const HRR_INT__d_p_g_s = hrrwork + 180;
    double * const HRR_INT__d_d_f_s = hrrwork + 450;
    double * const HRR_INT__d_d_g_s = hrrwork + 810;
    double * const HRR_INT__f_p_f_s = hrrwork + 1350;
    double * const HRR_INT__f_p_g_s = hrrwork + 1650;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_d_f_p = INT__d_d_f_p + real_abcd * 1080;
                ...
                for(ibra = 0; ibra < 36; ++ibra)
                {
                    ...
                    HRR_INT__d_d_f_p[ibra * 30 + 1] = HRR_INT__d_d_g_s[ibra * 15 + 1] + ( hCD[1] * HRR_INT__d_d_f_s[ibra * 10 + 0] );

                    HRR_INT__d_d_f_p[ibra * 30 + 2] = HRR_INT__d_d_g_s[ibra * 15 + 2] + ( hCD[2] * HRR_INT__d_d_f_s[ibra * 10 + 0] );
                    ...
                    HRR_INT__d_d_f_p[ibra * 30 + 5] = HRR_INT__d_d_g_s[ibra * 15 + 4] + ( hCD[2] * HRR_INT__d_d_f_s[ibra * 10 + 1] );
                    ...
                    HRR_INT__d_d_f_p[ibra * 30 + 11] = HRR_INT__d_d_g_s[ibra * 15 + 7] + ( hCD[2] * HRR_INT__d_d_f_s[ibra * 10 + 3] );
                    ...
                    HRR_INT__d_d_f_p[ibra * 30 + 20] = HRR_INT__d_d_g_s[ibra * 15 + 11] + ( hCD[2] * HRR_INT__d_d_f_s[ibra * 10 + 6] );
