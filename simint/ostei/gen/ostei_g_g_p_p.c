                  ...
                  double * const restrict INT__g_g_p_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_g_p_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__h_s_p_s = work + (SIMINT_NSHELL_SIMD * 135);
    double * const INT__h_s_d_s = work + (SIMINT_NSHELL_SIMD * 198);
    double * const INT__i_s_p_s = work + (SIMINT_NSHELL_SIMD * 324);
    double * const INT__i_s_d_s = work + (SIMINT_NSHELL_SIMD * 408);
    double * const INT__k_s_p_s = work + (SIMINT_NSHELL_SIMD * 576);
    double * const INT__k_s_d_s = work + (SIMINT_NSHELL_SIMD * 684);
    double * const INT__l_s_p_s = work + (SIMINT_NSHELL_SIMD * 900);
    double * const INT__l_s_d_s = work + (SIMINT_NSHELL_SIMD * 1035);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 95;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 175;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 235;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 340;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 430;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 520;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 646;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_d_s = primwork + 772;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 898;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_p_s = primwork + 1038;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_d_s = primwork + 1206;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_s_s = primwork + 1374;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_p_s = primwork + 1518;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_d_s = primwork + 1734;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_s_s = primwork + 1950;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_p_s = primwork + 2085;
    SIMINT_DBLTYPE * const restrict PRIM_INT__l_s_d_s = primwork + 2355;
    double * const hrrwork = (double *)(primwork + 2625);
    double * const HRR_INT__g_p_p_s = hrrwork + 0;
    double * const HRR_INT__g_p_d_s = hrrwork + 135;
    double * const HRR_INT__g_d_p_s = hrrwork + 405;
    double * const HRR_INT__g_d_d_s = hrrwork + 675;
    double * const HRR_INT__g_f_p_s = hrrwork + 1215;
    double * const HRR_INT__g_f_d_s = hrrwork + 1665;
    double * const HRR_INT__g_g_p_s = hrrwork + 2565;
    double * const HRR_INT__g_g_d_s = hrrwork + 3240;
    double * const HRR_INT__h_p_p_s = hrrwork + 4590;
    double * const HRR_INT__h_p_d_s = hrrwork + 4779;
    double * const HRR_INT__h_d_p_s = hrrwork + 5157;
    double * const HRR_INT__h_d_d_s = hrrwork + 5535;
    double * const HRR_INT__h_f_p_s = hrrwork + 6291;
    double * const HRR_INT__h_f_d_s = hrrwork + 6921;
    double * const HRR_INT__i_p_p_s = hrrwork + 8181;
    double * const HRR_INT__i_p_d_s = hrrwork + 8433;
    double * const HRR_INT__i_d_p_s = hrrwork + 8937;
    double * const HRR_INT__i_d_d_s = hrrwork + 9441;
    double * const HRR_INT__k_p_p_s = hrrwork + 10449;
    double * const HRR_INT__k_p_d_s = hrrwork + 10773;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__g_g_p_p = INT__g_g_p_p + real_abcd * 2025;
                ...
                {
                    HRR_INT__g_g_p_p[ibra * 9 + 0] = HRR_INT__g_g_d_s[ibra * 6 + 0] + ( hCD[0] * HRR_INT__g_g_p_s[ibra * 3 + 0] );

                    HRR_INT__g_g_p_p[ibra * 9 + 1] = HRR_INT__g_g_d_s[ibra * 6 + 1] + ( hCD[1] * HRR_INT__g_g_p_s[ibra * 3 + 0] );

                    HRR_INT__g_g_p_p[ibra * 9 + 2] = HRR_INT__g_g_d_s[ibra * 6 + 2] + ( hCD[2] * HRR_INT__g_g_p_s[ibra * 3 + 0] );

                    HRR_INT__g_g_p_p[ibra * 9 + 3] = HRR_INT__g_g_d_s[ibra * 6 + 1] + ( hCD[0] * HRR_INT__g_g_p_s[ibra * 3 + 1] );

                    HRR_INT__g_g_p_p[ibra * 9 + 4] = HRR_INT__g_g_d_s[ibra * 6 + 3] + ( hCD[1] * HRR_INT__g_g_p_s[ibra * 3 + 1] );

                    HRR_INT__g_g_p_p[ibra * 9 + 5] = HRR_INT__g_g_d_s[ibra * 6 + 4] + ( hCD[2] * HRR_INT__g_g_p_s[ibra * 3 + 1] );

                    HRR_INT__g_g_p_p[ibra * 9 + 6] = HRR_INT__g_g_d_s[ibra * 6 + 2] + ( hCD[0] * HRR_INT__g_g_p_s[ibra * 3 + 2] );

                    HRR_INT__g_g_p_p[ibra * 9 + 7] = HRR_INT__g_g_d_s[ibra * 6 + 4] + ( hCD[1] * HRR_INT__g_g_p_s[ibra * 3 + 2] );

                    HRR_INT__g_g_p_p[ibra * 9 + 8] = HRR_INT__g_g_d_s[ibra * 6 + 5] + ( hCD[2] * HRR_INT__g_g_p_s[ibra * 3 + 2] );
