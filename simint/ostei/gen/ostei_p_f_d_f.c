                  ...
                  double * const restrict INT__p_f_d_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_f_d_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_s = primwork + 350;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_p = primwork + 362;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_d = primwork + 398;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_f = primwork + 470;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_g = primwork + 590;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_h = primwork + 770;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_p = primwork + 1022;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_d = primwork + 1076;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_f = primwork + 1184;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_g = primwork + 1364;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_h = primwork + 1634;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_d = primwork + 2012;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_f = primwork + 2132;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_g = primwork + 2332;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_h = primwork + 2632;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_f = primwork + 3052;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_g = primwork + 3202;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_h = primwork + 3427;
    ...
    double * const HRR_INT__p_f_p_f = hrrwork + 1380;
    double * const HRR_INT__p_f_p_g = hrrwork + 2280;
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    // Forming PRIM_INT__s_p_s_f[4 * 30];
                    ...
                    // Forming PRIM_INT__s_d_s_d[3 * 36];
                    ...
                    for(n = 0; n < 3; ++n)  // loop over orders of auxiliary function
                    {
                        ...
                        PRIM_INT__s_d_s_p[n * 18 + 0] = SIMINT_MUL(P_PB[0], PRIM_INT__s_p_s_p[n * 9 + 0]);
                        PRIM_INT__s_d_s_p[n * 18 + 0] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_p_s_p[(n+1) * 9 + 0], PRIM_INT__s_d_s_p[n * 18 + 0]);
                        PRIM_INT__s_d_s_p[n * 18 + 0] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_p[(n+1) * 3 + 0], PRIM_INT__s_s_s_p[n * 3 + 0]), PRIM_INT__s_d_s_p[n * 18 + 0]);
                        PRIM_INT__s_d_s_p[n * 18 + 0] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_p_s_s[(n+1) * 3 + 0], PRIM_INT__s_d_s_p[n * 18 + 0]);

                        PRIM_INT__s_d_s_p[n * 18 + 1] = SIMINT_MUL(P_PB[0], PRIM_INT__s_p_s_p[n * 9 + 1]);
                        PRIM_INT__s_d_s_p[n * 18 + 1] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_p_s_p[(n+1) * 9 + 1], PRIM_INT__s_d_s_p[n * 18 + 1]);
                        PRIM_INT__s_d_s_p[n * 18 + 1] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_p[(n+1) * 3 + 1], PRIM_INT__s_s_s_p[n * 3 + 1]), PRIM_INT__s_d_s_p[n * 18 + 1]);

                        PRIM_INT__s_d_s_p[n * 18 + 2] = SIMINT_MUL(P_PB[0], PRIM_INT__s_p_s_p[n * 9 + 2]);
                        PRIM_INT__s_d_s_p[n * 18 + 2] = SIMINT_FMADD( aop_PQ[0], PRIM_INT__s_p_s_p[(n+1) * 9 + 2], PRIM_INT__s_d_s_p[n * 18 + 2]);
                        PRIM_INT__s_d_s_p[n * 18 + 2] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_p[(n+1) * 3 + 2], PRIM_INT__s_s_s_p[n * 3 + 2]), PRIM_INT__s_d_s_p[n * 18 + 2]);

                        PRIM_INT__s_d_s_p[n * 18 + 9] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_p[n * 9 + 3]);
                        PRIM_INT__s_d_s_p[n * 18 + 9] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_p[(n+1) * 9 + 3], PRIM_INT__s_d_s_p[n * 18 + 9]);
                        PRIM_INT__s_d_s_p[n * 18 + 9] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_p[(n+1) * 3 + 0], PRIM_INT__s_s_s_p[n * 3 + 0]), PRIM_INT__s_d_s_p[n * 18 + 9]);

                        PRIM_INT__s_d_s_p[n * 18 + 10] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_p[n * 9 + 4]);
                        PRIM_INT__s_d_s_p[n * 18 + 10] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_p[(n+1) * 9 + 4], PRIM_INT__s_d_s_p[n * 18 + 10]);
                        PRIM_INT__s_d_s_p[n * 18 + 10] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_p[(n+1) * 3 + 1], PRIM_INT__s_s_s_p[n * 3 + 1]), PRIM_INT__s_d_s_p[n * 18 + 10]);
                        PRIM_INT__s_d_s_p[n * 18 + 10] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_p_s_s[(n+1) * 3 + 1], PRIM_INT__s_d_s_p[n * 18 + 10]);

                        PRIM_INT__s_d_s_p[n * 18 + 11] = SIMINT_MUL(P_PB[1], PRIM_INT__s_p_s_p[n * 9 + 5]);
                        PRIM_INT__s_d_s_p[n * 18 + 11] = SIMINT_FMADD( aop_PQ[1], PRIM_INT__s_p_s_p[(n+1) * 9 + 5], PRIM_INT__s_d_s_p[n * 18 + 11]);
                        PRIM_INT__s_d_s_p[n * 18 + 11] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_p[(n+1) * 3 + 2], PRIM_INT__s_s_s_p[n * 3 + 2]), PRIM_INT__s_d_s_p[n * 18 + 11]);

                        PRIM_INT__s_d_s_p[n * 18 + 15] = SIMINT_MUL(P_PB[2], PRIM_INT__s_p_s_p[n * 9 + 6]);
                        PRIM_INT__s_d_s_p[n * 18 + 15] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_p_s_p[(n+1) * 9 + 6], PRIM_INT__s_d_s_p[n * 18 + 15]);
                        PRIM_INT__s_d_s_p[n * 18 + 15] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_p[(n+1) * 3 + 0], PRIM_INT__s_s_s_p[n * 3 + 0]), PRIM_INT__s_d_s_p[n * 18 + 15]);

                        PRIM_INT__s_d_s_p[n * 18 + 16] = SIMINT_MUL(P_PB[2], PRIM_INT__s_p_s_p[n * 9 + 7]);
                        PRIM_INT__s_d_s_p[n * 18 + 16] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_p_s_p[(n+1) * 9 + 7], PRIM_INT__s_d_s_p[n * 18 + 16]);
                        PRIM_INT__s_d_s_p[n * 18 + 16] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_p[(n+1) * 3 + 1], PRIM_INT__s_s_s_p[n * 3 + 1]), PRIM_INT__s_d_s_p[n * 18 + 16]);

                        PRIM_INT__s_d_s_p[n * 18 + 17] = SIMINT_MUL(P_PB[2], PRIM_INT__s_p_s_p[n * 9 + 8]);
                        PRIM_INT__s_d_s_p[n * 18 + 17] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__s_p_s_p[(n+1) * 9 + 8], PRIM_INT__s_d_s_p[n * 18 + 17]);
                        PRIM_INT__s_d_s_p[n * 18 + 17] = SIMINT_FMADD( vrr_const_1_over_2p, SIMINT_FMADD(a_over_p, PRIM_INT__s_s_s_p[(n+1) * 3 + 2], PRIM_INT__s_s_s_p[n * 3 + 2]), PRIM_INT__s_d_s_p[n * 18 + 17]);
                        PRIM_INT__s_d_s_p[n * 18 + 17] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_p_s_s[(n+1) * 3 + 2], PRIM_INT__s_d_s_p[n * 18 + 17]);
                    ...
                    ostei_general_vrr_J(0, 4, 0, 4, 1,
                            one_over_2p, a_over_p, one_over_2pq, aop_PQ, P_PB,
                            PRIM_INT__s_f_s_g, NULL, PRIM_INT__s_d_s_g, NULL, PRIM_INT__s_f_s_f, PRIM_INT__s_g_s_g);


                    ostei_general_vrr_J(0, 4, 0, 5, 1,
                            one_over_2p, a_over_p, one_over_2pq, aop_PQ, P_PB,
                            PRIM_INT__s_f_s_h, NULL, PRIM_INT__s_d_s_h, NULL, PRIM_INT__s_f_s_g, PRIM_INT__s_g_s_h);
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_f_d_f = INT__p_f_d_f + real_abcd * 1800;
                ...
                {
                    HRR_INT__p_f_p_f[ibra * 30 + 0] = HRR_INT__p_f_s_g[ibra * 15 + 0] - ( hCD[0] * HRR_INT__p_f_s_f[ibra * 10 + 0] );

                    HRR_INT__p_f_p_f[ibra * 30 + 1] = HRR_INT__p_f_s_g[ibra * 15 + 1] - ( hCD[0] * HRR_INT__p_f_s_f[ibra * 10 + 1] );

                    HRR_INT__p_f_p_f[ibra * 30 + 2] = HRR_INT__p_f_s_g[ibra * 15 + 2] - ( hCD[0] * HRR_INT__p_f_s_f[ibra * 10 + 2] );

                    HRR_INT__p_f_p_f[ibra * 30 + 3] = HRR_INT__p_f_s_g[ibra * 15 + 3] - ( hCD[0] * HRR_INT__p_f_s_f[ibra * 10 + 3] );

                    HRR_INT__p_f_p_f[ibra * 30 + 4] = HRR_INT__p_f_s_g[ibra * 15 + 4] - ( hCD[0] * HRR_INT__p_f_s_f[ibra * 10 + 4] );

                    HRR_INT__p_f_p_f[ibra * 30 + 5] = HRR_INT__p_f_s_g[ibra * 15 + 5] - ( hCD[0] * HRR_INT__p_f_s_f[ibra * 10 + 5] );

                    HRR_INT__p_f_p_f[ibra * 30 + 6] = HRR_INT__p_f_s_g[ibra * 15 + 6] - ( hCD[0] * HRR_INT__p_f_s_f[ibra * 10 + 6] );

                    HRR_INT__p_f_p_f[ibra * 30 + 7] = HRR_INT__p_f_s_g[ibra * 15 + 7] - ( hCD[0] * HRR_INT__p_f_s_f[ibra * 10 + 7] );

                    HRR_INT__p_f_p_f[ibra * 30 + 8] = HRR_INT__p_f_s_g[ibra * 15 + 8] - ( hCD[0] * HRR_INT__p_f_s_f[ibra * 10 + 8] );

                    HRR_INT__p_f_p_f[ibra * 30 + 9] = HRR_INT__p_f_s_g[ibra * 15 + 9] - ( hCD[0] * HRR_INT__p_f_s_f[ibra * 10 + 9] );

                    HRR_INT__p_f_p_f[ibra * 30 + 10] = HRR_INT__p_f_s_g[ibra * 15 + 1] - ( hCD[1] * HRR_INT__p_f_s_f[ibra * 10 + 0] );

                    HRR_INT__p_f_p_f[ibra * 30 + 11] = HRR_INT__p_f_s_g[ibra * 15 + 3] - ( hCD[1] * HRR_INT__p_f_s_f[ibra * 10 + 1] );

                    HRR_INT__p_f_p_f[ibra * 30 + 12] = HRR_INT__p_f_s_g[ibra * 15 + 4] - ( hCD[1] * HRR_INT__p_f_s_f[ibra * 10 + 2] );

                    HRR_INT__p_f_p_f[ibra * 30 + 13] = HRR_INT__p_f_s_g[ibra * 15 + 6] - ( hCD[1] * HRR_INT__p_f_s_f[ibra * 10 + 3] );

                    HRR_INT__p_f_p_f[ibra * 30 + 14] = HRR_INT__p_f_s_g[ibra * 15 + 7] - ( hCD[1] * HRR_INT__p_f_s_f[ibra * 10 + 4] );

                    HRR_INT__p_f_p_f[ibra * 30 + 15] = HRR_INT__p_f_s_g[ibra * 15 + 8] - ( hCD[1] * HRR_INT__p_f_s_f[ibra * 10 + 5] );

                    HRR_INT__p_f_p_f[ibra * 30 + 16] = HRR_INT__p_f_s_g[ibra * 15 + 10] - ( hCD[1] * HRR_INT__p_f_s_f[ibra * 10 + 6] );

                    HRR_INT__p_f_p_f[ibra * 30 + 17] = HRR_INT__p_f_s_g[ibra * 15 + 11] - ( hCD[1] * HRR_INT__p_f_s_f[ibra * 10 + 7] );

                    HRR_INT__p_f_p_f[ibra * 30 + 18] = HRR_INT__p_f_s_g[ibra * 15 + 12] - ( hCD[1] * HRR_INT__p_f_s_f[ibra * 10 + 8] );

                    HRR_INT__p_f_p_f[ibra * 30 + 19] = HRR_INT__p_f_s_g[ibra * 15 + 13] - ( hCD[1] * HRR_INT__p_f_s_f[ibra * 10 + 9] );

                    HRR_INT__p_f_p_f[ibra * 30 + 20] = HRR_INT__p_f_s_g[ibra * 15 + 2] - ( hCD[2] * HRR_INT__p_f_s_f[ibra * 10 + 0] );

                    HRR_INT__p_f_p_f[ibra * 30 + 21] = HRR_INT__p_f_s_g[ibra * 15 + 4] - ( hCD[2] * HRR_INT__p_f_s_f[ibra * 10 + 1] );

                    HRR_INT__p_f_p_f[ibra * 30 + 22] = HRR_INT__p_f_s_g[ibra * 15 + 5] - ( hCD[2] * HRR_INT__p_f_s_f[ibra * 10 + 2] );

                    HRR_INT__p_f_p_f[ibra * 30 + 23] = HRR_INT__p_f_s_g[ibra * 15 + 7] - ( hCD[2] * HRR_INT__p_f_s_f[ibra * 10 + 3] );

                    HRR_INT__p_f_p_f[ibra * 30 + 24] = HRR_INT__p_f_s_g[ibra * 15 + 8] - ( hCD[2] * HRR_INT__p_f_s_f[ibra * 10 + 4] );

                    HRR_INT__p_f_p_f[ibra * 30 + 25] = HRR_INT__p_f_s_g[ibra * 15 + 9] - ( hCD[2] * HRR_INT__p_f_s_f[ibra * 10 + 5] );

                    HRR_INT__p_f_p_f[ibra * 30 + 26] = HRR_INT__p_f_s_g[ibra * 15 + 11] - ( hCD[2] * HRR_INT__p_f_s_f[ibra * 10 + 6] );

                    HRR_INT__p_f_p_f[ibra * 30 + 27] = HRR_INT__p_f_s_g[ibra * 15 + 12] - ( hCD[2] * HRR_INT__p_f_s_f[ibra * 10 + 7] );

                    HRR_INT__p_f_p_f[ibra * 30 + 28] = HRR_INT__p_f_s_g[ibra * 15 + 13] - ( hCD[2] * HRR_INT__p_f_s_f[ibra * 10 + 8] );

                    HRR_INT__p_f_p_f[ibra * 30 + 29] = HRR_INT__p_f_s_g[ibra * 15 + 14] - ( hCD[2] * HRR_INT__p_f_s_f[ibra * 10 + 9] );
