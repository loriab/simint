                  ...
                  double * const restrict INT__p_s_f_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_s_f_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 182;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_g_s = primwork + 212;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_h_s = primwork + 257;
    double * const hrrwork = (double *)(primwork + 320);
    double * const HRR_INT__p_s_f_p = hrrwork + 0;
    double * const HRR_INT__p_s_g_p = hrrwork + 90;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_s_f_d = INT__p_s_f_d + real_abcd * 180;
