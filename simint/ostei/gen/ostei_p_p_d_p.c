                  ...
                  double * const restrict INT__p_p_d_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_p_d_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__d_s_d_s = work + (SIMINT_NSHELL_SIMD * 48);
    double * const INT__d_s_f_s = work + (SIMINT_NSHELL_SIMD * 84);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 75;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 93;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 129;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 189;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 225;
    double * const hrrwork = (double *)(primwork + 285);
    double * const HRR_INT__p_p_d_s = hrrwork + 0;
    double * const HRR_INT__p_p_f_s = hrrwork + 54;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_p_d_p = INT__p_p_d_p + real_abcd * 162;
