                  ...
                  double * const restrict INT__s_s_f_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_s_f_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_h_s = primwork + 105;
    double * const hrrwork = (double *)(primwork + 126);
    double * const HRR_INT__s_s_f_p = hrrwork + 0;
    double * const HRR_INT__s_s_g_p = hrrwork + 30;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__s_s_f_d = INT__s_s_f_d + real_abcd * 60;
