                  ...
                  double * const restrict INT__s_s_p_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_s_p_s);
    memset(INT__s_s_p_s, 0, P.nshell12_clip * Q.nshell12_clip * 3 * sizeof(double));
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_p_s = primwork + 2;
