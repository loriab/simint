                  ...
                  double * const restrict INT__d_f_d_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_f_d_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_h_d_s = work + (SIMINT_NSHELL_SIMD * 400);
    double * const INT__s_h_f_s = work + (SIMINT_NSHELL_SIMD * 526);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_p_s = primwork + 33;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_s = primwork + 60;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_p_s = primwork + 102;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_d_s = primwork + 156;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_s = primwork + 228;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_p_s = primwork + 288;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_d_s = primwork + 378;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_f_s = primwork + 498;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_s = primwork + 598;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_p_s = primwork + 673;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_d_s = primwork + 808;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_f_s = primwork + 988;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_s_s = primwork + 1138;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_p_s = primwork + 1222;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_d_s = primwork + 1411;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_f_s = primwork + 1663;
    ...
    double * const HRR_INT__p_g_d_s = hrrwork + 480;
    double * const HRR_INT__p_g_f_s = hrrwork + 750;
    double * const HRR_INT__d_f_d_s = hrrwork + 1200;
    double * const HRR_INT__d_f_f_s = hrrwork + 1560;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_f_d_p = INT__d_f_d_p + real_abcd * 1080;
