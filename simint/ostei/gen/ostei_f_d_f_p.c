                  ...
                  double * const restrict INT__f_d_f_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_d_f_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__g_s_g_s = work + (SIMINT_NSHELL_SIMD * 400);
    double * const INT__h_s_f_s = work + (SIMINT_NSHELL_SIMD * 625);
    double * const INT__h_s_g_s = work + (SIMINT_NSHELL_SIMD * 835);
    ...
    double * const HRR_INT__f_d_f_s = hrrwork + 750;
    double * const HRR_INT__f_d_g_s = hrrwork + 1350;
    double * const HRR_INT__g_p_f_s = hrrwork + 2250;
    double * const HRR_INT__g_p_g_s = hrrwork + 2700;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_d_f_p = INT__f_d_f_p + real_abcd * 1800;
