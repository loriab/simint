                  ...
                  double * const restrict INT__f_f_s_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_f_s_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__g_s_s_f = work + (SIMINT_NSHELL_SIMD * 100);
    double * const INT__h_s_s_f = work + (SIMINT_NSHELL_SIMD * 250);
    double * const INT__i_s_s_f = work + (SIMINT_NSHELL_SIMD * 460);
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*740);
    ...
    double * const HRR_INT__f_d_s_f = hrrwork + 300;
    double * const HRR_INT__g_p_s_f = hrrwork + 900;
    double * const HRR_INT__g_d_s_f = hrrwork + 1350;
    double * const HRR_INT__h_p_s_f = hrrwork + 2250;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 740 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_f_s_f = INT__f_f_s_f + real_abcd * 1000;
