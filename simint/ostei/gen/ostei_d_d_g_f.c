                  ...
                  double * const restrict INT__d_d_g_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_d_g_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__f_s_g_s = work + (SIMINT_NSHELL_SIMD * 600);
    double * const INT__f_s_h_s = work + (SIMINT_NSHELL_SIMD * 750);
    double * const INT__f_s_i_s = work + (SIMINT_NSHELL_SIMD * 960);
    double * const INT__f_s_k_s = work + (SIMINT_NSHELL_SIMD * 1240);
    double * const INT__g_s_g_s = work + (SIMINT_NSHELL_SIMD * 1600);
    double * const INT__g_s_h_s = work + (SIMINT_NSHELL_SIMD * 1825);
    double * const INT__g_s_i_s = work + (SIMINT_NSHELL_SIMD * 2140);
    double * const INT__g_s_k_s = work + (SIMINT_NSHELL_SIMD * 2560);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 810;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 846;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 918;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_g_s = primwork + 1038;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_h_s = primwork + 1218;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_i_s = primwork + 1470;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_k_s = primwork + 1806;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 2238;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 2346;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 2526;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_h_s = primwork + 2796;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_i_s = primwork + 3174;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_k_s = primwork + 3678;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 4326;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 4526;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_h_s = primwork + 4826;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_i_s = primwork + 5246;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_k_s = primwork + 5806;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 6526;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 6751;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_i_s = primwork + 7066;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_k_s = primwork + 7486;
    ...
    double * const HRR_INT__d_d_g_s = hrrwork + 1800;
    double * const HRR_INT__d_d_g_p = hrrwork + 2340;
    double * const HRR_INT__d_d_g_d = hrrwork + 3960;
    double * const HRR_INT__d_d_h_s = hrrwork + 7200;
    double * const HRR_INT__d_d_h_p = hrrwork + 7956;
    double * const HRR_INT__d_d_h_d = hrrwork + 10224;
    double * const HRR_INT__d_d_i_s = hrrwork + 14760;
    double * const HRR_INT__d_d_i_p = hrrwork + 15768;
    double * const HRR_INT__d_d_k_s = hrrwork + 18792;
    double * const HRR_INT__f_p_g_s = hrrwork + 20088;
    double * const HRR_INT__f_p_h_s = hrrwork + 20538;
    double * const HRR_INT__f_p_i_s = hrrwork + 21168;
    double * const HRR_INT__f_p_k_s = hrrwork + 22008;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_d_g_f = INT__d_d_g_f + real_abcd * 5400;
                  ...
                  double * const restrict INT__d_d_f_g)
{
    ...
    int ret = ostei_d_d_g_f(P, Q_tmp, screen_tol, work, INT__d_d_f_g);
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 10; ++c)
        for(int d = 0; d < 15; ++d)
            buffer[idx++] = INT__d_d_f_g[q*5400+a*900+b*150+d*10+c];

        memcpy(INT__d_d_f_g+q*5400, buffer, 5400*sizeof(double));
    }
