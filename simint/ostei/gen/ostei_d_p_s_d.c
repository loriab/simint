                  ...
                  double * const restrict INT__d_p_s_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_p_s_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*96);
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_s = primwork + 0;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 6;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_p = primwork + 21;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 39;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_p = primwork + 63;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_d = primwork + 99;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 135;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_p = primwork + 165;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_d = primwork + 225;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 96 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_p_s_d = INT__d_p_s_d + real_abcd * 108;
