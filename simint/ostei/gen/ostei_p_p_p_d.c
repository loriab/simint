                  ...
                  double * const restrict INT__p_p_p_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_p_p_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__p_s_s_f = work + (SIMINT_NSHELL_SIMD * 18);
    double * const INT__d_s_s_d = work + (SIMINT_NSHELL_SIMD * 48);
    double * const INT__d_s_s_f = work + (SIMINT_NSHELL_SIMD * 84);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_p = primwork + 75;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_d = primwork + 93;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_f = primwork + 129;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_d = primwork + 189;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_f = primwork + 225;
    double * const hrrwork = (double *)(primwork + 285);
    double * const HRR_INT__p_p_s_d = hrrwork + 0;
    double * const HRR_INT__p_p_s_f = hrrwork + 54;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                double * restrict PRIM_PTR_INT__p_s_s_f = INT__p_s_s_f + abcd * 30;
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    if(check_screen)
                    {
                        ...
                        if(vmax < screen_tol)
                        {
                            ...
                            PRIM_PTR_INT__p_s_s_f += lastoffset*30;
                    ...
                    for(n = 0; n < 1; ++n)  // loop over orders of auxiliary function
                    {
                        ...
                        PRIM_INT__d_s_s_d[n * 36 + 12] = SIMINT_MUL(P_PA[2], PRIM_INT__p_s_s_d[n * 18 + 0]);
                        PRIM_INT__d_s_s_d[n * 36 + 12] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 0], PRIM_INT__d_s_s_d[n * 36 + 12]);

                        PRIM_INT__d_s_s_d[n * 36 + 13] = SIMINT_MUL(P_PA[2], PRIM_INT__p_s_s_d[n * 18 + 1]);
                        PRIM_INT__d_s_s_d[n * 36 + 13] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 1], PRIM_INT__d_s_s_d[n * 36 + 13]);

                        PRIM_INT__d_s_s_d[n * 36 + 14] = SIMINT_MUL(P_PA[2], PRIM_INT__p_s_s_d[n * 18 + 2]);
                        PRIM_INT__d_s_s_d[n * 36 + 14] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 2], PRIM_INT__d_s_s_d[n * 36 + 14]);
                        PRIM_INT__d_s_s_d[n * 36 + 14] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 0], PRIM_INT__d_s_s_d[n * 36 + 14]);

                        PRIM_INT__d_s_s_d[n * 36 + 15] = SIMINT_MUL(P_PA[2], PRIM_INT__p_s_s_d[n * 18 + 3]);
                        PRIM_INT__d_s_s_d[n * 36 + 15] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 3], PRIM_INT__d_s_s_d[n * 36 + 15]);

                        PRIM_INT__d_s_s_d[n * 36 + 16] = SIMINT_MUL(P_PA[2], PRIM_INT__p_s_s_d[n * 18 + 4]);
                        PRIM_INT__d_s_s_d[n * 36 + 16] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 4], PRIM_INT__d_s_s_d[n * 36 + 16]);
                        PRIM_INT__d_s_s_d[n * 36 + 16] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 1], PRIM_INT__d_s_s_d[n * 36 + 16]);

                        PRIM_INT__d_s_s_d[n * 36 + 17] = SIMINT_MUL(P_PA[2], PRIM_INT__p_s_s_d[n * 18 + 5]);
                        PRIM_INT__d_s_s_d[n * 36 + 17] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 5], PRIM_INT__d_s_s_d[n * 36 + 17]);
                        PRIM_INT__d_s_s_d[n * 36 + 17] = SIMINT_FMADD( vrr_const_2_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 2], PRIM_INT__d_s_s_d[n * 36 + 17]);
                        ...
                        PRIM_INT__d_s_s_d[n * 36 + 24] = SIMINT_MUL(P_PA[2], PRIM_INT__p_s_s_d[n * 18 + 6]);
                        PRIM_INT__d_s_s_d[n * 36 + 24] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 6], PRIM_INT__d_s_s_d[n * 36 + 24]);

                        PRIM_INT__d_s_s_d[n * 36 + 25] = SIMINT_MUL(P_PA[2], PRIM_INT__p_s_s_d[n * 18 + 7]);
                        PRIM_INT__d_s_s_d[n * 36 + 25] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 7], PRIM_INT__d_s_s_d[n * 36 + 25]);

                        PRIM_INT__d_s_s_d[n * 36 + 26] = SIMINT_MUL(P_PA[2], PRIM_INT__p_s_s_d[n * 18 + 8]);
                        PRIM_INT__d_s_s_d[n * 36 + 26] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 8], PRIM_INT__d_s_s_d[n * 36 + 26]);
                        PRIM_INT__d_s_s_d[n * 36 + 26] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 3], PRIM_INT__d_s_s_d[n * 36 + 26]);

                        PRIM_INT__d_s_s_d[n * 36 + 27] = SIMINT_MUL(P_PA[2], PRIM_INT__p_s_s_d[n * 18 + 9]);
                        PRIM_INT__d_s_s_d[n * 36 + 27] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 9], PRIM_INT__d_s_s_d[n * 36 + 27]);

                        PRIM_INT__d_s_s_d[n * 36 + 28] = SIMINT_MUL(P_PA[2], PRIM_INT__p_s_s_d[n * 18 + 10]);
                        PRIM_INT__d_s_s_d[n * 36 + 28] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 10], PRIM_INT__d_s_s_d[n * 36 + 28]);
                        PRIM_INT__d_s_s_d[n * 36 + 28] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 4], PRIM_INT__d_s_s_d[n * 36 + 28]);

                        PRIM_INT__d_s_s_d[n * 36 + 29] = SIMINT_MUL(P_PA[2], PRIM_INT__p_s_s_d[n * 18 + 11]);
                        PRIM_INT__d_s_s_d[n * 36 + 29] = SIMINT_FMADD( aop_PQ[2], PRIM_INT__p_s_s_d[(n+1) * 18 + 11], PRIM_INT__d_s_s_d[n * 36 + 29]);
                        PRIM_INT__d_s_s_d[n * 36 + 29] = SIMINT_FMADD( vrr_const_2_over_2pq, PRIM_INT__p_s_s_p[(n+1) * 9 + 5], PRIM_INT__d_s_s_d[n * 36 + 29]);
                    ...
                    if(lastoffset == 0)
                    {
                        ...
                        contract_all(30, PRIM_INT__p_s_s_f, PRIM_PTR_INT__p_s_s_f);
                    ...
                    else
                    {
                        ...
                        contract(30, shelloffsets, PRIM_INT__p_s_s_f, PRIM_PTR_INT__p_s_s_f);
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double const * restrict HRR_INT__p_s_s_f = INT__p_s_s_f + abcd * 30;
                double const * restrict HRR_INT__d_s_s_d = INT__d_s_s_d + abcd * 36;
                double const * restrict HRR_INT__d_s_s_f = INT__d_s_s_f + abcd * 60;
                double * restrict HRR_INT__p_p_p_d = INT__p_p_p_d + real_abcd * 162;
                ...
                {
                    HRR_INT__p_p_s_f[0 * 10 + iket] = HRR_INT__d_s_s_f[0 * 10 + iket] + ( hAB[0] * HRR_INT__p_s_s_f[0 * 10 + iket] );

                    HRR_INT__p_p_s_f[1 * 10 + iket] = HRR_INT__d_s_s_f[1 * 10 + iket] + ( hAB[1] * HRR_INT__p_s_s_f[0 * 10 + iket] );

                    HRR_INT__p_p_s_f[2 * 10 + iket] = HRR_INT__d_s_s_f[2 * 10 + iket] + ( hAB[2] * HRR_INT__p_s_s_f[0 * 10 + iket] );

                    HRR_INT__p_p_s_f[3 * 10 + iket] = HRR_INT__d_s_s_f[1 * 10 + iket] + ( hAB[0] * HRR_INT__p_s_s_f[1 * 10 + iket] );

                    HRR_INT__p_p_s_f[4 * 10 + iket] = HRR_INT__d_s_s_f[3 * 10 + iket] + ( hAB[1] * HRR_INT__p_s_s_f[1 * 10 + iket] );

                    HRR_INT__p_p_s_f[5 * 10 + iket] = HRR_INT__d_s_s_f[4 * 10 + iket] + ( hAB[2] * HRR_INT__p_s_s_f[1 * 10 + iket] );

                    HRR_INT__p_p_s_f[6 * 10 + iket] = HRR_INT__d_s_s_f[2 * 10 + iket] + ( hAB[0] * HRR_INT__p_s_s_f[2 * 10 + iket] );

                    HRR_INT__p_p_s_f[7 * 10 + iket] = HRR_INT__d_s_s_f[4 * 10 + iket] + ( hAB[1] * HRR_INT__p_s_s_f[2 * 10 + iket] );

                    HRR_INT__p_p_s_f[8 * 10 + iket] = HRR_INT__d_s_s_f[5 * 10 + iket] + ( hAB[2] * HRR_INT__p_s_s_f[2 * 10 + iket] );
                ...
                {
                    HRR_INT__p_p_p_d[ibra * 18 + 0] = HRR_INT__p_p_s_f[ibra * 10 + 0] - ( hCD[0] * HRR_INT__p_p_s_d[ibra * 6 + 0] );

                    HRR_INT__p_p_p_d[ibra * 18 + 1] = HRR_INT__p_p_s_f[ibra * 10 + 1] - ( hCD[0] * HRR_INT__p_p_s_d[ibra * 6 + 1] );

                    HRR_INT__p_p_p_d[ibra * 18 + 2] = HRR_INT__p_p_s_f[ibra * 10 + 2] - ( hCD[0] * HRR_INT__p_p_s_d[ibra * 6 + 2] );

                    HRR_INT__p_p_p_d[ibra * 18 + 3] = HRR_INT__p_p_s_f[ibra * 10 + 3] - ( hCD[0] * HRR_INT__p_p_s_d[ibra * 6 + 3] );

                    HRR_INT__p_p_p_d[ibra * 18 + 4] = HRR_INT__p_p_s_f[ibra * 10 + 4] - ( hCD[0] * HRR_INT__p_p_s_d[ibra * 6 + 4] );

                    HRR_INT__p_p_p_d[ibra * 18 + 5] = HRR_INT__p_p_s_f[ibra * 10 + 5] - ( hCD[0] * HRR_INT__p_p_s_d[ibra * 6 + 5] );

                    HRR_INT__p_p_p_d[ibra * 18 + 6] = HRR_INT__p_p_s_f[ibra * 10 + 1] - ( hCD[1] * HRR_INT__p_p_s_d[ibra * 6 + 0] );

                    HRR_INT__p_p_p_d[ibra * 18 + 7] = HRR_INT__p_p_s_f[ibra * 10 + 3] - ( hCD[1] * HRR_INT__p_p_s_d[ibra * 6 + 1] );

                    HRR_INT__p_p_p_d[ibra * 18 + 8] = HRR_INT__p_p_s_f[ibra * 10 + 4] - ( hCD[1] * HRR_INT__p_p_s_d[ibra * 6 + 2] );

                    HRR_INT__p_p_p_d[ibra * 18 + 9] = HRR_INT__p_p_s_f[ibra * 10 + 6] - ( hCD[1] * HRR_INT__p_p_s_d[ibra * 6 + 3] );

                    HRR_INT__p_p_p_d[ibra * 18 + 10] = HRR_INT__p_p_s_f[ibra * 10 + 7] - ( hCD[1] * HRR_INT__p_p_s_d[ibra * 6 + 4] );

                    HRR_INT__p_p_p_d[ibra * 18 + 11] = HRR_INT__p_p_s_f[ibra * 10 + 8] - ( hCD[1] * HRR_INT__p_p_s_d[ibra * 6 + 5] );

                    HRR_INT__p_p_p_d[ibra * 18 + 12] = HRR_INT__p_p_s_f[ibra * 10 + 2] - ( hCD[2] * HRR_INT__p_p_s_d[ibra * 6 + 0] );

                    HRR_INT__p_p_p_d[ibra * 18 + 13] = HRR_INT__p_p_s_f[ibra * 10 + 4] - ( hCD[2] * HRR_INT__p_p_s_d[ibra * 6 + 1] );

                    HRR_INT__p_p_p_d[ibra * 18 + 14] = HRR_INT__p_p_s_f[ibra * 10 + 5] - ( hCD[2] * HRR_INT__p_p_s_d[ibra * 6 + 2] );

                    HRR_INT__p_p_p_d[ibra * 18 + 15] = HRR_INT__p_p_s_f[ibra * 10 + 7] - ( hCD[2] * HRR_INT__p_p_s_d[ibra * 6 + 3] );

                    HRR_INT__p_p_p_d[ibra * 18 + 16] = HRR_INT__p_p_s_f[ibra * 10 + 8] - ( hCD[2] * HRR_INT__p_p_s_d[ibra * 6 + 4] );

                    HRR_INT__p_p_p_d[ibra * 18 + 17] = HRR_INT__p_p_s_f[ibra * 10 + 9] - ( hCD[2] * HRR_INT__p_p_s_d[ibra * 6 + 5] );
