                  ...
                  double * const restrict INT__g_s_g_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_s_g_s);
    memset(INT__g_s_g_s, 0, P.nshell12_clip * Q.nshell12_clip * 225 * sizeof(double));
                  ...
                  double * const restrict INT__s_g_g_s)
{
    ...
    int ret = ostei_g_s_g_s(P_tmp, Q, screen_tol, work, INT__s_g_g_s);
                  ...
                  double * const restrict INT__g_s_s_g)
{
    ...
    int ret = ostei_g_s_g_s(P, Q_tmp, screen_tol, work, INT__g_s_s_g);
                  ...
                  double * const restrict INT__s_g_s_g)
{
    ...
    int ret = ostei_g_s_g_s(P_tmp, Q_tmp, screen_tol, work, INT__s_g_s_g);
