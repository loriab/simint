                  ...
                  double * const restrict INT__f_p_f_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_p_f_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const HRR_INT__f_p_g_s = hrrwork + 1200;
    double * const HRR_INT__f_p_g_p = hrrwork + 1650;
    double * const HRR_INT__f_p_h_s = hrrwork + 3000;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_p_f_d = INT__f_p_f_d + real_abcd * 1800;
