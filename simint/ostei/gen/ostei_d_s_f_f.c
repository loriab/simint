                  ...
                  double * const restrict INT__d_s_f_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_s_f_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const HRR_INT__d_s_f_d = hrrwork + 180;
    double * const HRR_INT__d_s_g_p = hrrwork + 540;
    double * const HRR_INT__d_s_g_d = hrrwork + 810;
    double * const HRR_INT__d_s_h_p = hrrwork + 1350;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_s_f_f = INT__d_s_f_f + real_abcd * 600;
