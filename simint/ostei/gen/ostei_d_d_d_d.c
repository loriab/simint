                  ...
                  double * const restrict INT__d_d_d_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_d_d_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    // partition workspace
    double * const INT__d_s_d_s = work + (SIMINT_NSHELL_SIMD * 0);
    double * const INT__d_s_f_s = work + (SIMINT_NSHELL_SIMD * 36);
    double * const INT__d_s_g_s = work + (SIMINT_NSHELL_SIMD * 96);
    double * const INT__f_s_d_s = work + (SIMINT_NSHELL_SIMD * 186);
    double * const INT__f_s_f_s = work + (SIMINT_NSHELL_SIMD * 246);
    double * const INT__f_s_g_s = work + (SIMINT_NSHELL_SIMD * 346);
    double * const INT__g_s_d_s = work + (SIMINT_NSHELL_SIMD * 496);
    double * const INT__g_s_f_s = work + (SIMINT_NSHELL_SIMD * 586);
    double * const INT__g_s_g_s = work + (SIMINT_NSHELL_SIMD * 736);
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*961);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 39;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 63;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 99;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 153;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 213;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 255;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 327;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 435;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 555;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 645;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 705;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 825;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 1005;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 1205;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 1355;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 1430;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 1610;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 1880;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 2180;
    double * const hrrwork = (double *)(primwork + 2405);
    double * const HRR_INT__d_p_d_s = hrrwork + 0;
    double * const HRR_INT__d_p_f_s = hrrwork + 108;
    double * const HRR_INT__d_p_g_s = hrrwork + 288;
    double * const HRR_INT__d_d_d_s = hrrwork + 558;
    double * const HRR_INT__d_d_d_p = hrrwork + 774;
    double * const HRR_INT__d_d_f_s = hrrwork + 1422;
    double * const HRR_INT__d_d_f_p = hrrwork + 1782;
    double * const HRR_INT__d_d_g_s = hrrwork + 2862;
    double * const HRR_INT__f_p_d_s = hrrwork + 3402;
    double * const HRR_INT__f_p_f_s = hrrwork + 3582;
    double * const HRR_INT__f_p_g_s = hrrwork + 3882;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 961 * sizeof(double));
            abcd = 0;
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                double * restrict PRIM_PTR_INT__d_s_d_s = INT__d_s_d_s + abcd * 36;
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    if(check_screen)
                    {
                        ...
                        if(vmax < screen_tol)
                        {
                            PRIM_PTR_INT__d_s_d_s += lastoffset*36;
                    ...
                    for(n = 0; n < 3; ++n)  // loop over orders of auxiliary function
                    {
                        ...
                        PRIM_INT__d_s_d_s[n * 36 + 2] = SIMINT_MUL(Q_PA[2], PRIM_INT__d_s_p_s[n * 18 + 0]);
                        PRIM_INT__d_s_d_s[n * 36 + 2] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 0], PRIM_INT__d_s_d_s[n * 36 + 2]);
                        ...
                        PRIM_INT__d_s_d_s[n * 36 + 4] = SIMINT_MUL(Q_PA[2], PRIM_INT__d_s_p_s[n * 18 + 1]);
                        PRIM_INT__d_s_d_s[n * 36 + 4] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 1], PRIM_INT__d_s_d_s[n * 36 + 4]);
                        ...
                        PRIM_INT__d_s_d_s[n * 36 + 8] = SIMINT_MUL(Q_PA[2], PRIM_INT__d_s_p_s[n * 18 + 3]);
                        PRIM_INT__d_s_d_s[n * 36 + 8] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 3], PRIM_INT__d_s_d_s[n * 36 + 8]);
                        ...
                        PRIM_INT__d_s_d_s[n * 36 + 10] = SIMINT_MUL(Q_PA[2], PRIM_INT__d_s_p_s[n * 18 + 4]);
                        PRIM_INT__d_s_d_s[n * 36 + 10] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 4], PRIM_INT__d_s_d_s[n * 36 + 10]);
                        ...
                        PRIM_INT__d_s_d_s[n * 36 + 14] = SIMINT_MUL(Q_PA[2], PRIM_INT__d_s_p_s[n * 18 + 6]);
                        PRIM_INT__d_s_d_s[n * 36 + 14] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 6], PRIM_INT__d_s_d_s[n * 36 + 14]);
                        PRIM_INT__d_s_d_s[n * 36 + 14] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_p_s[(n+1) * 9 + 0], PRIM_INT__d_s_d_s[n * 36 + 14]);
                        ...
                        PRIM_INT__d_s_d_s[n * 36 + 16] = SIMINT_MUL(Q_PA[2], PRIM_INT__d_s_p_s[n * 18 + 7]);
                        PRIM_INT__d_s_d_s[n * 36 + 16] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 7], PRIM_INT__d_s_d_s[n * 36 + 16]);
                        PRIM_INT__d_s_d_s[n * 36 + 16] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_p_s[(n+1) * 9 + 1], PRIM_INT__d_s_d_s[n * 36 + 16]);
                        ...
                        PRIM_INT__d_s_d_s[n * 36 + 20] = SIMINT_MUL(Q_PA[2], PRIM_INT__d_s_p_s[n * 18 + 9]);
                        PRIM_INT__d_s_d_s[n * 36 + 20] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 9], PRIM_INT__d_s_d_s[n * 36 + 20]);
                        ...
                        PRIM_INT__d_s_d_s[n * 36 + 22] = SIMINT_MUL(Q_PA[2], PRIM_INT__d_s_p_s[n * 18 + 10]);
                        PRIM_INT__d_s_d_s[n * 36 + 22] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 10], PRIM_INT__d_s_d_s[n * 36 + 22]);
                        ...
                        PRIM_INT__d_s_d_s[n * 36 + 26] = SIMINT_MUL(Q_PA[2], PRIM_INT__d_s_p_s[n * 18 + 12]);
                        PRIM_INT__d_s_d_s[n * 36 + 26] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 12], PRIM_INT__d_s_d_s[n * 36 + 26]);
                        PRIM_INT__d_s_d_s[n * 36 + 26] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_p_s[(n+1) * 9 + 3], PRIM_INT__d_s_d_s[n * 36 + 26]);
                        ...
                        PRIM_INT__d_s_d_s[n * 36 + 28] = SIMINT_MUL(Q_PA[2], PRIM_INT__d_s_p_s[n * 18 + 13]);
                        PRIM_INT__d_s_d_s[n * 36 + 28] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 13], PRIM_INT__d_s_d_s[n * 36 + 28]);
                        PRIM_INT__d_s_d_s[n * 36 + 28] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__p_s_p_s[(n+1) * 9 + 4], PRIM_INT__d_s_d_s[n * 36 + 28]);
                        ...
                        PRIM_INT__d_s_d_s[n * 36 + 32] = SIMINT_MUL(Q_PA[2], PRIM_INT__d_s_p_s[n * 18 + 15]);
                        PRIM_INT__d_s_d_s[n * 36 + 32] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 15], PRIM_INT__d_s_d_s[n * 36 + 32]);
                        PRIM_INT__d_s_d_s[n * 36 + 32] = SIMINT_FMADD( vrr_const_2_over_2pq, PRIM_INT__p_s_p_s[(n+1) * 9 + 6], PRIM_INT__d_s_d_s[n * 36 + 32]);
                        ...
                        PRIM_INT__d_s_d_s[n * 36 + 34] = SIMINT_MUL(Q_PA[2], PRIM_INT__d_s_p_s[n * 18 + 16]);
                        PRIM_INT__d_s_d_s[n * 36 + 34] = SIMINT_FMADD( aoq_PQ[2], PRIM_INT__d_s_p_s[(n+1) * 18 + 16], PRIM_INT__d_s_d_s[n * 36 + 34]);
                        PRIM_INT__d_s_d_s[n * 36 + 34] = SIMINT_FMADD( vrr_const_2_over_2pq, PRIM_INT__p_s_p_s[(n+1) * 9 + 7], PRIM_INT__d_s_d_s[n * 36 + 34]);
                    ...
                    for(n = 0; n < 3; ++n)  // loop over orders of auxiliary function
                    {
                        ...
                        PRIM_INT__p_s_d_s[n * 18 + 1] = SIMINT_MUL(Q_PA[1], PRIM_INT__p_s_p_s[n * 9 + 0]);
                        PRIM_INT__p_s_d_s[n * 18 + 1] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_p_s[(n+1) * 9 + 0], PRIM_INT__p_s_d_s[n * 18 + 1]);
                        ...
                        PRIM_INT__p_s_d_s[n * 18 + 7] = SIMINT_MUL(Q_PA[1], PRIM_INT__p_s_p_s[n * 9 + 3]);
                        PRIM_INT__p_s_d_s[n * 18 + 7] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_p_s[(n+1) * 9 + 3], PRIM_INT__p_s_d_s[n * 18 + 7]);
                        ...
                        PRIM_INT__p_s_d_s[n * 18 + 13] = SIMINT_MUL(Q_PA[1], PRIM_INT__p_s_p_s[n * 9 + 6]);
                        PRIM_INT__p_s_d_s[n * 18 + 13] = SIMINT_FMADD( aoq_PQ[1], PRIM_INT__p_s_p_s[(n+1) * 9 + 6], PRIM_INT__p_s_d_s[n * 18 + 13]);
                    ...
                    for(n = 0; n < 2; ++n)  // loop over orders of auxiliary function
                    {
                        ...
                        PRIM_INT__p_s_f_s[n * 30 + 3] = SIMINT_MUL(Q_PA[0], PRIM_INT__p_s_d_s[n * 18 + 3]);
                        PRIM_INT__p_s_f_s[n * 30 + 3] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_d_s[(n+1) * 18 + 3], PRIM_INT__p_s_f_s[n * 30 + 3]);
                        PRIM_INT__p_s_f_s[n * 30 + 3] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_d_s[(n+1) * 6 + 3], PRIM_INT__p_s_f_s[n * 30 + 3]);

                        PRIM_INT__p_s_f_s[n * 30 + 5] = SIMINT_MUL(Q_PA[0], PRIM_INT__p_s_d_s[n * 18 + 5]);
                        PRIM_INT__p_s_f_s[n * 30 + 5] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_d_s[(n+1) * 18 + 5], PRIM_INT__p_s_f_s[n * 30 + 5]);
                        ...
                        PRIM_INT__p_s_f_s[n * 30 + 13] = SIMINT_MUL(Q_PA[0], PRIM_INT__p_s_d_s[n * 18 + 9]);
                        PRIM_INT__p_s_f_s[n * 30 + 13] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_d_s[(n+1) * 18 + 9], PRIM_INT__p_s_f_s[n * 30 + 13]);

                        PRIM_INT__p_s_f_s[n * 30 + 15] = SIMINT_MUL(Q_PA[0], PRIM_INT__p_s_d_s[n * 18 + 11]);
                        PRIM_INT__p_s_f_s[n * 30 + 15] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_d_s[(n+1) * 18 + 11], PRIM_INT__p_s_f_s[n * 30 + 15]);
                        ...
                        PRIM_INT__p_s_f_s[n * 30 + 23] = SIMINT_MUL(Q_PA[0], PRIM_INT__p_s_d_s[n * 18 + 15]);
                        PRIM_INT__p_s_f_s[n * 30 + 23] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_d_s[(n+1) * 18 + 15], PRIM_INT__p_s_f_s[n * 30 + 23]);

                        PRIM_INT__p_s_f_s[n * 30 + 25] = SIMINT_MUL(Q_PA[0], PRIM_INT__p_s_d_s[n * 18 + 17]);
                        PRIM_INT__p_s_f_s[n * 30 + 25] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_d_s[(n+1) * 18 + 17], PRIM_INT__p_s_f_s[n * 30 + 25]);
                    ...
                    if(lastoffset == 0)
                    {
                        contract_all(36, PRIM_INT__d_s_d_s, PRIM_PTR_INT__d_s_d_s);
                    ...
                    {
                        contract(36, shelloffsets, PRIM_INT__d_s_d_s, PRIM_PTR_INT__d_s_d_s);
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                // set up HRR pointers
                double const * restrict HRR_INT__d_s_d_s = INT__d_s_d_s + abcd * 36;
                ...
                double * restrict HRR_INT__d_d_d_d = INT__d_d_d_d + real_abcd * 1296;

                // form INT__d_p_d_s
                for(iket = 0; iket < 6; ++iket)
                {
                    HRR_INT__d_p_d_s[0 * 6 + iket] = HRR_INT__f_s_d_s[0 * 6 + iket] + ( hAB[0] * HRR_INT__d_s_d_s[0 * 6 + iket] );

                    HRR_INT__d_p_d_s[1 * 6 + iket] = HRR_INT__f_s_d_s[1 * 6 + iket] + ( hAB[1] * HRR_INT__d_s_d_s[0 * 6 + iket] );

                    HRR_INT__d_p_d_s[2 * 6 + iket] = HRR_INT__f_s_d_s[2 * 6 + iket] + ( hAB[2] * HRR_INT__d_s_d_s[0 * 6 + iket] );

                    HRR_INT__d_p_d_s[3 * 6 + iket] = HRR_INT__f_s_d_s[1 * 6 + iket] + ( hAB[0] * HRR_INT__d_s_d_s[1 * 6 + iket] );

                    HRR_INT__d_p_d_s[4 * 6 + iket] = HRR_INT__f_s_d_s[3 * 6 + iket] + ( hAB[1] * HRR_INT__d_s_d_s[1 * 6 + iket] );

                    HRR_INT__d_p_d_s[5 * 6 + iket] = HRR_INT__f_s_d_s[4 * 6 + iket] + ( hAB[2] * HRR_INT__d_s_d_s[1 * 6 + iket] );

                    HRR_INT__d_p_d_s[6 * 6 + iket] = HRR_INT__f_s_d_s[2 * 6 + iket] + ( hAB[0] * HRR_INT__d_s_d_s[2 * 6 + iket] );

                    HRR_INT__d_p_d_s[7 * 6 + iket] = HRR_INT__f_s_d_s[4 * 6 + iket] + ( hAB[1] * HRR_INT__d_s_d_s[2 * 6 + iket] );

                    HRR_INT__d_p_d_s[8 * 6 + iket] = HRR_INT__f_s_d_s[5 * 6 + iket] + ( hAB[2] * HRR_INT__d_s_d_s[2 * 6 + iket] );

                    HRR_INT__d_p_d_s[9 * 6 + iket] = HRR_INT__f_s_d_s[3 * 6 + iket] + ( hAB[0] * HRR_INT__d_s_d_s[3 * 6 + iket] );

                    HRR_INT__d_p_d_s[10 * 6 + iket] = HRR_INT__f_s_d_s[6 * 6 + iket] + ( hAB[1] * HRR_INT__d_s_d_s[3 * 6 + iket] );

                    HRR_INT__d_p_d_s[11 * 6 + iket] = HRR_INT__f_s_d_s[7 * 6 + iket] + ( hAB[2] * HRR_INT__d_s_d_s[3 * 6 + iket] );

                    HRR_INT__d_p_d_s[12 * 6 + iket] = HRR_INT__f_s_d_s[4 * 6 + iket] + ( hAB[0] * HRR_INT__d_s_d_s[4 * 6 + iket] );

                    HRR_INT__d_p_d_s[13 * 6 + iket] = HRR_INT__f_s_d_s[7 * 6 + iket] + ( hAB[1] * HRR_INT__d_s_d_s[4 * 6 + iket] );

                    HRR_INT__d_p_d_s[14 * 6 + iket] = HRR_INT__f_s_d_s[8 * 6 + iket] + ( hAB[2] * HRR_INT__d_s_d_s[4 * 6 + iket] );

                    HRR_INT__d_p_d_s[15 * 6 + iket] = HRR_INT__f_s_d_s[5 * 6 + iket] + ( hAB[0] * HRR_INT__d_s_d_s[5 * 6 + iket] );

                    HRR_INT__d_p_d_s[16 * 6 + iket] = HRR_INT__f_s_d_s[8 * 6 + iket] + ( hAB[1] * HRR_INT__d_s_d_s[5 * 6 + iket] );

                    HRR_INT__d_p_d_s[17 * 6 + iket] = HRR_INT__f_s_d_s[9 * 6 + iket] + ( hAB[2] * HRR_INT__d_s_d_s[5 * 6 + iket] );
                ...
                {
                    HRR_INT__d_p_f_s[0 * 10 + iket] = HRR_INT__f_s_f_s[0 * 10 + iket] + ( hAB[0] * HRR_INT__d_s_f_s[0 * 10 + iket] );

                    HRR_INT__d_p_f_s[1 * 10 + iket] = HRR_INT__f_s_f_s[1 * 10 + iket] + ( hAB[1] * HRR_INT__d_s_f_s[0 * 10 + iket] );

                    HRR_INT__d_p_f_s[2 * 10 + iket] = HRR_INT__f_s_f_s[2 * 10 + iket] + ( hAB[2] * HRR_INT__d_s_f_s[0 * 10 + iket] );

                    HRR_INT__d_p_f_s[3 * 10 + iket] = HRR_INT__f_s_f_s[1 * 10 + iket] + ( hAB[0] * HRR_INT__d_s_f_s[1 * 10 + iket] );

                    HRR_INT__d_p_f_s[4 * 10 + iket] = HRR_INT__f_s_f_s[3 * 10 + iket] + ( hAB[1] * HRR_INT__d_s_f_s[1 * 10 + iket] );

                    HRR_INT__d_p_f_s[5 * 10 + iket] = HRR_INT__f_s_f_s[4 * 10 + iket] + ( hAB[2] * HRR_INT__d_s_f_s[1 * 10 + iket] );

                    HRR_INT__d_p_f_s[6 * 10 + iket] = HRR_INT__f_s_f_s[2 * 10 + iket] + ( hAB[0] * HRR_INT__d_s_f_s[2 * 10 + iket] );

                    HRR_INT__d_p_f_s[7 * 10 + iket] = HRR_INT__f_s_f_s[4 * 10 + iket] + ( hAB[1] * HRR_INT__d_s_f_s[2 * 10 + iket] );

                    HRR_INT__d_p_f_s[8 * 10 + iket] = HRR_INT__f_s_f_s[5 * 10 + iket] + ( hAB[2] * HRR_INT__d_s_f_s[2 * 10 + iket] );

                    HRR_INT__d_p_f_s[9 * 10 + iket] = HRR_INT__f_s_f_s[3 * 10 + iket] + ( hAB[0] * HRR_INT__d_s_f_s[3 * 10 + iket] );

                    HRR_INT__d_p_f_s[10 * 10 + iket] = HRR_INT__f_s_f_s[6 * 10 + iket] + ( hAB[1] * HRR_INT__d_s_f_s[3 * 10 + iket] );

                    HRR_INT__d_p_f_s[11 * 10 + iket] = HRR_INT__f_s_f_s[7 * 10 + iket] + ( hAB[2] * HRR_INT__d_s_f_s[3 * 10 + iket] );

                    HRR_INT__d_p_f_s[12 * 10 + iket] = HRR_INT__f_s_f_s[4 * 10 + iket] + ( hAB[0] * HRR_INT__d_s_f_s[4 * 10 + iket] );

                    HRR_INT__d_p_f_s[13 * 10 + iket] = HRR_INT__f_s_f_s[7 * 10 + iket] + ( hAB[1] * HRR_INT__d_s_f_s[4 * 10 + iket] );

                    HRR_INT__d_p_f_s[14 * 10 + iket] = HRR_INT__f_s_f_s[8 * 10 + iket] + ( hAB[2] * HRR_INT__d_s_f_s[4 * 10 + iket] );

                    HRR_INT__d_p_f_s[15 * 10 + iket] = HRR_INT__f_s_f_s[5 * 10 + iket] + ( hAB[0] * HRR_INT__d_s_f_s[5 * 10 + iket] );

                    HRR_INT__d_p_f_s[16 * 10 + iket] = HRR_INT__f_s_f_s[8 * 10 + iket] + ( hAB[1] * HRR_INT__d_s_f_s[5 * 10 + iket] );

                    HRR_INT__d_p_f_s[17 * 10 + iket] = HRR_INT__f_s_f_s[9 * 10 + iket] + ( hAB[2] * HRR_INT__d_s_f_s[5 * 10 + iket] );
                ...
                for(iket = 0; iket < 6; ++iket)
                {
                    HRR_INT__d_d_d_s[0 * 6 + iket] = HRR_INT__f_p_d_s[0 * 6 + iket] + ( hAB[0] * HRR_INT__d_p_d_s[0 * 6 + iket] );

                    HRR_INT__d_d_d_s[1 * 6 + iket] = HRR_INT__f_p_d_s[3 * 6 + iket] + ( hAB[1] * HRR_INT__d_p_d_s[0 * 6 + iket] );

                    HRR_INT__d_d_d_s[2 * 6 + iket] = HRR_INT__f_p_d_s[6 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[0 * 6 + iket] );

                    HRR_INT__d_d_d_s[3 * 6 + iket] = HRR_INT__f_p_d_s[4 * 6 + iket] + ( hAB[1] * HRR_INT__d_p_d_s[1 * 6 + iket] );

                    HRR_INT__d_d_d_s[4 * 6 + iket] = HRR_INT__f_p_d_s[7 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[1 * 6 + iket] );

                    HRR_INT__d_d_d_s[5 * 6 + iket] = HRR_INT__f_p_d_s[8 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[2 * 6 + iket] );

                    HRR_INT__d_d_d_s[6 * 6 + iket] = HRR_INT__f_p_d_s[3 * 6 + iket] + ( hAB[0] * HRR_INT__d_p_d_s[3 * 6 + iket] );

                    HRR_INT__d_d_d_s[7 * 6 + iket] = HRR_INT__f_p_d_s[9 * 6 + iket] + ( hAB[1] * HRR_INT__d_p_d_s[3 * 6 + iket] );

                    HRR_INT__d_d_d_s[8 * 6 + iket] = HRR_INT__f_p_d_s[12 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[3 * 6 + iket] );

                    HRR_INT__d_d_d_s[9 * 6 + iket] = HRR_INT__f_p_d_s[10 * 6 + iket] + ( hAB[1] * HRR_INT__d_p_d_s[4 * 6 + iket] );

                    HRR_INT__d_d_d_s[10 * 6 + iket] = HRR_INT__f_p_d_s[13 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[4 * 6 + iket] );

                    HRR_INT__d_d_d_s[11 * 6 + iket] = HRR_INT__f_p_d_s[14 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[5 * 6 + iket] );

                    HRR_INT__d_d_d_s[12 * 6 + iket] = HRR_INT__f_p_d_s[6 * 6 + iket] + ( hAB[0] * HRR_INT__d_p_d_s[6 * 6 + iket] );

                    HRR_INT__d_d_d_s[13 * 6 + iket] = HRR_INT__f_p_d_s[12 * 6 + iket] + ( hAB[1] * HRR_INT__d_p_d_s[6 * 6 + iket] );

                    HRR_INT__d_d_d_s[14 * 6 + iket] = HRR_INT__f_p_d_s[15 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[6 * 6 + iket] );

                    HRR_INT__d_d_d_s[15 * 6 + iket] = HRR_INT__f_p_d_s[13 * 6 + iket] + ( hAB[1] * HRR_INT__d_p_d_s[7 * 6 + iket] );

                    HRR_INT__d_d_d_s[16 * 6 + iket] = HRR_INT__f_p_d_s[16 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[7 * 6 + iket] );

                    HRR_INT__d_d_d_s[17 * 6 + iket] = HRR_INT__f_p_d_s[17 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[8 * 6 + iket] );

                    HRR_INT__d_d_d_s[18 * 6 + iket] = HRR_INT__f_p_d_s[9 * 6 + iket] + ( hAB[0] * HRR_INT__d_p_d_s[9 * 6 + iket] );

                    HRR_INT__d_d_d_s[19 * 6 + iket] = HRR_INT__f_p_d_s[18 * 6 + iket] + ( hAB[1] * HRR_INT__d_p_d_s[9 * 6 + iket] );

                    HRR_INT__d_d_d_s[20 * 6 + iket] = HRR_INT__f_p_d_s[21 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[9 * 6 + iket] );

                    HRR_INT__d_d_d_s[21 * 6 + iket] = HRR_INT__f_p_d_s[19 * 6 + iket] + ( hAB[1] * HRR_INT__d_p_d_s[10 * 6 + iket] );

                    HRR_INT__d_d_d_s[22 * 6 + iket] = HRR_INT__f_p_d_s[22 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[10 * 6 + iket] );

                    HRR_INT__d_d_d_s[23 * 6 + iket] = HRR_INT__f_p_d_s[23 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[11 * 6 + iket] );

                    HRR_INT__d_d_d_s[24 * 6 + iket] = HRR_INT__f_p_d_s[12 * 6 + iket] + ( hAB[0] * HRR_INT__d_p_d_s[12 * 6 + iket] );

                    HRR_INT__d_d_d_s[25 * 6 + iket] = HRR_INT__f_p_d_s[21 * 6 + iket] + ( hAB[1] * HRR_INT__d_p_d_s[12 * 6 + iket] );

                    HRR_INT__d_d_d_s[26 * 6 + iket] = HRR_INT__f_p_d_s[24 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[12 * 6 + iket] );

                    HRR_INT__d_d_d_s[27 * 6 + iket] = HRR_INT__f_p_d_s[22 * 6 + iket] + ( hAB[1] * HRR_INT__d_p_d_s[13 * 6 + iket] );

                    HRR_INT__d_d_d_s[28 * 6 + iket] = HRR_INT__f_p_d_s[25 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[13 * 6 + iket] );

                    HRR_INT__d_d_d_s[29 * 6 + iket] = HRR_INT__f_p_d_s[26 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[14 * 6 + iket] );

                    HRR_INT__d_d_d_s[30 * 6 + iket] = HRR_INT__f_p_d_s[15 * 6 + iket] + ( hAB[0] * HRR_INT__d_p_d_s[15 * 6 + iket] );

                    HRR_INT__d_d_d_s[31 * 6 + iket] = HRR_INT__f_p_d_s[24 * 6 + iket] + ( hAB[1] * HRR_INT__d_p_d_s[15 * 6 + iket] );

                    HRR_INT__d_d_d_s[32 * 6 + iket] = HRR_INT__f_p_d_s[27 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[15 * 6 + iket] );

                    HRR_INT__d_d_d_s[33 * 6 + iket] = HRR_INT__f_p_d_s[25 * 6 + iket] + ( hAB[1] * HRR_INT__d_p_d_s[16 * 6 + iket] );

                    HRR_INT__d_d_d_s[34 * 6 + iket] = HRR_INT__f_p_d_s[28 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[16 * 6 + iket] );

                    HRR_INT__d_d_d_s[35 * 6 + iket] = HRR_INT__f_p_d_s[29 * 6 + iket] + ( hAB[2] * HRR_INT__d_p_d_s[17 * 6 + iket] );
                ...
                for(iket = 0; iket < 10; ++iket)
                {
                    HRR_INT__d_d_f_s[0 * 10 + iket] = HRR_INT__f_p_f_s[0 * 10 + iket] + ( hAB[0] * HRR_INT__d_p_f_s[0 * 10 + iket] );

                    HRR_INT__d_d_f_s[1 * 10 + iket] = HRR_INT__f_p_f_s[3 * 10 + iket] + ( hAB[1] * HRR_INT__d_p_f_s[0 * 10 + iket] );

                    HRR_INT__d_d_f_s[2 * 10 + iket] = HRR_INT__f_p_f_s[6 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[0 * 10 + iket] );

                    HRR_INT__d_d_f_s[3 * 10 + iket] = HRR_INT__f_p_f_s[4 * 10 + iket] + ( hAB[1] * HRR_INT__d_p_f_s[1 * 10 + iket] );

                    HRR_INT__d_d_f_s[4 * 10 + iket] = HRR_INT__f_p_f_s[7 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[1 * 10 + iket] );

                    HRR_INT__d_d_f_s[5 * 10 + iket] = HRR_INT__f_p_f_s[8 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[2 * 10 + iket] );

                    HRR_INT__d_d_f_s[6 * 10 + iket] = HRR_INT__f_p_f_s[3 * 10 + iket] + ( hAB[0] * HRR_INT__d_p_f_s[3 * 10 + iket] );

                    HRR_INT__d_d_f_s[7 * 10 + iket] = HRR_INT__f_p_f_s[9 * 10 + iket] + ( hAB[1] * HRR_INT__d_p_f_s[3 * 10 + iket] );

                    HRR_INT__d_d_f_s[8 * 10 + iket] = HRR_INT__f_p_f_s[12 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[3 * 10 + iket] );

                    HRR_INT__d_d_f_s[9 * 10 + iket] = HRR_INT__f_p_f_s[10 * 10 + iket] + ( hAB[1] * HRR_INT__d_p_f_s[4 * 10 + iket] );

                    HRR_INT__d_d_f_s[10 * 10 + iket] = HRR_INT__f_p_f_s[13 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[4 * 10 + iket] );

                    HRR_INT__d_d_f_s[11 * 10 + iket] = HRR_INT__f_p_f_s[14 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[5 * 10 + iket] );

                    HRR_INT__d_d_f_s[12 * 10 + iket] = HRR_INT__f_p_f_s[6 * 10 + iket] + ( hAB[0] * HRR_INT__d_p_f_s[6 * 10 + iket] );

                    HRR_INT__d_d_f_s[13 * 10 + iket] = HRR_INT__f_p_f_s[12 * 10 + iket] + ( hAB[1] * HRR_INT__d_p_f_s[6 * 10 + iket] );

                    HRR_INT__d_d_f_s[14 * 10 + iket] = HRR_INT__f_p_f_s[15 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[6 * 10 + iket] );

                    HRR_INT__d_d_f_s[15 * 10 + iket] = HRR_INT__f_p_f_s[13 * 10 + iket] + ( hAB[1] * HRR_INT__d_p_f_s[7 * 10 + iket] );

                    HRR_INT__d_d_f_s[16 * 10 + iket] = HRR_INT__f_p_f_s[16 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[7 * 10 + iket] );

                    HRR_INT__d_d_f_s[17 * 10 + iket] = HRR_INT__f_p_f_s[17 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[8 * 10 + iket] );

                    HRR_INT__d_d_f_s[18 * 10 + iket] = HRR_INT__f_p_f_s[9 * 10 + iket] + ( hAB[0] * HRR_INT__d_p_f_s[9 * 10 + iket] );

                    HRR_INT__d_d_f_s[19 * 10 + iket] = HRR_INT__f_p_f_s[18 * 10 + iket] + ( hAB[1] * HRR_INT__d_p_f_s[9 * 10 + iket] );

                    HRR_INT__d_d_f_s[20 * 10 + iket] = HRR_INT__f_p_f_s[21 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[9 * 10 + iket] );

                    HRR_INT__d_d_f_s[21 * 10 + iket] = HRR_INT__f_p_f_s[19 * 10 + iket] + ( hAB[1] * HRR_INT__d_p_f_s[10 * 10 + iket] );

                    HRR_INT__d_d_f_s[22 * 10 + iket] = HRR_INT__f_p_f_s[22 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[10 * 10 + iket] );

                    HRR_INT__d_d_f_s[23 * 10 + iket] = HRR_INT__f_p_f_s[23 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[11 * 10 + iket] );

                    HRR_INT__d_d_f_s[24 * 10 + iket] = HRR_INT__f_p_f_s[12 * 10 + iket] + ( hAB[0] * HRR_INT__d_p_f_s[12 * 10 + iket] );

                    HRR_INT__d_d_f_s[25 * 10 + iket] = HRR_INT__f_p_f_s[21 * 10 + iket] + ( hAB[1] * HRR_INT__d_p_f_s[12 * 10 + iket] );

                    HRR_INT__d_d_f_s[26 * 10 + iket] = HRR_INT__f_p_f_s[24 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[12 * 10 + iket] );

                    HRR_INT__d_d_f_s[27 * 10 + iket] = HRR_INT__f_p_f_s[22 * 10 + iket] + ( hAB[1] * HRR_INT__d_p_f_s[13 * 10 + iket] );

                    HRR_INT__d_d_f_s[28 * 10 + iket] = HRR_INT__f_p_f_s[25 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[13 * 10 + iket] );

                    HRR_INT__d_d_f_s[29 * 10 + iket] = HRR_INT__f_p_f_s[26 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[14 * 10 + iket] );

                    HRR_INT__d_d_f_s[30 * 10 + iket] = HRR_INT__f_p_f_s[15 * 10 + iket] + ( hAB[0] * HRR_INT__d_p_f_s[15 * 10 + iket] );

                    HRR_INT__d_d_f_s[31 * 10 + iket] = HRR_INT__f_p_f_s[24 * 10 + iket] + ( hAB[1] * HRR_INT__d_p_f_s[15 * 10 + iket] );

                    HRR_INT__d_d_f_s[32 * 10 + iket] = HRR_INT__f_p_f_s[27 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[15 * 10 + iket] );

                    HRR_INT__d_d_f_s[33 * 10 + iket] = HRR_INT__f_p_f_s[25 * 10 + iket] + ( hAB[1] * HRR_INT__d_p_f_s[16 * 10 + iket] );

                    HRR_INT__d_d_f_s[34 * 10 + iket] = HRR_INT__f_p_f_s[28 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[16 * 10 + iket] );

                    HRR_INT__d_d_f_s[35 * 10 + iket] = HRR_INT__f_p_f_s[29 * 10 + iket] + ( hAB[2] * HRR_INT__d_p_f_s[17 * 10 + iket] );
                ...
                {
                    HRR_INT__d_d_d_p[ibra * 18 + 0] = HRR_INT__d_d_f_s[ibra * 10 + 0] + ( hCD[0] * HRR_INT__d_d_d_s[ibra * 6 + 0] );

                    HRR_INT__d_d_d_p[ibra * 18 + 1] = HRR_INT__d_d_f_s[ibra * 10 + 1] + ( hCD[1] * HRR_INT__d_d_d_s[ibra * 6 + 0] );

                    HRR_INT__d_d_d_p[ibra * 18 + 2] = HRR_INT__d_d_f_s[ibra * 10 + 2] + ( hCD[2] * HRR_INT__d_d_d_s[ibra * 6 + 0] );

                    HRR_INT__d_d_d_p[ibra * 18 + 3] = HRR_INT__d_d_f_s[ibra * 10 + 1] + ( hCD[0] * HRR_INT__d_d_d_s[ibra * 6 + 1] );

                    HRR_INT__d_d_d_p[ibra * 18 + 4] = HRR_INT__d_d_f_s[ibra * 10 + 3] + ( hCD[1] * HRR_INT__d_d_d_s[ibra * 6 + 1] );

                    HRR_INT__d_d_d_p[ibra * 18 + 5] = HRR_INT__d_d_f_s[ibra * 10 + 4] + ( hCD[2] * HRR_INT__d_d_d_s[ibra * 6 + 1] );

                    HRR_INT__d_d_d_p[ibra * 18 + 6] = HRR_INT__d_d_f_s[ibra * 10 + 2] + ( hCD[0] * HRR_INT__d_d_d_s[ibra * 6 + 2] );

                    HRR_INT__d_d_d_p[ibra * 18 + 7] = HRR_INT__d_d_f_s[ibra * 10 + 4] + ( hCD[1] * HRR_INT__d_d_d_s[ibra * 6 + 2] );

                    HRR_INT__d_d_d_p[ibra * 18 + 8] = HRR_INT__d_d_f_s[ibra * 10 + 5] + ( hCD[2] * HRR_INT__d_d_d_s[ibra * 6 + 2] );

                    HRR_INT__d_d_d_p[ibra * 18 + 9] = HRR_INT__d_d_f_s[ibra * 10 + 3] + ( hCD[0] * HRR_INT__d_d_d_s[ibra * 6 + 3] );

                    HRR_INT__d_d_d_p[ibra * 18 + 10] = HRR_INT__d_d_f_s[ibra * 10 + 6] + ( hCD[1] * HRR_INT__d_d_d_s[ibra * 6 + 3] );

                    HRR_INT__d_d_d_p[ibra * 18 + 11] = HRR_INT__d_d_f_s[ibra * 10 + 7] + ( hCD[2] * HRR_INT__d_d_d_s[ibra * 6 + 3] );

                    HRR_INT__d_d_d_p[ibra * 18 + 12] = HRR_INT__d_d_f_s[ibra * 10 + 4] + ( hCD[0] * HRR_INT__d_d_d_s[ibra * 6 + 4] );

                    HRR_INT__d_d_d_p[ibra * 18 + 13] = HRR_INT__d_d_f_s[ibra * 10 + 7] + ( hCD[1] * HRR_INT__d_d_d_s[ibra * 6 + 4] );

                    HRR_INT__d_d_d_p[ibra * 18 + 14] = HRR_INT__d_d_f_s[ibra * 10 + 8] + ( hCD[2] * HRR_INT__d_d_d_s[ibra * 6 + 4] );

                    HRR_INT__d_d_d_p[ibra * 18 + 15] = HRR_INT__d_d_f_s[ibra * 10 + 5] + ( hCD[0] * HRR_INT__d_d_d_s[ibra * 6 + 5] );

                    HRR_INT__d_d_d_p[ibra * 18 + 16] = HRR_INT__d_d_f_s[ibra * 10 + 8] + ( hCD[1] * HRR_INT__d_d_d_s[ibra * 6 + 5] );

                    HRR_INT__d_d_d_p[ibra * 18 + 17] = HRR_INT__d_d_f_s[ibra * 10 + 9] + ( hCD[2] * HRR_INT__d_d_d_s[ibra * 6 + 5] );
                ...
                for(ibra = 0; ibra < 36; ++ibra)
                {
                    HRR_INT__d_d_f_p[ibra * 30 + 0] = HRR_INT__d_d_g_s[ibra * 15 + 0] + ( hCD[0] * HRR_INT__d_d_f_s[ibra * 10 + 0] );

                    HRR_INT__d_d_f_p[ibra * 30 + 3] = HRR_INT__d_d_g_s[ibra * 15 + 1] + ( hCD[0] * HRR_INT__d_d_f_s[ibra * 10 + 1] );

                    HRR_INT__d_d_f_p[ibra * 30 + 4] = HRR_INT__d_d_g_s[ibra * 15 + 3] + ( hCD[1] * HRR_INT__d_d_f_s[ibra * 10 + 1] );

                    HRR_INT__d_d_f_p[ibra * 30 + 6] = HRR_INT__d_d_g_s[ibra * 15 + 2] + ( hCD[0] * HRR_INT__d_d_f_s[ibra * 10 + 2] );

                    HRR_INT__d_d_f_p[ibra * 30 + 7] = HRR_INT__d_d_g_s[ibra * 15 + 4] + ( hCD[1] * HRR_INT__d_d_f_s[ibra * 10 + 2] );

                    HRR_INT__d_d_f_p[ibra * 30 + 8] = HRR_INT__d_d_g_s[ibra * 15 + 5] + ( hCD[2] * HRR_INT__d_d_f_s[ibra * 10 + 2] );

                    HRR_INT__d_d_f_p[ibra * 30 + 9] = HRR_INT__d_d_g_s[ibra * 15 + 3] + ( hCD[0] * HRR_INT__d_d_f_s[ibra * 10 + 3] );

                    HRR_INT__d_d_f_p[ibra * 30 + 10] = HRR_INT__d_d_g_s[ibra * 15 + 6] + ( hCD[1] * HRR_INT__d_d_f_s[ibra * 10 + 3] );

                    HRR_INT__d_d_f_p[ibra * 30 + 12] = HRR_INT__d_d_g_s[ibra * 15 + 4] + ( hCD[0] * HRR_INT__d_d_f_s[ibra * 10 + 4] );

                    HRR_INT__d_d_f_p[ibra * 30 + 13] = HRR_INT__d_d_g_s[ibra * 15 + 7] + ( hCD[1] * HRR_INT__d_d_f_s[ibra * 10 + 4] );

                    HRR_INT__d_d_f_p[ibra * 30 + 14] = HRR_INT__d_d_g_s[ibra * 15 + 8] + ( hCD[2] * HRR_INT__d_d_f_s[ibra * 10 + 4] );

                    HRR_INT__d_d_f_p[ibra * 30 + 15] = HRR_INT__d_d_g_s[ibra * 15 + 5] + ( hCD[0] * HRR_INT__d_d_f_s[ibra * 10 + 5] );

                    HRR_INT__d_d_f_p[ibra * 30 + 16] = HRR_INT__d_d_g_s[ibra * 15 + 8] + ( hCD[1] * HRR_INT__d_d_f_s[ibra * 10 + 5] );

                    HRR_INT__d_d_f_p[ibra * 30 + 17] = HRR_INT__d_d_g_s[ibra * 15 + 9] + ( hCD[2] * HRR_INT__d_d_f_s[ibra * 10 + 5] );

                    HRR_INT__d_d_f_p[ibra * 30 + 18] = HRR_INT__d_d_g_s[ibra * 15 + 6] + ( hCD[0] * HRR_INT__d_d_f_s[ibra * 10 + 6] );

                    HRR_INT__d_d_f_p[ibra * 30 + 19] = HRR_INT__d_d_g_s[ibra * 15 + 10] + ( hCD[1] * HRR_INT__d_d_f_s[ibra * 10 + 6] );

                    HRR_INT__d_d_f_p[ibra * 30 + 21] = HRR_INT__d_d_g_s[ibra * 15 + 7] + ( hCD[0] * HRR_INT__d_d_f_s[ibra * 10 + 7] );

                    HRR_INT__d_d_f_p[ibra * 30 + 22] = HRR_INT__d_d_g_s[ibra * 15 + 11] + ( hCD[1] * HRR_INT__d_d_f_s[ibra * 10 + 7] );

                    HRR_INT__d_d_f_p[ibra * 30 + 23] = HRR_INT__d_d_g_s[ibra * 15 + 12] + ( hCD[2] * HRR_INT__d_d_f_s[ibra * 10 + 7] );

                    HRR_INT__d_d_f_p[ibra * 30 + 24] = HRR_INT__d_d_g_s[ibra * 15 + 8] + ( hCD[0] * HRR_INT__d_d_f_s[ibra * 10 + 8] );

                    HRR_INT__d_d_f_p[ibra * 30 + 25] = HRR_INT__d_d_g_s[ibra * 15 + 12] + ( hCD[1] * HRR_INT__d_d_f_s[ibra * 10 + 8] );

                    HRR_INT__d_d_f_p[ibra * 30 + 26] = HRR_INT__d_d_g_s[ibra * 15 + 13] + ( hCD[2] * HRR_INT__d_d_f_s[ibra * 10 + 8] );

                    HRR_INT__d_d_f_p[ibra * 30 + 27] = HRR_INT__d_d_g_s[ibra * 15 + 9] + ( hCD[0] * HRR_INT__d_d_f_s[ibra * 10 + 9] );

                    HRR_INT__d_d_f_p[ibra * 30 + 28] = HRR_INT__d_d_g_s[ibra * 15 + 13] + ( hCD[1] * HRR_INT__d_d_f_s[ibra * 10 + 9] );

                    HRR_INT__d_d_f_p[ibra * 30 + 29] = HRR_INT__d_d_g_s[ibra * 15 + 14] + ( hCD[2] * HRR_INT__d_d_f_s[ibra * 10 + 9] );
                ...
                for(ibra = 0; ibra < 36; ++ibra)
                {
                    HRR_INT__d_d_d_d[ibra * 36 + 0] = HRR_INT__d_d_f_p[ibra * 30 + 0] + ( hCD[0] * HRR_INT__d_d_d_p[ibra * 18 + 0] );

                    HRR_INT__d_d_d_d[ibra * 36 + 1] = HRR_INT__d_d_f_p[ibra * 30 + 3] + ( hCD[1] * HRR_INT__d_d_d_p[ibra * 18 + 0] );

                    HRR_INT__d_d_d_d[ibra * 36 + 2] = HRR_INT__d_d_f_p[ibra * 30 + 6] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 0] );

                    HRR_INT__d_d_d_d[ibra * 36 + 3] = HRR_INT__d_d_f_p[ibra * 30 + 4] + ( hCD[1] * HRR_INT__d_d_d_p[ibra * 18 + 1] );

                    HRR_INT__d_d_d_d[ibra * 36 + 4] = HRR_INT__d_d_f_p[ibra * 30 + 7] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 1] );

                    HRR_INT__d_d_d_d[ibra * 36 + 5] = HRR_INT__d_d_f_p[ibra * 30 + 8] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 2] );

                    HRR_INT__d_d_d_d[ibra * 36 + 6] = HRR_INT__d_d_f_p[ibra * 30 + 3] + ( hCD[0] * HRR_INT__d_d_d_p[ibra * 18 + 3] );

                    HRR_INT__d_d_d_d[ibra * 36 + 7] = HRR_INT__d_d_f_p[ibra * 30 + 9] + ( hCD[1] * HRR_INT__d_d_d_p[ibra * 18 + 3] );

                    HRR_INT__d_d_d_d[ibra * 36 + 8] = HRR_INT__d_d_f_p[ibra * 30 + 12] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 3] );

                    HRR_INT__d_d_d_d[ibra * 36 + 9] = HRR_INT__d_d_f_p[ibra * 30 + 10] + ( hCD[1] * HRR_INT__d_d_d_p[ibra * 18 + 4] );

                    HRR_INT__d_d_d_d[ibra * 36 + 10] = HRR_INT__d_d_f_p[ibra * 30 + 13] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 4] );

                    HRR_INT__d_d_d_d[ibra * 36 + 11] = HRR_INT__d_d_f_p[ibra * 30 + 14] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 5] );

                    HRR_INT__d_d_d_d[ibra * 36 + 12] = HRR_INT__d_d_f_p[ibra * 30 + 6] + ( hCD[0] * HRR_INT__d_d_d_p[ibra * 18 + 6] );

                    HRR_INT__d_d_d_d[ibra * 36 + 13] = HRR_INT__d_d_f_p[ibra * 30 + 12] + ( hCD[1] * HRR_INT__d_d_d_p[ibra * 18 + 6] );

                    HRR_INT__d_d_d_d[ibra * 36 + 14] = HRR_INT__d_d_f_p[ibra * 30 + 15] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 6] );

                    HRR_INT__d_d_d_d[ibra * 36 + 15] = HRR_INT__d_d_f_p[ibra * 30 + 13] + ( hCD[1] * HRR_INT__d_d_d_p[ibra * 18 + 7] );

                    HRR_INT__d_d_d_d[ibra * 36 + 16] = HRR_INT__d_d_f_p[ibra * 30 + 16] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 7] );

                    HRR_INT__d_d_d_d[ibra * 36 + 17] = HRR_INT__d_d_f_p[ibra * 30 + 17] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 8] );

                    HRR_INT__d_d_d_d[ibra * 36 + 18] = HRR_INT__d_d_f_p[ibra * 30 + 9] + ( hCD[0] * HRR_INT__d_d_d_p[ibra * 18 + 9] );

                    HRR_INT__d_d_d_d[ibra * 36 + 19] = HRR_INT__d_d_f_p[ibra * 30 + 18] + ( hCD[1] * HRR_INT__d_d_d_p[ibra * 18 + 9] );

                    HRR_INT__d_d_d_d[ibra * 36 + 20] = HRR_INT__d_d_f_p[ibra * 30 + 21] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 9] );

                    HRR_INT__d_d_d_d[ibra * 36 + 21] = HRR_INT__d_d_f_p[ibra * 30 + 19] + ( hCD[1] * HRR_INT__d_d_d_p[ibra * 18 + 10] );

                    HRR_INT__d_d_d_d[ibra * 36 + 22] = HRR_INT__d_d_f_p[ibra * 30 + 22] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 10] );

                    HRR_INT__d_d_d_d[ibra * 36 + 23] = HRR_INT__d_d_f_p[ibra * 30 + 23] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 11] );

                    HRR_INT__d_d_d_d[ibra * 36 + 24] = HRR_INT__d_d_f_p[ibra * 30 + 12] + ( hCD[0] * HRR_INT__d_d_d_p[ibra * 18 + 12] );

                    HRR_INT__d_d_d_d[ibra * 36 + 25] = HRR_INT__d_d_f_p[ibra * 30 + 21] + ( hCD[1] * HRR_INT__d_d_d_p[ibra * 18 + 12] );

                    HRR_INT__d_d_d_d[ibra * 36 + 26] = HRR_INT__d_d_f_p[ibra * 30 + 24] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 12] );

                    HRR_INT__d_d_d_d[ibra * 36 + 27] = HRR_INT__d_d_f_p[ibra * 30 + 22] + ( hCD[1] * HRR_INT__d_d_d_p[ibra * 18 + 13] );

                    HRR_INT__d_d_d_d[ibra * 36 + 28] = HRR_INT__d_d_f_p[ibra * 30 + 25] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 13] );

                    HRR_INT__d_d_d_d[ibra * 36 + 29] = HRR_INT__d_d_f_p[ibra * 30 + 26] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 14] );

                    HRR_INT__d_d_d_d[ibra * 36 + 30] = HRR_INT__d_d_f_p[ibra * 30 + 15] + ( hCD[0] * HRR_INT__d_d_d_p[ibra * 18 + 15] );

                    HRR_INT__d_d_d_d[ibra * 36 + 31] = HRR_INT__d_d_f_p[ibra * 30 + 24] + ( hCD[1] * HRR_INT__d_d_d_p[ibra * 18 + 15] );

                    HRR_INT__d_d_d_d[ibra * 36 + 32] = HRR_INT__d_d_f_p[ibra * 30 + 27] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 15] );

                    HRR_INT__d_d_d_d[ibra * 36 + 33] = HRR_INT__d_d_f_p[ibra * 30 + 25] + ( hCD[1] * HRR_INT__d_d_d_p[ibra * 18 + 16] );

                    HRR_INT__d_d_d_d[ibra * 36 + 34] = HRR_INT__d_d_f_p[ibra * 30 + 28] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 16] );

                    HRR_INT__d_d_d_d[ibra * 36 + 35] = HRR_INT__d_d_f_p[ibra * 30 + 29] + ( hCD[2] * HRR_INT__d_d_d_p[ibra * 18 + 17] );
