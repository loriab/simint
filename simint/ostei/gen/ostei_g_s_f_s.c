                  ...
                  double * const restrict INT__g_s_f_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_s_f_s);
    memset(INT__g_s_f_s, 0, P.nshell12_clip * Q.nshell12_clip * 150 * sizeof(double));
                  ...
                  double * const restrict INT__s_g_f_s)
{
    ...
    int ret = ostei_g_s_f_s(P_tmp, Q, screen_tol, work, INT__s_g_f_s);
                  ...
                  double * const restrict INT__g_s_s_f)
{
    ...
    int ret = ostei_g_s_f_s(P, Q_tmp, screen_tol, work, INT__g_s_s_f);
                  ...
                  double * const restrict INT__s_g_s_f)
{
    ...
    int ret = ostei_g_s_f_s(P_tmp, Q_tmp, screen_tol, work, INT__s_g_s_f);
