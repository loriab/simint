                  ...
                  double * const restrict INT__d_d_f_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_d_f_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__f_s_f_s = work + (SIMINT_NSHELL_SIMD * 276);
    double * const INT__f_s_g_s = work + (SIMINT_NSHELL_SIMD * 376);
    double * const INT__f_s_h_s = work + (SIMINT_NSHELL_SIMD * 526);
    double * const INT__g_s_f_s = work + (SIMINT_NSHELL_SIMD * 736);
    double * const INT__g_s_g_s = work + (SIMINT_NSHELL_SIMD * 886);
    double * const INT__g_s_h_s = work + (SIMINT_NSHELL_SIMD * 1111);
    ...
    double * const HRR_INT__d_d_f_s = hrrwork + 828;
    double * const HRR_INT__d_d_f_p = hrrwork + 1188;
    double * const HRR_INT__d_d_g_s = hrrwork + 2268;
    double * const HRR_INT__d_d_g_p = hrrwork + 2808;
    double * const HRR_INT__d_d_h_s = hrrwork + 4428;
    double * const HRR_INT__f_p_f_s = hrrwork + 5184;
    double * const HRR_INT__f_p_g_s = hrrwork + 5484;
    double * const HRR_INT__f_p_h_s = hrrwork + 5934;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_d_f_d = INT__d_d_f_d + real_abcd * 2160;
