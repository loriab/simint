                  ...
                  double * const restrict INT__p_d_s_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_d_s_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_f_s_d = work + (SIMINT_NSHELL_SIMD * 36);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_p = primwork + 21;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_s = primwork + 39;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_p = primwork + 63;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_d = primwork + 99;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_s = primwork + 135;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_p = primwork + 165;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_d = primwork + 225;
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    // Forming PRIM_INT__s_d_s_p[2 * 18];
                    ...
                    // Forming PRIM_INT__s_f_s_p[2 * 30];
                    for(n = 0; n < 2; ++n)  // loop over orders of auxiliary function
                    {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_d_s_d = INT__p_d_s_d + real_abcd * 108;
