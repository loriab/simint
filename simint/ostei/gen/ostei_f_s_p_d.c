                  ...
                  double * const restrict INT__f_s_p_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_s_p_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 52;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_p = primwork + 82;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_d = primwork + 136;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 208;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_p = primwork + 248;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_d = primwork + 338;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_f = primwork + 458;
    double * const hrrwork = (double *)(primwork + 558);
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_s_p_d = INT__f_s_p_d + real_abcd * 180;

                // form INT__f_s_p_d
                for(ibra = 0; ibra < 10; ++ibra)
                {
                    HRR_INT__f_s_p_d[ibra * 18 + 0] = HRR_INT__f_s_s_f[ibra * 10 + 0] - ( hCD[0] * HRR_INT__f_s_s_d[ibra * 6 + 0] );

                    HRR_INT__f_s_p_d[ibra * 18 + 1] = HRR_INT__f_s_s_f[ibra * 10 + 1] - ( hCD[0] * HRR_INT__f_s_s_d[ibra * 6 + 1] );

                    HRR_INT__f_s_p_d[ibra * 18 + 2] = HRR_INT__f_s_s_f[ibra * 10 + 2] - ( hCD[0] * HRR_INT__f_s_s_d[ibra * 6 + 2] );

                    HRR_INT__f_s_p_d[ibra * 18 + 3] = HRR_INT__f_s_s_f[ibra * 10 + 3] - ( hCD[0] * HRR_INT__f_s_s_d[ibra * 6 + 3] );

                    HRR_INT__f_s_p_d[ibra * 18 + 4] = HRR_INT__f_s_s_f[ibra * 10 + 4] - ( hCD[0] * HRR_INT__f_s_s_d[ibra * 6 + 4] );

                    HRR_INT__f_s_p_d[ibra * 18 + 5] = HRR_INT__f_s_s_f[ibra * 10 + 5] - ( hCD[0] * HRR_INT__f_s_s_d[ibra * 6 + 5] );

                    HRR_INT__f_s_p_d[ibra * 18 + 6] = HRR_INT__f_s_s_f[ibra * 10 + 1] - ( hCD[1] * HRR_INT__f_s_s_d[ibra * 6 + 0] );

                    HRR_INT__f_s_p_d[ibra * 18 + 7] = HRR_INT__f_s_s_f[ibra * 10 + 3] - ( hCD[1] * HRR_INT__f_s_s_d[ibra * 6 + 1] );

                    HRR_INT__f_s_p_d[ibra * 18 + 8] = HRR_INT__f_s_s_f[ibra * 10 + 4] - ( hCD[1] * HRR_INT__f_s_s_d[ibra * 6 + 2] );

                    HRR_INT__f_s_p_d[ibra * 18 + 9] = HRR_INT__f_s_s_f[ibra * 10 + 6] - ( hCD[1] * HRR_INT__f_s_s_d[ibra * 6 + 3] );

                    HRR_INT__f_s_p_d[ibra * 18 + 10] = HRR_INT__f_s_s_f[ibra * 10 + 7] - ( hCD[1] * HRR_INT__f_s_s_d[ibra * 6 + 4] );

                    HRR_INT__f_s_p_d[ibra * 18 + 11] = HRR_INT__f_s_s_f[ibra * 10 + 8] - ( hCD[1] * HRR_INT__f_s_s_d[ibra * 6 + 5] );

                    HRR_INT__f_s_p_d[ibra * 18 + 12] = HRR_INT__f_s_s_f[ibra * 10 + 2] - ( hCD[2] * HRR_INT__f_s_s_d[ibra * 6 + 0] );

                    HRR_INT__f_s_p_d[ibra * 18 + 13] = HRR_INT__f_s_s_f[ibra * 10 + 4] - ( hCD[2] * HRR_INT__f_s_s_d[ibra * 6 + 1] );

                    HRR_INT__f_s_p_d[ibra * 18 + 14] = HRR_INT__f_s_s_f[ibra * 10 + 5] - ( hCD[2] * HRR_INT__f_s_s_d[ibra * 6 + 2] );

                    HRR_INT__f_s_p_d[ibra * 18 + 15] = HRR_INT__f_s_s_f[ibra * 10 + 7] - ( hCD[2] * HRR_INT__f_s_s_d[ibra * 6 + 3] );

                    HRR_INT__f_s_p_d[ibra * 18 + 16] = HRR_INT__f_s_s_f[ibra * 10 + 8] - ( hCD[2] * HRR_INT__f_s_s_d[ibra * 6 + 4] );

                    HRR_INT__f_s_p_d[ibra * 18 + 17] = HRR_INT__f_s_s_f[ibra * 10 + 9] - ( hCD[2] * HRR_INT__f_s_s_d[ibra * 6 + 5] );
