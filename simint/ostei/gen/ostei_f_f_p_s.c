                  ...
                  double * const restrict INT__f_f_p_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_f_p_s);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__g_s_p_s = work + (SIMINT_NSHELL_SIMD * 30);
    double * const INT__h_s_p_s = work + (SIMINT_NSHELL_SIMD * 75);
    double * const INT__i_s_p_s = work + (SIMINT_NSHELL_SIMD * 138);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 115;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 145;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 205;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 250;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 313;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 376;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_p_s = primwork + 432;
    double * const hrrwork = (double *)(primwork + 516);
    double * const HRR_INT__f_p_p_s = hrrwork + 0;
    double * const HRR_INT__f_d_p_s = hrrwork + 90;
    double * const HRR_INT__g_p_p_s = hrrwork + 270;
    double * const HRR_INT__g_d_p_s = hrrwork + 405;
    double * const HRR_INT__h_p_p_s = hrrwork + 675;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_f_p_s = INT__f_f_p_s + real_abcd * 300;
