                  ...
                  double * const restrict INT__d_p_s_s)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_p_s_s);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 13;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 25;
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    // Forming PRIM_INT__f_s_s_s[1 * 10];
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_p_s_s = INT__d_p_s_s + real_abcd * 18;
