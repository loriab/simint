                  ...
                  double * const restrict INT__s_p_d_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__s_p_d_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_p_s_h = work + (SIMINT_NSHELL_SIMD * 75);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_f = primwork + 182;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_g = primwork + 212;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_h = primwork + 257;
    double * const hrrwork = (double *)(primwork + 320);
    double * const HRR_INT__s_p_p_f = hrrwork + 0;
    double * const HRR_INT__s_p_p_g = hrrwork + 90;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                double * restrict PRIM_PTR_INT__s_p_s_h = INT__s_p_s_h + abcd * 63;
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    if(check_screen)
                    {
                        ...
                        if(vmax < screen_tol)
                        {
                            ...
                            PRIM_PTR_INT__s_p_s_h += lastoffset*63;
                            continue;
                        }
                    }
                    ...
                    if(lastoffset == 0)
                    {
                        ...
                        contract_all(63, PRIM_INT__s_p_s_h, PRIM_PTR_INT__s_p_s_h);
                    }
                    else
                    {
                        ...
                        contract(63, shelloffsets, PRIM_INT__s_p_s_h, PRIM_PTR_INT__s_p_s_h);
                        PRIM_PTR_INT__s_p_s_f += lastoffset*30;
                        PRIM_PTR_INT__s_p_s_g += lastoffset*45;
                        PRIM_PTR_INT__s_p_s_h += lastoffset*63;
                    }
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double const * restrict HRR_INT__s_p_s_h = INT__s_p_s_h + abcd * 63;
                double * restrict HRR_INT__s_p_d_f = INT__s_p_d_f + real_abcd * 180;
