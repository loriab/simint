                  ...
                  double * const restrict INT__p_f_f_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_f_f_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_p_s = primwork + 362;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_d_s = primwork + 398;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_f_s = primwork + 470;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_g_s = primwork + 590;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_h_s = primwork + 770;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_p_s = primwork + 1022;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_d_s = primwork + 1076;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_f_s = primwork + 1184;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_g_s = primwork + 1364;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_h_s = primwork + 1634;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_d_s = primwork + 2012;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_f_s = primwork + 2132;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_g_s = primwork + 2332;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_h_s = primwork + 2632;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_f_s = primwork + 3052;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_g_s = primwork + 3202;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_h_s = primwork + 3427;
    ...
    double * const HRR_INT__p_f_g_s = hrrwork + 1200;
    double * const HRR_INT__p_f_g_p = hrrwork + 1650;
    double * const HRR_INT__p_f_h_s = hrrwork + 3000;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_f_f_d = INT__p_f_f_d + real_abcd * 1800;
