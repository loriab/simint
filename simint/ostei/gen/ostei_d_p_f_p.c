                  ...
                  double * const restrict INT__d_p_f_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_p_f_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 175;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 202;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 256;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_g_s = primwork + 346;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 481;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 553;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 673;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 853;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 953;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_p_f_p = INT__d_p_f_p + real_abcd * 540;
