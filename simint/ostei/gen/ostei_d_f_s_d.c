                  ...
                  double * const restrict INT__d_f_s_d)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_f_s_d);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_g_s_d = work + (SIMINT_NSHELL_SIMD * 60);
    double * const INT__s_h_s_d = work + (SIMINT_NSHELL_SIMD * 150);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_p = primwork + 65;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_s = primwork + 101;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_p = primwork + 151;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_d = primwork + 211;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_s = primwork + 271;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_p = primwork + 331;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_d = primwork + 421;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_s_s = primwork + 511;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_s_p = primwork + 574;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_h_s_d = primwork + 700;
    double * const hrrwork = (double *)(primwork + 826);
    double * const HRR_INT__p_f_s_d = hrrwork + 0;
    double * const HRR_INT__p_g_s_d = hrrwork + 180;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_f_s_d = INT__d_f_s_d + real_abcd * 360;
