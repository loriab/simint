                  ...
                  double * const restrict INT__p_p_s_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_p_s_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__d_s_s_f = work + (SIMINT_NSHELL_SIMD * 30);
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*90);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_d = primwork + 75;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_f = primwork + 111;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_f = primwork + 171;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 90 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_p_s_f = INT__p_p_s_f + real_abcd * 90;
