                  ...
                  double * const restrict INT__p_f_d_p)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_f_d_p);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_g_d_s = work + (SIMINT_NSHELL_SIMD * 160);
    double * const INT__s_g_f_s = work + (SIMINT_NSHELL_SIMD * 250);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_p_s = primwork + 29;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_s = primwork + 56;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_p_s = primwork + 92;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_d_s = primwork + 146;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_s = primwork + 218;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_p_s = primwork + 268;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_d_s = primwork + 358;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_f_s = primwork + 478;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_s = primwork + 578;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_p_s = primwork + 638;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_d_s = primwork + 773;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_f_s = primwork + 953;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_f_d_p = INT__p_f_d_p + real_abcd * 540;
