                  ...
                  double * const restrict INT__g_f_f_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__g_f_f_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__g_s_i_s = work + (SIMINT_NSHELL_SIMD * 690);
    double * const INT__h_s_f_s = work + (SIMINT_NSHELL_SIMD * 1110);
    double * const INT__h_s_g_s = work + (SIMINT_NSHELL_SIMD * 1320);
    double * const INT__h_s_h_s = work + (SIMINT_NSHELL_SIMD * 1635);
    double * const INT__h_s_i_s = work + (SIMINT_NSHELL_SIMD * 2076);
    double * const INT__i_s_f_s = work + (SIMINT_NSHELL_SIMD * 2664);
    double * const INT__i_s_g_s = work + (SIMINT_NSHELL_SIMD * 2944);
    double * const INT__i_s_h_s = work + (SIMINT_NSHELL_SIMD * 3364);
    double * const INT__i_s_i_s = work + (SIMINT_NSHELL_SIMD * 3952);
    double * const INT__k_s_f_s = work + (SIMINT_NSHELL_SIMD * 4736);
    double * const INT__k_s_g_s = work + (SIMINT_NSHELL_SIMD * 5096);
    double * const INT__k_s_h_s = work + (SIMINT_NSHELL_SIMD * 5636);
    double * const INT__k_s_i_s = work + (SIMINT_NSHELL_SIMD * 6392);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_d_s = primwork + 32;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 62;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 101;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 155;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 245;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 365;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 437;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 545;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 725;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 965;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 1235;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 1345;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 1525;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 1825;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 2225;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_h_s = primwork + 2675;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 3095;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 3245;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 3515;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 3965;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 4565;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 5240;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_i_s = primwork + 5870;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 6290;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 6479;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_d_s = primwork + 6857;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_f_s = primwork + 7487;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_g_s = primwork + 8327;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_h_s = primwork + 9272;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_i_s = primwork + 10154;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 10742;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_p_s = primwork + 10966;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_d_s = primwork + 11470;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_f_s = primwork + 12310;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_g_s = primwork + 13430;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_h_s = primwork + 14690;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_i_s = primwork + 15866;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_s_s = primwork + 16650;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_p_s = primwork + 16902;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_d_s = primwork + 17550;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_f_s = primwork + 18630;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_g_s = primwork + 20070;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_h_s = primwork + 21690;
    SIMINT_DBLTYPE * const restrict PRIM_INT__k_s_i_s = primwork + 23202;
    ...
    double * const HRR_INT__g_p_i_s = hrrwork + 2070;
    double * const HRR_INT__g_d_f_s = hrrwork + 3330;
    double * const HRR_INT__g_d_g_s = hrrwork + 4230;
    double * const HRR_INT__g_d_h_s = hrrwork + 5580;
    double * const HRR_INT__g_d_i_s = hrrwork + 7470;
    double * const HRR_INT__g_f_f_s = hrrwork + 9990;
    double * const HRR_INT__g_f_f_p = hrrwork + 11490;
    double * const HRR_INT__g_f_f_d = hrrwork + 15990;
    double * const HRR_INT__g_f_g_s = hrrwork + 24990;
    double * const HRR_INT__g_f_g_p = hrrwork + 27240;
    double * const HRR_INT__g_f_g_d = hrrwork + 33990;
    double * const HRR_INT__g_f_h_s = hrrwork + 47490;
    double * const HRR_INT__g_f_h_p = hrrwork + 50640;
    double * const HRR_INT__g_f_i_s = hrrwork + 60090;
    double * const HRR_INT__h_p_f_s = hrrwork + 64290;
    double * const HRR_INT__h_p_g_s = hrrwork + 64920;
    double * const HRR_INT__h_p_h_s = hrrwork + 65865;
    double * const HRR_INT__h_p_i_s = hrrwork + 67188;
    double * const HRR_INT__h_d_f_s = hrrwork + 68952;
    double * const HRR_INT__h_d_g_s = hrrwork + 70212;
    double * const HRR_INT__h_d_h_s = hrrwork + 72102;
    double * const HRR_INT__h_d_i_s = hrrwork + 74748;
    double * const HRR_INT__i_p_f_s = hrrwork + 78276;
    double * const HRR_INT__i_p_g_s = hrrwork + 79116;
    double * const HRR_INT__i_p_h_s = hrrwork + 80376;
    double * const HRR_INT__i_p_i_s = hrrwork + 82140;
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    // Forming PRIM_INT__p_s_s_s[13 * 3];
                    ...
                    // Forming PRIM_INT__d_s_s_s[12 * 6];
                    ...
                    // Forming PRIM_INT__f_s_s_s[11 * 10];
                    ...
                    // Forming PRIM_INT__g_s_s_s[10 * 15];
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__g_f_f_f = INT__g_f_f_f + real_abcd * 15000;
                ...
                for(ibra = 0; ibra < 150; ++ibra)
                {
                    ...
                    HRR_INT__g_f_f_p[ibra * 30 + 1] = HRR_INT__g_f_g_s[ibra * 15 + 1] + ( hCD[1] * HRR_INT__g_f_f_s[ibra * 10 + 0] );

                    HRR_INT__g_f_f_p[ibra * 30 + 2] = HRR_INT__g_f_g_s[ibra * 15 + 2] + ( hCD[2] * HRR_INT__g_f_f_s[ibra * 10 + 0] );
                    ...
                    HRR_INT__g_f_f_p[ibra * 30 + 5] = HRR_INT__g_f_g_s[ibra * 15 + 4] + ( hCD[2] * HRR_INT__g_f_f_s[ibra * 10 + 1] );
                    ...
                    HRR_INT__g_f_f_p[ibra * 30 + 11] = HRR_INT__g_f_g_s[ibra * 15 + 7] + ( hCD[2] * HRR_INT__g_f_f_s[ibra * 10 + 3] );
                    ...
                    HRR_INT__g_f_f_p[ibra * 30 + 20] = HRR_INT__g_f_g_s[ibra * 15 + 11] + ( hCD[2] * HRR_INT__g_f_f_s[ibra * 10 + 6] );
                  ...
                  double * const restrict INT__f_g_f_f)
{
    ...
    int ret = ostei_g_f_f_f(P_tmp, Q, screen_tol, work, INT__f_g_f_f);
    ...
    for(int q = 0; q < ret; q++)
    {
        ...
        for(int c = 0; c < 10; ++c)
        for(int d = 0; d < 10; ++d)
            buffer[idx++] = INT__f_g_f_f[q*15000+b*1000+a*100+c*10+d];

        memcpy(INT__f_g_f_f+q*15000, buffer, 15000*sizeof(double));
    }
