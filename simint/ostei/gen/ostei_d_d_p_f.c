                  ...
                  double * const restrict INT__d_d_p_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__d_d_p_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__f_s_s_f = work + (SIMINT_NSHELL_SIMD * 150);
    double * const INT__f_s_s_g = work + (SIMINT_NSHELL_SIMD * 250);
    double * const INT__g_s_s_f = work + (SIMINT_NSHELL_SIMD * 400);
    double * const INT__g_s_s_g = work + (SIMINT_NSHELL_SIMD * 550);
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*775);
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_s = primwork + 0;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_p = primwork + 9;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_d = primwork + 21;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 39;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_p = primwork + 63;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_d = primwork + 99;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_f = primwork + 153;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 213;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_p = primwork + 255;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_d = primwork + 327;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_f = primwork + 435;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_g = primwork + 555;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 645;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_p = primwork + 705;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_d = primwork + 825;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_f = primwork + 1005;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_g = primwork + 1205;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 1355;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_p = primwork + 1430;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_d = primwork + 1610;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_f = primwork + 1880;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_g = primwork + 2180;
    ...
    double * const HRR_INT__d_d_s_f = hrrwork + 450;
    double * const HRR_INT__d_d_s_g = hrrwork + 810;
    double * const HRR_INT__f_p_s_f = hrrwork + 1350;
    double * const HRR_INT__f_p_s_g = hrrwork + 1650;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 775 * sizeof(double));
            abcd = 0;
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    // Forming PRIM_INT__d_s_s_p[4 * 18];
                    ...
                    // Forming PRIM_INT__p_s_s_d[3 * 18];
                    for(n = 0; n < 3; ++n)  // loop over orders of auxiliary function
                    {
                    ...
                    // Forming PRIM_INT__p_s_s_f[2 * 30];
                    for(n = 0; n < 2; ++n)  // loop over orders of auxiliary function
                    {
                        ...
                        PRIM_INT__p_s_s_f[n * 30 + 3] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_d[n * 18 + 3]);
                        PRIM_INT__p_s_s_f[n * 30 + 3] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_d[(n+1) * 18 + 3], PRIM_INT__p_s_s_f[n * 30 + 3]);
                        PRIM_INT__p_s_s_f[n * 30 + 3] = SIMINT_FMADD( vrr_const_1_over_2pq, PRIM_INT__s_s_s_d[(n+1) * 6 + 3], PRIM_INT__p_s_s_f[n * 30 + 3]);

                        PRIM_INT__p_s_s_f[n * 30 + 5] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_d[n * 18 + 5]);
                        PRIM_INT__p_s_s_f[n * 30 + 5] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_d[(n+1) * 18 + 5], PRIM_INT__p_s_s_f[n * 30 + 5]);
                        ...
                        PRIM_INT__p_s_s_f[n * 30 + 13] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_d[n * 18 + 9]);
                        PRIM_INT__p_s_s_f[n * 30 + 13] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_d[(n+1) * 18 + 9], PRIM_INT__p_s_s_f[n * 30 + 13]);

                        PRIM_INT__p_s_s_f[n * 30 + 15] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_d[n * 18 + 11]);
                        PRIM_INT__p_s_s_f[n * 30 + 15] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_d[(n+1) * 18 + 11], PRIM_INT__p_s_s_f[n * 30 + 15]);
                        ...
                        PRIM_INT__p_s_s_f[n * 30 + 23] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_d[n * 18 + 15]);
                        PRIM_INT__p_s_s_f[n * 30 + 23] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_d[(n+1) * 18 + 15], PRIM_INT__p_s_s_f[n * 30 + 23]);

                        PRIM_INT__p_s_s_f[n * 30 + 25] = SIMINT_MUL(Q_PB[0], PRIM_INT__p_s_s_d[n * 18 + 17]);
                        PRIM_INT__p_s_s_f[n * 30 + 25] = SIMINT_FMADD( aoq_PQ[0], PRIM_INT__p_s_s_d[(n+1) * 18 + 17], PRIM_INT__p_s_s_f[n * 30 + 25]);
                    ...
                    // Forming PRIM_INT__f_s_s_p[4 * 30];
                    for(n = 0; n < 4; ++n)  // loop over orders of auxiliary function
                    {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__d_d_p_f = INT__d_d_p_f + real_abcd * 1080;
