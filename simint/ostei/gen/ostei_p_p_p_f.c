                  ...
                  double * const restrict INT__p_p_p_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_p_p_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__d_s_s_f = work + (SIMINT_NSHELL_SIMD * 75);
    double * const INT__d_s_s_g = work + (SIMINT_NSHELL_SIMD * 135);
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*225);
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_s = primwork + 0;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_p = primwork + 7;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_d = primwork + 25;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_f = primwork + 55;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_s_g = primwork + 95;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_d = primwork + 140;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_f = primwork + 176;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_g = primwork + 236;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_f = primwork + 326;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_g = primwork + 386;
    double * const hrrwork = (double *)(primwork + 476);
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 225 * sizeof(double));
            abcd = 0;
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    // Forming PRIM_INT__s_s_s_f[4 * 10];
                    ...
                    // Forming PRIM_INT__s_s_s_g[3 * 15];
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_p_p_f = INT__p_p_p_f + real_abcd * 270;
