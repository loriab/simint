                  ...
                  double * const restrict INT__f_f_f_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__f_f_f_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__i_s_f_s = work + (SIMINT_NSHELL_SIMD * 3404);
    double * const INT__i_s_g_s = work + (SIMINT_NSHELL_SIMD * 3684);
    double * const INT__i_s_h_s = work + (SIMINT_NSHELL_SIMD * 4104);
    double * const INT__i_s_i_s = work + (SIMINT_NSHELL_SIMD * 4692);
    SIMINT_DBLTYPE * const primwork = (SIMINT_DBLTYPE *)(work + SIMINT_NSHELL_SIMD*5476);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_s_f_s = primwork + 61;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_s_s = primwork + 101;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_p_s = primwork + 137;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_d_s = primwork + 191;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_f_s = primwork + 281;
    SIMINT_DBLTYPE * const restrict PRIM_INT__p_s_g_s = primwork + 401;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_s_s = primwork + 536;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_p_s = primwork + 602;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_d_s = primwork + 710;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_f_s = primwork + 890;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_g_s = primwork + 1130;
    SIMINT_DBLTYPE * const restrict PRIM_INT__d_s_h_s = primwork + 1400;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_s_s = primwork + 1652;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_p_s = primwork + 1752;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_d_s = primwork + 1932;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_f_s = primwork + 2232;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_g_s = primwork + 2632;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_h_s = primwork + 3082;
    SIMINT_DBLTYPE * const restrict PRIM_INT__f_s_i_s = primwork + 3502;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_s_s = primwork + 3782;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_p_s = primwork + 3917;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_d_s = primwork + 4187;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_f_s = primwork + 4637;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_g_s = primwork + 5237;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_h_s = primwork + 5912;
    SIMINT_DBLTYPE * const restrict PRIM_INT__g_s_i_s = primwork + 6542;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_s_s = primwork + 6962;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_p_s = primwork + 7130;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_d_s = primwork + 7508;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_f_s = primwork + 8138;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_g_s = primwork + 8978;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_h_s = primwork + 9923;
    SIMINT_DBLTYPE * const restrict PRIM_INT__h_s_i_s = primwork + 10805;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_s_s = primwork + 11393;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_p_s = primwork + 11589;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_d_s = primwork + 12093;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_f_s = primwork + 12933;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_g_s = primwork + 14053;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_h_s = primwork + 15313;
    SIMINT_DBLTYPE * const restrict PRIM_INT__i_s_i_s = primwork + 16489;
    double * const hrrwork = (double *)(primwork + 17273);
    ...
    double * const HRR_INT__f_d_g_s = hrrwork + 2820;
    double * const HRR_INT__f_d_h_s = hrrwork + 3720;
    double * const HRR_INT__f_d_i_s = hrrwork + 4980;
    double * const HRR_INT__f_f_f_s = hrrwork + 6660;
    double * const HRR_INT__f_f_f_p = hrrwork + 7660;
    double * const HRR_INT__f_f_f_d = hrrwork + 10660;
    double * const HRR_INT__f_f_g_s = hrrwork + 16660;
    double * const HRR_INT__f_f_g_p = hrrwork + 18160;
    double * const HRR_INT__f_f_g_d = hrrwork + 22660;
    double * const HRR_INT__f_f_h_s = hrrwork + 31660;
    double * const HRR_INT__f_f_h_p = hrrwork + 33760;
    double * const HRR_INT__f_f_i_s = hrrwork + 40060;
    double * const HRR_INT__g_p_f_s = hrrwork + 42860;
    double * const HRR_INT__g_p_g_s = hrrwork + 43310;
    double * const HRR_INT__g_p_h_s = hrrwork + 43985;
    double * const HRR_INT__g_p_i_s = hrrwork + 44930;
    double * const HRR_INT__g_d_f_s = hrrwork + 46190;
    double * const HRR_INT__g_d_g_s = hrrwork + 47090;
    double * const HRR_INT__g_d_h_s = hrrwork + 48440;
    double * const HRR_INT__g_d_i_s = hrrwork + 50330;
    double * const HRR_INT__h_p_f_s = hrrwork + 52850;
    double * const HRR_INT__h_p_g_s = hrrwork + 53480;
    double * const HRR_INT__h_p_h_s = hrrwork + 54425;
    double * const HRR_INT__h_p_i_s = hrrwork + 55748;
    ...
    for(ab = 0; ab < P.nshell12_clip; ++ab)
    {
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            memset(work, 0, SIMINT_NSHELL_SIMD * 5476 * sizeof(double));
            abcd = 0;
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__f_f_f_f = INT__f_f_f_f + real_abcd * 10000;
