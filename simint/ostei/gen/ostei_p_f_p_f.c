                  ...
                  double * const restrict INT__p_f_p_f)
{
    ...
    SIMINT_ASSUME_ALIGN_DBL(INT__p_f_p_f);
    int ab, cd, abcd;
    int istart, jstart;
    ...
    double * const INT__s_g_s_g = work + (SIMINT_NSHELL_SIMD * 400);
    ...
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_p = primwork + 45;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_p_s_d = primwork + 81;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_s = primwork + 135;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_p = primwork + 177;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_d = primwork + 249;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_d_s_f = primwork + 357;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_s = primwork + 477;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_p = primwork + 537;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_d = primwork + 657;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_f = primwork + 837;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_f_s_g = primwork + 1037;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_s = primwork + 1187;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_p = primwork + 1262;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_d = primwork + 1442;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_f = primwork + 1712;
    SIMINT_DBLTYPE * const restrict PRIM_INT__s_g_s_g = primwork + 2012;
        ...
        for(cd = 0; cd < Q.nshell12_clip; cd += SIMINT_NSHELL_SIMD)
        {
            ...
            for(i = istart; i < iend; ++i)
            {
                ...
                for(j = jstart; j < jend; j += SIMINT_SIMD_LEN)
                {
                    ...
                    // Forming PRIM_INT__s_f_s_p[4 * 30];
                    ...
                    // Forming PRIM_INT__s_d_s_p[4 * 18];
                    for(n = 0; n < 4; ++n)  // loop over orders of auxiliary function
                    {
            ...
            for(abcd = 0; abcd < nshellbatch; ++abcd, ++real_abcd)
            {
                ...
                double * restrict HRR_INT__p_f_p_f = INT__p_f_p_f + real_abcd * 900;
